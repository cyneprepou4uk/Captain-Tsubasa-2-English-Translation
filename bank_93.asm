...
loc_0x027010:
C D 1 - - - 0x027010 13:B000: A9 00     LDA #con_chr_bank + $00
C - - - - - 0x027012 13:B002: 8D 90 04  STA ram_chr_bank
C - - - - - 0x027015 13:B005: A9 02     LDA #con_chr_bank + $02
C - - - - - 0x027017 13:B007: 8D 91 04  STA ram_chr_bank + $01
C - - - - - 0x02701A 13:B00A: 8D 87 00  STA ram_0087_chr_bank
C - - - - - 0x02701D 13:B00D: A9 67     LDA #< tbl_B467_credits
C - - - - - 0x02701F 13:B00F: 85 88     STA ram_0088_t01_data_credits
C - - - - - 0x027021 13:B011: A9 B4     LDA #> tbl_B467_credits
C - - - - - 0x027023 13:B013: 85 89     STA ram_0088_t01_data_credits + $01
...
loc_B02D_loop:
C D 1 - - - 0x02703D 13:B02D: A4 8A     LDY ram_008A_t01_data_index
C - - - - - 0x02703F 13:B02F: B1 88     LDA (ram_0088_t01_data_credits),Y
C - - - - - 0x027041 13:B031: C9 E0     CMP #$E0
C - - - - - 0x027043 13:B033: 90 08     BCC bra_B03D
C - - - - - 0x027045 13:B035: E6 8A     INC ram_008A_t01_data_index
...
C - - - - - 0x02707F 13:B06F: A5 8B     LDA ram_008B_t02
C - - - - - 0x02708B 13:B07B: 8D A7 04  STA ram_04A7
C - - - - - 0x02709C 13:B08C: A5 8B     LDA ram_0086_смещение_текста_lo
                                        PHA
                                        AND #$E0
                                        STA ram_04A6
                                        PLA
...
C - - - - - 0x0270A2 13:B092: A4 8A     LDY ram_008A_t01_data_index
C - - - - - 0x0270A4 13:B094: B1 88     LDA (ram_0088_t01_data_credits),Y
...
C - - - - - 0x0270B5 13:B0A5: E6 8A     INC ram_008A_t01_data_index
...
C D 1 - - - 0x0270BF 13:B0AF: A4 8A     LDY ram_008A_t01_data_index
C - - - - - 0x0270C1 13:B0B1: B1 88     LDA (ram_0088_t01_data_credits),Y
C - - - - - 0x0270C3 13:B0B3: C9 E0     CMP #$E0
C - - - - - 0x0270C5 13:B0B5: 90 01     BCC bra_B0B8_00_DF
; E0-FF
C - - - - - 0x0270C7 13:B0B7: 60        RTS
bra_B0B8_00_DF:
C - - - - - 0x0270C8 13:B0B8: E6 8A     INC ram_008A_t01_data_index
...
C - - - - - 0x0270FA 13:B0EA: A5 8B     LDA ram_0086_смещение_текста_lo
...
C - - - - - 0x02712D 13:B11D: A5 8B     INC ram_0086_смещение_текста_lo
...
sub_B127_позиция_спрайта_для_скрытия_буквы:
                                        STA ram_003A_t16
                                        LDA ram_0086_смещение_текста_lo
                                        AND #$1F
                                        ASL
                                        ASL
                                        ASL
...
C D 1 - - - 0x027349 13:B339: A5 8A     LDA ram_008A_t01_data_index
C - - - - - 0x02734B 13:B33B: 18        CLC
C - - - - - 0x02734C 13:B33C: 65 88     ADC ram_0088_t01_data_credits
C - - - - - 0x02734E 13:B33E: 85 88     STA ram_0088_t01_data_credits
C - - - - - 0x027350 13:B340: 90 02     BCC bra_B344_not_overflow
C - - - - - 0x027352 13:B342: E6 89     INC ram_0088_t01_data_credits + $01
bra_B344_not_overflow:
C - - - - - 0x027354 13:B344: A9 00     LDA #$00
C - - - - - 0x027356 13:B346: 85 8A     STA ram_008A_t01_data_index
...
C - - - - - 0x0271BD 13:B1AD: B1 88     LDA (ram_0088_t01_data_credits),Y
...
C - - - - - 0x0271E8 13:B1D8: 69 15     ADC #con_003C_размер_массива
C - - - - - 0x0271EA 13:B1DA: AA        TAX
C - - - - - 0x0271EB 13:B1DB: E0 7E     CPX #con_003C_размер_массива * $06
...
bra_B1A8_loop_очистка_экрана:
                                        PHA
bra_B1A9_loop_ожидание_очистки:
                                        LDA #$81
                                        STA ram_0515_buffer_flag
                                        LDA #$01
...
C - - - - - 0x027209 13:B1F9: B1 88     LDA (ram_0088_t01_data_credits),Y
C - - - - - 0x02720B 13:B1FB: 48        PHA
C - - - - - 0x02720C 13:B1FC: C8        INY
C - - - - - 0x02720D 13:B1FD: B1 88     LDA (ram_0088_t01_data_credits),Y
C - - - - - 0x02720F 13:B1FF: C8        INY
C - - - - - 0x027210 13:B200: 84 8A     STY ram_008A_t01_data_index
...
C - - - - - 0x027231 13:B221: 85 8B     STA ram_0086_смещение_текста_lo
                                        INY
                                        LDA (ram_0088_t01_data_credits),Y
                                        STA ram_008B_t02
                                        INY
                                        STY ram_008A_t01_data_index
...
C - - - - - 0x0272BF 13:B2AF: 85 3A     STA ram_003A_t22
...
C - - - - - 0x0272CD 13:B2BD: 05 3A     ORA ram_003A_t22
C - - - - - 0x0272CF 13:B2BF: A4 3A     LDY ram_003A_t22
...
C - - - - - 0x0272E3 13:B2D3: A5 3A     LDA ram_003A_t22
...
C - - - - - 0x027363 13:B353: 85 4B     STA ram_004B_t02_scroll_Y
...
C - - - - - 0x027372 13:B362: 85 4A     STA ram_004A_t02_scroll_X_хз
...
C - - - - - 0x027419 13:B409: 86 8B     STX ram_008B_t01_ppu_addr_hi
C - - - - - 0x02741B 13:B40B: 86 8A     STX ram_008A_t03_ppu_addr_lo
...
C - - - - - 0x02743B 13:B42B: A6 8A     LDX ram_008A_t03_ppu_addr_lo
C - - - - - 0x02743D 13:B42D: 8E A6 04  STX ram_04A6
C - - - - - 0x027440 13:B430: 68        PLA
C - - - - - 0x027441 13:B431: 48        PHA
C - - - - - 0x027442 13:B432: 05 8B     ORA ram_008B_t01_ppu_addr_hi
...
C - - - - - 0x027450 13:B440: 85 8A     STA ram_008A_t03_ppu_addr_lo
C - - - - - 0x027452 13:B442: A5 8B     LDA ram_008B_t01_ppu_addr_hi
C - - - - - 0x027454 13:B444: 69 00     ADC #> $0020
C - - - - - 0x027456 13:B446: 85 8B     STA ram_008B_t01_ppu_addr_hi
