...
.export loc_0x020031_обработка_байтов_сценария
...
loc_0x020031_обработка_байтов_сценария:
...
loc_803F_loop:
C D 0 - - - 0x02004F 10:803F: A4 3A     LDY ram_003A_t12_data_index_scenario
C - - - - - 0x020051 10:8041: E6 3A     INC ram_003A_t12_data_index_scenario
...
C - - - - - 0x02006C 10:805C: A4 3A     LDY ram_003A_t12_data_index_scenario
C - - - - - 0x02006E 10:805E: E6 3A     INC ram_003A_t12_data_index_scenario
C - - - - - 0x020070 10:8060: B1 5D     LDA (ram_005D_t02_data_scenario),Y
C - - - - - 0x020079 10:8069: 8D 24 05  STA ram_фон_анимации
C - - - - - 0x02007C 10:806C: A4 3A     LDY ram_003A_t12_data_index_scenario
C - - - - - 0x02007E 10:806E: E6 3A     INC ram_003A_t12_data_index_scenario
C - - - - - 0x020080 10:8070: B1 5D     LDA (ram_005D_t02_data_scenario),Y
C - - - - - 0x020089 10:8079: 8D 28 05  STA ram_for_053C_номер_анимации
C - - - - - 0x02008C 10:807C: A4 3A     LDY ram_003A_t12_data_index_scenario
C - - - - - 0x02008E 10:807E: E6 3A     INC ram_003A_t12_data_index_scenario
...
loc_808C:
; 00-FC, FF
C - - - - - 0x02009C 10:808C: A5 3A     LDA ram_003A_t12_data_index_scenario
...
C - - - - - 0x0200B5 10:80A5: 20 0F C5  JMP loc_0x03CAF7_подготовить_подпрограмму_в_стеке
...
C - - - - - 0x020112 10:8102: 85 3A     STA ram_003A_t12_data_index_scenario
...
C - - - - - 0x020122 10:8112: 65 3A     ADC ram_003A_t12_data_index_scenario
...
C - - - - - 0x02013C 10:812C: 85 3A     STA ram_003A_t12_data_index_scenario
...
C - - - - - 0x020142 10:8132: 65 3A     ADC ram_003A_t12_data_index_scenario
...
loc_8150_отнять_хп_за_смерть_игрока___X_01:
...
C - - - - - 0x02025D 10:824D: 20 50 81  JMP loc_8150_отнять_хп_за_смерть_игрока___X_01
bra_8250_RTS:
...
C - - - - - 0x020401 10:83F1: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
...
; C - - - - - 0x0204A4 10:8494: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
; bra_8497_RTS:
...
; C - - - - - 0x0204BE 10:84AE: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
; bra_84B1_RTS:
...
C - - - - - 0x020578 10:8568: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
bra_856B_RTS:
...
C - - - - - 0x02061C 10:860C: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
...
C - - - - - 0x020696 10:8686: 20 50 81  JMP loc_8150_отнять_хп_за_смерть_игрока___X_01
bra_8689_RTS:
...
C - - - - - 0x0206B2 10:86A2: 20 11 82  JMP loc_8211_выставить_флаг_сценария_04
...
C - - - - - 0x020827 10:8817: 84 3A     STY ram_003A_t12_data_index_scenario
...
C - - - - - 0x02082D 10:881D: A5 3A     LDA ram_003A_t12_data_index_scenario
...
C - - - - - 0x020860 10:8850: 85 3A     STA ram_003A_t12_data_index_scenario
...
C - - - - - 0x020929 10:8919: AE 46 04  LDX ram_drive_overhead_flag
...
C - - - - - 0x020937 10:8927: AE 46 04  LDX ram_drive_overhead_flag
...
C - - - - - 0x020943 10:8933: EE 46 04  INC ram_drive_overhead_flag
...
C - - - - - 0x02097B 10:896B: 2C 49 04  BIT ram_drive_tiger_flag
C - - - - - 0x02097E 10:896E: 30 1E     BMI bra_898E_RTS
C - - - - - 0x020980 10:8970: EE 49 04  INC ram_drive_tiger_flag
C - - - - - 0x020983 10:8973: AD 49 04  LDA ram_drive_tiger_flag
...
C - - - - - 0x020995 10:8985: 8D 4A 04  STA ram_drive_tiger_timer
C - - - - - 0x020998 10:8988: A9 80     LDA #$80
C - - - - - 0x02099A 10:898A: E8        INX
bra_898B_не_активировать_спешал:
C - - - - - 0x02099B 10:898B: 8D 49 04  STA ram_drive_tiger_flag
bra_898E_RTS:
                ...
                ; защитник кипер/dive
                    ...
                    .byte off_case_02_01_00_01 - * ; high
                        ...
                        ; защитник кипер/dive/high
                            .byte con_8A09_soundID_delay, con_sfx_25, $02
...
; con_s_id_17
    ...
    .byte con_8A09_F7, $1F
    .byte con_8A09_soundID_delay, con_sfx_гроза, $02
    ...
    .byte con_8A09_soundID_delay, con_sfx_2B, $02
    .byte con_8A09_pause + $28
    .byte con_s_bg_01
    .byte con_s_anim_66
    ...
    .byte con_8A09_mirror_toggle
    .byte con_8A09_soundID_delay, con_sfx_2B, $31
    ...
    .byte con_s_cloud_FF_skip
    .byte con_8A09_mirror_toggle
    .byte con_8A09_soundID_delay, con_sfx_04, $02
    ...
    .byte con_8A09_F7, $33
    .byte con_8A09_soundID_delay, con_sfx_05, $02
    ...
    .byte con_s_cloud_clear
    .byte con_8A09_F7, $03
    .byte con_8A09_soundID_delay, con_sfx_61, $02
    .byte con_8A09_pause + $64
    .byte con_s_bg_07
    .byte con_s_anim_45
...
; con_s_id_1A
    ...
    .byte off_case_1A_01 - * ; спешал перепасовка
        ...
        ; обычная перепасовка
            ...
            .byte con_s_anim_7B
            .byte con_s_cloud_FF_skip
            .byte con_8A09_soundID_delay, con_sfx_2C, $1D
            .byte con_8A09_pause + $3C
            .byte con_s_bg_3C
            .byte con_s_anim_7C
        ...
        ; спешал перепасовка
            ...
            .byte off_case_1A_01_11 - * ; игрок без спешал перепасовки
                ...
                ; спешал перепасовка/p_tsubasa_my
                    .byte con_8A09_soundID_delay, con_sfx_2C, $21
                    .byte con_8A09_pause + $28
                    .byte con_s_bg_36
                    .byte con_s_anim_95
...
sub_B4BF_мяч_улетает_в_аут:
    .byte con_8A09_soundID_delay, con_sfx_64, $0B
...
loc_9C28_гол_и_проверка_на_рваную_сетку:
    ...
    .byte off_case_A267_01 - * ; сетка порвана
        ...
        off_case_A25D_00:
            .byte con_8A09_F7, $03
            .byte con_8A09_soundID_delay, con_sfx_60, $02
            .byte con_8A09_pause + $78
            .byte con_s_bg_07
            .byte con_s_anim_44
            .byte con_s_cloud_F0_default ; s_cloud_28
...
; вакашимазу отталкивается от штанги
                    ...
                    .byte con_8A09_F7, $05
                    .byte con_8A09_soundID_delay, con_sfx_68, $21
                    .byte con_8A09_pause + $2D
                    .byte con_s_bg_FF_skip
                    .byte con_s_anim_4D
                    .byte con_s_cloud_FF_skip
...
loc_9CA3_анимация_дриблинга_трудной_обводки:
                    ...
                    .byte con_8A09_F7, $24
                    .byte con_8A09_soundID_delay, con_sfx_68, $02
                    .byte con_8A09_pause + $10
                    .byte con_s_bg_6B
                    .byte con_s_anim_FF_skip
                    .byte con_s_cloud_FF_skip
loc_A7FE_движение_фона_после_дриблинга:
                ...
                ; dribble/vanishing feint
                    ...
                    .byte con_s_cloud_clear
                    .byte con_8A09_F7, $02
                    .byte con_8A09_soundID_delay, con_sfx_11, $02
                ...
                ; dribble/high speed dribble
                    ...
                    .byte con_8A09_F7, $0D
                    .byte con_8A09_soundID_delay, con_sfx_26, $02
                    .byte con_8A09_pause + $1E
                    .byte con_s_bg_47
                    .byte con_s_anim_D1
                    .byte con_s_cloud_F0_default ; s_cloud_45
    ...
    .word bra_long_case_9CF3_22 ; double eel
        ...
        ; drive shot
            ...
            .byte off_case_9CF3_03_02 - * ; con_p_diaz_argentina
                ...
                loc_AB57:
                    ...
                    .word sub_BBC7_очистка
                loc_AB58:
                    .byte con_8A09_soundID_delay, con_sfx_16, $02
                    .byte con_8A09_pause + $28
                    .byte con_s_bg_4A
                    .byte con_s_anim_8E
        ...
        ; falcon shot
            ...
            .byte off_case_9CF3_05_01 - * ; con_p_nitta_japan
                ...
                loc_ABD4:
                    ...
                    .word sub_AB86
                    .byte con_8A09_F7, $02
                    .byte con_8A09_soundID_delay, con_sfx_06, $02
                    .byte con_8A09_pause + $20
                    .byte con_s_bg_25
                    .byte con_s_anim_63
                    .byte con_s_cloud_FF_skip
        ...
        ; razor shot
            ...
            .byte off_case_9CF3_07_01 - * ; con_p_soda_tatsunami
                ...
                loc_ABF8:
                    .byte con_8A09_F7, $0D
                    .byte con_8A09_soundID_delay, con_sfx_17, $02
                    .byte con_8A09_pause + $3C
                    .byte con_s_bg_6A
                    .byte con_s_anim_9D
                    .byte con_s_cloud_F0_default ; s_cloud_49
                    .byte con_8A09_F7, $15
                    .byte con_8A09_soundID_delay, con_sfx_1D, $09
                    .byte con_8A09_pause + $20
                    .byte con_s_bg_05
                    .byte con_s_anim_CE
                    .byte con_s_cloud_FF_skip
        ...
        ; eagle shot
            ...
            .byte off_case_9CF3_0B_01 - * ; con_p_matsuyama_furano
                ...
                loc_AC2B:
                    ...
                    .word sub_BBC7_очистка
                    .byte con_8A09_F7, $19
                    .byte con_8A09_soundID_delay, con_sfx_15, $02
                    .byte con_8A09_pause + $28
                    .byte con_s_bg_49
                    .byte con_s_anim_8E
                    .byte con_s_cloud_F0_default ; s_cloud_49
                ...
                ; neo tiger shot/нет_защитников
                    ...
                    .byte off_case_9CF3_0D_00_01 - * ; con_p_hyuga_toho
                        ...
                        loc_AC7A:
                            ...
                            .byte con_s_cloud_F0_default ; s_cloud_49
                            .byte con_8A09_F7, $04
                            .byte con_8A09_soundID_delay, con_sfx_13, $02
                            .byte con_8A09_pause + $1E
                            .byte con_s_bg_41
                            .byte con_s_anim_8C
        ...
        ; drive tiger
            ...
            .byte con_s_cloud_FF_skip
            .byte con_8A09_F7, $10
            .byte con_8A09_soundID_delay, con_sfx_гроза, $11
            .byte con_8A09_pause + $14
            .byte con_s_bg_05
            .byte con_s_anim_00
            ...
            .byte con_s_cloud_FF_skip
            .byte con_8A09_F7, $23
            .byte con_8A09_soundID_delay, con_sfx_0A, $02
            .byte con_8A09_pause + $3C
            .byte con_s_bg_27
            .byte con_s_anim_DC
            .byte con_s_cloud_clear
            ...
            .byte con_8A09_mirror_toggle
            .byte con_8A09_soundID_delay, con_sfx_08, $02
        ...
        loc_AD25:
            ...
            .byte con_8A09_jsr
            .word sub_ABAE
            .byte con_8A09_soundID_delay, con_sfx_0E, $02
            ...
            .byte con_s_cloud_F0_default ; s_cloud_49
            .byte con_8A09_F7, $3D
            .byte con_8A09_soundID_delay, con_sfx_1B, $21
            .byte con_8A09_pause + $46
            .byte con_s_bg_51
            .byte con_s_anim_E8
            .byte con_s_cloud_FF_skip
        ...
        ; booster shot
            ...
            .byte con_s_cloud_clear
            .byte con_8A09_F7, $29
            .byte con_8A09_soundID_delay, con_sfx_14, $02
            .byte con_8A09_pause + $1E
            .byte con_s_bg_47
            .byte con_s_anim_E9
            ...
            .byte con_8A09_F7, $3E
            .byte con_8A09_moving_bg, $02
            .byte con_8A09_soundID_delay, con_sfx_0B, $02
            .byte con_8A09_pause + $28
            .byte con_s_bg_58
            .byte con_s_anim_C5
            .byte con_s_cloud_FF_skip
        ...
        ; fire shot
            ...
            .byte con_s_cloud_F0_default ; s_cloud_49
            .byte con_8A09_F7, $04
            .byte con_8A09_soundID_delay, con_sfx_13, $10
            .byte con_8A09_pause + $10
            .byte con_s_bg_41
            .byte con_s_anim_8C
...
loc_9D52_выбор_анимации_удара_по_высокому_мячу:
    ...
    .word bra_long_case_9D52_FF ; 22
        ...
        ; skylab hurricane
            .byte con_8A09_soundID_delay, con_sfx_1A, $21
        ...
        ; overhead
            ...
            .byte off_case_9D52_0E_21 - * ; con_p_kaltz_west_germany
                ...
                ; cyclone
                    .byte con_8A09_mirror_off
                    .byte con_8A09_soundID_delay, con_sfx_2B, $19
                    .byte con_8A09_pause + $3C
                    .byte con_s_bg_29
                    .byte con_s_anim_C6
                    .byte con_s_cloud_clear
...
sub_B0A7_tsubasa_cyclone_полная_анимация:
                    .byte con_8A09_soundID_delay, con_sfx_22, $02
                    .byte con_8A09_pause + $64
                    .byte con_s_bg_52
                    .byte con_s_anim_E5
                    .byte con_s_cloud_F0_default ; s_cloud_B5
                    .byte con_8A09_F7, $2F
                    .byte con_8A09_soundID_delay, con_sfx_1F, $02
                    .byte con_8A09_pause + $64
                    .byte con_s_bg_4A
                    .byte con_s_anim_C7
                    .byte con_s_cloud_FF_skip
                    ...
                    .byte con_s_anim_face_p_tsubasa_my
                    .byte con_s_cloud_F0_default ; s_cloud_AF
                    .byte con_8A09_soundID_delay, con_sfx_23, $11
                    .byte con_8A09_F7, $04
                    .byte con_8A09_pause + $28
                    .byte con_s_bg_41
                    .byte con_s_anim_8C
                ...
                ; rising dragon kick
                    .byte con_8A09_soundID_delay, con_sfx_1A, $02
                    .byte con_8A09_pause + $1E
                    .byte con_s_bg_1D
                    .byte con_s_anim_69
                    .byte con_s_cloud_F0_default ; s_cloud_49
        ...
        ; twin shot
            ...
            .byte off_case_9D9A_09_11 - * ; south_korea без рож
                ...
                loc_B1F6_мяч_улетает_от_игроков_после_twin_shot:
                    .byte con_8A09_F7, $23
                    .byte con_8A09_soundID_delay, con_sfx_09, $02
                    .byte con_8A09_pause + $46
                    .byte con_s_bg_27
                    .byte con_s_anim_DC
                    .byte con_s_cloud_FF_skip
...
loc_AD0C_cyclone:
        ...
        ; foward somersault
            ...
            .byte con_s_cloud_F0_default ; s_cloud_49
            .byte con_8A09_F7, $19
            .byte con_8A09_soundID_delay, con_sfx_1A, $11
            .byte con_8A09_pause + $28
            .byte con_s_bg_5C
            .byte con_s_anim_CD
            .byte con_s_cloud_FF_skip
            ...
            loc_B0FB_slider_cannon:
                ...
                off_case_9D9A_21_00:
                    ...
                    .byte con_s_anim_00
                    .byte con_s_cloud_clear
                    .byte con_8A09_soundID_delay, con_music_46, $02
                    .byte con_8A09_pause + $10
                    .byte con_s_bg_54
                    .byte con_s_anim_D4
                    .byte con_s_cloud_clear
                    ...
                    .byte con_s_anim_face_p_pierre_france
                    .byte con_s_cloud_F0_default ; s_cloud_8D
                    .byte con_8A09_soundID_delay, con_sfx_7F, $02
                    .byte con_8A09_jsr
                    .word sub_BBC7_очистка
                loc_9D9A_slider_cannon_без_катсцены:
                    ...
                    .byte con_s_cloud_FF_skip
                    .byte con_8A09_F7, $31
                    .byte con_8A09_soundID_delay, con_sfx_24, $02
...
loc_9E45_выбор_анимации_паса_с_земли_или_по_низкому_мячу:
    ...
    .byte off_case_9E45_03 - * ; topspin pass
        ...
        off_case_9E45_00:
        ; pass
            .byte con_8A09_soundID_delay, con_sfx_2B, $05
            .byte con_8A09_pause + $3C
            .byte con_s_bg_72
            .byte con_s_anim_66
            .byte con_s_cloud_F0_default ; s_cloud_47
        ...
        ; drive pass
            ...
            .byte con_8A09_F7, $10
            .byte con_8A09_soundID_delay, con_sfx_12, $02
            .byte con_8A09_pause + $14
            .byte con_s_bg_10
            .byte con_s_anim_62
            .byte con_s_cloud_FF_skip
        ...
        ; topspin pass
            ...
            .byte con_s_cloud_F0_default ; s_cloud_49
            .byte con_8A09_F7, $02
            .byte con_8A09_soundID_delay, con_sfx_07, $02
            .byte con_8A09_pause + $37
            .byte con_s_bg_24
            .byte con_s_anim_66
            .byte con_s_cloud_FF_skip
...
loc_9E4F_пас_головой_в_воздухе:
    .byte con_8A09_soundID_delay, con_sfx_2B, $15     ; отбитие мяча
...
sub_B4E7_конечный_полет_обычного_удара_с_земли:
            .byte con_8A09_soundID_delay, con_sfx_03, $02
            .byte con_8A09_pause + $3C
            .byte con_s_bg_1F
            .byte con_s_anim_84
            .byte con_s_cloud_clear
        ...
        ; eagle shot
            .byte con_8A09_jsr
            .word sub_BB85
            .byte con_8A09_soundID_delay, con_sfx_5E, $02
            .byte con_8A09_pause + $1E
            .byte con_s_bg_35
            .byte con_s_anim_32
            .byte con_s_cloud_clear
        ...
        ; mach shot
            ...
            .byte con_8A09_mirror_toggle
            .byte con_8A09_F7, $18
            .byte con_8A09_soundID_delay, con_sfx_0C, $02
            .byte con_8A09_pause + $32
            .byte con_s_bg_5D
            .byte con_s_anim_3D
            .byte con_s_cloud_clear
            .byte con_8A09_F7, $18
            .byte con_8A09_soundID_delay, con_sfx_0D, $02
            .byte con_8A09_pause + $20
            .byte con_s_bg_FF_skip
            .byte con_s_anim_00
            .byte con_s_cloud_clear
            ...
            .byte off_case_B61D_17_01 - * ; coimbra уже бил
                ...
                off_case_B61D_17_00:
                ; coimbra еще не бил
                    .byte con_8A09_soundID_delay, con_music_43, $02
                    .byte con_8A09_mirror_off
...
sub_9F9C_крит_кипера:
    ...
    .byte off_case_9F9C_02 - * ; крит wakabayashi
        ...
        off_case_9F9C_02:
        ; крит wakabayashi
            .byte con_8A09_soundID_delay, con_sfx_20, $02     ; звук когда вакабаяши злится
            .byte con_8A09_pause + $78
            .byte con_s_bg_48
            .byte con_s_anim_75
...
sub_9FC7_движение_фона_и_звук:
    .byte con_8A09_mirror_toggle
    .byte con_8A09_moving_bg, $04
    .byte con_8A09_soundID_delay, con_sfx_2A, $02     ; ловля мяча/мяч приклеился
    .byte con_8A09_rts
...
sub_A025_момент_касания_защитником_мяча_телом:
    .byte con_8A09_soundID_delay, con_sfx_2D, $02
    .byte con_8A09_pause + $14
    .byte con_s_bg_FF_skip
    .byte con_s_anim_0D
    .byte con_s_cloud_FF_skip
...
sub_A051_защитник_касается_телом_верхнего_мяча:
    .byte con_8A09_soundID_delay, con_sfx_2D, $02     ; удар мяча об живот
    .byte con_8A09_pause + $1B
    .byte con_s_bg_FF_skip
    .byte con_s_anim_0D
    .byte con_s_cloud_FF_skip
...
loc_A083_кипер_ловит_мяч_после_верхнего_dive:
    .byte con_8A09_F7, $07
    .byte con_8A09_soundID_delay, con_sfx_2A, $21     ; ловля мяча/мяч приклеился
    .byte con_8A09_pause + $50
    .byte con_s_bg_40
    .byte con_s_anim_17
    .byte con_s_cloud_F0_default ; s_cloud_0B
...
sub_A0AE_защитник_прыгает_без_движения_фона:
    .byte con_8A09_soundID_delay, con_sfx_25, $02     ; прыжок
    .byte con_8A09_pause + $14
    .byte con_s_bg_02
    .byte con_s_anim_1C
    .byte con_s_cloud_clear
...
sub_A0B6_защитник_касается_мяча_при_спасении_ворот:
    .byte con_8A09_soundID_delay, con_sfx_2B, $19     ; отбитие мяча/принятие на ногу
...
sub_A131_кипер_легко_отбивает_и_проверка_на_wakashimazu_gertise:
    ...
    .byte off_case_A131_02 - * ; gertise
        ...
        off_case_A131_00:
        ; другой кипер
            .byte con_8A09_soundID_delay, con_sfx_2B, $21     ; отбитие мяча
...
loc_A16E_защитник_ловит_высокий_мяч_ногой:
    .byte con_8A09_soundID_delay, con_sfx_2A, $02
    .byte con_8A09_pause + $46
    .byte con_s_bg_6C
    .byte con_s_anim_2E
    .byte con_s_cloud_F0_default ; s_cloud_16
...
loc_A18D_игрок_делает_clear_ногой:
    .byte con_8A09_F7, $02
    .byte con_8A09_soundID_delay, con_sfx_2C, $29
    .byte con_8A09_pause + $46
    .byte con_s_bg_22
    .byte con_s_anim_33
...
loc_A197_защитник_делает_clear_головой_из_своей_штрафной:
    .byte con_8A09_soundID_delay, con_sfx_2A, $21
    .byte con_8A09_pause + $2D
    .byte con_s_bg_6E
    .byte con_s_anim_34
    .byte con_s_cloud_F0_default ; s_cloud_17
...
sub_A1B1_защитник_выигрывает_нижний_compete:
    .byte con_8A09_moving_bg, $02
    .byte con_8A09_soundID_delay, con_sfx_2B, $1E
    .byte con_8A09_pause + $3A
    .byte con_s_bg_57
    .byte con_s_anim_35
...
sub_A1BB_защитник_выигрывает_верхний_compete:
    .byte con_8A09_soundID_delay, con_sfx_2C, $1E
    .byte con_8A09_pause + $3A
    .byte con_s_bg_6C
    .byte con_s_anim_35
    .byte con_s_cloud_F0_default ; s_cloud_1A
...
sub_A1E4_dark_illusion:
    .byte con_8A09_F7, $41
    .byte con_8A09_soundID_delay, con_sfx_21, $02
...
loc_A22E_игрок_делает_low_clearing_ногой_на_своей_штрафной:
    .byte con_8A09_F7, $02
    .byte con_8A09_soundID_delay, con_sfx_2C, $26
    .byte con_8A09_pause + $50
    .byte con_s_bg_22
    .byte con_s_anim_38
...
loc_A238_игрок_делает_clear_головой:
    .byte con_8A09_soundID_delay, con_sfx_2B, $21
    .byte con_8A09_pause + $56
    .byte con_s_bg_6D
    .byte con_s_anim_39
    .byte con_s_cloud_F0_default ; s_cloud_24
...
sub_A24E_штанга_со_звуком:
    .byte con_8A09_F7, $1F
    .byte con_8A09_soundID_delay, con_sfx_попадание_по_штанге, $02
loc_A253_штанга:
    .byte con_8A09_pause + $10
    .byte con_s_bg_06
    .byte con_s_anim_43
...
sub_A2DD_ярко_красное_мерцание:
    .byte con_8A09_F7, $0F
    .byte con_8A09_soundID_delay, con_sfx_2E, $02
loc_A2E2_мерцание:
...
sub_A2F4_сообщение_oops_на_мигающем_белом_фоне:
    .byte con_8A09_F7, $10
    .byte con_8A09_soundID_delay, con_sfx_65, $02
    .byte con_8A09_pause + $1E
    .byte con_s_bg_05
    .byte con_s_anim_00
...
loc_A35B_нарушение:
    .byte con_8A09_mirror_off
    .byte con_8A09_soundID_delay, con_sfx_67, $02
    .byte con_8A09_pause + $70
    .byte con_s_bg_0C
    .byte con_s_anim_4E
...
; p_galvan_argentina
    .byte con_8A09_moving_bg, $02
    .byte con_8A09_soundID_delay, con_sfx_27, $02
    .byte con_8A09_pause + $14
    .byte con_s_bg_59
    .byte con_s_anim_58
...
off_case_A3CF_FF_no_special_defense:
    ...
    .word sub_A5A9_kurae
    .byte con_8A09_moving_bg, $03
    .byte con_8A09_soundID_delay, con_sfx_28, $02
    .byte con_8A09_pause + $50
    .byte con_s_bg_57
    .byte con_s_anim_50
...
sub_A470_loop_power_tackle:
    .byte con_8A09_moving_bg, $02
    .byte con_8A09_soundID_delay, con_sfx_0F, $02
    .byte con_8A09_pause + $0A
    .byte con_s_bg_57
    .byte con_s_anim_50
    .byte con_s_cloud_FF_skip
...
loc_A74A_красное_мерцание_экрана_и_звук:
    .byte con_8A09_F7, $1E
    .byte con_8A09_soundID_delay, con_sfx_6D, $02
    .byte con_8A09_pause + $1E
    .byte con_s_bg_05
    .byte con_s_anim_FF_skip
    .byte con_s_cloud_FF_skip
...
sub_A810_анимация_heel_lift:
    .byte con_8A09_F7, $02
    .byte con_8A09_soundID_delay, con_sfx_1E, $31
    .byte con_8A09_pause + $3F
    .byte con_s_bg_23
    .byte con_s_anim_E2
    .byte con_s_cloud_F0_default ; s_cloud_49
...
sub_A86C_vanishing_feint:
    .byte con_8A09_F7, $02
    .byte con_8A09_soundID_delay, con_sfx_0C, $0D
    .byte con_8A09_pause + $10
    .byte con_s_bg_23
    .byte con_s_anim_DD
    .byte con_s_cloud_clear
...
sub_A8AB_clone_dribble:
    .byte con_8A09_F7, $02
    .byte con_8A09_soundID_delay, con_sfx_1F, $0D
...
sub_AB31_полная_анимация_обычного_удара_с_земли:
    .byte con_8A09_mirror_off
    .byte con_8A09_soundID_delay, con_sfx_19, $02
    .byte con_8A09_pause + $28
    .byte con_s_bg_01
    .byte con_s_anim_61
    .byte con_s_cloud_F0_default ; s_cloud_47
...
sub_ABB8:
    ...
    .byte con_s_cloud_F0_default ; s_cloud_49
    .byte con_8A09_F7, $04
    .byte con_8A09_soundID_delay, con_sfx_18, $02
    .byte con_8A09_pause + $14
    .byte con_s_bg_05
    .byte con_s_anim_FF_skip
    .byte con_s_cloud_FF_skip
...
loc_B4A6_игрок_принимает_пас_на_ногу:
    .byte con_8A09_soundID_delay, con_sfx_2C, $02
    .byte con_8A09_pause + $3C
    .byte con_s_bg_01
    .byte con_s_anim_78
...
loc_B4AE_игрок_принимает_пас_на_грудь:
    .byte con_8A09_soundID_delay, con_sfx_2C, $11
    .byte con_8A09_pause + $38
    .byte con_s_bg_63
    .byte con_s_anim_7A
    .byte con_s_cloud_F0_default ; s_cloud_6E
...
; slider shot
    .byte con_8A09_jsr
    .word sub_BBB7
    .byte con_8A09_soundID_delay, con_sfx_10, $02
    .byte con_8A09_pause + $37
    .byte con_s_bg_5B
    .byte con_s_anim_5E
    .byte con_s_cloud_clear
                ...
                ; мяч центр, кипер центр
                    ...
                    .byte off_case_21_01_04_02 - * ; кипер промахивается и штанга (нереальный случай)
                        ...
                        ; кипер отбивает
                            ...
                            .byte con_s_cloud_FF_skip
                            .byte con_8A09_mirror_toggle
                            .byte con_8A09_soundID_delay, con_sfx_7E, $02
                            .byte con_8A09_pause + $3C
                            .byte con_s_bg_20
                            .byte con_s_anim_52
                            .byte con_s_cloud_FF_skip
...
; con_s_id_25
    ...
    .byte off_case_25_01 - * ; 
        ...
        ; 
            .byte con_8A09_mirror_condition, con_8A09_mirr_сторона_полета_мяча
            .byte con_8A09_soundID_delay, con_sfx_12, $02     ; обычный удар с земли
            .byte con_8A09_pause + $30
            .byte con_s_bg_42
            .byte con_s_anim_82
...
; con_s_id_26
    ...
    .byte off_case_26_00 - * ; 
        ...
        ; 
            .byte con_8A09_mirror_condition, con_8A09_mirr_координаты_игрока
            .byte con_8A09_soundID_delay, con_sfx_2B, $09     ; отбитие мяча
            .byte con_8A09_pause + $37
            .byte con_s_bg_42
            .byte con_s_anim_83
...
; con_s_id_28
    .byte con_8A09_mirror_condition, con_8A09_mirr_координаты_игрока
    .byte con_8A09_soundID_delay, con_sfx_2B, $09
    .byte con_8A09_pause + $32
    .byte con_s_bg_26
    .byte con_s_anim_7F
...
; con_s_id_2D
    .byte con_8A09_mirror_condition, con_8A09_mirr_координаты_игрока
    .byte con_8A09_soundID_delay, con_sfx_64, $0D
    .byte con_8A09_pause + $3A
    .byte con_s_bg_3C
    .byte con_s_anim_80
...
; con_s_id_30
    ...
    .word bra_long_case_30_01 ; гол в левые ворота
        ...
        ; гол в правые ворота
            .byte con_8A09_mirror_off
            .byte con_8A09_F7, $13
            .byte con_8A09_soundID_delay, con_music_41, $02     ; гол в ворота соперника
...
sub_9C36_анимация_гола_в_левые_ворота_и_сообщения:
            .byte con_8A09_soundID_delay, con_music_42, $02     ; гол в ворота нашей команды
            .dbyt con_8A09_branch_short + con_8A09_bra_порвана_ли_сетка
...
; con_s_id_33
    .byte con_8A09_mirror_off
    .byte con_8A09_soundID_delay, con_sfx_66, $02
    .byte con_8A09_pause + $32
    .byte con_s_bg_0C
    .byte con_s_anim_4E
    ...
    .byte con_8A09_soundID_delay, con_music_cb_уменьшение_громкости, $02
    .byte con_8A09_pause + $C0
    .byte con_s_bg_FF_skip
    .byte con_s_anim_FF_skip
    .byte con_s_cloud_FF_skip
...
; con_s_id_35
    .byte con_8A09_soundID_delay, con_music_44, $EB
...
loc_B859_катсцена_озарения:
    ...
    .byte con_s_anim_FF_skip
    .byte con_s_cloud_FF_skip
    .byte con_8A09_soundID_delay, con_sfx_выкл_музыку_и_звуки, $02
    .byte con_8A09_F7, $06
    .byte con_8A09_pause + $56
    .byte con_s_bg_FF_skip
    .byte con_s_anim_FF_skip
    .byte con_s_cloud_F0_default ; s_cloud_7F
    .byte con_8A09_soundID_delay, con_music_52, $02
    .byte con_8A09_F7, $1F
...
loc_BA7F_гол_при_ударе_11м:
    .byte con_8A09_F7, $03
    .byte con_8A09_soundID_delay, con_sfx_5D, $02
    .dbyt con_8A09_branch_short + con_8A09_bra_порвана_ли_сетка
...
loc_B01B_overhead_без_очистки:
    .byte con_8A09_mirror_toggle
    .byte con_8A09_soundID_delay, con_sfx_1A, $31
    .byte con_8A09_pause + $64
    .byte con_s_bg_4C
    .byte con_s_anim_BF
    .byte con_s_cloud_F0_default ; s_cloud_49
