...
C - - - - - 0x02C026 21:8016: 4D 17 05  EOR ram_0517
...
C - - - - - 0x02C03C 21:802C: AD 38 05  LDA ram_0538
...
C - - - - - 0x02C053 21:8043: 2C 17 05  BIT ram_0517
...
C - - - - - 0x02C0C5 21:80B5: 20 09 C5  JSR sub_0x03CBA9_байты_после_JSR_для_непрямого_прыжка
- - - - - - 0x02C0C8 21:80B8: 00 00     .word $0000
- D - I - - 0x02C0CA 21:80BA: 61 81     .word ofs_030_8161_01_закончить_чтение_таблицы
- D - I - - 0x02C0CC 21:80BC: 64 81     .word ofs_030_8164_02
- D - I - - 0x02C0CE 21:80BE: 75 81     .word ofs_030_8175_03
...
C - - - - - 0x02C0FE 21:80EE: CD 40 05  CMP ram_0540
C - - - - - 0x02C101 21:80F1: 90 0A     BCC bra_80FD
C - - - - - 0x02C103 21:80F3: CD 41 05  CMP ram_0541
...
C - - - - - 0x02C140 21:8130: 9D 00 02  STA ram_spr_Y,X
...
ofs_030_8175_03:
C - J - - - 0x02C185 21:8175: AD 46 05  LDA ram_0546
...
C - - - - - 0x02C19B 21:818B: 4D 17 05  EOR ram_0517
