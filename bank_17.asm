...
- D - I - 0x020183 17:8173: 1C 82     .word ofs_821C_00_80_защитник_клон_или_нет
...
; 00 - атакующий легко обведет/защитник не напорется на летящий мяч
; 01 - атакующий с трудом обведет/защитник коснется летящего мяча
; 02 - защитник выбьет мяч у атакующего/отобьет мяч в воздухе/кипер еле отобьет
...
- - - - - 0x020458 17:8448: C9 60     CMP #$60      ; диас
...
C - - - - 0x02053F 17:852F: C9 60     CMP #$60      ; диас
C - - - - 0x020541 17:8531: F0 06     BEQ bra_8539_выход
C - - - - 0x020543 17:8533: CA        DEX
C - - - - 0x020544 17:8534: C9 01     CMP #$01      ; цубаса
...
C - - - - 0x020550 17:8540: C9 15     CMP #$15      ; нитта
...
C - - - - 0x02055C 17:854C: C9 1B     CMP #$1B      ; сода
C - - - - 0x02055E 17:854E: F0 05     BEQ bra_8555_выход
C - - - - 0x020560 17:8550: C9 4A     CMP #$4A      ; сода
...
C - - - - 0x0205A8 17:8598: C9 1A     CMP #$1A      ; хюга из японии
C - - - - 0x0205AA 17:859A: F0 05     BEQ bra_85A1_выход
C - - - - 0x0205AC 17:859C: C9 41     CMP #$41      ; хюга
...
C - - - - 0x0205B8 17:85A8: C9 1D     CMP #$1D      ; мацуяма из японии
C - - - - 0x0205BA 17:85AA: F0 05     BEQ bra_85B1_выход
C - - - - 0x0205BC 17:85AC: C9 4B     CMP #$4B      ; мацуяма соперник
...
C - - - - 0x0205C8 17:85B8: C9 3E     CMP #$3E      ; кальц из гамбурга
...
C - - - - 0x0205D4 17:85C4: C9 2B     CMP #$2B      ; карлос из фламенго
...
C - - - - 0x0205E0 17:85D0: C9 20     CMP #$20      ; мисуги из японии (наша команда)
C - - - - 0x0205E2 17:85D2: F0 05     BEQ bra_85D9_выход
C - - - - 0x0205E4 17:85D4: C9 45     CMP #$45      ; мисуги из японии (соперник)
...
C - - - - 0x0205F0 17:85E0: C9 11     CMP #$11      ; мисаки из нанкацу
...
- D - I - 0x020ACB 17:8ABB: F3        .byte con_branch, $80     ; защитник клон или не клон
...
- D - I - 0x020AD3 17:8AC3: F3        .byte con_branch, $81     ; выживет ли защитник
- D - I - 0x020AD5 17:8AC5: 07        .byte bra_case_8ACC_00_защитник_выживет - *
- D - I - 0x020AD6 17:8AC6: CD        .byte bra_case_8B93_01_защитник_убьется - *

bra_case_8AC7_00_защитник_выживет:
- D - I - 0x020AD7 17:8AC7: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x020AD9 17:8AC9: 08        .byte bra_case_8AD1_00_блок - *
- D - I - 0x020ADA 17:8ACA: 15        .byte bra_case_8ADF_01_подкат - *
- D - I - 0x020ADB 17:8ACB: 0D        .byte bra_case_8AD8_02_перехват - *

bra_case_8ACC_00_защитник_выживет:
- D - I - 0x020ADC 17:8ACC: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x020ADE 17:8ACE: 18        .byte bra_case_8AE6_00_блок - *
- D - I - 0x020ADF 17:8ACF: 1E        .byte bra_case_8AED_01_подкат - *
- D - I - 0x020AE0 17:8AD0: 24        .byte bra_case_8AF4_02_перехват - *
...
- D - I - 0x020BA0 17:8B90: 08        .byte bra_case_8B98_00_блок - *
- D - I - 0x020BA1 17:8B91: 15        .byte bra_case_8BA6_01_подкат - *
- D - I - 0x020BA2 17:8B92: 0D        .byte bra_case_8B9F_02_перехват - *

bra_case_8B93_01_защитник_убьется:
- D - I - 0x020BA3 17:8B93: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x020BA5 17:8B95: 18        .byte bra_case_8BAD_00_блок - *
- D - I - 0x020BA6 17:8B96: 25        .byte bra_case_8BBB_01_подкат - *
- D - I - 0x020BA7 17:8B97: 1D        .byte bra_case_8BB4_02_перехват - *
...
- D - I - 0x020C5D 17:8C4D: F3        .byte con_branch, $00     ; защитник клон или не клон
- D - I - 0x020C5F 17:8C4F: 53 8C     .word bra_long_case_8C53_00_защитник_не_клон
- D - I - 0x020C61 17:8C51: F3 8D     .word bra_long_case_8DF3_01_защитник_клон

bra_long_case_8C53_00_защитник_не_клон:
...
- D - I - 0x020C69 17:8C59: 03        .byte bra_case_8C5C_00_блок - *
- D - I - 0x020C6A 17:8C5A: 43        .byte bra_case_8C9D_01_подкат - *
- D - I - 0x020C6B 17:8C5B: 7A        .byte bra_case_8CD5_02_перехват - *

bra_case_8C5C_00_блок:
...
- D - I - 0x020D1F 17:8D0F: 03        .byte bra_case_8D12_00_блок - *
- D - I - 0x020D20 17:8D10: 61        .byte bra_case_8D71_01_подкат - *
- D - I - 0x020D21 17:8D11: 9B        .byte bra_case_8DAC_02_перехват - *

bra_case_8D12_00_блок:
...
bra_long_case_8DF3_01_защитник_клон:
...
bra_case_8DF7_00:
- D - I - 0x020E07 17:8DF7: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x020E09 17:8DF9: 03        .byte bra_case_8DFC_00_блок - *
- D - I - 0x020E0A 17:8DFA: 28        .byte bra_case_8E22_01_подкат - *
- D - I - 0x020E0B 17:8DFB: 4D        .byte bra_case_8E48_02_перехват - *

bra_case_8DFC_00_блок:
- D - I - 0x020E0C 17:8DFC: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020E12 17:8E02: 0D        .byte bra_case_8E0F_04_нарушение - *
...
bra_case_8E22_01_подкат:
- D - I - 0x020E32 17:8E22: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020E38 17:8E28: 0D        .byte bra_case_8E35_04_нарушение - *
...
bra_case_8E48_02_перехват:
- D - I - 0x020E58 17:8E48: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020E5E 17:8E4E: 0D        .byte bra_case_8E5B_04_нарушение - *
...
bra_case_8E6E_01:
- D - I - 0x020E7E 17:8E6E: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x020E80 17:8E70: 03        .byte bra_case_8E73_00_блок - *
- D - I - 0x020E81 17:8E71: 34        .byte bra_case_8EA5_01_подкат - *
- D - I - 0x020E82 17:8E72: 65        .byte bra_case_8ED7_02_перехват - *

bra_case_8E73_00_блок:
- D - I - 0x020E83 17:8E73: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020E89 17:8E79: 0D        .byte bra_case_8E86_04_нарушение - *
...
bra_case_8EA5_01_подкат:
- D - I - 0x020EB5 17:8EA5: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020EBB 17:8EAB: 0D        .byte bra_case_8EB8_04_нарушение - *
...
bra_case_8ED7_02_перехват:
- D - I - 0x020EE7 17:8ED7: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x020EED 17:8EDD: 0D        .byte bra_case_8EEA_04_нарушение - *
...
- D - I - 0x020F1B 17:8F0B: F3        .byte con_branch, $00     ; защитник клон или не клон
- D - I - 0x020F1D 17:8F0D: 11 8F     .word bra_long_case_8F11_00_защитник_не_клон
- D - I - 0x020F1F 17:8F0F: 76 90     .word bra_long_case_9076_01_защитник_клон

bra_long_case_8F11_00_защитник_не_клон:
...
- D - I - 0x020F27 17:8F17: 03        .byte bra_case_8F1A_00_блок - *
- D - I - 0x020F28 17:8F18: 55        .byte bra_case_8F6D_01_подкат - *
- D - I - 0x020F29 17:8F19: 8F        .byte bra_case_8FA8_02_перехват - *

bra_case_8F1A_00_блок:
...
- D - I - 0x020FF2 17:8FE2: 03        .byte bra_case_8FE5_00_блок - *
- D - I - 0x020FF3 17:8FE3: 58        .byte bra_case_903B_01_подкат - *
- D - I - 0x020FF4 17:8FE4: 96        .byte bra_case_907A_02_перехват - *

bra_case_8FE5_00_блок:
...
bra_long_case_9076_01_защитник_клон:
...
bra_case_90C1_00:
- D - I - 0x0210D1 17:90C1: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x0210D3 17:90C3: 03        .byte bra_case_90C6_00_блок - *
- D - I - 0x0210D4 17:90C4: 28        .byte bra_case_90EC_01_подкат - *
- D - I - 0x0210D5 17:90C5: 4D        .byte bra_case_9112_02_перехват - *

bra_case_90C6_00_блок:
- D - I - 0x0210D6 17:90C6: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x0210DC 17:90CC: 0D        .byte bra_case_90D9_04_нарушение - *
...
bra_case_90EC_01_подкат:
- D - I - 0x0210FC 17:90EC: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x021102 17:90F2: 0D        .byte bra_case_90FF_04_нарушение - *
...
bra_case_9112_02_перехват:
- D - I - 0x021122 17:9112: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x021128 17:9118: 0D        .byte bra_case_9125_04_нарушение - *
...
bra_case_9138_01:
- D - I - 0x021148 17:9138: F3        .byte con_branch, $82     ; действие защитника
- D - I - 0x02114A 17:913A: 03        .byte bra_case_913D_00_блок - *
- D - I - 0x02114B 17:913B: 34        .byte bra_case_916F_01_подкат - *
- D - I - 0x02114C 17:913C: 65        .byte bra_case_91A1_02_перехват - *

bra_case_913D_00_блок:
- D - I - 0x02114D 17:913D: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x021153 17:9143: 0D        .byte bra_case_9150_04_нарушение - *
...
bra_case_916F_01_подкат:
- D - I - 0x02117F 17:916F: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x021185 17:9175: 0D        .byte bra_case_9182_04_нарушение - *
...
bra_case_91A1_02_перехват:
- D - I - 0x0211B1 17:91A1: F3        .byte con_branch, $83     ; результат действия защитника
...
- - - - - 0x0211B7 17:91A7: 0D        .byte bra_case_91B4_04_нарушение - *
...
_scenario_91F2_01:
- D - I - 0x021202 17:91F2: FD        .byte con_mirror_condition, $01
...
_scenario_91FF_02:
- D - I - 0x02120F 17:91FF: FD        .byte con_mirror_condition, $01
...
_scenario_9205_0F:
- D - I - 0x021215 17:9205: FD        .byte con_mirror_condition, $01
...
- D - I - 0x021257 17:9247: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021269 17:9259: FD        .byte con_mirror_condition, $01
...
_scenario_9263_06:
- D - I - 0x021273 17:9263: FD        .byte con_mirror_condition, $01
...
- D - I - 0x021279 17:9269: FD        .byte con_mirror_condition, $01
...
- D - I - 0x02127F 17:926F: FD        .byte con_mirror_condition, $01
...
_scenario_927F_12:
- D - I - 0x02128F 17:927F: FD        .byte con_mirror_condition, $03
...
_scenario_9285_07:
- D - I - 0x021295 17:9285: FD        .byte con_mirror_condition, $03
...
- D - I - 0x02136A 17:935A: FD        .byte con_mirror_condition, $03
...
- D - I - 0x02170A 17:96FA: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021830 17:9820: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021840 17:9830: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021849 17:9839: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021857 17:9847: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021865 17:9855: FD        .byte con_mirror_condition, $03
...
- D - I - 0x02187A 17:986A: FD        .byte con_mirror_condition, $03
...
- - - - - 0x021888 17:9878: FD        .byte con_mirror_condition, $03
...
- D - I - 0x021893 17:9883: FD        .byte con_mirror_condition, $03
...
_scenario_9B82_14:
- D - I - 0x021B92 17:9B82: FD        .byte con_mirror_condition, $03
...
loc_9C23:
sub_9C23:
- D - I - 0x021C33 17:9C23: 01        .byte con_pause + $01
- D - I - 0x021C34 17:9C24: F0        .byte con_bg + con_skip
- D - I - 0x021C35 17:9C25: F0        .byte con_animation + con_skip
- D - I - 0x021C36 17:9C26: 00        .byte con_cloud + con_clear
...
bra_case_9CE4_00:
- D - I - 0x021CF4 17:9CE4: FD        .byte con_mirror_condition, $03
...
_scenario_9F54_2C:
- D - I - 0x021F64 17:9F54: FD        .byte con_mirror_condition, $03
...
bra_case_A27F_01:
- D - I - 0x02228F 11:A27F: 01        .byte con_pause + $01
- D - I - 0x022290 11:A280: F0        .byte con_bg + con_skip
- D - I - 0x022291 11:A281: F0        .byte con_animation + con_skip
- D - I - 0x022292 11:A282: 00        .byte con_cloud + con_clear
...
- D - I - 0x0222A3 11:A293: 00        .byte con_cloud + con_clear
...
- - - - - 0x0222AE 11:A29E: 00        .byte con_cloud + con_clear
...
loc_A34B:
- D - I - 0x02235B 11:A34B: FD        .byte con_mirror_condition, $03
sub_A34D:
bra_long_case_A34D:
...
sub_A394:
- D - I - 0x0223A4 11:A394: 28        .byte con_pause + $28
- D - I - 0x0223A5 11:A395: 28        .byte con_bg + $28
- D - I - 0x0223A6 11:A396: 56        .byte con_animation + $56
- D - I - 0x0223A7 11:A397: 37        .byte con_cloud + $37
- D - I - 0x0223A8 11:A398: FB        .byte con_rts

sub_A399:
- D - I - 0x0223A9 11:A399: 28        .byte con_pause + $28
- D - I - 0x0223AA 11:A39A: 28        .byte con_bg + $28
- D - I - 0x0223AB 11:A39B: 56        .byte con_animation + $56
- D - I - 0x0223AC 11:A39C: 38        .byte con_cloud + $38
- D - I - 0x0223AD 11:A39D: FB        .byte con_rts

sub_A39E:
- D - I - 0x0223AE 11:A39E: 28        .byte con_pause + $28
- D - I - 0x0223AF 11:A39F: 28        .byte con_bg + $28
- D - I - 0x0223B0 11:A3A0: 56        .byte con_animation + $56
- D - I - 0x0223B1 11:A3A1: 39        .byte con_cloud + $39
...
loc_AC7A:
- D - I - 0x022C8A 11:AC7A: 01        .byte con_pause + $01
- D - I - 0x022C8B 11:AC7B: F0        .byte con_bg + con_skip
- D - I - 0x022C8C 11:AC7C: F0        .byte con_animation + con_skip
- D - I - 0x022C8D 11:AC7D: 00        .byte con_cloud + con_clear
...
- D - I - 0x02329E 11:B28E: 01        .byte con_pause + $01
- D - I - 0x02329F 11:B28F: F0        .byte con_bg + con_skip
- D - I - 0x0232A0 11:B290: F0        .byte con_animation + con_skip
- D - I - 0x0232A1 11:B291: 00        .byte con_cloud + con_clear
...
loc_B378:
- D - I - 0x023388 11:B378: 01        .byte con_pause + $01
- D - I - 0x023389 11:B379: F0        .byte con_bg + con_skip
- D - I - 0x02338A 11:B37A: F0        .byte con_animation + con_skip
- D - I - 0x02338B 11:B37B: 00        .byte con_cloud + con_clear
bra_case_B37C_07:
bra_case_B37C_08:
bra_case_B37C_09:
bra_case_B37C_0A:
...
- D - I - 0x023769 11:B759: FD        .byte con_mirror_condition, $03
...
- D - I - 0x023788 11:B778: FD        .byte con_mirror_condition, $03
...
_scenario_B7DA_1E:
- D - I - 0x0237EA 11:B7DA: FD        .byte con_mirror_condition, $02
...
loc_B822:
sub_B822:
- D - I - 0x023832 11:B822: 01        .byte con_pause + $01
- D - I - 0x023833 11:B823: F0        .byte con_bg + con_skip
- D - I - 0x023834 11:B824: F0        .byte con_animation + con_skip
- D - I - 0x023835 11:B825: 00        .byte con_cloud + con_clear
...
- D - I - 0x02383F 11:B82F: F0        .byte con_bg + con_skip
- D - I - 0x023840 11:B830: F0        .byte con_animation + con_skip
- D - I - 0x023841 11:B831: 00        .byte con_cloud + con_clear
...
- D - I - 0x02384B 11:B83B: F0        .byte con_bg + con_skip
- D - I - 0x02384C 11:B83C: F0        .byte con_animation + con_skip
- D - I - 0x02384D 11:B83D: 00        .byte con_cloud + con_clear
...
sub_B848:
- D - I - 0x023858 11:B848: 01        .byte con_pause + $01
- D - I - 0x023859 11:B849: F0        .byte con_bg + con_skip
- D - I - 0x02385A 11:B84A: F0        .byte con_animation + con_skip
- D - I - 0x02385B 11:B84B: 00        .byte con_cloud + con_clear
...
- D - I - 0x0238AD 11:B89D: F0        .byte con_bg + con_skip
- D - I - 0x0238AE 11:B89E: F0        .byte con_animation + con_skip
- D - I - 0x0238AF 11:B89F: 00        .byte con_cloud + con_clear
...
- D - I - 0x0238CD 11:B8BD: 01        .byte con_pause + $01
- D - I - 0x0238CE 11:B8BE: F0        .byte con_bg + con_skip
- D - I - 0x0238CF 11:B8BF: F0        .byte con_animation + con_skip
- D - I - 0x0238D0 11:B8C0: 00        .byte con_cloud + con_clear
...
- D - I - 0x023918 11:B908: 01        .byte con_pause + $01
- D - I - 0x023919 11:B909: F0        .byte con_bg + con_skip
- D - I - 0x02391A 11:B90A: F0        .byte con_animation + con_skip
- D - I - 0x02391B 11:B90B: 00        .byte con_cloud + con_clear
...
- D - I - 0x023ABA 11:BAAA: F0        .byte con_bg + con_skip
- D - I - 0x023ABB 11:BAAB: F0        .byte con_animation + con_skip
- D - I - 0x023ABC 11:BAAC: F0        .byte con_cloud + con_skip
...
- - - - - 0x023AC9 11:BAB9: F0        .byte con_bg + con_skip
- - - - - 0x023ACA 11:BABA: F0        .byte con_animation + con_skip
- - - - - 0x023ACB 11:BABB: F0        .byte con_cloud + con_skip
...
- D - I - 0x023D97 11:BD87: FD        .byte con_mirror_condition, $01
