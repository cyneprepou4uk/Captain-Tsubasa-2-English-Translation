...
C - - - - - 0x002043 01:A033: A5 E1     LDA ram_random
...
- - - - - - 0x0020F8 01:A0E8: 49 41     EOR #$01 + $40
...
C - - - - - 0x002119 01:A109: 20 E8 98  JMP loc_0x0018F8_затереть_часть_экрана



sub_0x00211D_экран_continue:
C D 1 - - - 0x00211D 01:A10D: 20 A0 9B  JSR sub_0x001BB0
...
C - - - - - 0x0021AA 01:A19A: A9 33     LDA #con_music_33
...
C - - - - - 0x00225D 01:A24D: A9 12     LDA #con_sfx_12
...
; выключить музыку
                                        LDA #con_sfx_выкл_музыку_и_звуки
                                        STA ram_номер_звука
                                        LDA #$01
                                        JSR sub_0x001FB8_задержка_кадра
; 
                                        LDA #con_sfx_попадание_по_штанге
                                        STA ram_номер_звука
                                        LDA #$3C    ; 60 сек
                                        JSR sub_0x001FB8_задержка_кадра
; звук неправильного пароля
C - - - - - 0x0022D3 01:A2C3: A9 43     LDA #con_music_43
...
C - - - - - 0x0022EA 01:A2DA: 4C 9F A1  JMP loc_A19A
...
C - - - - - 0x0022F7 01:A2E7: 85 E7     STA ram_00E7_t14_div04
...
C - - - - - 0x002300 01:A2F0: A5 E7     LDA ram_00E7_t14_div04
...
bra_A36B_продолжить:
C - - - - - 0x00237B 01:A36B: AD 60 06  LDA ram_0660
; / 04
C - - - - - 0x00237E 01:A36E: 4A        LSR
C - - - - - 0x00237F 01:A36F: 4A        LSR
C - - - - - 0x002380 01:A370: 85 26     STA ram_номер_матча
; 
...
C - - - - - 0x0023A0 01:A390: 85 4C     STA ram_004C_t03
                                        ...
                                        LDA #$3C
                                        JSR sub_0x001FB8_задержка_кадра
                                        LDA #con_music_cb_уменьшение_громкости          ; уменьшение громкости
                                        STA ram_номер_звука
                                        LDA #$F0
                                        JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x0023C0 01:A3B0: 20 B4 A3  JMP loc_A3B4
bra_A3B3_RTS:
C - - - - - 0x0023C3 01:A3B3: 60        RTS
...
loc_A64C:
sub_0x00265C:
C D 1 - - - 0x00265C 01:A64C: 20 A0 98  JSR sub_0x0018B0_очистка_двух_nametable
C - - - - - 0x00265F 01:A64F: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
loc_A652:
C D 1 - - - 0x002662 01:A652: A6 26     LDX ram_номер_матча
...
C - - J - - 0x00268B 01:A67B: A6 26     LDA ram_номер_матча
                                        CLC
                                        ADC #$23
...
bra_A710_продолжить_матч:
                                        LDA #con_music_cb_уменьшение_громкости
                                        STA ram_номер_звука
                                        JMP loc_0x001BB0
...
C D 1 - - - 0x002731 01:A721: 20 A0 9B  JSR sub_0x001BB0
...
C - - - - - 0x002750 01:A740: 4C 4E A8  JMP loc_A84E_экран_опций_japan
bra_A743_это_не_japan:
...
bra_A761_loop:
C - - - - - 0x002771 01:A761: B9 A2 AC  LDA tbl_AD9E_курсор_опции_sao_paulo_nankatsu - $FC,Y
...
C - - - - - 0x00278A 01:A77A: A0 81     LDY #< tbl_A781_опции_sao_paulo_nankatsu
C - - - - - 0x00278C 01:A77C: A2 A7     LDX #> tbl_A781_опции_sao_paulo_nankatsu
...
C - - - - - 0x0027C3 01:A7B3: A0 A2     LDY #< tbl_ADA2_курсор_defense_sao_paulo_nankatsu
C - - - - - 0x0027C5 01:A7B5: A2 AD     LDX #> tbl_ADA2_курсор_defense_sao_paulo_nankatsu
...
loc_A84E_экран_опций_japan:
C D 1 - - - 0x00285E 01:A84E: A0 51     LDY #< tbl_B451_экран_с_опциями_с_запасными
...
C - - - - - 0x0028A6 01:A896: A0 9D     LDY #< tbl_A89D_опции_japan
C - - - - - 0x0028A8 01:A898: A2 A8     LDX #> tbl_A89D_опции_japan
...
C - - - - - 0x0028E3 01:A8D3: A0 B8     LDY #< tbl_ADB8_курсор_защиты_japan
C - - - - - 0x0028E5 01:A8D5: A2 AD     LDX #> tbl_ADB8_курсор_защиты_japan
...
bra_A995:
loc_A995:
C D 1 - - - 0x0029A5 01:A995: AC 5C 05  LDY ram_055C
...
- - - - - - 0x0029ED 01:A9DD: 20 BF AA  JSR sub_AABF
- - - - - - 0x0029F0 01:A9E0: B0 7D     BCS bra_AA5F
bra_A9E2:
...
loc_A9FB:
C D 1 - - - 0x002A0B 01:A9FB: AC 60 05  LDY ram_0560
...
C - - - - - 0x002A3E 01:AA2E: B1 34     LDA (ram_plr_data),Y    ; con_plr_id
...
bra_AB87:
loc_AB87:
C D 1 - - - 0x002B97 01:AB87: 24 1E     BIT ram_btn_press
; con_btn_B
...
C - - - - - 0x002BBD 01:ABAD: A0 46     LDY #< $2064
C - - - - - 0x002BBF 01:ABAF: A2 20     LDX #> $2064
C - - - - - 0x002BC1 01:ABB1: 20 05 AF  JSR sub_AF05
C - - - - - 0x002BC4 01:ABB4: A0 03     LDY #con_plr_lvl
C - - - - - 0x002BC6 01:ABB6: B1 34     LDA (ram_plr_data),Y    ; con_plr_lvl
...
C - - - - - 0x002C51 01:AC41: B1 34     LDA (ram_plr_data),Y    ; con_plr_id
...
tbl_AD8A:
- D 1 - - - 0x002D9A 01:AD8A: 00        .byte $00   ; 
- D 1 - - - 0x002D9B 01:AD8B: 00        .byte $00   ; 
- D 1 - - - 0x002D9C 01:AD8C: 01        .byte $01   ; 
- D 1 - - - 0x002D9D 01:AD8D: 02        .byte $02   ; 

- D 1 - - - 0x002D9E 01:AD8E: 03        .byte $03   ; 
- D 1 - - - 0x002D9F 01:AD8F: 03        .byte $03   ; 
- D 1 - - - 0x002DA0 01:AD90: 04        .byte $04   ; 
- D 1 - - - 0x002DA1 01:AD91: 05        .byte $05   ; 

- D 1 - - - 0x002DA2 01:AD92: 06        .byte $06   ; 
- D 1 - - - 0x002DA3 01:AD93: 06        .byte $06   ; 
- D 1 - - - 0x002DA4 01:AD94: 07        .byte $07   ; 
- D 1 - - - 0x002DA5 01:AD95: 08        .byte $08   ; 

- D 1 - - - 0x002DA6 01:AD96: 09        .byte $09   ; 
- D 1 - - - 0x002DA7 01:AD97: 09        .byte $09   ; 
- D 1 - - - 0x002DA8 01:AD98: 0A        .byte $0A   ; 
- D 1 - - - 0x002DA9 01:AD99: 0B        .byte $0B   ; 

- D 1 - - - 0x002DAA 01:AD9A: 0C        .byte $0C   ; 
- D 1 - - - 0x002DAB 01:AD9B: 0C        .byte $0C   ; 
- - - - - - 0x002DAC 01:AD9C: 0D        .byte $0D   ; 
- - - - - - 0x002DAD 01:AD9D: 0E        .byte $0E   ; 



tbl_AD9E_курсор_опции_sao_paulo_nankatsu:
- D 1 - - - 0x002DAE 01:AD9E: 38        .byte $38   ; 
- D 1 - - - 0x002DAF 01:AD9F: 71        .byte $71   ; 
- D 1 - - - 0x002DB0 01:ADA0: 00        .byte $00   ; 
- D 1 - - - 0x002DB1 01:ADA1: 88        .byte $90   ; 



tbl_ADA2_курсор_defense_sao_paulo_nankatsu:
    .byte $F8       ; ? начальный индекс oam
    .byte $58       ; Y
    .byte $71       ; тайл
    .byte $00       ; палитра
    .byte $98       ; X
...
tbl_ADBE_курсор_замены_игроков_japan_1:
    .byte $F8       ; ? начальный индекс oam
    .byte $28       ; Y
    .byte $71       ; тайл
    .byte $00       ; палитра
...
tbl_ADC4_курсор_замены_игроков_japan_2:
    .byte $F4       ; ? начальный индекс oam
    .byte $28       ; Y
    .byte $71       ; тайл
    .byte $00       ; палитра
...
tbl_ADCA_курсор_замены_киперов_japan:
    .byte $F4       ; ? начальный индекс oam
    .byte $B8       ; Y
    .byte $71       ; тайл
    .byte $00       ; палитра
...
C D 1 - - - 0x002E9F 01:AE8F: BE 2D B8  LDX tbl_B82D_офсет_спрайтов_миникарты,Y
...
C - - - - - 0x002F1E 01:AF0E: 85 ED     STA ram_00ED_t01_длина_имени
bra_AF10_loop:
C - - - - - 0x002F20 01:AF10: A2 00     LDX #$00
C - - - - - 0x002F22 01:AF12: A0 00     LDY #$00
C - - - - - 0x002F24 01:AF14: B1 30     LDA (ram_0030_t05_data_словарь),Y
C - - - - - 0x002F26 01:AF16: C9 FC     CMP #$FC
C - - - - - 0x002F28 01:AF18: B0 07     BCS bra_AF21
C - - - - - 0x002F2A 01:AF1A: E6 30     INC ram_0030_t05_data_словарь
C - - - - - 0x002F2C 01:AF1C: D0 02     BNE bra_AF20_not_overflow
- - - - - - 0x002F2E 01:AF1E: E6 31     INC ram_0030_t05_data_словарь + $01
bra_AF20_not_overflow:
...
C D 1 - - - 0x002F89 01:AF79: A5 26     LDA ram_номер_матча
...
C D 1 - - - 0x002F9A 01:AF8A: A5 26     LDA ram_номер_матча
...
C - - - - - 0x002FE4 01:AFD4: A5 26     LDA ram_номер_матча
...
; / 04
; bzk bug? кривая математика? сначала должен быть LSR, потом ROR?
...
C D 1 - - - 0x003060 01:B050: A5 26     LDA ram_номер_матча
...
C - - - - - 0x0030B5 01:B0A5: A0 C8     LDY #< tbl_B9C8_количество_замен_для_japan
...
tbl_B2FD:
- D 1 - - - 0x00330D 01:B2FD: 40        .byte $40   ; 
- D 1 - - - 0x00330E 01:B2FE: 01        .byte $01   ; 
- D 1 - - - 0x00330F 01:B2FF: 00        .byte $00   ; 
- D 1 - - - 0x003310 01:B300: 50        .byte $50   ; 
- D 1 - - - 0x003311 01:B301: 48        .byte $48   ; 
- D 1 - - - 0x003312 01:B302: 01        .byte $01   ; 
- D 1 - - - 0x003313 01:B303: 00        .byte $00   ; 
- D 1 - - - 0x003314 01:B304: 50        .byte $50   ; 
...
- D 1 - I - 0x003457 01:B447: 00        .byte $00   ; 
- D 1 - I - 0x003458 01:B448: 74 B4     .word off_B474_окно_основных_игроков_sao_paulo_nankatsu

- D 1 - I - 0x00345A 01:B44A: 00        .byte $00   ; 
- D 1 - I - 0x00345B 01:B44B: B3 B4     .word off_B4B3_опции_sao_paulo_nankatsu
...
- D 1 - I - 0x00346F 01:B45F: 00        .byte $00   ; 
- D 1 - I - 0x003470 01:B460: 83 B5     .word off_B583_опции_japan
; + смещение влево
- D 1 - I - 0x003472 01:B462: 01        .byte $01   ; 
- D 1 - I - 0x003473 01:B463: 53 B6     .word off_B653_миникарта
- D 1 - I - 0x003475 01:B465: FB        .byte $FA   ; 

- D 1 - I - 0x00346B 01:B45B: 01        .byte $00   ; 
...
- D 1 - I - 0x0034AE 01:B49E: 00        .byte $00   ; 
- D 1 - I - 0x0034AF 01:B49F: 3C        .byte $39   ; 
- D 1 - I - 0x0034B0 01:B4A0: 00        .byte $00   ; 
- D 1 - I - 0x0034B1 01:B4A1: 3B        .byte $38   ; 
- D 1 - I - 0x0034B2 01:B4A2: 00        .byte $00   ; 
- D 1 - I - 0x0034B3 01:B4A3: 3A        .byte $37   ; 
- D 1 - I - 0x0034B4 01:B4A4: 00        .byte $00   ; 
- D 1 - I - 0x0034B5 01:B4A5: 39        .byte $36   ; 
- D 1 - I - 0x0034B6 01:B4A6: 00        .byte $00   ; 
- D 1 - I - 0x0034B7 01:B4A7: 38        .byte $35   ; 
- D 1 - I - 0x0034B8 01:B4A8: 00        .byte $00   ; 
- D 1 - I - 0x0034B9 01:B4A9: 37        .byte $34   ; 
- D 1 - I - 0x0034BA 01:B4AA: 00        .byte $00   ; 
- D 1 - I - 0x0034BB 01:B4AB: 36        .byte $33   ; 
...
tbl_B6BB_название_твоей_команды_в_опциях:
    .word off_0000_sao_paulo
    .word off_0000_nankatsu
    .word off_0000_japan
...
tbl_BB10_nankatsu:
- D 1 - I - 0x003B20 01:BB10: 0A        .byte $0A   ; 00
- D 1 - I - 0x003B21 01:BB11: 04        .byte $04   ; 01
- D 1 - I - 0x003B22 01:BB12: 02        .byte $02   ; 02
- D 1 - I - 0x003B23 01:BB13: 06        .byte $06   ; 03
- D 1 - I - 0x003B24 01:BB14: 00        .byte $00   ; 04
- D 1 - I - 0x003B25 01:BB15: 10        .byte $10   ; 05
- D 1 - I - 0x003B26 01:BB16: 12        .byte $12   ; 06
- D 1 - I - 0x003B27 01:BB17: 08        .byte $08   ; 07
- D 1 - I - 0x003B28 01:BB18: 0E        .byte $0E   ; 08
- D 1 - I - 0x003B29 01:BB19: 0C        .byte $0C   ; 09



tbl_BB1A_sao_paulo:
- D 1 - I - 0x003B2A 01:BB1A: 08        .byte $08   ; 00
- D 1 - I - 0x003B2B 01:BB1B: 04        .byte $04   ; 01
- D 1 - I - 0x003B2C 01:BB1C: 02        .byte $02   ; 02
- D 1 - I - 0x003B2D 01:BB1D: 06        .byte $06   ; 03
- D 1 - I - 0x003B2E 01:BB1E: 0E        .byte $0E   ; 04
- D 1 - I - 0x003B2F 01:BB1F: 00        .byte $00   ; 05
- D 1 - I - 0x003B30 01:BB20: 12        .byte $12   ; 06
- D 1 - I - 0x003B31 01:BB21: 10        .byte $10   ; 07
- D 1 - I - 0x003B32 01:BB22: 0A        .byte $0A   ; 08
- D 1 - I - 0x003B33 01:BB23: 0C        .byte $0C   ; 09



tbl_BB24_japan:
- D 1 - I - 0x003B34 01:BB24: 00        .byte $00   ; 00
- D 1 - I - 0x003B35 01:BB25: 04        .byte $04   ; 01
- D 1 - I - 0x003B36 01:BB26: 00        .byte $00   ; 02
- D 1 - I - 0x003B37 01:BB27: 08        .byte $08   ; 03
- D 1 - I - 0x003B38 01:BB28: 0E        .byte $0E   ; 04
- D 1 - I - 0x003B39 01:BB29: 06        .byte $06   ; 05
- D 1 - I - 0x003B3A 01:BB2A: 00        .byte $00   ; 06
- D 1 - I - 0x003B3B 01:BB2B: 0E        .byte $0E   ; 07
- D 1 - I - 0x003B3C 01:BB2C: 02        .byte $02   ; 08
- D 1 - I - 0x003B3D 01:BB2D: 02        .byte $02   ; 09
...
off_BB55_p_tsubasa_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $9D       ; индекс имени спешала в словаре (drive shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $03       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A8       ; индекс имени спешала в словаре (overhead kick)
    .byte $00       ; номер действия атаки/защиты
    .byte $0E       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $FE       ; флаг drive overhead
    .byte $9E       ; индекс имени спешала в словаре (drive overhead)
    .byte $00       ; номер действия атаки/защиты
    .byte $04       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $10       ; минимальный номер матча для наличия спешала у игрока
    .byte $A3       ; индекс имени спешала в словаре (twin shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $09       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $FD       ; флаг cyclone
    .byte $AC       ; индекс имени спешала в словаре (cyclone)
    .byte $00       ; номер действия атаки/защиты
    .byte $12       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $BE       ; индекс имени спешала в словаре (heel lift)
    .byte $02       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $C5       ; индекс имени спешала в словаре (drive pass)
    .byte $01       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $10       ; минимальный номер матча для наличия спешала у игрока
    .byte $C9       ; индекс имени спешала в словаре (golden combo)
    .byte $03       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BB7E_p_misaki_my:
    ...
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $AA       ; индекс имени спешала в словаре (jumping volley)
    .byte $00       ; номер действия атаки/защиты
    .byte $10       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BB93_p_ishizaki_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $CE       ; индекс имени спешала в словаре (face block)
    .byte $00       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
...
off_BB99_p_nitta_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $9F       ; индекс имени спешала в словаре (falcon shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $05       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A0       ; индекс имени спешала в словаре (falcon volley)
    .byte $00       ; номер действия атаки/защиты
    .byte $06       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BBA4_p_masao_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A2       ; индекс имени спешала в словаре (skylb hurricane)
    .byte $00       ; номер действия атаки/защиты
    .byte $08       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A4       ; индекс имени спешала в словаре (skylab twin shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $0A       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    ...
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $CB       ; индекс имени спешала в словаре (gemini attack)
    .byte $03       ; номер действия атаки/защиты
    .byte $03       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D2       ; индекс имени спешала в словаре (skylab tackle)
    .byte $01       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты       ; у другого брата 03
    .byte con_bsw_1C_02 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $CF       ; индекс имени спешала в словаре (skylab block)
    .byte $00       ; номер действия атаки/защиты
    .byte $02       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D8       ; индекс имени спешала в словаре (skylab pass cut)
    .byte $02       ; номер действия атаки/защиты
    .byte $01       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
...
off_BBC8_p_kazuo_my:
    ...
    .byte $D2       ; индекс имени спешала в словаре (skylab tackle)
    .byte $01       ; номер действия атаки/защиты
    .byte $03       ; подтип действия атаки/защиты       ; у другого брата 01
    .byte con_bsw_1C_02 ; индекс обработчика
...
off_BBEC_p_hyuga_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A6       ; индекс имени спешала в словаре (tiger shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $0C       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A7       ; индекс имени спешала в словаре (neo-tiger shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $0D       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    ...
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $BF       ; индекс имени спешала в словаре (force dribble)
    .byte $02       ; номер действия атаки/защиты
    .byte $02       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $CA       ; индекс имени спешала в словаре (toho combo)
    .byte $03       ; номер действия атаки/защиты
    .byte $02       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D5       ; индекс имени спешала в словаре (tiger tackle)
    .byte $01       ; номер действия атаки/защиты
    .byte $04       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
...
off_BC0B_p_soda_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A1       ; индекс имени спешала в словаре (razor shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $07       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D3       ; индекс имени спешала в словаре (razor tackle)
    .byte $01       ; номер действия атаки/защиты
    .byte $02       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $C6       ; индекс имени спешала в словаре (razor pass)
    .byte $01       ; номер действия атаки/защиты
    .byte $02       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BC1B_p_jito_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $AD       ; индекс имени спешала в словаре (sano combo)
    .byte $00       ; номер действия атаки/защиты
    .byte $13       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
    ...
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D4       ; индекс имени спешала в словаре (power tackle)
    .byte $01       ; номер действия атаки/защиты
    .byte $03       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
    
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $D0       ; индекс имени спешала в словаре (power block)
    .byte $00       ; номер действия атаки/защиты
    .byte $03       ; подтип действия атаки/защиты
    .byte con_bsw_1C_02 ; индекс обработчика
...
off_BC30_p_matsuyama_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A5       ; индекс имени спешала в словаре (eagle shot)
    .byte $00       ; номер действия атаки/защиты
    .byte $0B       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BC3C_p_misugi_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $A9       ; индекс имени спешала в словаре (hyper overhead)
    .byte $00       ; номер действия атаки/защиты
    .byte $0F       ; подтип действия атаки/защиты
    .byte con_bsw_1C_01 ; индекс обработчика
...
off_BC42_p_wakashimazu_my:
    .byte $00       ; минимальный номер матча для наличия спешала у игрока
    .byte $E5       ; индекс имени спешала в словаре (triangle jump)
    .byte $02       ; номер действия атаки/защиты
    .byte $00       ; подтип действия атаки/защиты
    .byte con_bsw_1C_03 ; индекс обработчика
...
.out .sprintf("Free bytes in bank 81: 0x%04X [%d]", ($C000 - *), ($C000 - *))
