...
C - - - - - 0x027384 19:B374: A2 10     LDX #$10    ; палитра спрайтов
C - - - - - 0x027386 19:B376: A9 15     LDA #$15
C - - - - - 0x027388 19:B378: 20 30 C5  JSR sub_0x03CC12_запись_палитры_во_время_матча
C - - - - - 0x02738B 19:B37B: A2 00     LDX #$00    ; палитра фона
C - - - - - 0x02738D 19:B37D: A9 16     LDA #$16
C - - - - - 0x02738F 19:B37F: 20 30 C5  JSR sub_0x03CC12_запись_палитры_во_время_матча
