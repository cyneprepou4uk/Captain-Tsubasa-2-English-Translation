...
.export sub_0x018010_sound_engine_update



sub_0x018010_sound_engine_update:
C D 0 - - - 0x018010 0C:8000: A2 05     LDX #$05
bra_8002_loop:
C - - - - - 0x018012 0C:8002: BC 00 07  LDY ram_номер_звука,X
...
C - - - - - 0x0180B9 0C:80A9: 9D 00 07  STA ram_номер_звука,X
...
C - - - - - 0x0180C4 0C:80B4: 9D 00 07  STA ram_номер_звука,X
bra_80B7:
loc_80B7:
C D 0 - - - 0x0180C7 0C:80B7: CA        DEX
C - - - - - 0x0180C8 0C:80B8: 10 A9     BPL bra_8063_loop
C - - - - - 0x0180CA 0C:80BA: A9 27     LDA #< ram_0727
C - - - - - 0x0180CC 0C:80BC: 85 F0     STA ram_00F0_se_t02_data
C - - - - - 0x0180CE 0C:80BE: A9 07     LDA #> ram_0727
C - - - - - 0x0180D0 0C:80C0: 85 F1     STA ram_00F0_se_t02_data + $01
C - - - - - 0x0180D2 0C:80C2: A9 00     LDA #$00
C - - - - - 0x0180D4 0C:80C4: 85 F2     STA ram_00F2_se_t01_индекс_массива
; bzk optimize, заменить на 07 и подправить вычисления
C - - - - - 0x0180D6 0C:80C6: A0 08     LDY #$08
C - - - - - 0x0180D8 0C:80C8: 84 F3     STY ram_00F3_se_t01_индекс_массива
bra_80CA_loop:
...
C - - - - - 0x0180E7 0C:80D7: A6 F2     LDX ram_00F2_se_t01_индекс_массива
C - - - - - 0x0180E9 0C:80D9: DE 07 07  DEC ram_0707,X
C - - - - - 0x0180EC 0C:80DC: D0 03     BNE bra_80E1
C - - - - - 0x0180EE 0C:80DE: 20 CB 83  JSR sub_83CB
bra_80E1:
C - - - - - 0x0180F1 0C:80E1: A6 F2     LDX ram_00F2_se_t01_индекс_массива
C - - - - - 0x0180F3 0C:80E3: DE 09 07  DEC ram_0709,X
C - - - - - 0x0180F6 0C:80E6: D0 21     BNE bra_8109
C - - - - - 0x0180F8 0C:80E8: A0 02     LDY #$02
C - - - - - 0x0180FA 0C:80EA: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0180FC 0C:80EC: 85 F6     STA ram_00F6_se_t01_data
C - - - - - 0x0180FE 0C:80EE: C8        INY ; 03
C - - - - - 0x0180FF 0C:80EF: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018101 0C:80F1: 85 F7     STA ram_00F6_se_t01_data + $01
C - - - - - 0x018103 0C:80F3: C8        INY ; 04
C - - - - - 0x018104 0C:80F4: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018106 0C:80F6: 48        PHA
C - - - - - 0x018107 0C:80F7: 18        CLC
C - - - - - 0x018108 0C:80F8: 69 02     ADC #$02
C - - - - - 0x01810A 0C:80FA: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01810C 0C:80FC: 68        PLA
C - - - - - 0x01810D 0C:80FD: A8        TAY
C - - - - - 0x01810E 0C:80FE: B1 F6     LDA (ram_00F6_se_t01_data),Y
C - - - - - 0x018110 0C:8100: 9D 09 07  STA ram_0709,X
C - - - - - 0x018113 0C:8103: C8        INY
C - - - - - 0x018114 0C:8104: B1 F6     LDA (ram_00F6_se_t01_data),Y
C - - - - - 0x018116 0C:8106: 9D 0A 07  STA ram_070A,X
bra_8109:
C - - - - - 0x018119 0C:8109: 20 DB 81  JSR sub_81DB
bra_810C:
C - - - - - 0x01811C 0C:810C: 18        CLC
C - - - - - 0x01811D 0C:810D: A9 10     LDA #< $0410
C - - - - - 0x01811F 0C:810F: 65 F0     ADC ram_00F0_se_t02_data
C - - - - - 0x018121 0C:8111: 85 F0     STA ram_00F0_se_t02_data
C - - - - - 0x018123 0C:8113: A9 04     LDA #> $0410
C - - - - - 0x018125 0C:8115: 65 F2     ADC ram_00F2_se_t01_индекс_массива
C - - - - - 0x018127 0C:8117: 85 F2     STA ram_00F2_se_t01_индекс_массива
C - - - - - 0x018129 0C:8119: C6 F3     DEC ram_00F3_se_t01_индекс_массива
C - - - - - 0x01812B 0C:811B: D0 AD     BNE bra_80CA_loop
C - - - - - 0x01812D 0C:811D: A9 27     LDA #< ram_0727
C - - - - - 0x01812F 0C:811F: 85 F0     STA ram_00F0_se_t03_data
C - - - - - 0x018131 0C:8121: 85 FC     STA ram_00FC_se_t01_ptr_lo
C - - - - - 0x018133 0C:8123: A9 07     LDA #> ram_0727
C - - - - - 0x018135 0C:8125: 85 F1     STA ram_00F0_se_t03_data + $01
C - - - - - 0x018137 0C:8127: 85 FD     STA ram_00FD_se_t01_ptr_hi
C - - - - - 0x018139 0C:8129: A9 03     LDA #$03
C - - - - - 0x01813B 0C:812B: 85 F2     STA ram_00F2_se_t02_loop_counter
C - - - - - 0x01813D 0C:812D: A9 11     LDA #$11
C - - - - - 0x01813F 0C:812F: 85 F3     STA ram_00F3_se_t02
bra_8131_loop:
C - - - - - 0x018141 0C:8131: AD 06 07  LDA ram_0706
C - - - - - 0x018144 0C:8134: 25 F3     AND ram_00F3_se_t02
...
C - - - - - 0x01814F 0C:813F: 65 F0     ADC ram_00F0_se_t03_data
C - - - - - 0x018151 0C:8141: 85 F0     STA ram_00F0_se_t03_data
C - - - - - 0x018153 0C:8143: A9 00     LDA #> $0040
C - - - - - 0x018155 0C:8145: 65 F1     ADC ram_00F0_se_t03_data + $01
C - - - - - 0x018157 0C:8147: 85 F1     STA ram_00F0_se_t03_data + $01
bra_8149:
C - - - - - 0x018159 0C:8149: 20 6E 81  JSR sub_816E
bra_814C:
C - - - - - 0x01815C 0C:814C: 18        CLC
C - - - - - 0x01815D 0C:814D: A9 10     LDA #< $0010
C - - - - - 0x01815F 0C:814F: 65 FC     ADC ram_00FC_se_t01_ptr_lo
C - - - - - 0x018161 0C:8151: 85 FC     STA ram_00FC_se_t01_ptr_lo
C - - - - - 0x018163 0C:8153: 85 F0     STA ram_00F0_se_t03_data
C - - - - - 0x018165 0C:8155: A9 00     LDA #> $0010
C - - - - - 0x018167 0C:8157: 65 FD     ADC ram_00FD_se_t01_ptr_hi
C - - - - - 0x018169 0C:8159: 85 FD     STA ram_00FD_se_t01_ptr_hi
C - - - - - 0x01816B 0C:815B: 85 F1     STA ram_00F0_se_t03_data + $01
C - - - - - 0x01816D 0C:815D: 06 F3     ASL ram_00F3_se_t02
C - - - - - 0x01816F 0C:815F: C6 F2     DEC ram_00F2_se_t02_loop_counter
...
C - - - - - 0x018180 0C:8170: 45 F2     EOR ram_00F2_se_t02_loop_counter
; * 04
C - - - - - 0x018182 0C:8172: 0A        ASL
C - - - - - 0x018183 0C:8173: 0A        ASL
C - - - - - 0x018184 0C:8174: AA        TAX
C - - - - - 0x018185 0C:8175: A0 06     LDY #$06
C - - - - - 0x018187 0C:8177: B1 F0     LDA (ram_00F0_se_t03_data),Y
C - - - - - 0x018189 0C:8179: 48        PHA
C - - - - - 0x01818A 0C:817A: A5 F2     LDA ram_00F2_se_t02_loop_counter
C - - - - - 0x01818C 0C:817C: 85 FB     STA ram_00FB_se_t01
...
C - - - - - 0x01819C 0C:818C: 9D 00 40  STA $4000,X ; 4000 4004 400C 
C - - - - - 0x01819F 0C:818F: A9 10     LDA #$10
C - - - - - 0x0181A1 0C:8191: A0 05     LDY #$05
C - - - - - 0x0181A3 0C:8193: 31 F0     AND (ram_00F0_se_t03_data),Y
C - - - - - 0x0181A5 0C:8195: D0 10     BNE bra_81A7
C - - - - - 0x0181A7 0C:8197: A9 08     LDA #$08
C - - - - - 0x0181A9 0C:8199: A4 FB     LDY ram_00FB_se_t01
C - - - - - 0x0181AB 0C:819B: 99 E4 07  STA ram_07E4,Y
C - - - - - 0x0181AE 0C:819E: 9D 01 40  STA $4001,X ; 4001 4005 400D 
C - - - - - 0x0181B1 0C:81A1: 4C B1 81  JMP loc_81B1
bra_81A4:
C - - - - - 0x0181B4 0C:81A4: 9D 00 40  STA $4000,X ; 4008 
bra_81A7:
C - - - - - 0x0181B7 0C:81A7: A0 08     LDY #$08
C - - - - - 0x0181B9 0C:81A9: B1 F0     LDA (ram_00F0_se_t03_data),Y
C - - - - - 0x0181BB 0C:81AB: 10 2D     BPL bra_81DA_RTS
C - - - - - 0x0181BD 0C:81AD: 29 7F     AND #$7F
C - - - - - 0x0181BF 0C:81AF: 91 F0     STA (ram_00F0_se_t03_data),Y
loc_81B1:
C D 0 - - - 0x0181C1 0C:81B1: A0 07     LDY #$07
C - - - - - 0x0181C3 0C:81B3: B1 F0     LDA (ram_00F0_se_t03_data),Y
C - - - - - 0x0181C5 0C:81B5: 9D 02 40  STA $4002,X ; 4002 4006 400A 400E 
C - - - - - 0x0181C8 0C:81B8: C8        INY ; 08
C - - - - - 0x0181C9 0C:81B9: B1 F0     LDA (ram_00F0_se_t03_data),Y
C - - - - - 0x0181CB 0C:81BB: 09 18     ORA #$18
C - - - - - 0x0181CD 0C:81BD: A4 FB     LDY ram_00FB_se_t01
...
bra_81CA:
C - - - - - 0x0181DA 0C:81CA: 9D 03 40  STA $4003,X ; 4003 4007 400B 400F 
...
C - - - - - 0x018212 0C:8202: A5 F7     LDA ram_00F7_se_t03
C - - - - - 0x018214 0C:8204: 18        CLC
C - - - - - 0x018215 0C:8205: 69 01     ADC #$01
C - - - - - 0x018217 0C:8207: C9 0F     CMP #$0F
C - - - - - 0x018219 0C:8209: 85 F7     STA ram_00F7_se_t04
...
bra_8217:
C - - - - - 0x018227 0C:8217: A5 F7     LDA ram_00F7_se_t04
C - - - - - 0x018229 0C:8219: 05 F6     ORA ram_00F6_se_t03
C - - - - - 0x01822B 0C:821B: AA        TAX
C - - - - - 0x01822C 0C:821C: A0 05     LDY #$05
C - - - - - 0x01822E 0C:821E: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018230 0C:8220: 8A        TXA
C - - - - - 0x018231 0C:8221: 29 0F     AND #$0F
C - - - - - 0x018233 0C:8223: 85 F7     STA ram_00F7_se_t03
C - - - - - 0x018235 0C:8225: A4 F3     LDY ram_00F3_se_t01_индекс_массива
...
bra_8233:
C - - - - - 0x018243 0C:8233: A6 F2     LDX ram_00F2_se_t01_индекс_массива
C - - - - - 0x018245 0C:8235: BD 0A 07  LDA ram_070A,X
C - - - - - 0x018248 0C:8238: 38        SEC
C - - - - - 0x018249 0C:8239: E5 F7     SBC ram_00F7_se_t03
C - - - - - 0x01824B 0C:823B: 10 02     BPL bra_823F
C - - - - - 0x01824D 0C:823D: A9 00     LDA #$00
bra_823F:
C - - - - - 0x01824F 0C:823F: 05 F6     ORA ram_00F6_se_t03
C - - - - - 0x018251 0C:8241: A0 06     LDY #$06
C - - - - - 0x018253 0C:8243: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018255 0C:8245: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
C - - - - - 0x01826F 0C:825F: 85 F9     STA ram_00F9_se_t01_jmp
C - - - - - 0x018271 0C:8261: B9 6A 82  LDA tbl_8269 + $01,Y
C - - - - - 0x018274 0C:8264: 85 FA     STA ram_00F9_se_t01_jmp + $01
C - - - - - 0x018276 0C:8266: 6C F9 00  JMP (ram_00F9_se_t01_jmp)
...
C - - - - - 0x018295 0C:8285: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018297 0C:8287: BD BF 07  LDA ram_07BF,X
C - - - - - 0x01829A 0C:828A: 69 00     ADC #$00
C - - - - - 0x01829C 0C:828C: C8        INY ; 08
C - - - - - 0x01829D 0C:828D: 91 F0     STA (ram_00F0_se_t02_data),Y
...
C - - - - - 0x0182AC 0C:829C: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0182AE 0C:829E: BD BF 07  LDA ram_07BF,X
C - - - - - 0x0182B1 0C:82A1: C8        INY ; 08
C - - - - - 0x0182B2 0C:82A2: 91 F0     STA (ram_00F0_se_t02_data),Y
loc_82A4:
...
C - - - - - 0x0182CC 0C:82BC: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0182CE 0C:82BE: BD BF 07  LDA ram_07BF,X
C - - - - - 0x0182D1 0C:82C1: E9 00     SBC #$00
C - - - - - 0x0182D3 0C:82C3: C8        INY ; 01
C - - - - - 0x0182D4 0C:82C4: 91 F0     STA (ram_00F0_se_t02_data),Y
...
C - - - - - 0x0182EA 0C:82DA: 85 F9     STA ram_00F9_se_t02_jmp
C - - - - - 0x0182EC 0C:82DC: B9 E5 82  LDA tbl_82E4 + $01,Y
C - - - - - 0x0182EF 0C:82DF: 85 FA     STA ram_00F9_se_t02_jmp + $01
C - - - - - 0x0182F1 0C:82E1: 6C F9 00  JMP (ram_00F9_se_t02_jmp)
...
C - - - - - 0x01830C 0C:82FC: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01830E 0C:82FE: BD BF 07  LDA ram_07BF,X
C - - - - - 0x018311 0C:8301: 69 00     ADC #$00
C - - - - - 0x018313 0C:8303: C8        INY ; 01
C - - - - - 0x018314 0C:8304: 91 F0     STA (ram_00F0_se_t02_data),Y
...
C - - - - - 0x018323 0C:8313: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018325 0C:8315: BD BF 07  LDA ram_07BF,X
C - - - - - 0x018328 0C:8318: C8        INY ; 08
C - - - - - 0x018329 0C:8319: 91 F0     STA (ram_00F0_se_t02_data),Y
loc_831B:
...
C - - - - - 0x018343 0C:8333: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018345 0C:8335: BD BF 07  LDA ram_07BF,X
C - - - - - 0x018348 0C:8338: E9 00     SBC #$00
C - - - - - 0x01834A 0C:833A: C8        INY ; 08
C - - - - - 0x01834B 0C:833B: 91 F0     STA (ram_00F0_se_t02_data),Y
...
; in
    ; Y = con_sfx / con_music
C - - - - - 0x018359 0C:8349: 86 F5     STX ram_00F5_se_t02_save_X
C - - - - - 0x01835B 0C:834B: A9 00     LDA #$00
C - - - - - 0x01835D 0C:834D: 9D 00 07  STA ram_номер_звука,X
; bzk optimize, удалить DEY, скорректировать поинтер на -02
...
C - - - - - 0x018367 0C:8357: 85 F0     STA ram_00F0_se_t01_data
C - - - - - 0x018369 0C:8359: B9 DB 8B  LDA tbl_8BDA_таблица_звуков + $01,Y
C - - - - - 0x01836C 0C:835C: 85 F1     STA ram_00F0_se_t01_data + $01
C - - - - - 0x01836E 0C:835E: A0 00     LDY #$00
bra_8360_продолжить_чтение_поинтеров_звука:
C - - - - - 0x018370 0C:8360: B1 F0     LDA (ram_00F0_se_t01_data),Y
...
C - - - - - 0x018379 0C:8369: A6 F5     LDX ram_00F5_se_t02_save_X
C - - - - - 0x01837B 0C:836B: 60        RTS
bra_836C_прочитать_поинтеры_звука:
C - - - - - 0x01837C 0C:836C: 85 F4     STA ram_00F4_se_t02
C - - - - - 0x01837E 0C:836E: A9 08     LDA #$08
C - - - - - 0x018380 0C:8370: 18        CLC
C - - - - - 0x018381 0C:8371: E5 F4     SBC ram_00F4_se_t02
...
C - - - - - 0x0183A4 0C:8394: A5 F4     LDA ram_00F4_se_t02
; * 10
...
C - - - - - 0x0183AC 0C:839C: B1 F0     LDA (ram_00F0_se_t01_data),Y
C - - - - - 0x0183AE 0C:839E: 9D 27 07  STA ram_0727,X
C - - - - - 0x0183B1 0C:83A1: C8        INY
C - - - - - 0x0183B2 0C:83A2: B1 F0     LDA (ram_00F0_se_t01_data),Y
...
C - - - - - 0x0183C1 0C:83B1: A5 F4     LDA ram_00F4_se_t02
; * 04
...
C - - - - - 0x0183CC 0C:83BC: A6 F4     LDX ram_00F4_se_t02
bra_83BE_loop:
...
C - - - - - 0x0183DF 0C:83CF: 31 F0     AND (ram_00F0_se_t02_data),Y
C - - - - - 0x0183E1 0C:83D1: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0183E3 0C:83D3: A0 00     LDY #$00
C - - - - - 0x0183E5 0C:83D5: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0183E7 0C:83D7: 85 F4     STA ram_00F4_se_t01_data
C - - - - - 0x0183E9 0C:83D9: C8        INY ; 01
C - - - - - 0x0183EA 0C:83DA: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0183EC 0C:83DC: 85 F5     STA ram_00F4_se_t01_data + $01
C - - - - - 0x0183EE 0C:83DE: 88        DEY ; 00
bra_83DF_loop:
C - - - - - 0x0183EF 0C:83DF: B1 F4     LDA (ram_00F4_se_t01_data),Y
...
C - - - - - 0x01840A 0C:83FA: A6 F2     LDX ram_00F2_se_t01_индекс_массива
...
C - - - - - 0x01841A 0C:840A: 65 F4     ADC ram_00F4_se_t01_data
C - - - - - 0x01841C 0C:840C: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01841E 0C:840E: C8        INY ; 01
C - - - - - 0x01841F 0C:840F: A9 00     LDA #$00
C - - - - - 0x018421 0C:8411: 65 F5     ADC ram_00F4_se_t01_data + $01
C - - - - - 0x018423 0C:8413: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018425 0C:8415: 68        PLA
C - - - - - 0x018426 0C:8416: A2 05     LDX #$05
C - - - - - 0x018428 0C:8418: E4 F3     CPX ram_00F3_se_t01_индекс_массива
C - - - - - 0x01842A 0C:841A: F0 06     BEQ bra_8422
C - - - - - 0x01842C 0C:841C: A2 01     LDX #$01
C - - - - - 0x01842E 0C:841E: E4 F3     CPX ram_00F3_se_t01_индекс_массива
C - - - - - 0x018430 0C:8420: 90 0C     BCC bra_842E
bra_8422:
C - - - - - 0x018432 0C:8422: C9 10     CMP #$10
C - - - - - 0x018434 0C:8424: F0 0F     BEQ bra_8435
C - - - - - 0x018436 0C:8426: 85 F4     STA ram_00F4_se_t03_lo
C - - - - - 0x018438 0C:8428: A9 00     LDA #$00
C - - - - - 0x01843A 0C:842A: 85 F5     STA ram_00F5_se_t01_hi
...
C - - - - - 0x018449 0C:8439: 11 F0     ORA (ram_00F0_se_t02_data),Y
C - - - - - 0x01844B 0C:843B: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01844D 0C:843D: D0 67     BNE bra_84A6    ; jmp
bra_843F:
C - - - - - 0x01844F 0C:843F: 0A        ASL
C - - - - - 0x018450 0C:8440: A8        TAY
C - - - - - 0x018451 0C:8441: B9 0D 87  LDA tbl_870D,Y
C - - - - - 0x018454 0C:8444: 85 F4     STA ram_00F4_se_t03_lo
C - - - - - 0x018456 0C:8446: B9 0E 87  LDA tbl_870D + $01,Y
C - - - - - 0x018459 0C:8449: 85 F5     STA ram_00F5_se_t01_hi
...
bra_8455_loop:
C - - - - - 0x018465 0C:8455: 46 F5     LSR ram_00F5_se_t01_hi
C - - - - - 0x018467 0C:8457: 66 F4     ROR ram_00F4_se_t03_lo
C - - - - - 0x018469 0C:8459: CA        DEX
C - - - - - 0x01846A 0C:845A: D0 F9     BNE bra_8455_loop
bra_845C:
C - - - - - 0x01846C 0C:845C: A5 F4     LDA ram_00F4_se_t03_lo
C - - - - - 0x01846E 0C:845E: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
C - - - - - 0x01847E 0C:846E: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018480 0C:8470: 9D B7 07  STA ram_07B7,X
C - - - - - 0x018483 0C:8473: A5 F5     LDA ram_00F5_se_t01_hi
C - - - - - 0x018485 0C:8475: 4C 84 84  JMP loc_8484
bra_8478:
C - - - - - 0x018488 0C:8478: A0 07     LDY #$07
C - - - - - 0x01848A 0C:847A: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01848C 0C:847C: 9D B7 07  STA ram_07B7,X
C - - - - - 0x01848F 0C:847F: A5 F5     LDA ram_00F5_se_t01_hi
C - - - - - 0x018491 0C:8481: 38        SEC
C - - - - - 0x018492 0C:8482: E9 01     SBC #$01
loc_8484:
C D 0 - - - 0x018494 0C:8484: 09 80     ORA #$80
C - - - - - 0x018496 0C:8486: C8        INY ; 08
C - - - - - 0x018497 0C:8487: 91 F0     STA (ram_00F0_se_t02_data),Y
...
C - - - - - 0x0184A5 0C:8495: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0184A7 0C:8497: 9D B7 07  STA ram_07B7,X
C - - - - - 0x0184AA 0C:849A: C8        INY ; 08
C - - - - - 0x0184AB 0C:849B: A5 F5     LDA ram_00F5_se_t01_hi
C - - - - - 0x0184AD 0C:849D: 69 00     ADC #$00
C - - - - - 0x0184AF 0C:849F: 09 80     ORA #$80
C - - - - - 0x0184B1 0C:84A1: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0184B3 0C:84A3: 9D BF 07  STA ram_07BF,X
bra_84A6:
loc_84A6:
C D 0 - - - 0x0184B6 0C:84A6: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
C - - - - - 0x0184C3 0C:84B3: A6 F2     LDX ram_00F2_se_t01_индекс_массива
...
C - - - - - 0x0184CE 0C:84BE: 91 F0     STA (ram_00F0_se_t02_data),Y
bra_84C0:
C - - - - - 0x0184D0 0C:84C0: A6 F2     LDX ram_00F2_se_t01_индекс_массива
...
C - - - - - 0x0184E0 0C:84D0: 85 F6     STA ram_00F6_se_t02_jmp
C - - - - - 0x0184E2 0C:84D2: BD DB 84  LDA tbl_84DA + $01,X
C - - - - - 0x0184E5 0C:84D5: 85 F7     STA ram_00F6_se_t02_jmp + $01
C - - - - - 0x0184E7 0C:84D7: 6C F6 00  JMP (ram_00F6_se_t02_jmp)
...
C - - - - - 0x01852F 0C:851F: 8D 00 07  STA ram_номер_звука
C - - - - - 0x018532 0C:8522: 8D 01 07  STA ram_номер_звука + $01
C - - - - - 0x018535 0C:8525: 8D 02 07  STA ram_номер_звука + $02
C - - - - - 0x018538 0C:8528: 8D 03 07  STA ram_номер_звука + $03
C - - - - - 0x01853B 0C:852B: 8D 04 07  STA ram_номер_звука + $04
C - - - - - 0x01853E 0C:852E: 8D 05 07  STA ram_номер_звука + $05
C - - - - - 0x018541 0C:8531: 60        RTS



ofs_013_8532_F4:
C - - J - - 0x018542 0C:8532: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
ofs_013_853B_F3:
C - - J - - 0x01854B 0C:853B: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
ofs_013_8544_E0:
C - - J - - 0x018554 0C:8544: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x018556 0C:8546: C8        INY
C - - - - - 0x018557 0C:8547: 84 F6     STY ram_00F6_se_t04_save_Y
...
C - - - - - 0x018566 0C:8556: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018568 0C:8558: C8        INY ; 03
C - - - - - 0x018569 0C:8559: 8A        TXA
C - - - - - 0x01856A 0C:855A: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01856C 0C:855C: A4 F6     LDY ram_00F6_se_t04_save_Y
C - - - - - 0x01856E 0C:855E: 60        RTS



ofs_013_855F_E3_громкость:
C - - J - - 0x01856F 0C:855F: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x018571 0C:8561: C8        INY
C - - - - - 0x018572 0C:8562: 84 F6     STY ram_00F6_se_t05_save_Y
C - - - - - 0x018574 0C:8564: AC DF 07  LDY ram_07DF
C - - - - - 0x018577 0C:8567: D0 0C     BNE bra_8575
C - - - - - 0x018579 0C:8569: 85 F7     STA ram_00F7_se_t01
C - - - - - 0x01857B 0C:856B: A9 F0     LDA #$F0
C - - - - - 0x01857D 0C:856D: A0 05     LDY #$05
C - - - - - 0x01857F 0C:856F: 31 F0     AND (ram_00F0_se_t02_data),Y
C - - - - - 0x018581 0C:8571: 05 F7     ORA ram_00F7_se_t01
C - - - - - 0x018583 0C:8573: 91 F0     STA (ram_00F0_se_t02_data),Y
bra_8575:
C - - - - - 0x018585 0C:8575: A4 F6     LDY ram_00F6_se_t05_save_Y
...
C - - J - - 0x018588 0C:8578: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x01858A 0C:857A: C8        INY
C - - - - - 0x01858B 0C:857B: AA        TAX
C - - - - - 0x01858C 0C:857C: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x01858E 0C:857E: 86 F4     STX ram_00F4_se_t01_data
C - - - - - 0x018590 0C:8580: 85 F5     STA ram_00F4_se_t01_data + $01
...
ofs_013_8585_E9_jsr:
; могут быть вложенные JSR
C - - J - - 0x018595 0C:8585: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x018597 0C:8587: C8        INY
C - - - - - 0x018598 0C:8588: AA        TAX
C - - - - - 0x018599 0C:8589: B1 F4     LDA (ram_00F4_se_t01_data),Y
...
C - - - - - 0x0185A1 0C:8591: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185A3 0C:8593: A8        TAY
C - - - - - 0x0185A4 0C:8594: 68        PLA
C - - - - - 0x0185A5 0C:8595: 18        CLC
C - - - - - 0x0185A6 0C:8596: 65 F4     ADC ram_00F4_se_t01_data
C - - - - - 0x0185A8 0C:8598: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185AA 0C:859A: 88        DEY
C - - - - - 0x0185AB 0C:859B: A9 00     LDA #$00
C - - - - - 0x0185AD 0C:859D: 65 F5     ADC ram_00F4_se_t01_data + $01
C - - - - - 0x0185AF 0C:859F: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185B1 0C:85A1: 88        DEY
C - - - - - 0x0185B2 0C:85A2: 98        TYA
C - - - - - 0x0185B3 0C:85A3: A0 09     LDY #$09
C - - - - - 0x0185B5 0C:85A5: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185B7 0C:85A7: 86 F4     STX ram_00F4_se_t01_data
C - - - - - 0x0185B9 0C:85A9: 68        PLA
C - - - - - 0x0185BA 0C:85AA: 85 F5     STA ram_00F4_se_t01_data + $01
...
C - - - - - 0x0185C1 0C:85B1: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185C3 0C:85B3: A8        TAY
C - - - - - 0x0185C4 0C:85B4: C8        INY
C - - - - - 0x0185C5 0C:85B5: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185C7 0C:85B7: C8        INY
C - - - - - 0x0185C8 0C:85B8: 85 F5     STA ram_00F4_se_t01_data + $01
C - - - - - 0x0185CA 0C:85BA: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185CC 0C:85BC: 85 F4     STA ram_00F4_se_t01_data
C - - - - - 0x0185CE 0C:85BE: 98        TYA
C - - - - - 0x0185CF 0C:85BF: A0 09     LDY #$09
C - - - - - 0x0185D1 0C:85C1: 91 F0     STA (ram_00F0_se_t02_data),Y
...
ofs_013_85C6_EB:
C - - J - - 0x0185D6 0C:85C6: B1 F4     LDA (ram_00F4_se_t01_data),Y
...
C - - - - - 0x0185DE 0C:85CE: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185E0 0C:85D0: A8        TAY
C - - - - - 0x0185E1 0C:85D1: 68        PLA
C - - - - - 0x0185E2 0C:85D2: 18        CLC
C - - - - - 0x0185E3 0C:85D3: 65 F4     ADC ram_00F4_se_t01_data
C - - - - - 0x0185E5 0C:85D5: 85 F4     STA ram_00F4_se_t01_data
C - - - - - 0x0185E7 0C:85D7: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185E9 0C:85D9: 88        DEY
C - - - - - 0x0185EA 0C:85DA: A9 00     LDA #$00
C - - - - - 0x0185EC 0C:85DC: 65 F5     ADC ram_00F4_se_t01_data + $01
C - - - - - 0x0185EE 0C:85DE: 85 F5     STA ram_00F4_se_t01_data + $01
C - - - - - 0x0185F0 0C:85E0: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185F2 0C:85E2: 88        DEY
C - - - - - 0x0185F3 0C:85E3: 8A        TXA
C - - - - - 0x0185F4 0C:85E4: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x0185F6 0C:85E6: 88        DEY
C - - - - - 0x0185F7 0C:85E7: 98        TYA
C - - - - - 0x0185F8 0C:85E8: A0 09     LDY #$09
C - - - - - 0x0185FA 0C:85EA: 91 F0     STA (ram_00F0_se_t02_data),Y
...
ofs_013_85EF_EC:
C - - J - - 0x0185FF 0C:85EF: 84 F6     STY ram_00F6_se_t06_save_Y
C - - - - - 0x018601 0C:85F1: A0 09     LDY #$09
C - - - - - 0x018603 0C:85F3: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018605 0C:85F5: A8        TAY
C - - - - - 0x018606 0C:85F6: C8        INY
C - - - - - 0x018607 0C:85F7: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018609 0C:85F9: 38        SEC
C - - - - - 0x01860A 0C:85FA: E9 01     SBC #$01
C - - - - - 0x01860C 0C:85FC: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x01860E 0C:85FE: F0 0D     BEQ bra_860D
C - - - - - 0x018610 0C:8600: C8        INY
C - - - - - 0x018611 0C:8601: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018613 0C:8603: C8        INY
C - - - - - 0x018614 0C:8604: 85 F5     STA ram_00F4_se_t01_data + $01
C - - - - - 0x018616 0C:8606: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x018618 0C:8608: 85 F4     STA ram_00F4_se_t01_data
...
C - - - - - 0x018622 0C:8612: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018624 0C:8614: A4 F6     LDY ram_00F6_se_t06_save_Y
C - - - - - 0x018626 0C:8616: 60        RTS



ofs_013_8617_E4:
C - - J - - 0x018627 0C:8617: 84 F6     STY ram_00F6_se_t07_save_Y
C - - - - - 0x018629 0C:8619: A0 05     LDY #$05
C - - - - - 0x01862B 0C:861B: B1 F0     LDA (ram_00F0_se_t02_data),Y
C - - - - - 0x01862D 0C:861D: 09 10     ORA #$10
C - - - - - 0x01862F 0C:861F: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018631 0C:8621: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
C - - - - - 0x01863C 0C:862C: A4 F6     LDY ram_00F6_se_t07_save_Y
C - - - - - 0x01863E 0C:862E: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x018640 0C:8630: 9D 01 40  STA $4001,X ; 4001 4005 
C - - - - - 0x018643 0C:8633: C8        INY
C - - - - - 0x018644 0C:8634: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
ofs_013_8641_E2:
C - - J - - 0x018651 0C:8641: B1 F4     LDA (ram_00F4_se_t01_data),Y
C - - - - - 0x018653 0C:8643: C8        INY
C - - - - - 0x018654 0C:8644: 84 F6     STY ram_00F6_se_t08_save_Y
C - - - - - 0x018656 0C:8646: 85 F7     STA ram_00F7_se_t02
C - - - - - 0x018658 0C:8648: A0 05     LDY #$05
C - - - - - 0x01865A 0C:864A: A9 3F     LDA #$3F
C - - - - - 0x01865C 0C:864C: 31 F0     AND (ram_00F0_se_t02_data),Y
C - - - - - 0x01865E 0C:864E: 05 F7     ORA ram_00F7_se_t02
C - - - - - 0x018660 0C:8650: 91 F0     STA (ram_00F0_se_t02_data),Y
C - - - - - 0x018662 0C:8652: A4 F6     LDY ram_00F6_se_t08_save_Y
...
C - - - - - 0x01866D 0C:865D: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
C - - - - - 0x01867A 0C:866A: 9D 00 40  STA $4000,X ; 4000 4004 4008 400C 
...
ofs_013_8670_E5:
C - - J - - 0x018680 0C:8670: A6 F3     LDX ram_00F3_se_t01_индекс_массива
C - - - - - 0x018682 0C:8672: CA        DEX
C - - - - - 0x018683 0C:8673: B1 F4     LDA (ram_00F4_se_t01_data),Y
...
ofs_013_8681_ED:
C - - J - - 0x018691 0C:8681: A6 F3     LDX ram_00F3_se_t01_индекс_массива
C - - - - - 0x018693 0C:8683: CA        DEX
C - - - - - 0x018694 0C:8684: B1 F4     LDA (ram_00F4_se_t01_data),Y
...
ofs_013_8690_EF:
C - - J - - 0x0186A0 0C:8690: A6 F3     LDX ram_00F3_se_t01_индекс_массива
...
ofs_013_86F6_FE:
- - - - - - 0x018706 0C:86F6: B1 F4     LDA (ram_00F4_se_t01_data),Y
- - - - - - 0x018708 0C:86F8: C8        INY
- - - - - - 0x018709 0C:86F9: 84 F6     STY ram_00F6_se_t09_save_Y
- - - - - - 0x01870B 0C:86FB: A6 F3     LDX ram_00F3_se_t01_индекс_массива
- - - - - - 0x01870D 0C:86FD: CA        DEX
- - - - - - 0x01870E 0C:86FE: 9D CF 07  STA ram_07CF,X
- - - - - - 0x018711 0C:8701: 9D D7 07  STA ram_07D7,X
- - - - - - 0x018714 0C:8704: A4 F6     LDY ram_00F6_se_t09_save_Y
...
- - - - - - 0x018C4A 0C:8C3A: FE 9F     .word $0000      ; 31 con_music_cb_уменьшение_громкости
; музыка
...
- - - - - - 0x018C7C 0C:8C6C: 42 8E     .word _off001_8E42_01_выключить_музыку_и_звуки ; con_music_4A
...
- - - - - - 0x018C9E 0C:8C8E: FE 9F     .word $0000      ; con_music_5B
- - - - - - 0x018CA0 0C:8C90: FE 9F     .word $0000      ; con_music_5C
; звуки
...
; bzk garbage
- - - - - - 0x018CCA 0C:8CBA: B5 9C     .word _off000_9CB5_71
- - - - - - 0x018CCC 0C:8CBC: B5 9C     .word _off000_9CB5_72
...
; bzk optimize, удалить лишние поинтеры сюда
_off001_8E42_01_выключить_музыку_и_звуки:
; con_sfx_выкл_музыку_и_звуки
...
.out .sprintf("Free bytes in bank 8C: 0x%04X [%d]", ($A000 - *), ($A000 - *))
