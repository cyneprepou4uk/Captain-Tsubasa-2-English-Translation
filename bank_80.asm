...
C - - - - - 0x00009F 00:808F: 85 ED     STA ram_00ED_temp
loc_8091:
C D 0 - - - 0x0000A1 00:8091: A5 ED     LDA ram_00ED_temp
...
bra_80BC:
C - - - - - 0x0000CC 00:80BC: A5 ED     LDA ram_00ED_temp
C - - - - - 0x0000CE 00:80BE: 49 40     EOR #$40
loc_80C0:
C D 0 - - - 0x0000D0 00:80C0: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x0000EF 00:80DF: 24 ED     BIT ram_00ED_temp
...
C - - - - - 0x00030E 00:82FE: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x000493 00:8483: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x0004D1 00:84C1: A6 ED     LDX ram_00ED_temp
...
C - - - - - 0x000708 00:86F8: 85 ED     STA ram_00ED_temp
bra_86FA_loop:
C - - - - - 0x00070A 00:86FA: A6 ED     LDX ram_00ED_temp
...
C - - - - - 0x00071A 00:870A: C6 ED     DEC ram_00ED_temp
...
C - - - - - 0x000725 00:8715: 85 ED     STA ram_00ED_temp
bra_8717_loop:
C - - - - - 0x000727 00:8717: A6 ED     LDX ram_00ED_temp
...
C - - - - - 0x000737 00:8727: E6 ED     INC ram_00ED_temp
C - - - - - 0x000739 00:8729: A5 ED     LDA ram_00ED_temp
...
C - - - - - 0x00080B 00:87FB: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x00093C 00:892C: A5 ED     LDA ram_00ED_temp
C - - - - - 0x00093E 00:892E: 69 BF     ADC #> tbl_0x00DF10
C - - - - - 0x000940 00:8930: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x000B07 00:8AF7: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x000B2C 00:8B1C: A5 ED     LDA ram_00ED_temp
...
C - - - - - 0x000BE0 00:8BD0: 65 ED     ADC ram_00ED_temp
...
C - - - - - 0x000C33 00:8C23: A5 ED     LDA ram_00ED_temp
C - - - - - 0x000C35 00:8C25: E9 00     SBC #> $0001
C - - - - - 0x000C37 00:8C27: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x000C42 00:8C32: 65 ED     ADC ram_00ED_temp
...
C - - - - - 0x000DD1 00:8DC1: A5 47     LDA ram_0047_temp
C - - - - - 0x000DD3 00:8DC3: 38        SEC
C - - - - - 0x000DD4 00:8DC4: E5 6A     SBC ram_006A
C - - - - - 0x000DD6 00:8DC6: 85 47     STA ram_0047_temp
loc_8DC8:
...
C - - - - - 0x000E33 00:8E23: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x000E80 00:8E70: C6 ED     DEC ram_00ED_temp
...
C - - - - - 0x0010C0 00:90B0: 86 ED     STX ram_00ED_temp
...
C - - - - - 0x001122 00:9112: A6 ED     LDX ram_00ED_temp
...
C - - - - - 0x0011C0 00:91B0: E5 47     SBC ram_0047_temp
...
sub_975B:
C - - - - - 0x00176B 00:975B: 86 ED     STX ram_00ED_temp
...
C - - - - - 0x00178B 00:977B: A4 ED     LDY ram_00ED_temp
...
sub_9BCA:
C - - - - - 0x001BDA 00:9BCA: 85 47     STA ram_0047_temp
...
C - - - - - 0x001D25 00:9D15: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x001D32 00:9D22: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x001DD3 00:9DC3: A5 ED     LDA ram_00ED_temp
...
C - - - - - 0x001E26 00:9E16: 26 ED     ROL ram_00ED_temp
...
- - - - - - 0x001E40 00:9E30: E6 ED     INC ram_00ED_temp
bra_9E32:
