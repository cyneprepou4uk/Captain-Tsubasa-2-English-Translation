...
.export sub_0x00090B_реверснуть_приоритет_всех_спрайтов_над_фоном
...
.export loc_0x0017C8_запись_в_буфер_со_смещением
.export loc_0x0018A5
...
.export loc_0x001A00_выход_из_экрана
.export ofs_006_0x001A00_08_выход_из_экрана
.export ofs_065_0x001A00_08_выход_из_экрана
.export sub_0x001A1D
.export sub_0x001A45
.export sub_0x001A53
...
.export sub_0x001D83_добавить_тайлы_закрытия_полоски_special_в_буфер
...
.export sub_0x001E1C_конвертация_в_dec___хз
.export sub_0x001E5F
...
; бряк сработал при переходе от радостных игроков перед игрой в саму игру
...
C - - - - - 0x000054 00:8044: 85 4C     STA ram_004C_t03
C - - - - - 0x000056 00:8046: 85 5B     STA ram_005B_t02_флаги
C - - - - - 0x000058 00:8048: A9 01     LDA #con_sfx_выкл_музыку_и_звуки
C - - - - - 0x00005A 00:804A: 8D 00 07  STA ram_номер_звука
...
C - - - - - 0x000071 00:8061: A9 0D     LDA #$0D    ; номер анимации 1
                                        STA ram_00E6_t36_массив_номеров_анимаций + $01
                                        LDA #$01    ; длина массива (колво адресов с анимацией)
                                        STA ram_00E6_t36_массив_номеров_анимаций
                                        LDA #< (ram_00E6_t36_массив_номеров_анимаций - $01)
                                        STA ram_004D_t02_data_катсцена
                                        LDA #> (ram_00E6_t36_массив_номеров_анимаций - $01)
                                        STA ram_004D_t02_data_катсцена + $01
                                        JSR sub_9085
C - - - - - 0x000076 00:8066: A9 00     LDA #$00
C - - - - - 0x000078 00:8068: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
...
C - - - - - 0x000084 00:8074: 20 FB 88  JSR sub_88FB_реверснуть_приоритет_всех_спрайтов_над_фоном
...
C - - - - - 0x000091 00:8081: 85 90     STA ram_008E_t01_chr_banks + $02
C - - - - - 0x000093 00:8083: A9 02     LDA #con_chr_bank + $02
C - - - - - 0x000095 00:8085: 85 91     STA ram_008E_t01_chr_banks + $03
C - - - - - 0x000097 00:8087: A5 1B     LDA ram_флаг_nmi
C - - - - - 0x000099 00:8089: 29 FE     AND #$01 ^ $FF
C - - - - - 0x00009B 00:808B: 85 1B     STA ram_флаг_nmi
C - - - - - 0x00009D 00:808D: A9 0A     LDA #$0A
C - - - - - 0x00009F 00:808F: 85 ED     STA ram_00ED_t10_ppu_addr_lo
loc_8091_loop:
C D 0 - - - 0x0000A1 00:8091: A5 ED     LDA ram_00ED_t10_ppu_addr_lo
C - - - - - 0x0000A3 00:8093: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0000A5 00:8095: A9 22     LDA #$22
C - - - - - 0x0000A7 00:8097: 85 E7     STA ram_00E7_t03_ppu_addr_hi
C - - - - - 0x0000A9 00:8099: A0 01     LDY #$01    ; количество строк
C - - - - - 0x0000AB 00:809B: A2 01     LDX #$01    ; длина строки
C - - - - - 0x0000AD 00:809D: A9 7F     LDA #$7F    ; номер тайла
C - - - - - 0x0000AF 00:809F: 20 EA 98  JSR sub_98EA_замостить_часть_экрана_тайлом_A
...
C - - - - - 0x0000B9 00:80A9: 29 3C     AND #con_btns_SS + con_btns_UD
C - - - - - 0x0000BB 00:80AB: F0 F5     BEQ bra_80A2_ожидание_нажатия
C - - - - - 0x0000BD 00:80AD: 0A        ASL
C - - - - - 0x0000BE 00:80AE: 0A        ASL
C - - - - - 0x0000BF 00:80AF: 30 0B     BMI bra_80BC_нажата_Select  ; if con_btn_Select
C - - - - - 0x0000C1 00:80B1: 0A        ASL
C - - - - - 0x0000C2 00:80B2: 30 20     BMI bra_80D4_нажата_Start   ; if con_btn_Start
; тут остается потенциальные 
...
C - - - - - 0x0000D6 00:80C6: A9 22     LDA #> $220A
C - - - - - 0x0000D8 00:80C8: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
C - - - - - 0x0000E1 00:80D1: 4C 91 80  JMP loc_8091_loop
bra_80D4_нажата_Start:
C - - - - - 0x0000E4 00:80D4: A5 1C     LDA ram_btn_hold
C - - - - - 0x0000E6 00:80D6: 29 C0     AND #con_btns_AB
C - - - - - 0x0000E8 00:80D8: C9 C0     CMP #con_btns_AB
C - - - - - 0x0000EA 00:80DA: D0 03     BNE bra_80DF_skip_музыкальный_экран
C - - - - - 0x0000EC 00:80DC: 4C 09 A2  JMP loc_0x0043E8_управление_музыкальным_экраном
bra_80DF_skip_музыкальный_экран:
; проверить на какой опции сейчас курсор
C - - - - - 0x0000EF 00:80DF: 24 ED     BIT ram_00ED_t10_ppu_addr_lo
C - - - - - 0x0000F1 00:80E1: 50 03     BVC bra_80E6_kick_off
; if опция continue
C - - - - - 0x0000F3 00:80E3: 4C 6A 82  JMP loc_826A_опция_continue
bra_80E6_kick_off:
...
C - - - - - 0x000101 00:80F1: A9 C0     LDA #$80 + $40
C - - - - - 0x000103 00:80F3: 85 E0     STA ram_00E0_flags
...
C - - - - - 0x000115 00:8105: A9 01     LDA #con_sfx_выкл_музыку_и_звуки
C - - - - - 0x000117 00:8107: 8D 00 07  STA ram_номер_звука
...
; замена номера звука на экране с тренером у последней команды
C - - - - - 0x000132 00:8122: A2 55     LDX #con_music_55
C - - - - - 0x000134 00:8124: A5 26     LDA ram_номер_матча
C - - - - - 0x000136 00:8126: C9 20     CMP #$20
C - - - - - 0x000138 00:8128: 90 02     BCC bra_812C_это_не_последний_матч
C - - - - - 0x00013A 00:812A: A2 4C     LDX #con_music_4C
bra_812C_это_не_последний_матч:
C - - - - - 0x00013C 00:812C: 8E 00 07  STX ram_номер_звука
...
C - - - - - 0x000155 00:8145: 24 E0     BIT ram_00E0_flags
C - - - - - 0x000157 00:8147: 30 06     BMI bra_814F
C - - - - - 0x000159 00:8149: A5 E4     LDA ram_prev_номер_матча_1
C - - - - - 0x00015B 00:814B: C5 26     CMP ram_номер_матча
C - - - - - 0x00015D 00:814D: B0 14     BCS bra_8163
bra_814F:
C - - - - - 0x00015F 00:814F: AE 26 00  LDX ram_номер_матча
C - - - - - 0x000162 00:8152: BD DC 83  LDA tbl_83DC_катсцена_перед_матчем,X
C - - - - - 0x000165 00:8155: F0 0C     BEQ bra_8163
; if нужно воспроизвести катсцену
...
C - - - - - 0x00016D 00:815D: A5 E0     LDA ram_00E0_flags
C - - - - - 0x00016F 00:815F: 29 7F     AND #$80 ^ $FF
C - - - - - 0x000171 00:8161: 85 E0     STA ram_00E0_flags
bra_8163:
...
C - - - - - 0x000180 00:8170: A5 26     LDA ram_номер_матча
C - - - - - 0x000182 00:8172: C5 E4     CMP ram_prev_номер_матча_1
...
C - - - - - 0x000188 00:8178: 85 E4     STA ram_prev_номер_матча_1
C - - - - - 0x00018A 00:817A: AE 26 00  LDX ram_номер_матча
...
bra_8196_ничья:
C - - - - - 0x0001A6 00:8196: A6 26     LDX ram_номер_матча
...
bra_81C0_ничья:
C - - - - - 0x0001D0 00:81C0: A6 26     LDX ram_номер_матча
...
C - - - - - 0x0001F3 00:81E3: 4C E6 81  JMP loc_81E6_поражение
bra_81E6_ничья:
loc_81E6_поражение:
...
C - - - - - 0x000209 00:81F9: A6 26     LDX ram_номер_матча
C - - - - - 0x00020B 00:81FB: BD 98 83  LDA tbl_8398_номер_матча_в_случае_проигрыша,X
C - - - - - 0x00020E 00:81FE: 85 26     STA ram_номер_матча
...
C - - - - - 0x00021E 00:820E: 24 E0     BIT ram_00E0_flags
C - - - - - 0x000220 00:8210: 70 0A     BVS bra_821C
C - - - - - 0x000222 00:8212: A5 26     LDA ram_номер_матча
C - - - - - 0x000224 00:8214: C5 E5     CMP ram_prev_номер_матча_2
...
C - - - - - 0x00022A 00:821A: 85 E5     STA ram_prev_номер_матча_2
bra_821C:
C - - - - - 0x00022C 00:821C: A6 26     LDX ram_номер_матча
...
C - - - - - 0x000239 00:8229: A5 E0     LDA ram_00E0_flags
C - - - - - 0x00023B 00:822B: 29 BF     AND #$40 ^ $FF
C - - - - - 0x00023D 00:822D: 85 E0     STA ram_00E0_flags
bra_822F_не_воспроизводить_катсцену:
C - - - - - 0x00023F 00:822F: AE 26 00  LDX ram_номер_матча
...
C - - - - - 0x000253 00:8243: A9 01     LDA #con_sfx_выкл_музыку_и_звуки
C - - - - - 0x000255 00:8245: 8D 00 07  STA ram_номер_звука
C - - - - - 0x000258 00:8248: 20 78 C5  JSR sub_0x03D0E1_попытка_убить_мисуги
C - - - - - 0x00025B 00:824B: E6 26     INC ram_номер_матча
...
sub_8285_перерыв:
C - - - - - 0x000295 00:8285: A9 01     LDA #con_sfx_выкл_музыку_и_звуки
C - - - - - 0x000297 00:8287: 8D 00 07  STA ram_номер_звука
...
C - - - - - 0x0002BE 00:82AE: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x0002C0 00:82B0: 05 4E     ORA ram_004D_t02_data_катсцена + $01
...
C - - - - - 0x0002CA 00:82BA: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x0002CC 00:82BC: 05 4E     ORA ram_004D_t02_data_катсцена + $01
...
C - - - - - 0x0002E8 00:82D8: 85 4C     STA ram_004C_t03
C - - - - - 0x0002EA 00:82DA: A9 01     LDA #con_sfx_выкл_музыку_и_звуки
C - - - - - 0x0002EC 00:82DC: 8D 00 07  STA ram_номер_звука
C - - - - - 0x0002EF 00:82DF: 20 A0 9B  JSR sub_9BA0
C - - - - - 0x0002F2 00:82E2: A9 00     LDA #$00
C - - - - - 0x0002F4 00:82E4: 85 44     STA ram_0044_t01_scroll_Y
C - - - - - 0x0002F6 00:82E6: 85 45     STA ram_0045_t01
C - - - - - 0x0002F8 00:82E8: 85 7A     STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x0002FA 00:82EA: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
...
C - - - - - 0x000300 00:82F0: A5 4C     LDA ram_004C_t03
...
C - - - - - 0x000309 00:82F9: 85 EC     STA ram_00EC_t01_data
C - - - - - 0x00030B 00:82FB: BD 01 B8  LDA tbl_0x00D810 + $01,X
C - - - - - 0x00030E 00:82FE: 85 ED     STA ram_00EC_t01_data + $01
C - - - - - 0x000310 00:8300: A0 00     LDY #$00
C - - - - - 0x000312 00:8302: B1 EC     LDA (ram_00EC_t01_data),Y
C - - - - - 0x000314 00:8304: 30 4F     BMI bra_8355
C - - - - - 0x000316 00:8306: 85 E9     STA ram_00E9_t17_индекс_массива
bra_8308_loop:
C - - - - - 0x000318 00:8308: A9 01     LDA #$01
C - - - - - 0x00031A 00:830A: 85 EB     STA ram_00EB_t06_data_index
loc_830C_loop:
C D 0 - - - 0x00031C 00:830C: A4 EB     LDY ram_00EB_t06_data_index
C - - - - - 0x00031E 00:830E: B1 EC     LDA (ram_00EC_t01_data),Y
...
C - - - - - 0x000328 00:8318: 85 EA     STA ram_00EA_t03
C - - - - - 0x00032A 00:831A: A6 E9     LDX ram_00E9_t17_индекс_массива
C - - - - - 0x00032C 00:831C: A9 03     LDA #$03
C - - - - - 0x00032E 00:831E: 85 EB     STA ram_00EB_t04_loop_counter
bra_8320_loop:
C - - - - - 0x000330 00:8320: C8        INY
C - - - - - 0x000331 00:8321: E8        INX
C - - - - - 0x000332 00:8322: B1 EC     LDA (ram_00EC_t01_data),Y
C - - - - - 0x000334 00:8324: F0 03     BEQ bra_8329_00
C - - - - - 0x000336 00:8326: 9D 2A 06  STA ram_062A,X
bra_8329_00:
C - - - - - 0x000339 00:8329: C6 EB     DEC ram_00EB_t04_loop_counter
C - - - - - 0x00033B 00:832B: D0 F3     BNE bra_8320_loop
C - - - - - 0x00033D 00:832D: C8        INY
C - - - - - 0x00033E 00:832E: 84 EB     STY ram_00EB_t06_data_index
bra_8330_loop:
...
C - - - - - 0x00034D 00:833D: A5 4C     LDA ram_004C_t03
...
C - - - - - 0x00035A 00:834A: A5 4C     LDA ram_004C_t03
C - - - - - 0x00035C 00:834C: 10 35     BPL bra_8383
C - - - - - 0x00035E 00:834E: C6 EA     DEC ram_00EA_t03
C - - - - - 0x000360 00:8350: D0 F5     BNE bra_8347_loop
C - - - - - 0x000362 00:8352: 4C 0C 83  JMP loc_830C_loop
bra_8355:
C - - - - - 0x000365 00:8355: 29 01     AND #$01
C - - - - - 0x000367 00:8357: 85 E9     STA ram_00E9_t18_индекс_массива_chr_банков
bra_8359_loop:
C - - - - - 0x000369 00:8359: A9 01     LDA #$01
C - - - - - 0x00036B 00:835B: 85 EB     STA ram_00EB_t05_data_index
loc_835D_loop:
C D 0 - - - 0x00036D 00:835D: A4 EB     LDY ram_00EB_t05_data_index
C - - - - - 0x00036F 00:835F: B1 EC     LDA (ram_00EC_t01_data),Y
...
C - - - - - 0x000379 00:8369: A6 E9     LDX ram_00E9_t18_индекс_массива_chr_банков
C - - - - - 0x00037B 00:836B: 95 8E     STA ram_008E_t01_chr_banks,X
C - - - - - 0x00037D 00:836D: C8        INY
C - - - - - 0x00037E 00:836E: B1 EC     LDA (ram_00EC_t01_data),Y
C - - - - - 0x000380 00:8370: 85 EA     STA ram_00EA_t04
C - - - - - 0x000382 00:8372: C8        INY
C - - - - - 0x000383 00:8373: 84 EB     STY ram_00EB_t05_data_index
bra_8375_loop:
C - - - - - 0x000385 00:8375: 20 8A 83  JSR sub_838A
C - - - - - 0x000388 00:8378: A5 4C     LDA ram_004C_t03
C - - - - - 0x00038A 00:837A: 10 07     BPL bra_8383
C - - - - - 0x00038C 00:837C: C6 EA     DEC ram_00EA_t04
C - - - - - 0x00038E 00:837E: D0 F5     BNE bra_8375_loop
C - - - - - 0x000390 00:8380: 4C 5D 83  JMP loc_835D_loop
bra_8383:
loc_8383:
C D 0 - - - 0x000393 00:8383: A9 00     LDA #$00
C - - - - - 0x000395 00:8385: 85 4C     STA ram_004C_t03
...
; если катсцена превышает максимальный байт, код вычитает
; этот байт, чтобы считать поинтеры из начала банка и выбирает
; соответствующий номер банка при помощи уже настроенного Y.
...
C - - - - - 0x000485 00:8475: 69 00     ADC #< $A000
C - - - - - 0x000487 00:8477: 85 4D     STA ram_004D_t01_data
C - - - - - 0x000489 00:8479: A9 00     LDA #$00
C - - - - - 0x00048B 00:847B: 69 A0     ADC #> $A000
C - - - - - 0x00048D 00:847D: 85 4E     STA ram_004D_t01_data + $01
C - - - - - 0x00048F 00:847F: 86 56     STX ram_0056_t04_prg_bank
C - - - - - 0x000491 00:8481: A5 25     LDA ram_for_5115
C - - - - - 0x000493 00:8483: 85 ED     STA ram_00ED_t26_save_prg_bank
C - - - - - 0x000495 00:8485: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
C - - - - - 0x000498 00:8488: A0 00     LDY #$00
C - - - - - 0x00049A 00:848A: B1 4D     LDA (ram_004D_t01_data),Y
C - - - - - 0x00049C 00:848C: AA        TAX
C - - - - - 0x00049D 00:848D: C8        INY ; 01
C - - - - - 0x00049E 00:848E: B1 4D     LDA (ram_004D_t01_data),Y
C - - - - - 0x0004A0 00:8490: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x0004A2 00:8492: 86 4D     STX ram_004D_t02_data_катсцена
...
C - - - - - 0x0004AC 00:849C: 95 01     STA ram_0001_stack_pointer,X
...
C - - - - - 0x0004C0 00:84B0: A9 E0     LDA #< $23E0
C - - - - - 0x0004C2 00:84B2: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0004C4 00:84B4: A9 23     LDA #> $23E0
C - - - - - 0x0004C6 00:84B6: 85 E7     STA ram_00E7_t03_ppu_addr_hi
C - - - - - 0x0004C8 00:84B8: A0 01     LDY #$01    ; количество строк
C - - - - - 0x0004CA 00:84BA: A2 20     LDX #$20    ; длина строки
C - - - - - 0x0004CC 00:84BC: A9 55     LDA #$55    ; номер тайла
C - - - - - 0x0004CE 00:84BE: 20 EA 98  JSR sub_98EA_замостить_часть_экрана_тайлом_A
C - - - - - 0x0004D1 00:84C1: A6 ED     LDX ram_00ED_t26_save_prg_bank
C - - - - - 0x0004D3 00:84C3: 4C B9 C4  JMP loc_0x03C4C9_банксвич_PRG_5115



ofs_84C6:
C - - - - - 0x0004D6 00:84C6: A6 56     LDX ram_0056_t04_prg_bank
C - - - - - 0x0004D8 00:84C8: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
; базовая скорость текста
C - - - - - 0x0004DB 00:84CB: A9 08     LDA #$04
C - - - - - 0x0004DD 00:84CD: 85 55     STA ram_0055_t01_скорость_текста
; базовая позиция текста
C - - - - - 0x0004DF 00:84CF: A9 49     LDA #< $2260
C - - - - - 0x0004E1 00:84D1: 85 4F     STA ram_004F_t01_ppu_addr_lo
C - - - - - 0x0004E3 00:84D3: A9 22     LDA #> $2260
C - - - - - 0x0004E5 00:84D5: 85 50     STA ram_0050_t02_ppu_addr_hi
loc_84D7:
C D 0 - - - 0x0004E7 00:84D7: A5 4F     LDA ram_004F_t01_ppu_addr_lo
C - - - - - 0x0004E9 00:84D9: 85 51     STA ram_0051_t01_ppu_addr_lo
C - - - - - 0x0004EB 00:84DB: 29 1F     AND #$1F
C - - - - - 0x0004ED 00:84DD: 85 54     STA ram_0054_t04_ppu_offset_затирание
C - - - - - 0x0004EF 00:84DF: A5 50     LDA ram_0050_t02_ppu_addr_hi
C - - - - - 0x0004F1 00:84E1: 85 52     STA ram_0052_t03_ppu_addr_hi
loc_84E3:
C D 0 - - - 0x0004F3 00:84E3: A5 51     LDA ram_0051_t01_ppu_addr_lo
C - - - - - 0x0004F5 00:84E5: 85 53     STA ram_0053_t01_ppu_addr_lo
loc_84E7_продолжить_чтение_байтов_катсцены:
C D 0 - - - 0x0004F7 00:84E7: A0 00     LDY #$00
C - - - - - 0x0004F9 00:84E9: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x0004FB 00:84EB: C9 D8     CMP #$E5
C - - - - - 0x0004FD 00:84ED: B0 15     BCS bra_8537_E5_FF
; 00-E4
C - - - - - 0x0004FF 00:84EF: A6 52     LDX ram_0052_t03_ppu_addr_hi
C - - - - - 0x000501 00:84F1: A4 53     LDY ram_0053_t01_ppu_addr_lo
C - - - - - 0x000503 00:84F3: 20 CA 88  JSR sub_88CA_запись_символа_в_буфер
C - - - - - 0x000506 00:84F6: E6 53     INC ram_0053_t01_ppu_addr_lo
C - - - - - 0x000508 00:84F8: A5 55     LDA ram_0055_t01_скорость_текста
...
; con_8545_offset
                                        INY
                                        LDA (ram_004D_t02_data_катсцена),Y
                                        STA ram_00B1_t01
                                        BPL @сместить_вправо
...
@сместить_вправо:
                                        CLC
                                        ADC ram_0053_t01_ppu_addr_lo
                                        STA ram_0053_t01_ppu_addr_lo
                                        BCC @пропуск
                                        BIT ram_00B1_t01
                                        BMI @пропуск
                                        INC ram_0052_t03_ppu_addr_hi
@пропуск:
                                        LDA #$02
...
C - - - - - 0x000586 00:8576: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
C - - - - - 0x0005A3 00:8593: A9 00     LDA #< $2000
C - - - - - 0x0005A5 00:8595: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0005A7 00:8597: A9 20     LDA #> $2000
C - - - - - 0x0005A9 00:8599: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
C - - - - - 0x0005B2 00:85A2: A9 00     LDA #< $2400
C - - - - - 0x0005B4 00:85A4: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0005B6 00:85A6: A9 24     LDA #> $2400
C - - - - - 0x0005B8 00:85A8: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
C - - - - - 0x0005E4 00:85D4: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
bra_85EE_loop:
C - - - - - 0x0005FE 00:85EE: BD 00 07  LDA ram_номер_звука,X
...
C - - - - - 0x00060A 00:85FA: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x00060C 00:85FC: 9D 00 07  STA ram_номер_звука,X
...
; con_8545_clear_all
C - - - - - 0x000614 00:8604: A9 21     LDA #< $2221
C - - - - - 0x000616 00:8606: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x000618 00:8608: A9 22     LDA #> $2221
C - - - - - 0x00061A 00:860A: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
; con_8545_base_offset
; указывается младший и старший байт для 2006
C - - - - - 0x00063C 00:862C: C8        INY
C - - - - - 0x00063D 00:862D: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x00063F 00:862F: 85 4F     STA ram_004F_t01_ppu_addr_lo
C - - - - - 0x000641 00:8631: 85 51     STA ram_0051_t01_ppu_addr_lo
C - - - - - 0x000643 00:8633: C8        INY
C - - - - - 0x000644 00:8634: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x000646 00:8636: 85 50     STA ram_0050_t02_ppu_addr_hi
C - - - - - 0x000648 00:8638: 85 52     STA ram_0052_t03_ppu_addr_hi
C - - - - - 0x00064A 00:863A: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x00064C 00:863C: 18        CLC
C - - - - - 0x00064D 00:863D: 69 03     ADC #< $0003
C - - - - - 0x00064F 00:863F: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x000651 00:8641: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x000653 00:8643: 69 00     ADC #> $0003
C - - - - - 0x000655 00:8645: 85 4E     STA ram_004D_t02_data_катсцена + $01
...
; con_8545_window
C - - - - - 0x00065A 00:864A: A9 21     LDA #< $2221
C - - - - - 0x00065C 00:864C: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x00065E 00:864E: A9 22     LDA #> $2221
C - - - - - 0x000660 00:8650: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
C - - - - - 0x00066B 00:865B: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
C - - - - - 0x00067E 00:866E: A6 56     LDX ram_0056_t04_prg_bank
...
C - - - - - 0x000689 00:8679: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x00068B 00:867B: 85 55     STA ram_0055_t01_скорость_текста
...
C - - - - - 0x000693 00:8683: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
C - - - - - 0x0006B9 00:86A9: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x0006BB 00:86AB: AA        TAX
C - - - - - 0x0006BC 00:86AC: 88        DEY ; 02
C - - - - - 0x0006BD 00:86AD: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
C - - - - - 0x0006C9 00:86B9: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
tbl_86C6:
; see con_86C6
- - - - - - 0x0006D6 00:86C6: D5 86     .word $0000 ; unused, index doesn't exist
- D 0 - - - 0x0006D8 00:86C8: DD 86     .word ofs_002_86DE_01_яркость_спрайтов_1 - $01
- D 0 - - - 0x0006DA 00:86CA: E5 86     .word ofs_002_86E6_02_яркость_спрайтов_2 - $01
- D 0 - - - 0x0006DC 00:86CC: ED 86     .word ofs_002_86EE_03_яркость_спрайтов_3 - $01
...
ofs_002_86DE_01_яркость_спрайтов_1:
; con_86C6_яркость_спрайтов_1
...
ofs_002_86E6_02_яркость_спрайтов_2:
; con_86C6_яркость_спрайтов_2
...
ofs_002_86EE_03_яркость_спрайтов_3:
; con_86C6_яркость_спрайтов_3
...
; con_86C6_скрыть_текст
C - - - - - 0x000706 00:86F6: A9 04     LDA #$04
C - - - - - 0x000708 00:86F8: 85 ED     STA ram_00ED_t28_яркость_текста
bra_86FA_loop:
C - - - - - 0x00070A 00:86FA: A6 ED     LDX ram_00ED_t28_яркость_текста
C - - - - - 0x00070C 00:86FC: BD B3 87  LDA tbl_87B4_палитра_текста - $01,X
...
C - - - - - 0x00071A 00:870A: C6 ED     DEC ram_00ED_t28_яркость_текста
...
; con_86C6_показать_текст
C - - - - - 0x000723 00:8713: A9 00     LDA #$00
C - - - - - 0x000725 00:8715: 85 ED     STA ram_00ED_t29_яркость_текста
bra_8717_loop:
C - - - - - 0x000727 00:8717: A6 ED     LDX ram_00ED_t29_яркость_текста
C - - - - - 0x000729 00:8719: BD B4 87  LDA tbl_87B4_палитра_текста,X
...
C - - - - - 0x000737 00:8727: E6 ED     INC ram_00ED_t29_яркость_текста
C - - - - - 0x000739 00:8729: A5 ED     LDA ram_00ED_t29_яркость_текста
...
; con_86C6_ожидание_перехода_к_скрытому_диалогу
bra_8734_loop_repeat_моргание:
C - - - - - 0x000744 00:8734: A0 FC     LDY #$FC
bra_8736_loop_копирование_данных_мячика_курсора:
...
C - - - - - 0x00074D 00:873D: D0 F7     BNE bra_8736_loop_копирование_данных_мячика_курсора
...
C - - - - - 0x000784 00:8774: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x000786 00:8776: 18        CLC
C - - - - - 0x000787 00:8777: 69 03     ADC #< $0003
C - - - - - 0x000789 00:8779: 85 58     STA ram_0058_t02_data_ptr_катсцена
C - - - - - 0x00078B 00:877B: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x00078D 00:877D: 69 00     ADC #> $0003
C - - - - - 0x00078F 00:877F: 85 59     STA ram_0058_t02_data_ptr_катсцена + $01
C - - - - - 0x000791 00:8781: A5 56     LDA ram_0056_t04_prg_bank
C - - - - - 0x000793 00:8783: 85 5A     STA ram_005A_t01_prg_bank
; прочитать 2й байт и получить индекс для таблицы данных скрытой катсцены
C - - - - - 0x000795 00:8785: A0 02     LDY #$02
C - - - - - 0x000797 00:8787: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
                                        STA ram_00B0_t01_номер_скрытой_катсцены
; * 03
; bzk optimize, CLC не нужен
C - - - - - 0x000799 00:8789: 0A        ASL
                                        CLC
                                        ADC ram_00B0_t01_номер_скрытой_катсцены
C - - - - - 0x00079A 00:878A: A8        TAY
C - - - - - 0x00079B 00:878B: A2 06     LDX tbl_879D_банк_скрытой_катсцены,Y
C - - - - - 0x00079D 00:878D: 86 56     STX ram_0056_t04_prg_bank
...
C - - - - - 0x0007A5 00:8795: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x0007A7 00:8797: B9 01 A0  LDA tbl_879D_поинтер_скрытой_катсцены + $02,Y
C - - - - - 0x0007AA 00:879A: 85 4E     STA ram_004D_t02_data_катсцена + $01
...
; con_86C6_возврат_из_скрытой_катсцены
C - - - - - 0x0007AF 00:879F: 20 B1 88  JSR sub_88B1_затирание_текста
C - - - - - 0x0007B2 00:87A2: A5 58     LDA ram_0058_t02_data_ptr_катсцена
C - - - - - 0x0007B4 00:87A4: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x0007B6 00:87A6: A5 59     LDA ram_0058_t02_data_ptr_катсцена + $01
C - - - - - 0x0007B8 00:87A8: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x0007BA 00:87AA: A6 5A     LDX ram_005A_t01_prg_bank
C - - - - - 0x0007BC 00:87AC: 86 56     STX ram_0056_t04_prg_bank
C - - - - - 0x0007BE 00:87AE: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
C - - - - - 0x0007C1 00:87B1: 4C D7 84  JMP loc_84D7



tbl_87B4_палитра_текста:
...
C - - - - - 0x0007CB 00:87BB: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
bra_87C4_FF:
C - - - - - 0x0007D4 00:87C4: 86 4C     STX ram_004C_t03
...
C - - - - - 0x0007DF 00:87CF: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
...
bra_87E5:
C - - - - - 0x0007F5 00:87E5: A5 7B     LDA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x0007F7 00:87E7: 49 01     EOR #$01
C - - - - - 0x0007F9 00:87E9: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x0007FB 00:87EB: A9 00     LDA #$00
C - - - - - 0x0007FD 00:87ED: 85 7A     STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x0007FF 00:87EF: 85 44     STA ram_0044_t01_scroll_Y
C - - - - - 0x000801 00:87F1: 85 45     STA ram_0045_t01
...
C - - - - - 0x000809 00:87F9: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x00080B 00:87FB: 85 ED     STA ram_00ED_t05_байт_F8_1
; bzk bug? следующий байт по идее вообще не должен быть считан,
; поскольку в катсценах после F8 должен идти только 1 байт,
; а следующий может быть вообще каким угодно,
; что может привести к багам

; дополнение 07.08.2025
; 00EC может быть считан в зависимости от подпрограммы
; в ram_00ED_t05_байт_F8_1, например подпрограмма 01 0x00456E
C - - - - - 0x00080D 00:87FD: C8        INY
C - - - - - 0x00080E 00:87FE: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x000810 00:8800: 85 EC     STA ram_00EC_t07_байт_F8_2
...
C - - - - - 0x00081B 00:880B: A6 56     LDX ram_0056_t04_prg_bank
...
; con_8545_bg_1
C - - - - - 0x000824 00:8814: A5 5B     LDA ram_005B_t02_флаги
C - - - - - 0x000826 00:8816: 29 FB     AND #$04 ^ $FF
...
; con_8545_bg_2
C - - - - - 0x00082B 00:881B: A5 5B     LDA ram_005B_t02_флаги
C - - - - - 0x00082D 00:881D: 09 04     ORA #$04
loc_881F:
C D 0 - - - 0x00082F 00:881F: 85 5B     STA ram_005B_t02_флаги
C - - - - - 0x000831 00:8821: C8        INY
C - - - - - 0x000832 00:8822: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x000834 00:8824: 20 F7 8A  JSR sub_8AF7
C - - - - - 0x000837 00:8827: A6 56     LDX ram_0056_t04_prg_bank
...
C - - - - - 0x00084F 00:883F: A5 51     LDA ram_0051_t01_ppu_addr_lo
C - - - - - 0x000851 00:8841: 18        CLC
C - - - - - 0x000852 00:8842: 69 40     ADC #< $0040
C - - - - - 0x000854 00:8844: 85 51     STA ram_0051_t01_ppu_addr_lo
C - - - - - 0x000856 00:8846: A5 52     LDA ram_0052_t03_ppu_addr_hi
C - - - - - 0x000858 00:8848: 69 00     ADC #> $0040
C - - - - - 0x00085A 00:884A: 85 52     STA ram_0052_t03_ppu_addr_hi
C - - - - - 0x00085C 00:884C: E6 4D     INC ram_004D_t02_data_катсцена
C - - - - - 0x00085E 00:884E: D0 02     BNE bra_8852_not_overflow
C - - - - - 0x000860 00:8850: E6 4E     INC ram_004D_t02_data_катсцена + $01
...
C - - - - - 0x000873 00:8863: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x000875 00:8865: AA        TAX
C - - - - - 0x000876 00:8866: C8        INY
C - - - - - 0x000877 00:8867: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x000879 00:8869: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x00087B 00:886B: 86 4D     STX ram_004D_t02_data_катсцена
...
C - - - - - 0x000882 00:8872: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x000884 00:8874: 85 4E     STA ram_004D_t02_data_катсцена + $01
...
C - - - - - 0x00088A 00:887A: 65 4D     ADC ram_004D_t02_data_катсцена
C - - - - - 0x00088C 00:887C: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x00088E 00:887E: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x000890 00:8880: 69 00     ADC #$00
C - - - - - 0x000892 00:8882: 85 4E     STA ram_004D_t02_data_катсцена + $01
...
C - - - - - 0x000898 00:8888: 65 4D     ADC ram_004D_t02_data_катсцена
C - - - - - 0x00089A 00:888A: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x00089C 00:888C: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x00089E 00:888E: 69 00     ADC #$00
C - - - - - 0x0008A0 00:8890: 85 4E     STA ram_004D_t02_data_катсцена + $01
...
; in
    ; A
        ...
        ; 80 = дождь?
        ; 81 = тряска экрана?
C - - - - - 0x0008A5 00:8895: 85 57     STA ram_0057_t01
...
sub_88B0_частичное_затирание_текста:
                                        LDX #$09
bra_88B1:
                                        LDA ram_0054_tFF_useless
                                        PHA
                                        STX ram_0054_t04_ppu_offset_затирание
                                        JSR sub_88B1_затирание_текста
                                        PLA
                                        STA ram_0054_tFF_useless
                                        RTS
...
; in
    ; ram_0054_t04_ppu_offset_затирание
C - - - - - 0x0008C1 00:88B1: A5 54     LDA ram_0054_t04_ppu_offset_затирание
...
C - - - - - 0x0008CB 00:88BB: A5 4F     LDA ram_004F_t01_ppu_addr_lo
C - - - - - 0x0008CD 00:88BD: 29 E0     AND #$E0
C - - - - - 0x0008CF 00:88BF: 05 54     ORA ram_0054_t04_ppu_offset_затирание
C - - - - - 0x0008D1 00:88C1: 85 E6     STA ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0008D3 00:88C3: A5 50     LDA ram_0050_t02_ppu_addr_hi
C - - - - - 0x0008D5 00:88C5: 85 E7     STA ram_00E7_t03_ppu_addr_hi
...
sub_88FB_реверснуть_приоритет_всех_спрайтов_над_фоном:
sub_0x00090B_реверснуть_приоритет_всех_спрайтов_над_фоном:
...
; in
    ; A = con_BF00
        ; по сути множитель 1, но также удобен как коммент для данных
C - - - - - 0x000930 00:8920: A2 13     LDX #$13    ; множитель 2
C - - - - - 0x000932 00:8922: 20 EE 9D  JSR sub_9DEE_умножить_A_на_X
C - - - - - 0x000935 00:8925: A5 EC     LDA ram_00EC_t04_произведение_lo
C - - - - - 0x000937 00:8927: 18        CLC
C - - - - - 0x000938 00:8928: 69 00     ADC #< tbl_0x00DF10
C - - - - - 0x00093A 00:892A: 85 EC     STA ram_00EC_t02_data
C - - - - - 0x00093C 00:892C: A5 ED     LDA ram_00ED_t03_произведение_hi
C - - - - - 0x00093E 00:892E: 69 BF     ADC #> tbl_0x00DF10
C - - - - - 0x000940 00:8930: 85 ED     STA ram_00EC_t02_data + $01
C - - - - - 0x000942 00:8932: A5 25     LDA ram_for_5115
C - - - - - 0x000944 00:8934: 85 EA     STA ram_00EA_t05_prg_bank
...
C - - - - - 0x00094B 00:893B: A5 78     LDA ram_0078_t01_индекс_массива
C - - - - - 0x00094D 00:893D: D0 FC     BNE bra_893B_infinite_loop
C - - - - - 0x00094F 00:893F: A0 00     LDY #$00
C - - - - - 0x000951 00:8941: B1 EC     LDA (ram_00EC_t02_data),Y
C - - - - - 0x000953 00:8943: 8D 79 00  STA ram_0079_t02_номер_сканлинии
C - - - - - 0x000956 00:8946: A9 00     LDA #$00
C - - - - - 0x000958 00:8948: 8D 7A 00  STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x00095B 00:894B: C8        INY ; 01
C - - - - - 0x00095C 00:894C: A2 12     LDX #$12
bra_894E_loop:
C - - - - - 0x00095E 00:894E: B1 EC     LDA (ram_00EC_t02_data),Y
C - - - - - 0x000960 00:8950: 99 7B 00  STA ram_007C_t01_массив_конфиг_ppu - $01,Y
...
; in
    ; A = скорость текста
C - - - - - 0x00096D 00:895D: AA        TAX ; скорость текста
C - - - - - 0x00096E 00:895E: A5 99     LDA ram_0099_флаг_диалогов
C - - - - - 0x000970 00:8960: 10 04     BPL bra_8966
C - - - - - 0x000972 00:8962: 49 41     EOR #$01 + $40
C - - - - - 0x000974 00:8964: 85 99     STA ram_0099_флаг_диалогов
bra_8966:
bra_8966_loop:
C - - - - - 0x000976 00:8966: A9 01     LDA #$01
C - - - - - 0x000978 00:8968: 20 A8 9F  JSR sub_9FA8_задержка_кадра
C - - - - - 0x00097B 00:896B: 8A        TXA ; скорость текста
C - - - - - 0x00097C 00:896C: 48        PHA
C - - - - - 0x00097D 00:896D: 20 FF 89  JSR sub_89FF_анимация_чарли
C - - - - - 0x000980 00:8970: 68        PLA
C - - - - - 0x000981 00:8971: AA        TAX ; скорость текста
...
; in
    ; X = номер анимации 1
    ; Y = номер анимации 2
C - - - - - 0x000986 00:8976: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x000988 00:8978: 85 EA     STA ram_00EA_t01_data_ptr
C - - - - - 0x00098A 00:897A: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x00098C 00:897C: 85 EB     STA ram_00EA_t01_data_ptr + $01
C - - - - - 0x00098E 00:897E: A9 02     LDA #$02    ; длина массива (колво адресов с анимацией)
C - - - - - 0x000990 00:8980: 85 E6     STA ram_00E6_t36_массив_номеров_анимаций
C - - - - - 0x000992 00:8982: 86 E7     STX ram_00E6_t36_массив_номеров_анимаций + $01   ; номер анимации 1
C - - - - - 0x000994 00:8984: 84 E8     STY ram_00E6_t36_массив_номеров_анимаций + $02   ; номер анимации 2
; !!!
C - - - - - 0x000996 00:8986: A9 E5     LDA #< (ram_00E6_t36_массив_номеров_анимаций - $01)
C - - - - - 0x000998 00:8988: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x00099A 00:898A: A9 00     LDA #> (ram_00E6_t36_массив_номеров_анимаций - $01)
C - - - - - 0x00099C 00:898C: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x00099E 00:898E: 20 85 90  JSR sub_9085
C - - - - - 0x0009A1 00:8991: A5 EA     LDA ram_00EA_t01_data_ptr
C - - - - - 0x0009A3 00:8993: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x0009A5 00:8995: A5 EB     LDA ram_00EA_t01_data_ptr + $01
C - - - - - 0x0009A7 00:8997: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x0009A9 00:8999: 60        RTS



sub_899A___для_0099___бит7_0___бит6_1:
C - - - - - 0x0009AA 00:899A: A5 99     LDA ram_0099_флаг_диалогов
C - - - - - 0x0009AC 00:899C: 29 80     AND #$80
C - - - - - 0x0009AE 00:899E: 09 40     ORA #$40
C - - - - - 0x0009B0 00:89A0: 85 99     STA ram_0099_флаг_диалогов
...
C - - - - - 0x000A03 00:89F3: 85 90     STA ram_008E_t01_chr_banks + $02
...
; bzk optimize, делать проверку на чарли, а только потом RTS сюда
...
C - - - - - 0x000A43 00:8A33: B1 E6     LDA (ram_00E6_t01_data),Y
...
C - - - - - 0x000A4F 00:8A3F: 85 E8     STA ram_00E8_t11
C - - - - - 0x000A51 00:8A41: 4A        LSR
C - - - - - 0x000A52 00:8A42: 18        CLC
C - - - - - 0x000A53 00:8A43: 65 E8     ADC ram_00E8_t11
C - - - - - 0x000A55 00:8A45: 85 E8     STA ram_00E8_t12_ptr_lo
C - - - - - 0x000A57 00:8A47: A9 00     LDA #$00
C - - - - - 0x000A59 00:8A49: 69 00     ADC #$00
C - - - - - 0x000A5B 00:8A4B: 85 E9     STA ram_00E9_t08_ptr_hi
C - - - - - 0x000A5D 00:8A4D: A5 E8     LDA ram_00E8_t12_ptr_lo
C - - - - - 0x000A5F 00:8A4F: 18        CLC
C - - - - - 0x000A60 00:8A50: 69 80     ADC #< tbl_0x00DD90_тайлы_чарли_в_катсцене
C - - - - - 0x000A62 00:8A52: 85 E8     STA ram_00E8_t01_data_тайлы_чарли
C - - - - - 0x000A64 00:8A54: A5 E9     LDA ram_00E9_t08_ptr_hi
C - - - - - 0x000A66 00:8A56: 69 BD     ADC #> tbl_0x00DD90_тайлы_чарли_в_катсцене
C - - - - - 0x000A68 00:8A58: 85 E9     STA ram_00E8_t01_data_тайлы_чарли + $01
...
C - - - - - 0x000A81 00:8A71: B1 E6     LDA (ram_00E6_t01_data),Y
...
C - - - - - 0x000AA1 00:8A91: A9 84     LDA #$04 + $80
C - - - - - 0x000AA3 00:8A93: 20 28 9B  JSR sub_9B28_подготовить_буфер
C - - - - - 0x000AA6 00:8A96: A0 00     LDY #$00
bra_8A98_loop:
C - - - - - 0x000AA8 00:8A98: B1 E8     LDA (ram_00E8_t01_data_тайлы_чарли),Y
C - - - - - 0x000AAA 00:8A9A: 9D E8 05  STA ram_05E8_буфер,X
...
C - - - - - 0x000AB6 00:8AA6: A5 E8     LDA ram_00E8_t01_data_тайлы_чарли
C - - - - - 0x000AB8 00:8AA8: 18        CLC
C - - - - - 0x000AB9 00:8AA9: 69 04     ADC #< $0004
C - - - - - 0x000ABB 00:8AAB: 85 E8     STA ram_00E8_t01_data_тайлы_чарли
C - - - - - 0x000ABD 00:8AAD: A5 E9     LDA ram_00E8_t01_data_тайлы_чарли + $01
C - - - - - 0x000ABF 00:8AAF: 69 00     ADC #> $0004
C - - - - - 0x000AC1 00:8AB1: 85 E9     STA ram_00E8_t01_data_тайлы_чарли + $01
...
C - - - - - 0x000B07 00:8AF7: 85 ED     STA ram_00ED_t30
...
C - - - - - 0x000B13 00:8B03: A5 5B     LDA ram_005B_t02_флаги
C - - - - - 0x000B15 00:8B05: 29 7F     AND #$80 ^ $FF
C - - - - - 0x000B17 00:8B07: 85 5B     STA ram_005B_t02_флаги
C - - - - - 0x000B19 00:8B09: A5 25     LDA ram_for_5115
C - - - - - 0x000B1B 00:8B0B: 85 77     STA ram_0077_t02_prg_bank
...
C - - - - - 0x000B2C 00:8B1C: A5 ED     LDA ram_00ED_t30
...
C - - - - - 0x000B38 00:8B28: 85 63     STA ram_0063_t01_data_ptr
C - - - - - 0x000B3A 00:8B2A: 98        TYA
C - - - - - 0x000B3B 00:8B2B: 69 A0     ADC #> tbl_0x00E010_параметры_заднего_фона
C - - - - - 0x000B3D 00:8B2D: 85 64     STA ram_0063_t01_data_ptr + $01
C - - - - - 0x000B3F 00:8B2F: A0 00     LDY #$00
C - - - - - 0x000B41 00:8B31: B1 63     LDA (ram_0063_t01_data_ptr),Y
C - - - - - 0x000B43 00:8B33: AA        TAX
C - - - - - 0x000B44 00:8B34: C8        INY ; 01
C - - - - - 0x000B45 00:8B35: B1 63     LDA (ram_0063_t01_data_ptr),Y
C - - - - - 0x000B47 00:8B37: 85 64     STA ram_0063_t02_data_парам_задн_фона + $01
C - - - - - 0x000B49 00:8B39: 86 63     STX ram_0063_t02_data_парам_задн_фона
C - - - - - 0x000B4B 00:8B3B: A0 00     LDY #$00
C - - - - - 0x000B4D 00:8B3D: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
; комменты в 0x00EE5B
; номер банка chr 1
C - - - - - 0x000B4F 00:8B3F: 85 75     STA ram_0075_chr_bank_1
C - - - - - 0x000B51 00:8B41: C8        INY ; 01
C - - - - - 0x000B52 00:8B42: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
; номер банка chr 2
C - - - - - 0x000B54 00:8B44: 85 76     STA ram_0076_chr_bank_2
C - - - - - 0x000B56 00:8B46: C8        INY ; 02
C - - - - - 0x000B57 00:8B47: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
; номер палитры + ???
C - - - - - 0x000B59 00:8B49: AA        TAX
C - - - - - 0x000B5A 00:8B4A: 29 3F     AND #$3F
C - - - - - 0x000B5C 00:8B4C: 85 48     STA ram_0048_t03_bg_pal_index
C - - - - - 0x000B5E 00:8B4E: 8A        TXA
C - - - - - 0x000B5F 00:8B4F: 46 5B     LSR ram_005B_t02_флаги
C - - - - - 0x000B61 00:8B51: 2A        ROL
C - - - - - 0x000B62 00:8B52: 26 5B     ROL ram_005B_t02_флаги
C - - - - - 0x000B64 00:8B54: C8        INY ; 03
; bzk optimize, залупно сделано, при помощи байтов смещения
; код будет читать байты в самом конце списка, которые
; было бы удобнее поместить после этих первых 6 байтов,
; то есть по сути эти поинтеры нужны для чтения
; следующих поинтеров, для чего такое посредничество,
; если все равно последние 2 байта читаются перед тем,
; как продолжить чтение списка
C - - - - - 0x000B65 00:8B55: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
; множитель счетчика количества байтов для чтения
C - - - - - 0x000B67 00:8B57: 85 5E     STA ram_005E_t01_loop_counter_main
C - - - - - 0x000B69 00:8B59: C8        INY ; 04
C - - - - - 0x000B6A 00:8B5A: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
; счетчик количества байтов для чтения
C - - - - - 0x000B6C 00:8B5C: 85 5F     STA ram_005F_t03_loop_counter
C - - - - - 0x000B6E 00:8B5E: C8        INY ; 05
C - - - - - 0x000B6F 00:8B5F: B1 63     LDA (ram_0063_t02_data_парам_задн_фона),Y
...
C - - - - - 0x000B9F 00:8B8F: 05 5D     ORA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000BA1 00:8B91: 85 5D     STA ram_005D_t20_ppu_addr_hi
bra_8B93_пропуск:
C - - - - - 0x000BA3 00:8B93: A5 5E     LDA ram_005E_t01_loop_counter_main
...
bra_8B9F_00_08:
C - - - - - 0x000BAF 00:8B9F: A5 5D     LDA ram_005D_t20_ppu_addr_hi
...
C - - - - - 0x000BC3 00:8BB3: A5 63     LDA ram_0063_t02_data_парам_задн_фона
C - - - - - 0x000BC5 00:8BB5: 18        CLC
C - - - - - 0x000BC6 00:8BB6: 69 06     ADC #< $0006
C - - - - - 0x000BC8 00:8BB8: 85 63     STA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000BCA 00:8BBA: A5 64     LDA ram_0063_t02_data_парам_задн_фона + $01
C - - - - - 0x000BCC 00:8BBC: 69 00     ADC #> $0006
C - - - - - 0x000BCE 00:8BBE: 85 64     STA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000BD0 00:8BC0: A5 5E     LDA ram_005E_t01_loop_counter_main
C - - - - - 0x000BD2 00:8BC2: A6 5F     LDX ram_005F_t03_loop_counter
C - - - - - 0x000BD4 00:8BC4: 20 EE 9D  JSR sub_9DEE_умножить_A_на_X
C - - - - - 0x000BD7 00:8BC7: A5 63     LDA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000BD9 00:8BC9: 18        CLC
C - - - - - 0x000BDA 00:8BCA: 65 EC     ADC ram_00EC_t04_произведение_lo
C - - - - - 0x000BDC 00:8BCC: 85 70     STA ram_0070_t01_data
C - - - - - 0x000BDE 00:8BCE: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000BE0 00:8BD0: 65 ED     ADC ram_00ED_t03_произведение_hi
C - - - - - 0x000BE2 00:8BD2: 85 71     STA ram_0070_t01_data + $01
C - - - - - 0x000BE4 00:8BD4: A9 00     LDA #$00
C - - - - - 0x000BE6 00:8BD6: 85 60     STA ram_0060_t01_lo
C - - - - - 0x000BE8 00:8BD8: A0 01     LDY #$01
C - - - - - 0x000BEA 00:8BDA: B1 70     LDA (ram_0070_t01_data),Y
C - - - - - 0x000BEC 00:8BDC: 29 E0     AND #$E0
C - - - - - 0x000BEE 00:8BDE: 85 62     STA ram_0062_t01
...
C - - - - - 0x000BF9 00:8BE9: 66 60     ROR ram_0060_t01_lo
C - - - - - 0x000BFB 00:8BEB: 85 61     STA ram_0061_t03_hi
C - - - - - 0x000BFD 00:8BED: 8A        TXA
C - - - - - 0x000BFE 00:8BEE: F0 03     BEQ bra_8BF3_пропуск
C - - - - - 0x000C00 00:8BF0: C8        INY ; 01
C - - - - - 0x000C01 00:8BF1: B1 70     LDA (ram_0070_t01_data),Y
bra_8BF3_пропуск:
C - - - - - 0x000C03 00:8BF3: 85 72     STA ram_0072_t02_loop_counter
C - - - - - 0x000C05 00:8BF5: A5 62     LDA ram_0062_t01
...
C - - - - - 0x000C17 00:8C07: A4 5F     LDY ram_005F_t03_loop_counter
C - - - - - 0x000C19 00:8C09: 4C 59 8C  JMP loc_8C59
bra_8C0C_80:
C - - - - - 0x000C1C 00:8C0C: A9 04     LDA #$04
C - - - - - 0x000C1E 00:8C0E: A2 01     LDX #$01
C - - - - - 0x000C20 00:8C10: A4 5F     LDY ram_005F_t03_loop_counter
C - - - - - 0x000C22 00:8C12: 4C 59 8C  JMP loc_8C59
bra_8C15_40:
C - - - - - 0x000C25 00:8C15: A5 5E     LDA ram_005E_t01_loop_counter_main
C - - - - - 0x000C27 00:8C17: A6 5F     LDX ram_005F_t03_loop_counter
C - - - - - 0x000C29 00:8C19: 20 EE 9D  JSR sub_9DEE_умножить_A_на_X
C - - - - - 0x000C2C 00:8C1C: A5 EC     LDA ram_00EC_t04_произведение_lo
C - - - - - 0x000C2E 00:8C1E: 38        SEC
C - - - - - 0x000C2F 00:8C1F: E9 01     SBC #< $0001
C - - - - - 0x000C31 00:8C21: 85 EC     STA ram_00EC_t08_data_ptr_lo
C - - - - - 0x000C33 00:8C23: A5 ED     LDA ram_00ED_t03_произведение_hi
C - - - - - 0x000C35 00:8C25: E9 00     SBC #> $0001
C - - - - - 0x000C37 00:8C27: 85 ED     STA ram_00ED_t06_data_ptr_hi
C - - - - - 0x000C39 00:8C29: A5 63     LDA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000C3B 00:8C2B: 18        CLC
C - - - - - 0x000C3C 00:8C2C: 65 EC     ADC ram_00EC_t08_data_ptr_lo
C - - - - - 0x000C3E 00:8C2E: 85 63     STA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000C40 00:8C30: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000C42 00:8C32: 65 ED     ADC ram_00ED_t06_data_ptr_hi
C - - - - - 0x000C44 00:8C34: 85 64     STA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000C46 00:8C36: A9 00     LDA #$00
C - - - - - 0x000C48 00:8C38: 38        SEC
C - - - - - 0x000C49 00:8C39: E5 5F     SBC ram_005F_t03_loop_counter
...
bra_8C0C_00:
; bzk optimize, заменить на LDY + DEY + TYA
C - - - - - 0x000C53 00:8C43: A5 5F     LDA ram_005F_t03_loop_counter
C - - - - - 0x000C55 00:8C45: 38        SEC
C - - - - - 0x000C56 00:8C46: E9 01     SBC #$01
C - - - - - 0x000C58 00:8C48: 18        CLC
C - - - - - 0x000C59 00:8C49: 65 63     ADC ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000C5B 00:8C4B: 85 63     STA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000C5D 00:8C4D: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000C5F 00:8C4F: 69 00     ADC #$00
C - - - - - 0x000C61 00:8C51: 85 64     STA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000C63 00:8C53: A9 FC     LDA #$FC
C - - - - - 0x000C65 00:8C55: A2 FF     LDX #$FF
C - - - - - 0x000C67 00:8C57: A4 5F     LDY ram_005F_t03_loop_counter
loc_8C59:
C D 0 - - - 0x000C69 00:8C59: 85 6D     STA ram_006D_t01
C - - - - - 0x000C6B 00:8C5B: 86 6E     STX ram_006E_t01
C - - - - - 0x000C6D 00:8C5D: 84 6F     STY ram_006F_t01
C - - - - - 0x000C6F 00:8C5F: A5 5E     LDA ram_005E_t01_loop_counter_main
...
C - - - - - 0x000C78 00:8C68: 85 5E     STA ram_005E_t02_loop_counter
C - - - - - 0x000C7A 00:8C6A: A0 07     LDY #$07    ; loop counter (main)
C - - - - - 0x000C7C 00:8C6C: A6 5F     LDX ram_005F_t03_loop_counter
C - - - - - 0x000C7E 00:8C6E: 20 15 8E  JSR sub_8E15
C - - - - - 0x000C81 00:8C71: A9 01     LDA #$01
C - - - - - 0x000C83 00:8C73: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
...
C - - - - - 0x000C8D 00:8C7D: 95 01     STA ram_0001_stack_pointer,X
C - - - - - 0x000C8F 00:8C7F: A0 78     LDY #$78 - $02
C - - - - - 0x000C93 00:8C83: 20 69 9F  JSR sub_9F69
C - - - - - 0x000C96 00:8C86: 4C A5 8C  JMP loc_8CA5
bra_8C89:
C - - - - - 0x000C99 00:8C89: A4 5E     LDY ram_005E_t01_loop_counter_main
C - - - - - 0x000C9B 00:8C8B: A6 5F     LDX ram_005F_t03_loop_counter
C - - - - - 0x000C9D 00:8C8D: 20 15 8E  JSR sub_8E15
C - - - - - 0x000CA0 00:8C90: A5 72     LDA ram_0072_t02_loop_counter
...
C - - - - - 0x000CAC 00:8C9C: 95 01     STA ram_0001_stack_pointer,X
C - - - - - 0x000CAE 00:8C9E: A0 78     LDY #$78 - $02
C - - - - - 0x000CB2 00:8CA2: 20 69 9F  JSR sub_9F69
bra_8CA5:
loc_8CA5:
C D 0 - - - 0x000CB5 00:8CA5: A5 75     LDA ram_0075_chr_bank_1
C - - - - - 0x000CB7 00:8CA7: 85 8E     STA ram_008E_t01_chr_banks
C - - - - - 0x000CB9 00:8CA9: A5 76     LDA ram_0076_chr_bank_2
C - - - - - 0x000CBB 00:8CAB: 85 8F     STA ram_008E_t01_chr_banks + $01
C - - - - - 0x000CBD 00:8CAD: A9 00     LDA #$00
C - - - - - 0x000CBF 00:8CAF: 85 44     STA ram_0044_t01_scroll_Y
C - - - - - 0x000CC1 00:8CB1: 85 45     STA ram_0045_t01
C - - - - - 0x000CC3 00:8CB3: 85 7A     STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x000CC5 00:8CB5: A6 77     LDX ram_0077_t02_prg_bank
...
C - - - - - 0x000CD1 00:8CC1: 85 69     STA ram_0069_t02_lo
C - - - - - 0x000CD3 00:8CC3: 85 6A     STA ram_006A_t02
C - - - - - 0x000CD5 00:8CC5: 24 62     BIT ram_0062_t01
C - - - - - 0x000CD7 00:8CC7: 30 0D     BMI bra_8CD6
; EOR
C - - - - - 0x000CD9 00:8CC9: A9 00     LDA #$00
C - - - - - 0x000CDB 00:8CCB: 38        SEC
C - - - - - 0x000CDC 00:8CCC: E5 60     SBC ram_0060_t01_lo
C - - - - - 0x000CDE 00:8CCE: 85 60     STA ram_0060_t01_lo
C - - - - - 0x000CE0 00:8CD0: A9 00     LDA #$00
C - - - - - 0x000CE2 00:8CD2: E5 61     SBC ram_0061_t03_hi
C - - - - - 0x000CE4 00:8CD4: 85 61     STA ram_0061_t03_hi
bra_8CD6:
bra_8CD6_loop:
C - - - - - 0x000CE6 00:8CD6: A9 01     LDA #$01
C - - - - - 0x000CE8 00:8CD8: 20 A8 9F  JSR sub_9FA8_задержка_кадра
C - - - - - 0x000CEB 00:8CDB: A5 60     LDA ram_0060_t01_lo
C - - - - - 0x000CED 00:8CDD: 18        CLC
C - - - - - 0x000CEE 00:8CDE: 65 69     ADC ram_0069_t02_lo
C - - - - - 0x000CF0 00:8CE0: 85 69     STA ram_0069_t02_lo
C - - - - - 0x000CF2 00:8CE2: A9 00     LDA #$00
C - - - - - 0x000CF4 00:8CE4: 65 61     ADC ram_0061_t03_hi
...
C - - - - - 0x000D03 00:8CF3: 65 6A     ADC ram_006A_t02
C - - - - - 0x000D05 00:8CF5: 85 6A     STA ram_006A_t02
C - - - - - 0x000D07 00:8CF7: 38        SEC
C - - - - - 0x000D08 00:8CF8: E9 20     SBC #$20
C - - - - - 0x000D0A 00:8CFA: 90 DA     BCC bra_8CD6_loop
C - - - - - 0x000D0C 00:8CFC: 85 6A     STA ram_006A_t02
loc_8CFE:
C - - - - - 0x000D0E 00:8CFE: A5 5B     LDA ram_005B_t02_флаги
...
C - - - - - 0x000D22 00:8D12: 95 01     STA ram_0001_stack_pointer,X
C - - - - - 0x000D24 00:8D14: A0 A0     LDY #$A0 - $02
C - - - - - 0x000D28 00:8D18: 20 69 9F  JSR sub_9F69
C - - - - - 0x000D2B 00:8D1B: C6 5E     DEC ram_005E_t02_loop_counter
...
C - - - - - 0x000D3B 00:8D2B: B1 70     LDA (ram_0070_t01_data),Y
...
C - - - - - 0x000D50 00:8D40: 85 69     STA ram_0069_t02_lo
C - - - - - 0x000D52 00:8D42: 85 6A     STA ram_006A_t02
C - - - - - 0x000D54 00:8D44: 24 62     BIT ram_0062_t01
C - - - - - 0x000D56 00:8D46: 30 0D     BMI bra_8D55
; EOR
C - - - - - 0x000D58 00:8D48: A9 00     LDA #$00
C - - - - - 0x000D5A 00:8D4A: 38        SEC
C - - - - - 0x000D5B 00:8D4B: E5 60     SBC ram_0060_t01_lo
C - - - - - 0x000D5D 00:8D4D: 85 60     STA ram_0060_t01_lo
C - - - - - 0x000D5F 00:8D4F: A9 00     LDA #$00
C - - - - - 0x000D61 00:8D51: E5 61     SBC ram_0061_t03_hi
C - - - - - 0x000D63 00:8D53: 85 61     STA ram_0061_t03_hi
bra_8D55:
C - - - - - 0x000D65 00:8D55: 24 62     BIT ram_0062_t01
...
C - - - - - 0x000D6E 00:8D5E: A5 60     LDA ram_0060_t01_lo
C - - - - - 0x000D70 00:8D60: 18        CLC
C - - - - - 0x000D71 00:8D61: 65 69     ADC ram_0069_t02_lo
C - - - - - 0x000D73 00:8D63: 85 69     STA ram_0069_t02_lo
C - - - - - 0x000D75 00:8D65: A9 00     LDA #$00
C - - - - - 0x000D77 00:8D67: 65 61     ADC ram_0061_t03_hi
...
C - - - - - 0x000D86 00:8D76: 65 6A     ADC ram_006A_t02
C - - - - - 0x000D88 00:8D78: 85 6A     STA ram_006A_t02
C - - - - - 0x000D8A 00:8D7A: 38        SEC
C - - - - - 0x000D8B 00:8D7B: E9 20     SBC #$20
C - - - - - 0x000D8D 00:8D7D: 90 DA     BCC bra_8D59_loop
C - - - - - 0x000D8F 00:8D7F: 85 6A     STA ram_006A_t02
C - - - - - 0x000D91 00:8D81: C6 72     DEC ram_0072_t02_loop_counter
...
C - - - - - 0x000D9D 00:8D8D: A5 60     LDA ram_0060_t01_lo
C - - - - - 0x000D9F 00:8D8F: 18        CLC
C - - - - - 0x000DA0 00:8D90: 65 69     ADC ram_0069_t02_lo
C - - - - - 0x000DA2 00:8D92: 85 69     STA ram_0069_t02_lo
C - - - - - 0x000DA4 00:8D94: A9 00     LDA #$00
C - - - - - 0x000DA6 00:8D96: 65 61     ADC ram_0061_t03_hi
...
C - - - - - 0x000DB5 00:8DA5: 65 6A     ADC ram_006A_t02
C - - - - - 0x000DB7 00:8DA7: 85 6A     STA ram_006A_t02
C - - - - - 0x000DB9 00:8DA9: 38        SEC
C - - - - - 0x000DBA 00:8DAA: E9 20     SBC #$20
C - - - - - 0x000DBC 00:8DAC: 90 DA     BCC bra_8D88_loop
C - - - - - 0x000DBE 00:8DAE: 85 6A     STA ram_006A_t02
C - - - - - 0x000DC0 00:8DB0: C6 72     DEC ram_0072_t02_loop_counter
C - - - - - 0x000DC2 00:8DB2: D0 D4     BNE bra_8D88_loop
C - - - - - 0x000DC4 00:8DB4: A5 7A     LDA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x000DC6 00:8DB6: 38        SEC
C - - - - - 0x000DC7 00:8DB7: E5 6A     SBC ram_006A_t02
C - - - - - 0x000DC9 00:8DB9: 85 7A     STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x000DCB 00:8DBB: A5 7B     LDA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x000DCD 00:8DBD: E9 00     SBC #$00
C - - - - - 0x000DCF 00:8DBF: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x000DD1 00:8DC1: A5 47     LDA ram_0047_t02
C - - - - - 0x000DD3 00:8DC3: 38        SEC
C - - - - - 0x000DD4 00:8DC4: E5 6A     SBC ram_006A_t02
C - - - - - 0x000DD6 00:8DC6: 85 47     STA ram_0047_t02
loc_8DC8:
C D 0 - - - 0x000DD8 00:8DC8: A5 62     LDA ram_0062_t01
C - - - - - 0x000DDA 00:8DCA: 29 20     AND #$20
C - - - - - 0x000DDC 00:8DCC: D0 2E     BNE bra_8DFC_выход
C - - - - - 0x000DDE 00:8DCE: A5 70     LDA ram_0070_t01_data
C - - - - - 0x000DE0 00:8DD0: 18        CLC
C - - - - - 0x000DE1 00:8DD1: 69 03     ADC #< $0003
C - - - - - 0x000DE3 00:8DD3: 85 70     STA ram_0070_t01_data
C - - - - - 0x000DE5 00:8DD5: A5 71     LDA ram_0070_t01_data + $01
C - - - - - 0x000DE7 00:8DD7: 69 00     ADC #> $0003
C - - - - - 0x000DE9 00:8DD9: 85 71     STA ram_0070_t01_data + $01
C - - - - - 0x000DEB 00:8DDB: A9 00     LDA #$00
C - - - - - 0x000DED 00:8DDD: 85 60     STA ram_0060_t01_lo
C - - - - - 0x000DEF 00:8DDF: A0 01     LDY #$01
C - - - - - 0x000DF1 00:8DE1: B1 70     LDA (ram_0070_t01_data),Y
C - - - - - 0x000DF3 00:8DE3: 29 E0     AND #$E0
C - - - - - 0x000DF5 00:8DE5: 85 62     STA ram_0062_t01
...
C - - - - - 0x000E00 00:8DF0: 66 60     ROR ram_0060_t01_lo
C - - - - - 0x000E02 00:8DF2: 85 61     STA ram_0061_t03_hi
C - - - - - 0x000E04 00:8DF4: C8        INY ; 02
C - - - - - 0x000E05 00:8DF5: B1 70     LDA (ram_0070_t01_data),Y
C - - - - - 0x000E07 00:8DF7: 85 72     STA ram_0072_t02_loop_counter
C - - - - - 0x000E09 00:8DF9: 4C 22 8D  JMP loc_8D22_loop
bra_8DFC_выход:
...
ofs_8DFF:
C - - - - - 0x000E0F 00:8DFF: A5 5B     LDA ram_005B_t02_флаги
C - - - - - 0x000E11 00:8E01: 09 80     ORA #$80
C - - - - - 0x000E13 00:8E03: 85 5B     STA ram_005B_t02_флаги
C - - - - - 0x000E15 00:8E05: A0 01     LDY #$01    ; loop counter (main)
C - - - - - 0x000E17 00:8E07: A6 5F     LDX ram_005F_t03_loop_counter
C - - - - - 0x000E19 00:8E09: 20 15 8E  JSR sub_8E15
C - - - - - 0x000E1C 00:8E0C: A5 5B     LDA ram_005B_t02_флаги
C - - - - - 0x000E1E 00:8E0E: 29 7F     AND #$80 ^ $FF
C - - - - - 0x000E20 00:8E10: 85 5B     STA ram_005B_t02_флаги
...
; in
    ; X = loop counter 1
    ; Y = loop counter 2
C - - - - - 0x000E25 00:8E15: 84 6C     STY ram_006C_t01_loop_counter_main
C - - - - - 0x000E27 00:8E17: 86 6B     STX ram_006B_t02_loop_counter
loc_8E19_loop:
C D 0 - - - 0x000E29 00:8E19: A5 63     LDA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000E2B 00:8E1B: 85 65     STA ram_0065_t02_ptr_lo
C - - - - - 0x000E2D 00:8E1D: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000E2F 00:8E1F: 85 66     STA ram_0066_t01_ptr_hi
C - - - - - 0x000E31 00:8E21: A5 6B     LDA ram_006B_t02_loop_counter
C - - - - - 0x000E33 00:8E23: 85 ED     STA ram_00ED_t31_loop_counter
C - - - - - 0x000E35 00:8E25: A5 5C     LDA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000E37 00:8E27: 85 73     STA ram_0073_t02_ppu_addr_lo
C - - - - - 0x000E39 00:8E29: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000E3B 00:8E2B: 85 74     STA ram_0074_t01_ppu_addr_hi
bra_8E2D_loop:
C - - - - - 0x000E3D 00:8E2D: A0 00     LDY #$00
C - - - - - 0x000E3F 00:8E2F: B1 63     LDA (ram_0063_t03_data_парам_задн_фона),Y
C - - - - - 0x000E41 00:8E31: 20 F0 8E  JSR sub_8EF0_чтение_блоков_тайлов
C - - - - - 0x000E44 00:8E34: A5 5C     LDA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000E46 00:8E36: AA        TAX
C - - - - - 0x000E47 00:8E37: 18        CLC
C - - - - - 0x000E48 00:8E38: 65 6D     ADC ram_006D_t01
C - - - - - 0x000E4A 00:8E3A: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000E4C 00:8E3C: 8A        TXA
C - - - - - 0x000E4D 00:8E3D: 45 5C     EOR ram_005C_t03_ppu_addr_lo
...
C - - - - - 0x000E5E 00:8E4E: 65 5C     ADC ram_005C_t03_ppu_addr_lo
C - - - - - 0x000E60 00:8E50: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000E62 00:8E52: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000E64 00:8E54: 49 04     EOR #$04
C - - - - - 0x000E66 00:8E56: 85 5D     STA ram_005D_t20_ppu_addr_hi
bra_8E58:
C - - - - - 0x000E68 00:8E58: A5 6E     LDA ram_006E_t01
C - - - - - 0x000E6A 00:8E5A: 48        PHA
C - - - - - 0x000E6B 00:8E5B: 18        CLC
C - - - - - 0x000E6C 00:8E5C: 65 63     ADC ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000E6E 00:8E5E: 85 63     STA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000E70 00:8E60: 68        PLA
C - - - - - 0x000E71 00:8E61: 30 07     BMI bra_8E6A
C - - - - - 0x000E73 00:8E63: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000E75 00:8E65: 69 00     ADC #$00
C - - - - - 0x000E77 00:8E67: 4C 6E 8E  JMP loc_8E6E
bra_8E6A:
C - - - - - 0x000E7A 00:8E6A: A5 64     LDA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000E7C 00:8E6C: E9 00     SBC #$00
loc_8E6E:
C D 0 - - - 0x000E7E 00:8E6E: 85 64     STA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000E80 00:8E70: C6 ED     DEC ram_00ED_t31_loop_counter
C - - - - - 0x000E82 00:8E72: D0 B9     BNE bra_8E2D_loop
C - - - - - 0x000E84 00:8E74: A5 6F     LDA ram_006F_t01
C - - - - - 0x000E86 00:8E76: 48        PHA
C - - - - - 0x000E87 00:8E77: 18        CLC
C - - - - - 0x000E88 00:8E78: 65 65     ADC ram_0065_t02_ptr_lo
C - - - - - 0x000E8A 00:8E7A: 85 63     STA ram_0063_t03_data_парам_задн_фона
C - - - - - 0x000E8C 00:8E7C: 68        PLA
C - - - - - 0x000E8D 00:8E7D: 30 07     BMI bra_8E86
C - - - - - 0x000E8F 00:8E7F: A5 66     LDA ram_0066_t01_ptr_hi
C - - - - - 0x000E91 00:8E81: 69 00     ADC #$00
C - - - - - 0x000E93 00:8E83: 4C 8A 8E  JMP loc_8E8A
bra_8E86:
C - - - - - 0x000E96 00:8E86: A5 66     LDA ram_0066_t01_ptr_hi
C - - - - - 0x000E98 00:8E88: E9 00     SBC #$00
loc_8E8A:
C D 0 - - - 0x000E9A 00:8E8A: 85 64     STA ram_0063_t03_data_парам_задн_фона + $01
C - - - - - 0x000E9C 00:8E8C: A5 62     LDA ram_0062_t01
C - - - - - 0x000E9E 00:8E8E: 29 C0     AND #$C0
C - - - - - 0x000EA0 00:8E90: C9 40     CMP #$40
C - - - - - 0x000EA2 00:8E92: F0 2E     BEQ bra_8EC2
C - - - - - 0x000EA4 00:8E94: A5 73     LDA ram_0073_t02_ppu_addr_lo
C - - - - - 0x000EA6 00:8E96: 18        CLC
C - - - - - 0x000EA7 00:8E97: 69 80     ADC #< $0080
C - - - - - 0x000EA9 00:8E99: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000EAB 00:8E9B: AA        TAX
C - - - - - 0x000EAC 00:8E9C: A5 74     LDA ram_0074_t01_ppu_addr_hi
C - - - - - 0x000EAE 00:8E9E: 69 00     ADC #> $0080
C - - - - - 0x000EB0 00:8EA0: 85 5D     STA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000EB2 00:8EA2: 8A        TXA
C - - - - - 0x000EB3 00:8EA3: 38        SEC
C - - - - - 0x000EB4 00:8EA4: E9 40     SBC #< $0040
C - - - - - 0x000EB6 00:8EA6: 10 40     BPL bra_8EE8
C - - - - - 0x000EB8 00:8EA8: A5 5D     LDA ram_005D_t20_ppu_addr_hi
...
C - - - - - 0x000EC2 00:8EB2: A5 5C     LDA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000EC4 00:8EB4: 38        SEC
C - - - - - 0x000EC5 00:8EB5: E9 C0     SBC #< $03C0
; bzk optimize, бесполезный STA?
C - - - - - 0x000EC7 00:8EB7: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000EC9 00:8EB9: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000ECB 00:8EBB: E9 03     SBC #> $03C0
C - - - - - 0x000ECD 00:8EBD: 85 5D     STA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000ECF 00:8EBF: 4C E8 8E  JMP loc_8EE8
bra_8EC2:
C - - - - - 0x000ED2 00:8EC2: A5 73     LDA ram_0073_t02_ppu_addr_lo
C - - - - - 0x000ED4 00:8EC4: 38        SEC
C - - - - - 0x000ED5 00:8EC5: E9 80     SBC #< $0080
C - - - - - 0x000ED7 00:8EC7: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000ED9 00:8EC9: AA        TAX
C - - - - - 0x000EDA 00:8ECA: A5 74     LDA ram_0074_t01_ppu_addr_hi
C - - - - - 0x000EDC 00:8ECC: E9 00     SBC #> $0080
C - - - - - 0x000EDE 00:8ECE: 85 5D     STA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000EE0 00:8ED0: 8A        TXA
C - - - - - 0x000EE1 00:8ED1: 10 15     BPL bra_8EE8
C - - - - - 0x000EE3 00:8ED3: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000EE5 00:8ED5: 29 03     AND #$03
C - - - - - 0x000EE7 00:8ED7: C9 03     CMP #$03
C - - - - - 0x000EE9 00:8ED9: D0 0D     BNE bra_8EE8
C - - - - - 0x000EEB 00:8EDB: A5 5C     LDA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000EED 00:8EDD: 18        CLC
C - - - - - 0x000EEE 00:8EDE: 69 C0     ADC #< $03C0
C - - - - - 0x000EF0 00:8EE0: 85 5C     STA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000EF2 00:8EE2: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000EF4 00:8EE4: 69 03     ADC #> $03C0
C - - - - - 0x000EF6 00:8EE6: 85 5D     STA ram_005D_t20_ppu_addr_hi
bra_8EE8:
loc_8EE8:
C D 0 - - - 0x000EF8 00:8EE8: C6 6C     DEC ram_006C_t01_loop_counter_main
...
C - - - - - 0x000F01 00:8EF1: A5 5C     LDA ram_005C_t03_ppu_addr_lo
C - - - - - 0x000F03 00:8EF3: 85 67     STA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F05 00:8EF5: A5 5D     LDA ram_005D_t20_ppu_addr_hi
C - - - - - 0x000F07 00:8EF7: 85 68     STA ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F09 00:8EF9: A5 5B     LDA ram_005B_t02_флаги
...
C - - - - - 0x000F17 00:8F07: 26 EB     ROL ram_00EB_t13
C - - - - - 0x000F19 00:8F09: 0A        ASL
C - - - - - 0x000F1A 00:8F0A: 26 EB     ROL ram_00EB_t13
C - - - - - 0x000F1C 00:8F0C: 0A        ASL
C - - - - - 0x000F1D 00:8F0D: 26 EB     ROL ram_00EB_t13
C - - - - - 0x000F1F 00:8F0F: 18        CLC
C - - - - - 0x000F20 00:8F10: 65 EA     ADC ram_00EA_t10
C - - - - - 0x000F22 00:8F12: 85 EA     STA ram_00EA_t11_ptr_lo
...
C - - - - - 0x000F2E 00:8F1E: 85 EA     STA ram_00EA_t02_data_блок_4x4
C - - - - - 0x000F30 00:8F20: A5 EB     LDA ram_00EB_t14_ptr_hi
C - - - - - 0x000F32 00:8F22: 69 A0     ADC #> tbl_0x010010_блоки_4x4_тайла
C - - - - - 0x000F34 00:8F24: 85 EB     STA ram_00EA_t02_data_блок_4x4 + $01
...
C - - - - - 0x000F3D 00:8F2D: B1 EA     LDA (ram_00EA_t02_data_блок_4x4),Y
C - - - - - 0x000F3F 00:8F2F: 85 E7     STA ram_00E7_t06
C - - - - - 0x000F41 00:8F31: 20 D1 8F  JSR sub_8FD1
C - - - - - 0x000F44 00:8F34: E6 EA     INC ram_00EA_t02_data_блок_4x4
C - - - - - 0x000F46 00:8F36: D0 02     BNE bra_8F3A_not_overflow
C - - - - - 0x000F48 00:8F38: E6 EB     INC ram_00EA_t02_data_блок_4x4 + $01
bra_8F3A_not_overflow:
C - - - - - 0x000F4A 00:8F3A: A9 04     LDA #$04
C - - - - - 0x000F4C 00:8F3C: 85 E8     STA ram_00E8_t13_loop_counter
bra_8F3E_loop:
loc_8F3E_loop:
C D 0 - - - 0x000F4E 00:8F3E: A4 67     LDY ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F50 00:8F40: A6 68     LDX ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F52 00:8F42: A9 04     LDA #$04
C - - - - - 0x000F54 00:8F44: 20 28 9B  JSR sub_9B28_подготовить_буфер
C - - - - - 0x000F57 00:8F47: A0 00     LDY #$00
bra_8F49_loop:
C - - - - - 0x000F59 00:8F49: B1 EA     LDA (ram_00EA_t02_data_блок_4x4),Y
C - - - - - 0x000F5B 00:8F4B: 9D E8 05  STA ram_05E8_буфер,X
...
C - - - - - 0x000F67 00:8F57: C6 E8     DEC ram_00E8_t13_loop_counter
C - - - - - 0x000F69 00:8F59: F0 70     BEQ bra_8FCB
C - - - - - 0x000F6B 00:8F5B: A5 EA     LDA ram_00EA_t02_data_блок_4x4
C - - - - - 0x000F6D 00:8F5D: 18        CLC
C - - - - - 0x000F6E 00:8F5E: 69 04     ADC #< $0004
C - - - - - 0x000F70 00:8F60: 85 EA     STA ram_00EA_t02_data_блок_4x4
C - - - - - 0x000F72 00:8F62: A5 EB     LDA ram_00EA_t02_data_блок_4x4 + $01
C - - - - - 0x000F74 00:8F64: 69 00     ADC #> $0004
C - - - - - 0x000F76 00:8F66: 85 EB     STA ram_00EA_t02_data_блок_4x4 + $01
C - - - - - 0x000F78 00:8F68: A5 67     LDA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F7A 00:8F6A: 18        CLC
C - - - - - 0x000F7B 00:8F6B: 69 20     ADC #< $0020
C - - - - - 0x000F7D 00:8F6D: 85 67     STA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F7F 00:8F6F: A5 68     LDA ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F81 00:8F71: 69 00     ADC #> $0020
C - - - - - 0x000F83 00:8F73: 85 68     STA ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F85 00:8F75: 29 03     AND #$03
C - - - - - 0x000F87 00:8F77: C9 03     CMP #$03
C - - - - - 0x000F89 00:8F79: D0 C3     BNE bra_8F3E_loop
C - - - - - 0x000F8B 00:8F7B: A5 67     LDA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F8D 00:8F7D: C9 C0     CMP #$C0
C - - - - - 0x000F8F 00:8F7F: 90 BD     BCC bra_8F3E_loop
C - - - - - 0x000F91 00:8F81: A5 67     LDA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F93 00:8F83: 38        SEC
C - - - - - 0x000F94 00:8F84: E9 C0     SBC #< $03C0
C - - - - - 0x000F96 00:8F86: 85 67     STA ram_0067_t01_ppu_addr_lo
C - - - - - 0x000F98 00:8F88: A5 68     LDA ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F9A 00:8F8A: E9 03     SBC #> $03C0
C - - - - - 0x000F9C 00:8F8C: 85 68     STA ram_0068_t01_ppu_addr_hi
C - - - - - 0x000F9E 00:8F8E: 20 49 90  JSR sub_9049_вычислить_ppu_address
...
C - - - - - 0x000FAD 00:8F9D: A5 62     LDA ram_0062_t01
...
C - - - - - 0x000FBB 00:8FAB: 9D E8 05  STA ram_05E8_буфер,X
...
C - - - - - 0x000FD1 00:8FC1: 9D E8 05  STA ram_05E8_буфер,X
...
sub_8FD1:
C - - - - - 0x000FE1 00:8FD1: 20 49 90  JSR sub_9049_вычислить_ppu_address
C - - - - - 0x000FE4 00:8FD4: 24 67     BIT ram_0067_t01_ppu_addr_lo
C - - - - - 0x000FE6 00:8FD6: 50 62     BVC bra_903A
C - - - - - 0x000FE8 00:8FD8: 84 E8     STY ram_00E8_t14_ppu_addr_lo
C - - - - - 0x000FEA 00:8FDA: 86 E9     STX ram_00E9_t09_ppu_addr_hi
...
C - - - - - 0x000FF8 00:8FE8: A5 62     LDA ram_0062_t01
...
- - - - - - 0x001016 00:9006: 85 E6     STA ram_00E6_t19
...
C - - - - - 0x00102F 00:901F: 85 E6     STA ram_00E6_t19
...
C - - - - - 0x00104F 00:903F: A5 E7     LDA ram_00E7_t06
loc_9041:
...
sub_9049_вычислить_ppu_address:
; in
    ; ram_0067_t01_ppu_addr_lo
    ; ram_0068_t01_ppu_addr_hi
; out
    ; X = ppu addr hi
    ; Y = ppu addr lo
...
C - - - - - 0x001076 00:9066: 05 E6     ORA ram_00E6_t24
C - - - - - 0x001078 00:9068: A8        TAY
C - - - - - 0x001079 00:9069: A5 68     LDA ram_0068_t01_ppu_addr_hi
...
bra_9078:
C D 0 - - - 0x001088 00:9078: 85 E7     STA ram_00E7_t03_ppu_addr_hi
C - - - - - 0x00108A 00:907A: A9 00     LDA #$00
C - - - - - 0x00108C 00:907C: 85 E6     STA ram_00E6_t17_ppu_addr_lo
...
sub_9085:
; in
    ; ram_004D_t02_data_катсцена
C - - - - - 0x001095 00:9085: A9 00     LDA #$00
C - - - - - 0x001097 00:9087: A0 01     LDY #$01
bra_9089_loop_0468_0556:
C - - - - - 0x001099 00:9089: 99 67 04  STA ram_copy_oam - $01,Y
C - - - - - 0x00109C 00:908C: C8        INY
C - - - - - 0x00109D 00:908D: D0 FA     BNE bra_9089_loop_0468_0556
; A = 00
; Y = 00
; bzk optimize, STY + INY вместо LDA + STA + LDY
    ; еще можно вместо STY записать STA
C - - - - - 0x00109F 00:908F: A9 00     LDA #$00
C - - - - - 0x0010A1 00:9091: 85 97     STA ram_0097
C - - - - - 0x0010A3 00:9093: A0 01     LDY #$01
; ram_00E6_t36_массив_номеров_анимаций
C - - - - - 0x0010A5 00:9095: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x0010A7 00:9097: 85 EC     STA ram_00EC_t19_колво_адресов_анимаций
C - - - - - 0x0010A9 00:9099: A5 4D     LDA ram_004D_t02_data_катсцена
C - - - - - 0x0010AB 00:909B: 18        CLC
C - - - - - 0x0010AC 00:909C: 69 02     ADC #< $0002
C - - - - - 0x0010AE 00:909E: 85 4D     STA ram_004D_t02_data_катсцена
C - - - - - 0x0010B0 00:90A0: A5 4E     LDA ram_004D_t02_data_катсцена + $01
C - - - - - 0x0010B2 00:90A2: 69 00     ADC #> $0002
C - - - - - 0x0010B4 00:90A4: 85 4E     STA ram_004D_t02_data_катсцена + $01
C - - - - - 0x0010B6 00:90A6: A9 68     LDA #< ram_0568
C - - - - - 0x0010B8 00:90A8: 85 94     STA ram_0094_t01_data
C - - - - - 0x0010BA 00:90AA: A9 05     LDA #> ram_0568
C - - - - - 0x0010BC 00:90AC: 85 95     STA ram_0094_t01_data + $01
loc_90AE_loop:
C D 0 - - - 0x0010BE 00:90AE: A6 25     LDX ram_for_5115
C - - - - - 0x0010C0 00:90B0: 86 ED     STX ram_00ED_t27_for_5115
C - - - - - 0x0010C2 00:90B2: A0 00     LDY #$00
; ram_00E6_t36_массив_номеров_анимаций + $01
; ram_00E6_t36_массив_номеров_анимаций + $02
C - - - - - 0x0010C4 00:90B4: B1 4D     LDA (ram_004D_t02_data_катсцена),Y
C - - - - - 0x0010C6 00:90B6: A8        TAY ; -> номер анимации
C - - - - - 0x0010C7 00:90B7: A2 09     LDX #con_prg_bank + $09
; в банке 09 анимации 00-6C, в банке 0A анимации 6D-CB
...
C - - - - - 0x0010D0 00:90C0: A8        TAY ; -> номер анимации
C - - - - - 0x0010D1 00:90C1: E8        INX ; -> con_prg_bank + $0A
bra_90C2:
C - - - - - 0x0010D2 00:90C2: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
; bzk optimize, наверняка можно упростить вычисление поинтера
C - - - - - 0x0010D5 00:90C5: 98        TYA ; <- номер анимации
...
; поинтер A000 на банки 09 и 0A изменять нельзя
C - - - - - 0x0010DF 00:90CF: 69 00     ADC #< $A000
C - - - - - 0x0010E1 00:90D1: 85 92     STA ram_0092_t02_data
C - - - - - 0x0010E3 00:90D3: 8A        TXA
C - - - - - 0x0010E4 00:90D4: 69 A0     ADC #> $A000
C - - - - - 0x0010E6 00:90D6: 85 93     STA ram_0092_t02_data + $01
C - - - - - 0x0010E8 00:90D8: A0 00     LDY #$00
C - - - - - 0x0010EA 00:90DA: B1 92     LDA (ram_0092_t02_data),Y
C - - - - - 0x0010EC 00:90DC: AA        TAX
C - - - - - 0x0010ED 00:90DD: C8        INY ; 01
C - - - - - 0x0010EE 00:90DE: B1 92     LDA (ram_0092_t02_data),Y
C - - - - - 0x0010F0 00:90E0: 85 93     STA ram_0092_t03_data + $01
C - - - - - 0x0010F2 00:90E2: 86 92     STX ram_0092_t03_data
; bzk optimize, DEY
; bzk optimize, можно в 0x0010E8 начать с LDY 01 + DEY
C - - - - - 0x0010F4 00:90E4: A0 00     LDY #$00
bra_90E6_loop:
C - - - - - 0x0010F6 00:90E6: B9 8B 97  LDA tbl_978B,Y
C - - - - - 0x0010F9 00:90E9: 91 94     STA (ram_0094_t01_data),Y
...
C - - - - - 0x001105 00:90F5: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001107 00:90F7: 11 94     ORA (ram_0094_t01_data),Y ; 0568 0588 05A8 
C - - - - - 0x001109 00:90F9: 91 94     STA (ram_0094_t01_data),Y ; 0568 0588 05A8 
; bzk optimize, бесполезный LDY (уже 00)
C - - - - - 0x00110B 00:90FB: A0 00     LDY #$00
C - - - - - 0x00110D 00:90FD: B1 92     LDA (ram_0092_t03_data),Y
C - - - - - 0x00110F 00:90FF: 85 49     STA ram_0049_t04_spr_pal_index
C - - - - - 0x001111 00:9101: E6 92     INC ram_0092_t03_data
C - - - - - 0x001113 00:9103: D0 02     BNE bra_9107_not_overflow
; if overflow
C - - - - - 0x001115 00:9105: E6 93     INC ram_0092_t03_data + $01
bra_9107_not_overflow:
C - - - - - 0x001117 00:9107: A0 02     LDY #con_0094_02_data_prt_lo
C - - - - - 0x001119 00:9109: A5 92     LDA ram_0092_t03_data
C - - - - - 0x00111B 00:910B: 91 94     STA (ram_0094_t01_data),Y
C - - - - - 0x00111D 00:910D: C8        INY ; 03    con_0094_03_data_prt_hi
C - - - - - 0x00111E 00:910E: A5 93     LDA ram_0092_t03_data + $01
C - - - - - 0x001120 00:9110: 91 94     STA (ram_0094_t01_data),Y
C - - - - - 0x001122 00:9112: A6 ED     LDX ram_00ED_t27_for_5115
C - - - - - 0x001124 00:9114: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
C - - - - - 0x001127 00:9117: E6 4D     INC ram_004D_t02_data_катсцена
C - - - - - 0x001129 00:9119: D0 02     BNE bra_911D_not_overflow
- - - - - - 0x00112B 00:911B: E6 4E     INC ram_004D_t02_data_катсцена + $01
bra_911D_not_overflow:
C - - - - - 0x00112D 00:911D: A5 94     LDA ram_0094_t01_data
C - - - - - 0x00112F 00:911F: 18        CLC
C - - - - - 0x001130 00:9120: 69 20     ADC #< $0020
C - - - - - 0x001132 00:9122: 85 94     STA ram_0094_t01_data
C - - - - - 0x001134 00:9124: A5 95     LDA ram_0094_t01_data + $01
C - - - - - 0x001136 00:9126: 69 00     ADC #> $0020
C - - - - - 0x001138 00:9128: 85 95     STA ram_0094_t01_data + $01
C - - - - - 0x00113A 00:912A: C6 EC     DEC ram_00EC_t19_колво_адресов_анимаций
C - - - - - 0x00113C 00:912C: F0 03     BEQ bra_9131_больше_адресов_нет
C - - - - - 0x00113E 00:912E: 4C AE 90  JMP loc_90AE_loop
bra_9131_больше_адресов_нет:
...
C - - - - - 0x00115A 00:914A: 85 94     STA ram_0094_t02_data
C - - - - - 0x00115C 00:914C: A9 05     LDA #> ram_0568
C - - - - - 0x00115E 00:914E: 85 95     STA ram_0094_t02_data + $01
C - - - - - 0x001160 00:9150: A9 04     LDA #$04
C - - - - - 0x001162 00:9152: 85 96     STA ram_0096_loop_counter
loc_9154:
C D 0 - - - 0x001164 00:9154: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001166 00:9156: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001168 00:9158: 30 03     BMI bra_915D
C - - - - - 0x00116A 00:915A: 4C C1 94  JMP loc_94C1
bra_915D:
C - - - - - 0x00116D 00:915D: AA        TAX
C - - - - - 0x00116E 00:915E: A0 04     LDY #con_0094_04_pos_Y_lo
C - - - - - 0x001170 00:9160: 20 4A 97  JSR sub_974A
C - - - - - 0x001173 00:9163: A0 06     LDY #con_0094_06_pos_Y_lo
...
bra_9175:
C - - - - - 0x001185 00:9175: A2 04     LDX #con_0094_04_pos_Y_lo
C - - - - - 0x001187 00:9177: A0 0A     LDY #con_0094_0A
C - - - - - 0x001189 00:9179: 20 5B 97  JSR sub_975B
C - - - - - 0x00118C 00:917C: A5 9A     LDA ram_009A_t01_pos_Y_lo
C - - - - - 0x00118E 00:917E: 85 E6     STA ram_00E6_t25_pos_Y_lo
C - - - - - 0x001190 00:9180: A0 04     LDY #con_0094_04_pos_Y_lo
C - - - - - 0x001192 00:9182: 20 4A 97  JSR sub_974A
C - - - - - 0x001195 00:9185: A5 9A     LDA ram_009A_t01_pos_Y_lo
C - - - - - 0x001197 00:9187: 38        SEC
C - - - - - 0x001198 00:9188: E5 E6     SBC ram_00E6_t25_pos_Y_lo
C - - - - - 0x00119A 00:918A: 85 E6     STA ram_00E6_t18_spr_Y
C - - - - - 0x00119C 00:918C: A2 06     LDX #con_0094_06_pos_Y_lo
C - - - - - 0x00119E 00:918E: A0 0E     LDY #con_0094_0E
C - - - - - 0x0011A0 00:9190: 20 5B 97  JSR sub_975B
C - - - - - 0x0011A3 00:9193: A5 9C     LDA ram_009C_t01_pos_Y_lo
C - - - - - 0x0011A5 00:9195: 85 E8     STA ram_00E8_t15_pos_Y_lo
C - - - - - 0x0011A7 00:9197: A0 06     LDY #con_0094_06_pos_Y_lo
C - - - - - 0x0011A9 00:9199: 20 4A 97  JSR sub_974A
C - - - - - 0x0011AC 00:919C: A5 9C     LDA ram_009C_t01_pos_Y_lo
C - - - - - 0x0011AE 00:919E: 38        SEC
C - - - - - 0x0011AF 00:919F: E5 E8     SBC ram_00E8_t15_pos_Y_lo
C - - - - - 0x0011B1 00:91A1: 85 E8     STA ram_00E8_t05_pos_Y_lo_разница
C - - - - - 0x0011B3 00:91A3: 4C B4 91  JMP loc_91B4
bra_91A6:
; EOR
C - - - - - 0x0011B6 00:91A6: A9 00     LDA #$00
C - - - - - 0x0011B8 00:91A8: 38        SEC
C - - - - - 0x0011B9 00:91A9: E5 46     SBC ram_0046_t01
C - - - - - 0x0011BB 00:91AB: 85 E6     STA ram_00E6_t18_spr_Y
C - - - - - 0x0011BD 00:91AD: A9 00     LDA #$00
C - - - - - 0x0011BF 00:91AF: 38        SEC
C - - - - - 0x0011C0 00:91B0: E5 47     SBC ram_0047_t02
C - - - - - 0x0011C2 00:91B2: 85 E8     STA ram_00E8_t05_pos_Y_lo_разница
loc_91B4:
C D 0 - - - 0x0011C4 00:91B4: A0 10     LDY #con_0094_10
C - - - - - 0x0011C6 00:91B6: B1 94     LDA (ram_0094_t02_data),Y
...
bra_91BF_loop:
C - - - - - 0x0011CF 00:91BF: A5 E6     LDA ram_00E6_t18_spr_Y
...
C - - - - - 0x0011D9 00:91C9: 45 E6     EOR ram_00E6_t18_spr_Y
...
bra_91D5:
C - - - - - 0x0011E5 00:91D5: A5 E8     LDA ram_00E8_t05_pos_Y_lo_разница
...
C - - - - - 0x0011EF 00:91DF: 45 E8     EOR ram_00E8_t05_pos_Y_lo_разница
...
loc_91F3:
C D 0 - - - 0x001203 00:91F3: A0 01     LDY #con_0094_01_timer
C - - - - - 0x001205 00:91F5: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001207 00:91F7: 38        SEC
C - - - - - 0x001208 00:91F8: E9 01     SBC #$01
C - - - - - 0x00120A 00:91FA: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00120C 00:91FC: F0 03     BEQ bra_9201
C - - - - - 0x00120E 00:91FE: 4C C1 94  JMP loc_94C1
bra_9201:
C - - - - - 0x001211 00:9201: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001213 00:9203: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x00121E 00:920E: A0 02     LDY #con_0094_02_data_prt_lo
C - - - - - 0x001220 00:9210: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001222 00:9212: 85 92     STA ram_0092_t01_data
C - - - - - 0x001224 00:9214: C8        INY ; 03    con_0094_03_data_prt_hi
C - - - - - 0x001225 00:9215: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001227 00:9217: 85 93     STA ram_0092_t01_data + $01
C - - - - - 0x001229 00:9219: A0 00     LDY #con_0094_00_flag
C - - - - - 0x00122B 00:921B: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x001236 00:9226: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x001238 00:9228: 30 17     BMI bra_9241_80_FF
; 00-7F
C - - - - - 0x00123A 00:922A: C8        INY ; 01    con_0094_01_timer
C - - - - - 0x00123B 00:922B: 0A        ASL
C - - - - - 0x00123C 00:922C: 91 94     STA (ram_0094_t02_data),Y
; bzk optimize, INY
C - - - - - 0x00123E 00:922E: A0 02     LDY #con_0094_02_data_prt_lo
C - - - - - 0x001240 00:9230: A5 92     LDA ram_0092_t01_data
C - - - - - 0x001242 00:9232: 18        CLC
C - - - - - 0x001243 00:9233: 69 01     ADC #< $0001
C - - - - - 0x001245 00:9235: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001247 00:9237: C8        INY ; 03    con_0094_03_data_prt_hi
C - - - - - 0x001248 00:9238: A5 93     LDA ram_0092_t01_data + $01
C - - - - - 0x00124A 00:923A: 69 00     ADC #> $0001
C - - - - - 0x00124C 00:923C: 91 94     STA (ram_0094_t02_data),Y
...
C - - - - - 0x001258 00:9248: 85 E7     STA ram_00E6_t02_data + $01
C - - - - - 0x00125A 00:924A: A0 01     LDY #$01
C - - - - - 0x00125C 00:924C: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x00125E 00:924E: 85 E6     STA ram_00E6_t02_data
C - - - - - 0x001260 00:9250: 20 D8 94  JSR sub_94D8_чтение_байтов_спрайтов_анимации
C - - - - - 0x001263 00:9253: A9 02     LDA #$02
C - - - - - 0x001265 00:9255: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
bra_9258_A0_FF:
...
C - - - - - 0x00126F 00:925F: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x001271 00:9261: 85 92     STA ram_0092_t01_data
C - - - - - 0x001273 00:9263: 86 93     STX ram_0092_t01_data + $01
C - - - - - 0x001275 00:9265: 4C 24 92  JMP loc_9224_loop
bra_9268_С0_FF:
C - - - - - 0x001278 00:9268: C9 E0     CMP #$E0
C - - - - - 0x00127A 00:926A: B0 34     BCS bra_92A0_E0_FF  ; jmp?



; C0-DF
; bzk garbage? 0x001284 бесконечный цикл, код видимо мусорный
; в новых логах не выполнялось
- - - - - - 0x00127C 00:926C: 85 E7     STA ram_00E7_t19
- - - - - - 0x00127E 00:926E: A0 13     LDY #con_0094_13_timer
- - - - - - 0x001280 00:9270: B1 94     LDA (ram_0094_t02_data),Y
...
- - - - - - 0x00128A 00:927A: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x00128C 00:927C: 8A        TXA
- - - - - - 0x00128D 00:927D: 0A        ASL
- - - - - - 0x00128E 00:927E: 18        CLC
- - - - - - 0x00128F 00:927F: 69 18     ADC #$18
- - - - - - 0x001291 00:9281: A8        TAY ; 18/1A
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo / con_0094_1C_data_ptr_lo?
- - - - - - 0x001292 00:9282: A5 92     LDA ram_0092_t01_data
- - - - - - 0x001294 00:9284: 18        CLC
- - - - - - 0x001295 00:9285: 69 02     ADC #< $0002
- - - - - - 0x001297 00:9287: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x001299 00:9289: C8        INY ; 19/1B
; con_0094_19_data_ptr_hi / con_0094_1B_data_ptr_hi / con_0094_1D_data_ptr_hi?
- - - - - - 0x00129A 00:928A: A5 93     LDA ram_0092_t01_data + $01
- - - - - - 0x00129C 00:928C: 69 00     ADC #> $0002
- - - - - - 0x00129E 00:928E: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x0012A0 00:9290: A0 01     LDY #$01
- - - - - - 0x0012A2 00:9292: B1 92     LDA (ram_0092_t01_data),Y
- - - - - - 0x0012A4 00:9294: 85 92     STA ram_0092_t01_data
- - - - - - 0x0012A6 00:9296: A5 E7     LDA ram_00E7_t19
- - - - - - 0x0012A8 00:9298: 38        SEC
- - - - - - 0x0012A9 00:9299: E9 20     SBC #$20
- - - - - - 0x0012AB 00:929B: 85 93     STA ram_0092_t01_data + $01
...
C - - - - - 0x0012B5 00:92A5: A0 13     LDY #con_0094_13_timer
C - - - - - 0x0012B7 00:92A7: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x0012C0 00:92B0: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0012C2 00:92B2: 18        CLC
C - - - - - 0x0012C3 00:92B3: 69 13     ADC #$13
C - - - - - 0x0012C5 00:92B5: A8        TAY ; 14/15
; con_0094_14_timer / con_0094_15_timer
C - - - - - 0x0012C6 00:92B6: 8A        TXA
C - - - - - 0x0012C7 00:92B7: 38        SEC
C - - - - - 0x0012C8 00:92B8: E9 E0     SBC #$E0
C - - - - - 0x0012CA 00:92BA: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0012CC 00:92BC: 98        TYA
C - - - - - 0x0012CD 00:92BD: 0A        ASL
C - - - - - 0x0012CE 00:92BE: 38        SEC
C - - - - - 0x0012CF 00:92BF: E9 10     SBC #$10
C - - - - - 0x0012D1 00:92C1: A8        TAY ; 18/1A
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo
C - - - - - 0x0012D2 00:92C2: A5 92     LDA ram_0092_t01_data
C - - - - - 0x0012D4 00:92C4: 18        CLC
C - - - - - 0x0012D5 00:92C5: 69 01     ADC #< $0001
C - - - - - 0x0012D7 00:92C7: 85 92     STA ram_0092_t01_data
C - - - - - 0x0012D9 00:92C9: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0012DB 00:92CB: C8        INY ; 19/1B
; con_0094_19_data_ptr_hi / con_0094_1B_data_ptr_hi
C - - - - - 0x0012DC 00:92CC: A5 93     LDA ram_0092_t01_data + $01
C - - - - - 0x0012DE 00:92CE: 69 00     ADC #> $0001
C - - - - - 0x0012E0 00:92D0: 85 93     STA ram_0092_t01_data + $01
C - - - - - 0x0012E2 00:92D2: 91 94     STA (ram_0094_t02_data),Y
...
- - - - - - 0x0012F9 00:92E9: 4F 93     .word ofs_003_9350_F2 - $01 ; unused
- - - - - - 0x0012FB 00:92EB: 5D 93     .word ofs_003_935E_F3 - $01 ; unused
- - - - - - 0x0012FD 00:92ED: 6B 93     .word ofs_003_936C_F4 - $01 ; unused
- D 0 - - - 0x0012FF 00:92EF: 8C 93     .word ofs_003_938D_F5_зеркало_on - $01
- D 0 - - - 0x001301 00:92F1: 99 93     .word ofs_003_939A_F6_зеркало_off - $01
- D 0 - - - 0x001303 00:92F3: A6 93     .word ofs_003_93A7_F7_физика - $01
- - - - - - 0x001305 00:92F5: 29 94     .word ofs_003_942A_F8_запись_палитры - $01 ; unused
- D 0 - - - 0x001307 00:92F7: 34 94     .word ofs_003_9435_F9 - $01
- D 0 - - - 0x001309 00:92F9: 41 94     .word ofs_003_9442_FA_разговор - $01
- - - - - - 0x00130B 00:92FB: 8E 94     .word $0000 ;  unused
- - - - - - 0x00130D 00:92FD: 8E 94     .word $0000 ;  unused
- - - - - - 0x00130F 00:92FF: 8E 94     .word $0000 ;  unused
- - - - - - 0x001311 00:9301: 91 94     .word ofs_003_9492_FE - $01 ; unused
- D 0 - - - 0x001313 00:9303: BB 94     .word ofs_003_94BC_FF_выход - $01
...
C - - - - - 0x001315 00:9305: A0 13     LDY #con_0094_13_timer
C - - - - - 0x001317 00:9307: B1 94     LDA (ram_0094_t02_data),Y ; 057B 059B 05BB 
...
C - - - - - 0x00131F 00:930F: A8        TAY ; 14/15
; con_0094_14_timer / con_0094_15_timer
C - - - - - 0x001320 00:9310: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001322 00:9312: 38        SEC
C - - - - - 0x001323 00:9313: E9 01     SBC #$01
C - - - - - 0x001325 00:9315: 91 94     STA (ram_0094_t02_data),Y
...
C - - - - - 0x00132E 00:931E: A8        TAY ; 18/1A
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo
C - - - - - 0x00132F 00:931F: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001331 00:9321: 85 92     STA ram_0092_t01_data
C - - - - - 0x001333 00:9323: C8        INY ; 19/1B
; con_0094_19_data_ptr_hi / con_0094_1B_data_ptr_hi
C - - - - - 0x001334 00:9324: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001336 00:9326: 85 93     STA ram_0092_t01_data + $01
C - - - - - 0x001338 00:9328: 4C 24 92  JMP loc_9224
bra_932B:
C - - - - - 0x00133B 00:932B: A0 13     LDY #con_0094_13_timer
C - - - - - 0x00133D 00:932D: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00133F 00:932F: 38        SEC
C - - - - - 0x001340 00:9330: E9 01     SBC #$01
C - - - - - 0x001342 00:9332: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001344 00:9334: A9 01     LDA #$01
C - - - - - 0x001346 00:9336: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A



ofs_003_9339_F1_координаты_Y_X:
; con_92E5_координаты_Y_X
C - - - - - 0x001349 00:9339: A0 01     LDY #$01
C - - - - - 0x00134B 00:933B: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x00134D 00:933D: A0 04     LDY #con_0094_04_pos_Y_lo
C - - - - - 0x00134F 00:933F: 20 35 97  JSR sub_9735
C - - - - - 0x001352 00:9342: A0 02     LDY #$02
C - - - - - 0x001354 00:9344: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x001356 00:9346: A0 06     LDY #con_0094_06_pos_Y_lo
C - - - - - 0x001358 00:9348: 20 35 97  JSR sub_9735
C - - - - - 0x00135B 00:934B: A9 03     LDA #$03
C - - - - - 0x00135D 00:934D: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
...
- - - - - - 0x001362 00:9352: B1 92     LDA (ram_0092_t01_data),Y
- - - - - - 0x001364 00:9354: A0 04     LDY #con_0094_04_pos_Y_lo
- - - - - - 0x001366 00:9356: 20 35 97  JSR sub_9735
- - - - - - 0x001369 00:9359: A9 02     LDA #$02
- - - - - - 0x00136B 00:935B: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
...
- - - - - - 0x001370 00:9360: B1 92     LDA (ram_0092_t01_data),Y
- - - - - - 0x001372 00:9362: A0 06     LDY #con_0094_06_pos_Y_lo
- - - - - - 0x001374 00:9364: 20 35 97  JSR sub_9735
- - - - - - 0x001377 00:9367: A9 02     LDA #$02
- - - - - - 0x001379 00:9369: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
...
; con_92E5_F4
; bzk garbage
- - - - - - 0x00137C 00:936C: A0 01     LDY #con_0094_01_timer
- - - - - - 0x00137E 00:936E: B1 92     LDA (ram_0092_t01_data),Y
- - - - - - 0x001380 00:9370: 91 94     STA (ram_0094_t02_data),Y
; bzk optimize, копировать сразу после сложения с 0002
- - - - - - 0x001382 00:9372: A5 92     LDA ram_0092_t01_data
- - - - - - 0x001384 00:9374: 18        CLC
- - - - - - 0x001385 00:9375: 69 02     ADC #< $0002
- - - - - - 0x001387 00:9377: 85 92     STA ram_0092_t01_data
- - - - - - 0x001389 00:9379: A5 93     LDA ram_0092_t01_data + $01
- - - - - - 0x00138B 00:937B: 69 00     ADC #> $0002
- - - - - - 0x00138D 00:937D: 85 93     STA ram_0092_t01_data + $01
; bzk optimize, INY
- - - - - - 0x00138F 00:937F: A0 02     LDY #con_0094_02_data_prt_lo
- - - - - - 0x001391 00:9381: A5 92     LDA ram_0092_t01_data
- - - - - - 0x001393 00:9383: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x001395 00:9385: C8        INY ; 03    con_0094_03_data_prt_hi
- - - - - - 0x001396 00:9386: A5 93     LDA ram_0092_t01_data + $01
- - - - - - 0x001398 00:9388: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x00139A 00:938A: 4C C1 94  JMP loc_94C1



ofs_003_938D_F5_зеркало_on:
; con_92E5_зеркало_on
C - - - - - 0x00139D 00:938D: A0 00     LDY #con_0094_00_flag
C - - - - - 0x00139F 00:938F: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x0013A1 00:9391: 09 40     ORA #$40
C - - - - - 0x0013A3 00:9393: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013A5 00:9395: A9 01     LDA #$01
C - - - - - 0x0013A7 00:9397: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A



ofs_003_939A_F6_зеркало_off:
; con_92E5_зеркало_off
C - - - - - 0x0013AA 00:939A: A0 00     LDY #con_0094_00_flag
C - - - - - 0x0013AC 00:939C: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x0013AE 00:939E: 29 BF     AND #$40 ^ $FF
C - - - - - 0x0013B0 00:93A0: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013B2 00:93A2: A9 01     LDA #$01
C - - - - - 0x0013B4 00:93A4: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A



ofs_003_93A7_F7_физика:
; con_92E5_физика
; 1й байт = скорость + угол + направление (00/80)
; 2й = разгон X
; 3й = разгон Y
...
C - - - - - 0x0013C0 00:93B0: A0 09     LDY #con_0094_09_hi
C - - - - - 0x0013C2 00:93B2: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013C4 00:93B4: 29 04     AND #$04
C - - - - - 0x0013C6 00:93B6: D0 0F     BNE bra_93C7
C - - - - - 0x0013C8 00:93B8: 6A        ROR
C - - - - - 0x0013C9 00:93B9: 88        DEY ; 08
; con_0094_08_lo
C - - - - - 0x0013CA 00:93BA: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013CC 00:93BC: A0 02     LDY #$02
C - - - - - 0x0013CE 00:93BE: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x0013D0 00:93C0: A0 0A     LDY #con_0094_0A
C - - - - - 0x0013D2 00:93C2: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013D4 00:93C4: 4C DE 93  JMP loc_93DE
bra_93C7:
; con_0094_09_hi
C - - - - - 0x0013D7 00:93C7: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x0013D9 00:93C9: 09 F8     ORA #$F8
C - - - - - 0x0013DB 00:93CB: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013DD 00:93CD: A9 00     LDA #$00
C - - - - - 0x0013DF 00:93CF: 6A        ROR
C - - - - - 0x0013E0 00:93D0: 88        DEY ; 08
; con_0094_08_lo
C - - - - - 0x0013E1 00:93D1: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013E3 00:93D3: A0 02     LDY #$02
C - - - - - 0x0013E5 00:93D5: A9 00     LDA #$00
C - - - - - 0x0013E7 00:93D7: 38        SEC
C - - - - - 0x0013E8 00:93D8: F1 92     SBC (ram_0092_t01_data),Y
C - - - - - 0x0013EA 00:93DA: A0 0A     LDY #con_0094_0A
C - - - - - 0x0013EC 00:93DC: 91 94     STA (ram_0094_t02_data),Y
loc_93DE:
C D 0 - - - 0x0013EE 00:93DE: A0 01     LDY #$01
C - - - - - 0x0013F0 00:93E0: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x0013F2 00:93E2: 29 0F     AND #$0F
C - - - - - 0x0013F4 00:93E4: 4A        LSR
C - - - - - 0x0013F5 00:93E5: A0 0D     LDY #con_0094_0D_hi
C - - - - - 0x0013F7 00:93E7: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0013F9 00:93E9: 29 04     AND #$04
C - - - - - 0x0013FB 00:93EB: D0 0F     BNE bra_93FC
C - - - - - 0x0013FD 00:93ED: 6A        ROR
C - - - - - 0x0013FE 00:93EE: 88        DEY ; 0C    con_0094_0C_lo
C - - - - - 0x0013FF 00:93EF: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001401 00:93F1: A0 03     LDY #$03
C - - - - - 0x001403 00:93F3: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x001405 00:93F5: A0 0E     LDY #con_0094_0E
C - - - - - 0x001407 00:93F7: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001409 00:93F9: 4C 13 94  JMP loc_9413
bra_93FC:
; con_0094_0D_hi
C - - - - - 0x00140C 00:93FC: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00140E 00:93FE: 09 F8     ORA #$F8
C - - - - - 0x001410 00:9400: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001412 00:9402: A9 00     LDA #$00
C - - - - - 0x001414 00:9404: 6A        ROR
C - - - - - 0x001415 00:9405: 88        DEY ; 0C
C - - - - - 0x001416 00:9406: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001418 00:9408: A0 03     LDY #$03
C - - - - - 0x00141A 00:940A: A9 00     LDA #$00
C - - - - - 0x00141C 00:940C: 38        SEC
C - - - - - 0x00141D 00:940D: F1 92     SBC (ram_0092_t01_data),Y
C - - - - - 0x00141F 00:940F: A0 0E     LDY #con_0094_0E
C - - - - - 0x001421 00:9411: 91 94     STA (ram_0094_t02_data),Y
loc_9413:
C D 0 - - - 0x001423 00:9413: A9 00     LDA #$00
C - - - - - 0x001425 00:9415: A0 0B     LDY #con_0094_0B
C - - - - - 0x001427 00:9417: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001429 00:9419: A0 0F     LDY #$0F
C - - - - - 0x00142B 00:941B: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00142D 00:941D: A0 00     LDY #con_0094_00_flag
C - - - - - 0x00142F 00:941F: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001431 00:9421: 09 20     ORA #$20
C - - - - - 0x001433 00:9423: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001435 00:9425: A9 04     LDA #$04
C - - - - - 0x001437 00:9427: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
...
ofs_003_9435_F9:
; con_92E5_F9
C - - - - - 0x001445 00:9435: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001447 00:9437: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001449 00:9439: 09 10     ORA #$10
C - - - - - 0x00144B 00:943B: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00144D 00:943D: A9 01     LDA #$01
C - - - - - 0x00144F 00:943F: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A



ofs_003_9442_FA_разговор:
; con_92E5_разговор
; 2 развилки для анимации персонажа, если тот молчит/говорит
C - - - - - 0x001452 00:9442: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001454 00:9444: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001456 00:9446: 09 02     ORA #$02
C - - - - - 0x001458 00:9448: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00145A 00:944A: A9 C0     LDA #$80 + $40
C - - - - - 0x00145C 00:944C: 85 99     STA ram_0099_флаг_диалогов
C - - - - - 0x00145E 00:944E: A0 02     LDY #con_0094_02_data_prt_lo
C - - - - - 0x001460 00:9450: A5 92     LDA ram_0092_t01_data
C - - - - - 0x001462 00:9452: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001464 00:9454: C8        INY ; 03    con_0094_03_data_prt_hi
C - - - - - 0x001465 00:9455: A5 93     LDA ram_0092_t01_data + $01
C - - - - - 0x001467 00:9457: 91 94     STA (ram_0094_t02_data),Y
loc_9459:
C D 0 - - - 0x001469 00:9459: 24 99     BIT ram_0099_флаг_диалогов
C - - - - - 0x00146B 00:945B: 50 1D     BVC bra_947A
C - - - - - 0x00146D 00:945D: A5 99     LDA ram_0099_флаг_диалогов
C - - - - - 0x00146F 00:945F: 29 01     AND #$01
C - - - - - 0x001471 00:9461: 38        SEC
C - - - - - 0x001472 00:9462: 2A        ROL
C - - - - - 0x001473 00:9463: A8        TAY
C - - - - - 0x001474 00:9464: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x001476 00:9466: 85 E6     STA ram_00E6_t02_data
C - - - - - 0x001478 00:9468: C8        INY
C - - - - - 0x001479 00:9469: B1 92     LDA (ram_0092_t01_data),Y
C - - - - - 0x00147B 00:946B: 85 E7     STA ram_00E6_t02_data + $01
C - - - - - 0x00147D 00:946D: 20 D8 94  JSR sub_94D8_чтение_байтов_спрайтов_анимации
; bzk optimize, значения FE не бывает в этом адресе
; bzk bug?
C - - - - - 0x001480 00:9470: A5 99     LDA ram_0099_флаг_диалогов
C - - - - - 0x001482 00:9472: C9 FE     CMP #$FE
C - - - - - 0x001484 00:9474: F0 0C     BEQ bra_9482_FE
C - - - - - 0x001486 00:9476: 29 BF     AND #$40 ^ $FF
C - - - - - 0x001488 00:9478: 85 99     STA ram_0099_флаг_диалогов
bra_947A:
C - - - - - 0x00148A 00:947A: A9 01     LDA #$01
C - - - - - 0x00148C 00:947C: A8        TAY ; 01    ; con_0094_01_timer
C - - - - - 0x00148D 00:947D: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00148F 00:947F: 4C C1 94  JMP loc_94C1
bra_9482_FE:
; в новых логах выполнялось
- - - - - - 0x001492 00:9482: A0 00     LDY #con_0094_00_flag
- - - - - - 0x001494 00:9484: B1 94     LDA (ram_0094_t02_data),Y
- - - - - - 0x001496 00:9486: 29 FD     AND #$FD
- - - - - - 0x001498 00:9488: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x00149A 00:948A: A9 05     LDA #$05
- - - - - - 0x00149C 00:948C: 4C AE 94  JMP loc_94AE_увеличить_поинтер_0092_на_A
...
; con_92E5_FE
; bzk garbage
- - - - - - 0x0014A2 00:9492: A0 13     LDY #con_0094_13_timer
- - - - - - 0x0014A4 00:9494: B1 94     LDA (ram_0094_t02_data),Y
...
- - - - - - 0x0014AB 00:949B: 91 94     STA (ram_0094_t02_data),Y
- - - - - - 0x0014AD 00:949D: 0A        ASL
- - - - - - 0x0014AE 00:949E: 18        CLC
- - - - - - 0x0014AF 00:949F: 69 18     ADC #$18
- - - - - - 0x0014B1 00:94A1: A8        TAY ; 18/1A/1C
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo / con_0094_1C_data_ptr_lo
- - - - - - 0x0014B2 00:94A2: B1 94     LDA (ram_0094_t02_data),Y
- - - - - - 0x0014B4 00:94A4: 85 92     STA ram_0092_t01_data
- - - - - - 0x0014B6 00:94A6: C8        INY ; 19/1A/1D
; con_0094_19_data_ptr_hi / 1con_0094_1B_data_ptr_hi / con_0094_1D_data_ptr_hi
- - - - - - 0x0014B7 00:94A7: B1 94     LDA (ram_0094_t02_data),Y
- - - - - - 0x0014B9 00:94A9: 85 93     STA ram_0092_t01_data + $01
- - - - - - 0x0014BB 00:94AB: 4C 24 92  JMP loc_9224



loc_94AE_увеличить_поинтер_0092_на_A:
sub_94AE_увеличить_поинтер_0092_на_A:
C D 0 - - - 0x0014BE 00:94AE: 18        CLC
C - - - - - 0x0014BF 00:94AF: 65 92     ADC ram_0092_t01_data
C - - - - - 0x0014C1 00:94B1: 85 92     STA ram_0092_t01_data
C - - - - - 0x0014C3 00:94B3: A5 93     LDA ram_0092_t01_data + $01
C - - - - - 0x0014C5 00:94B5: 69 00     ADC #$00
C - - - - - 0x0014C7 00:94B7: 85 93     STA ram_0092_t01_data + $01
C - - - - - 0x0014C9 00:94B9: 4C 24 92  JMP loc_9224



ofs_003_94BC_FF_выход:
; con_92E5_выход
C - - - - - 0x0014CC 00:94BC: A9 00     LDA #$00
C - - - - - 0x0014CE 00:94BE: A8        TAY ; 00    ; con_0094_00_flag
C - - - - - 0x0014CF 00:94BF: 91 94     STA (ram_0094_t02_data),Y
loc_94C1:
C D 0 - - - 0x0014D1 00:94C1: A5 94     LDA ram_0094_t02_data
C - - - - - 0x0014D3 00:94C3: 18        CLC
C - - - - - 0x0014D4 00:94C4: 69 20     ADC #< $0020
C - - - - - 0x0014D6 00:94C6: 85 94     STA ram_0094_t02_data
C - - - - - 0x0014D8 00:94C8: A5 95     LDA ram_0094_t02_data + $01
C - - - - - 0x0014DA 00:94CA: 69 00     ADC #> $0020
C - - - - - 0x0014DC 00:94CC: 85 95     STA ram_0094_t02_data + $01
C - - - - - 0x0014DE 00:94CE: C6 96     DEC ram_0096_loop_counter
...
C - - - - - 0x0014EA 00:94DA: B1 E6     LDA (ram_00E6_t02_data),Y
C - - - - - 0x0014EE 00:94DE: 85 9E     STA ram_for_5124
C - - - - - 0x0014F0 00:94E0: C8        INY ; 01
C - - - - - 0x0014F1 00:94E1: B1 E6     LDA (ram_00E6_t02_data),Y
C - - - - - 0x0014F3 00:94E3: 85 9F     STA ram_for_5125
                                        INY ; 02
C - - - - - 0x0014F7 00:94E7: B1 E6     LDA (ram_00E6_t02_data),Y
C - - - - - 0x0014F9 00:94E9: 85 A0     STA ram_for_5126
C - - - - - 0x0014FB 00:94EB: C8        INY ; 03
C - - - - - 0x0014FC 00:94EC: B1 E6     LDA (ram_00E6_t02_data),Y
C - - - - - 0x0014FE 00:94EE: 85 A1     STA ram_for_5127
C - - - - - 0x001500 00:94F0: A5 E6     LDA ram_00E6_t02_data
C - - - - - 0x001502 00:94F2: 18        CLC
C - - - - - 0x001503 00:94F3: 69 04     ADC #< $0004
C - - - - - 0x001505 00:94F5: 85 E6     STA ram_00E6_t03_data
C - - - - - 0x001507 00:94F7: A5 E7     LDA ram_00E6_t02_data + $01
C - - - - - 0x001509 00:94F9: 69 00     ADC #> $0004
C - - - - - 0x00150B 00:94FB: 85 E7     STA ram_00E6_t03_data + $01
C - - - - - 0x00150D 00:94FD: A0 00     LDY #con_0094_00_flag
C - - - - - 0x00150F 00:94FF: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001511 00:9501: A0 10     LDY #$10    ; con_0094_10
C - - - - - 0x001513 00:9503: 29 08     AND #$08
C - - - - - 0x001515 00:9505: D0 04     BNE bra_950B
C - - - - - 0x001517 00:9507: A5 97     LDA ram_0097
C - - - - - 0x001519 00:9509: 91 94     STA (ram_0094_t02_data),Y
bra_950B:
C - - - - - 0x00151B 00:950B: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00151D 00:950D: 85 98     STA ram_0098_индекс_oam
C - - - - - 0x00151F 00:950F: A9 00     LDA #$00
C - - - - - 0x001521 00:9511: 85 E8     STA ram_00E8_t16
C - - - - - 0x001523 00:9513: 85 E9     STA ram_00E9_t10
loc_9515_продолжить_чтение_байтов_спрайтов_анимации:
C D 0 - - - 0x001525 00:9515: A0 00     LDY #$00
C - - - - - 0x001527 00:9517: B1 E6     LDA (ram_00E6_t03_data),Y
...
C - - - - - 0x001535 00:9525: 65 9A     ADC ram_009A_t01_pos_Y_lo
C - - - - - 0x001537 00:9527: 9D 68 04  STA ram_copy_spr_Y,X
C - - - - - 0x00153A 00:952A: 85 EA     STA ram_00EA_t12_spr_Y
C - - - - - 0x00153C 00:952C: A9 00     LDA #$00
C - - - - - 0x00153E 00:952E: 65 9B     ADC ram_009B_t01_pos_Y_hi
C - - - - - 0x001540 00:9530: 4C 41 95  JMP loc_9541
bra_9533:
C - - - - - 0x001543 00:9533: 38        SEC
C - - - - - 0x001544 00:9534: 6A        ROR
C - - - - - 0x001545 00:9535: 18        CLC
C - - - - - 0x001546 00:9536: 65 9A     ADC ram_009A_t01_pos_Y_lo
C - - - - - 0x001548 00:9538: 9D 68 04  STA ram_copy_spr_Y,X
; bzk optimize, возможно бесполезный STA
C - - - - - 0x00154B 00:953B: 85 EA     STA ram_00EA_t12_spr_Y
C - - - - - 0x00154D 00:953D: A9 00     LDA #$00
C - - - - - 0x00154F 00:953F: E5 9B     SBC ram_009B_t01_pos_Y_hi
loc_9541:
C D 0 - - - 0x001551 00:9541: 29 01     AND #$01
C - - - - - 0x001553 00:9543: 85 EB     STA ram_00EB_t16
C - - - - - 0x001555 00:9545: 0A        ASL
C - - - - - 0x001556 00:9546: 85 EC     STA ram_00EC_t22
C - - - - - 0x001558 00:9548: A5 E8     LDA ram_00E8_t16
...
C - - - - - 0x001569 00:9559: B1 E6     LDA (ram_00E6_t03_data),Y
                                       ;LDY #con_0094_00_flag
C - - - - - 0x00156B 00:955B: 51 94     EOR (ram_0094_t02_data),Y
C - - - - - 0x00156D 00:955D: 29 40     AND #$40
C - - - - - 0x00156F 00:955F: 05 EC     ORA ram_00EC_t21_spr_A
C - - - - - 0x001571 00:9561: 85 EC     STA ram_00EC_t20_spr_A_full
C - - - - - 0x001573 00:9563: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x001575 00:9565: 29 03     AND #$03
C - - - - - 0x001577 00:9567: 05 EC     ORA ram_00EC_t20_spr_A_full
C - - - - - 0x001579 00:9569: 9D 6A 04  STA ram_copy_spr_A,X
C - - - - - 0x00157C 00:956C: C8        INY ; 01
C - - - - - 0x00157D 00:956D: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x00157F 00:956F: 9D 69 04  STA ram_copy_spr_T,X
C - - - - - 0x001582 00:9572: A5 98     LDA ram_0098_индекс_oam
C - - - - - 0x001584 00:9574: 18        CLC
C - - - - - 0x001585 00:9575: 69 04     ADC #$04
C - - - - - 0x001587 00:9577: 85 98     STA ram_0098_индекс_oam
C - - - - - 0x001589 00:9579: A5 E6     LDA ram_00E6_t03_data
C - - - - - 0x00158B 00:957B: 18        CLC
C - - - - - 0x00158C 00:957C: 69 02     ADC #< $0002
C - - - - - 0x00158E 00:957E: 85 E6     STA ram_00E6_t03_data
C - - - - - 0x001590 00:9580: A5 E7     LDA ram_00E6_t03_data + $01
C - - - - - 0x001592 00:9582: 69 00     ADC #> $0002
C - - - - - 0x001594 00:9584: 85 E7     STA ram_00E6_t03_data + $01
...
C - - - - - 0x0015A2 00:9592: 85 EA     STA ram_00EA_t13_pos_Y_lo
; 80+ будет если умножается байт 90-9F
C - - - - - 0x0015A4 00:9594: 10 01     BPL bra_9597
C - - - - - 0x0015A6 00:9596: CA        DEX ; FF
bra_9597:
C - - - - - 0x0015A7 00:9597: 86 EB     STX ram_00EB_t15_pos_Y_hi
C - - - - - 0x0015A9 00:9599: A5 9A     LDA ram_009A_t01_pos_Y_lo
C - - - - - 0x0015AB 00:959B: 18        CLC
C - - - - - 0x0015AC 00:959C: 65 EA     ADC ram_00EA_t13_pos_Y_lo
C - - - - - 0x0015AE 00:959E: 85 EA     STA ram_00EA_t12_spr_Y
C - - - - - 0x0015B0 00:95A0: A5 9B     LDA ram_009B_t01_pos_Y_hi
C - - - - - 0x0015B2 00:95A2: 65 EB     ADC ram_00EB_t15_pos_Y_hi
C - - - - - 0x0015B4 00:95A4: 85 EB     STA ram_00EB_t16
C - - - - - 0x0015B6 00:95A6: E6 E6     INC ram_00E6_t03_data
C - - - - - 0x0015B8 00:95A8: D0 02     BNE bra_95AC_not_overflow
; if overflow
- - - - - - 0x0015BA 00:95AA: E6 E7     INC ram_00E6_t03_data + $01
bra_95AC_not_overflow:
...
C - - - - - 0x0015C4 00:95B4: A0 00     LDY #con_0094_00_flag
C - - - - - 0x0015C6 00:95B6: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x0015D8 00:95C8: 85 E8     STA ram_00E8_t17
C - - - - - 0x0015DA 00:95CA: 10 01     BPL bra_95CD
C - - - - - 0x0015DC 00:95CC: CA        DEX ; FF
bra_95CD:
C - - - - - 0x0015DD 00:95CD: 86 E9     STX ram_00E9_t11
C - - - - - 0x0015DF 00:95CF: A5 9C     LDA ram_009C_t01_pos_Y_lo
C - - - - - 0x0015E1 00:95D1: 18        CLC
C - - - - - 0x0015E2 00:95D2: 65 E8     ADC ram_00E8_t17
C - - - - - 0x0015E4 00:95D4: 85 E8     STA ram_00E8_t16
C - - - - - 0x0015E6 00:95D6: A5 9D     LDA ram_009D_t01_pos_Y_hi
C - - - - - 0x0015E8 00:95D8: 65 E9     ADC ram_00E9_t11
C - - - - - 0x0015EA 00:95DA: 85 E9     STA ram_00E9_t10
C - - - - - 0x0015EC 00:95DC: E6 E6     INC ram_00E6_t03_data
C - - - - - 0x0015EE 00:95DE: D0 02     BNE bra_95E2_not_overflow
; if overflow
C - - - - - 0x0015F0 00:95E0: E6 E7     INC ram_00E6_t03_data + $01
bra_95E2_not_overflow:
...
C - - - - - 0x0015FD 00:95ED: A0 00     LDY #con_0094_00_flag
C - - - - - 0x0015FF 00:95EF: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x00161E 00:960E: 65 E8     ADC ram_00E8_t16
C - - - - - 0x001620 00:9610: A6 98     LDX ram_0098_индекс_oam
C - - - - - 0x001622 00:9612: 9D 6B 04  STA ram_copy_spr_X,X
C - - - - - 0x001625 00:9615: 98        TYA
C - - - - - 0x001626 00:9616: 65 E9     ADC ram_00E9_t10
C - - - - - 0x001628 00:9618: 29 01     AND #$01
C - - - - - 0x00162A 00:961A: 85 EC     STA ram_00EC_t16
...
C - - - - - 0x00163B 00:962B: 65 EA     ADC ram_00EA_t12_spr_Y
C - - - - - 0x00163D 00:962D: 9D 68 04  STA ram_copy_spr_Y,X
C - - - - - 0x001640 00:9630: A5 EB     LDA ram_00EB_t16
...
C - - - - - 0x00164C 00:963C: 65 EA     ADC ram_00EA_t12_spr_Y
C - - - - - 0x00164E 00:963E: 9D 68 04  STA ram_copy_spr_Y,X
C - - - - - 0x001651 00:9641: A5 EB     LDA ram_00EB_t16
...
C - - - - - 0x001660 00:9650: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x001662 00:9652: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001664 00:9654: 51 94     EOR (ram_0094_t02_data),Y
C - - - - - 0x001666 00:9656: 29 40     AND #$40
C - - - - - 0x001668 00:9658: 05 EC     ORA ram_00EC_t17_spr_A
C - - - - - 0x00166A 00:965A: 85 EC     STA ram_00EC_t18_spr_A_full
C - - - - - 0x00166C 00:965C: A0 01     LDY #$01
C - - - - - 0x00166E 00:965E: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x001670 00:9660: 29 03     AND #$03
C - - - - - 0x001672 00:9662: 05 EC     ORA ram_00EC_t18_spr_A_full
C - - - - - 0x001674 00:9664: 9D 6A 04  STA ram_copy_spr_A,X
C - - - - - 0x001677 00:9667: C8        INY
C - - - - - 0x001678 00:9668: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x00167A 00:966A: 9D 69 04  STA ram_copy_spr_T,X
C - - - - - 0x00167D 00:966D: A5 98     LDA ram_0098_индекс_oam
C - - - - - 0x00167F 00:966F: 18        CLC
C - - - - - 0x001680 00:9670: 69 04     ADC #$04
C - - - - - 0x001682 00:9672: 85 98     STA ram_0098_индекс_oam
C - - - - - 0x001684 00:9674: A5 E6     LDA ram_00E6_t03_data
C - - - - - 0x001686 00:9676: 18        CLC
C - - - - - 0x001687 00:9677: 69 03     ADC #< $0003
C - - - - - 0x001689 00:9679: 85 E6     STA ram_00E6_t03_data
C - - - - - 0x00168B 00:967B: A5 E7     LDA ram_00E6_t03_data + $01
C - - - - - 0x00168D 00:967D: 69 00     ADC #> $0003
C - - - - - 0x00168F 00:967F: 85 E7     STA ram_00E6_t03_data + $01
...
; смотреть con_9692
- - - - - - 0x0016A2 00:9692: A1 96     .word $0000 ; F8 
- - - - - - 0x0016A4 00:9694: A1 96     .word $0000 ; F9 
- D 0 - - - 0x0016A6 00:9696: A4 96     .word ofs_004_96A5_FA_jsr - $01
- D 0 - - - 0x0016A8 00:9698: C6 96     .word ofs_004_96C7_FB_jmp - $01
- - - - - - 0x0016AA 00:969A: A1 96     .word $0000 ; FC 
- - - - - - 0x0016AC 00:969C: A1 96     .word $0000 ; FD
- D 0 - - - 0x0016AE 00:969E: D5 96     .word ofs_004_96D6_FE_rts - $01
...
ofs_004_96A5_FA_jsr:
; con_9692_jsr
C - - - - - 0x0016B5 00:96A5: A0 13     LDY #con_0094_13_timer
C - - - - - 0x0016B7 00:96A7: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x0016C1 00:96B1: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0016C3 00:96B3: 8A        TXA
C - - - - - 0x0016C4 00:96B4: 0A        ASL
C - - - - - 0x0016C5 00:96B5: 18        CLC
C - - - - - 0x0016C6 00:96B6: 69 18     ADC #$18
C - - - - - 0x0016C8 00:96B8: A8        TAY ; 18/1A/1C
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo / con_0094_1C_data_ptr_lo
C - - - - - 0x0016C9 00:96B9: A5 E6     LDA ram_00E6_t03_data
C - - - - - 0x0016CB 00:96BB: 18        CLC
C - - - - - 0x0016CC 00:96BC: 69 03     ADC #< $0003
C - - - - - 0x0016CE 00:96BE: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x0016D0 00:96C0: A5 E7     LDA ram_00E6_t03_data + $01
C - - - - - 0x0016D2 00:96C2: 69 00     ADC #> $0003
C - - - - - 0x0016D4 00:96C4: C8        INY ; 19/1B/1D
; con_0094_19_data_ptr_hi / con_0094_1B_data_ptr_hi / con_0094_1D_data_ptr_hi
C - - - - - 0x0016D5 00:96C5: 91 94     STA (ram_0094_t02_data),Y
ofs_004_96C7_FB_jmp:
; con_9692_jmp
C - - - - - 0x0016D7 00:96C7: A0 01     LDY #$01
C - - - - - 0x0016D9 00:96C9: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x0016DB 00:96CB: AA        TAX
C - - - - - 0x0016DC 00:96CC: C8        INY ; 02
C - - - - - 0x0016DD 00:96CD: B1 E6     LDA (ram_00E6_t03_data),Y
C - - - - - 0x0016DF 00:96CF: 85 E7     STA ram_00E6_t03_data + $01
C - - - - - 0x0016E1 00:96D1: 86 E6     STX ram_00E6_t03_data
...
ofs_004_96D6_FE_rts:
; con_9692_rts
C - - - - - 0x0016E6 00:96D6: A0 13     LDY #con_0094_13_timer
C - - - - - 0x0016E8 00:96D8: B1 94     LDA (ram_0094_t02_data),Y ; 057B 059B 05BB 
; в новых логах условие BEQ никогда не выполнялось
; возможно это проверка на баги от разработчиков
...
C - - - - - 0x0016EF 00:96DF: 91 94     STA (ram_0094_t02_data),Y ; 057B 059B 05BB 
C - - - - - 0x0016F1 00:96E1: 0A        ASL
C - - - - - 0x0016F2 00:96E2: 18        CLC
C - - - - - 0x0016F3 00:96E3: 69 18     ADC #$18
C - - - - - 0x0016F5 00:96E5: A8        TAY ; 18/1A/1C
; con_0094_18_data_ptr_lo / con_0094_1A_data_ptr_lo / con_0094_1C_data_ptr_lo
C - - - - - 0x0016F6 00:96E6: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x0016F8 00:96E8: 85 E6     STA ram_00E6_t03_data
C - - - - - 0x0016FA 00:96EA: C8        INY ; 19/1B/1D
; con_0094_19_data_ptr_hi / con_0094_1B_data_ptr_hi / con_0094_1D_data_ptr_hi
C - - - - - 0x0016FB 00:96EB: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x0016FD 00:96ED: 85 E7     STA ram_00E6_t03_data + $01
...
; con_9692_выход
C - - - - - 0x001702 00:96F2: A0 00     LDY #con_0094_00_flag
C - - - - - 0x001704 00:96F4: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001706 00:96F6: 29 08     AND #$08
C - - - - - 0x001708 00:96F8: D0 09     BNE bra_9703
C - - - - - 0x00170A 00:96FA: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00170C 00:96FC: 09 08     ORA #$08
C - - - - - 0x00170E 00:96FE: 91 94     STA (ram_0094_t02_data),Y
; bzk optimize, BNE
C - - - - - 0x001710 00:9700: 4C 27 97  JMP loc_9727
bra_9703:
C - - - - - 0x001713 00:9703: A0 10     LDY #con_0094_10
C - - - - - 0x001715 00:9705: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001717 00:9707: C8        INY ; 11    con_0094_11
C - - - - - 0x001718 00:9708: 18        CLC
C - - - - - 0x001719 00:9709: 71 94     ADC (ram_0094_t02_data),Y
...
C - - - - - 0x001725 00:9715: A6 98     LDX ram_0098_индекс_oam
bra_9717_loop:
...
bra_9727:
loc_9727:
C D 0 - - - 0x001737 00:9727: A5 98     LDA ram_0098_индекс_oam
C - - - - - 0x001739 00:9729: AA        TAX
C - - - - - 0x00173A 00:972A: A0 10     LDY #con_0094_10
C - - - - - 0x00173C 00:972C: 38        SEC
C - - - - - 0x00173D 00:972D: F1 94     SBC (ram_0094_t02_data),Y
C - - - - - 0x00173F 00:972F: C8        INY ; 11    con_0094_11
C - - - - - 0x001740 00:9730: 91 94     STA (ram_0094_t02_data),Y
...
sub_9735:
; con_0094_04_pos_Y_lo / con_0094_06_pos_Y_lo
C - - - - - 0x001745 00:9735: AA        TAX
C - - - - - 0x001746 00:9736: A9 00     LDA #$00
C - - - - - 0x001748 00:9738: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00174A 00:973A: C8        INY ; 05/07
; con_0094_05_pos_Y_hi / con_0094_07_pos_Y_hi
C - - - - - 0x00174B 00:973B: 8A        TXA
C - - - - - 0x00174C 00:973C: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00174E 00:973E: 0A        ASL
; also ram_009C_t01_pos_Y_lo
C - - - - - 0x00174F 00:973F: 99 95 00  STA ram_009A_t01_pos_Y_lo - $05,Y
C - - - - - 0x001752 00:9742: A9 00     LDA #$00
C - - - - - 0x001754 00:9744: 69 00     ADC #$00
; also ram_009D_t01_pos_Y_hi
C - - - - - 0x001756 00:9746: 99 96 00  STA ram_009B_t01_pos_Y_hi - $05,Y
...
sub_974A:
; con_0094_04_pos_Y_lo / con_0094_06_pos_Y_lo
C - - - - - 0x00175A 00:974A: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00175C 00:974C: 0A        ASL
C - - - - - 0x00175D 00:974D: C8        INY ; 05/07
; con_0094_05_pos_Y_hi / con_0094_07_pos_Y_hi
C - - - - - 0x00175E 00:974E: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x001760 00:9750: 2A        ROL
; also ram_009C_t01_pos_Y_lo
C - - - - - 0x001761 00:9751: 99 95 00  STA ram_009A_t01_pos_Y_lo - $05,Y
C - - - - - 0x001764 00:9754: A9 00     LDA #$00
C - - - - - 0x001766 00:9756: 2A        ROL
; also ram_009D_t01_pos_Y_hi
C - - - - - 0x001767 00:9757: 99 96 00  STA ram_009B_t01_pos_Y_hi - $05,Y
...
; in
    ; X
        ; 04 = con_0094_04_pos_Y_lo
        ; 06 = con_0094_06_pos_Y_lo
    ; Y
        ; 0A = con_0094_0A
        ; 0E = con_0094_0E
C - - - - - 0x00176B 00:975B: 86 ED     STX ram_00ED_t09_data_index
C - - - - - 0x00176D 00:975D: B1 94     LDA (ram_0094_t02_data),Y
...
C - - - - - 0x001779 00:9769: B1 94     LDA (ram_0094_t02_data),Y
C - - - - - 0x00177B 00:976B: 88        DEY
C - - - - - 0x00177C 00:976C: 88        DEY ; 08/0C
; con_0094_08_lo / con_0094_0C_lo
C - - - - - 0x00177D 00:976D: 18        CLC
C - - - - - 0x00177E 00:976E: 71 94     ADC (ram_0094_t02_data),Y
C - - - - - 0x001780 00:9770: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001782 00:9772: 85 EC     STA ram_00EC_t23
C - - - - - 0x001784 00:9774: C8        INY ; 09/0D
; con_0094_09_hi / con_0094_0D_hi
C - - - - - 0x001785 00:9775: 8A        TXA
C - - - - - 0x001786 00:9776: 71 94     ADC (ram_0094_t02_data),Y
C - - - - - 0x001788 00:9778: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x00178A 00:977A: AA        TAX
C - - - - - 0x00178B 00:977B: A4 ED     LDY ram_00ED_t09_data_index
; con_0094_04_pos_Y_lo / con_0094_06_pos_Y_lo
C - - - - - 0x00178D 00:977D: A5 EC     LDA ram_00EC_t23
C - - - - - 0x00178F 00:977F: 18        CLC
C - - - - - 0x001790 00:9780: 71 94     ADC (ram_0094_t02_data),Y
C - - - - - 0x001792 00:9782: 91 94     STA (ram_0094_t02_data),Y
C - - - - - 0x001794 00:9784: 8A        TXA
C - - - - - 0x001795 00:9785: C8        INY ; 05/07
; con_0094_05_pos_Y_hi / con_0094_07_pos_Y_hi
C - - - - - 0x001796 00:9786: 71 94     ADC (ram_0094_t02_data),Y
C - - - - - 0x001798 00:9788: 91 94     STA (ram_0094_t02_data),Y
...
tbl_978B:
; 00-1F
- D 0 - - - 0x00179B 00:978B: 80        .byte $80   ; con_0094_00_flag
- D 0 - - - 0x00179C 00:978C: 01        .byte $01   ; con_0094_01_timer
- D 0 - - - 0x00179D 00:978D: 00        .byte $00   ; con_0094_02_data_prt_lo
- D 0 - - - 0x00179E 00:978E: 00        .byte $00   ; con_0094_03_data_prt_hi
- D 0 - - - 0x00179F 00:978F: 00        .byte $00   ; con_0094_04_pos_Y_lo
- D 0 - - - 0x0017A0 00:9790: 30        .byte $30   ; con_0094_05_pos_Y_hi
- D 0 - - - 0x0017A1 00:9791: 00        .byte $00   ; con_0094_06_pos_Y_lo
- D 0 - - - 0x0017A2 00:9792: 40        .byte $40   ; con_0094_07_pos_Y_hi
- D 0 - - - 0x0017A3 00:9793: 00        .byte $00   ; con_0094_08_lo
- D 0 - - - 0x0017A4 00:9794: 00        .byte $00   ; con_0094_09_hi
- D 0 - - - 0x0017A5 00:9795: 00        .byte $00   ; con_0094_0A
- D 0 - - - 0x0017A6 00:9796: 00        .byte $00   ; con_0094_0B
- D 0 - - - 0x0017A7 00:9797: 00        .byte $00   ; con_0094_0C_lo
- D 0 - - - 0x0017A8 00:9798: 00        .byte $00   ; con_0094_0D_hi
- D 0 - - - 0x0017A9 00:9799: 00        .byte $00   ; con_0094_0E
- D 0 - - - 0x0017AA 00:979A: 00        .byte $00   ; con_0094_0F
- D 0 - - - 0x0017AB 00:979B: 00        .byte $00   ; con_0094_10
- D 0 - - - 0x0017AC 00:979C: 00        .byte $00   ; con_0094_11
- D 0 - - - 0x0017AD 00:979D: 00        .byte $00   ; con_0094_12
- D 0 - - - 0x0017AE 00:979E: 00        .byte $00   ; con_0094_13_timer
- D 0 - - - 0x0017AF 00:979F: 00        .byte $00   ; con_0094_14_timer
- D 0 - - - 0x0017B0 00:97A0: 00        .byte $00   ; con_0094_15_timer
- D 0 - - - 0x0017B1 00:97A1: 00        .byte $00   ; con_0094_16
- D 0 - - - 0x0017B2 00:97A2: 00        .byte $00   ; con_0094_17
- D 0 - - - 0x0017B3 00:97A3: 00        .byte $00   ; con_0094_18_data_ptr_lo
- D 0 - - - 0x0017B4 00:97A4: 00        .byte $00   ; con_0094_19_data_ptr_hi
- D 0 - - - 0x0017B5 00:97A5: 00        .byte $00   ; con_0094_1A_data_ptr_lo
- D 0 - - - 0x0017B6 00:97A6: 00        .byte $00   ; con_0094_1B_data_ptr_hi
- D 0 - - - 0x0017B7 00:97A7: 00        .byte $00   ; con_0094_1C_data_ptr_lo
- D 0 - - - 0x0017B8 00:97A8: 00        .byte $00   ; con_0094_1D_data_ptr_hi
- D 0 - - - 0x0017B9 00:97A9: 00        .byte $00   ; con_0094_1E
- D 0 - - - 0x0017BA 00:97AA: 00        .byte $00   ; con_0094_1F
...
C - - - - - 0x0017BD 00:97AD: 85 E9     STA ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x0017BF 00:97AF: A9 01     LDA #$01
C - - - - - 0x0017C1 00:97B1: 85 EB     STA ram_00EB_t26_флаг_задержки_кадра
; bzk optimize, BNE
...
loc_0x0017C8_запись_в_буфер_со_смещением:
; in
    ; A = смещение ppu lo
        ; 00 FB FC FD
    ; X = ptr hi
    ; Y = ptr lo
C - - - - - 0x0017C8 00:97B8: 85 E9     STA ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x0017CA 00:97BA: A5 4A     LDA ram_004A_t01_степень_яркости_фона
C - - - - - 0x0017CC 00:97BC: 05 4B     ORA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x0017CE 00:97BE: F0 59     BEQ bra_9819
C - - - - - 0x0017D0 00:97C0: A9 00     LDA #$00
C - - - - - 0x0017D2 00:97C2: 85 EB     STA ram_00EB_t26_флаг_задержки_кадра
loc_97C4:
C D 0 - - - 0x0017D4 00:97C4: 84 E6     STY ram_00E6_t04_data
C - - - - - 0x0017D6 00:97C6: 86 E7     STX ram_00E6_t04_data + $01
bra_97C8_loop_repeat:
C - - - - - 0x0017D8 00:97C8: A0 01     LDY #$01
C - - - - - 0x0017DA 00:97CA: B1 E6     LDA (ram_00E6_t04_data),Y
C - - - - - 0x0017DC 00:97CC: 18        CLC
C - - - - - 0x0017DD 00:97CD: 65 E9     ADC ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x0017DF 00:97CF: 85 E8     STA ram_00E8_t18_ppu_addr_lo
C - - - - - 0x0017E1 00:97D1: C8        INY ; 02
C - - - - - 0x0017E2 00:97D2: A9 00     LDA #$00
C - - - - - 0x0017E4 00:97D4: 24 E9     BIT ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x0017E6 00:97D6: 10 02     BPL bra_97DA
C - - - - - 0x0017E8 00:97D8: A9 FF     LDA #$FF
bra_97DA:
C - - - - - 0x0017EA 00:97DA: 71 E6     ADC (ram_00E6_t04_data),Y
C - - - - - 0x0017EC 00:97DC: AA        TAX ; ppu addr hi
C - - - - - 0x0017ED 00:97DD: A0 00     LDY #$00
C - - - - - 0x0017EF 00:97DF: B1 E6     LDA (ram_00E6_t04_data),Y
C - - - - - 0x0017F1 00:97E1: A4 E8     LDY ram_00E8_t18_ppu_addr_lo
C - - - - - 0x0017F3 00:97E3: 85 E8     STA ram_00E8_t19
C - - - - - 0x0017F5 00:97E5: 29 BF     AND #$40 ^ $FF
C - - - - - 0x0017F7 00:97E7: 20 28 9B  JSR sub_9B28_подготовить_буфер
C - - - - - 0x0017FA 00:97EA: A5 E8     LDA ram_00E8_t19
...
C - - - - - 0x001801 00:97F1: B1 E6     LDA (ram_00E6_t04_data),Y
C - - - - - 0x001803 00:97F3: 9D E8 05  STA ram_05E8_буфер,X
...
C - - - - - 0x001810 00:9800: 65 E6     ADC ram_00E6_t04_data
C - - - - - 0x001812 00:9802: 85 E6     STA ram_00E6_t04_data
C - - - - - 0x001814 00:9804: A5 E7     LDA ram_00E6_t04_data + $01
C - - - - - 0x001816 00:9806: 69 00     ADC #$00
C - - - - - 0x001818 00:9808: 85 E7     STA ram_00E6_t04_data + $01
C - - - - - 0x00181A 00:980A: 20 5E 9B  JSR sub_9B5E_закрыть_буфер
C - - - - - 0x00181D 00:980D: A5 EB     LDA ram_00EB_t26_флаг_задержки_кадра
C - - - - - 0x00181F 00:980F: F0 03     BEQ bra_9814_пропуск
; A = 01
                                       ;LDA #$01
C - - - - - 0x001821 00:9811: 20 A8 9F  JSR sub_9FA8_задержка_кадра
bra_9814_пропуск:
C - - - - - 0x001824 00:9814: 24 E8     BIT ram_00E8_t19
C - - - - - 0x001826 00:9816: 50 B0     BVC bra_97C8_loop_repeat
C - - - - - 0x001828 00:9818: 60        RTS
bra_9819:
C - - - - - 0x001829 00:9819: A5 20     LDA ram_for_2000
C - - - - - 0x00182B 00:981B: 29 7F     AND #$7F
C - - - - - 0x00182D 00:981D: 8D 00 20  STA $2000
C - - - - - 0x001830 00:9820: 85 20     STA ram_for_2000
...
C - - - - - 0x00183B 00:982B: 84 E6     STY ram_00E6_t05_ppu_data
C - - - - - 0x00183D 00:982D: 86 E7     STX ram_00E6_t05_ppu_data + $01
loc_982F_loop:
C D 0 - - - 0x00183F 00:982F: A0 01     LDY #$01
C - - - - - 0x001841 00:9831: B1 E6     LDA (ram_00E6_t05_ppu_data),Y
C - - - - - 0x001843 00:9833: 18        CLC
C - - - - - 0x001844 00:9834: 65 E9     ADC ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x001846 00:9836: AA        TAX
C - - - - - 0x001847 00:9837: C8        INY
C - - - - - 0x001848 00:9838: A9 00     LDA #$00
C - - - - - 0x00184A 00:983A: 24 E9     BIT ram_00E9_t12_смещение_ppu_lo
C - - - - - 0x00184C 00:983C: 10 02     BPL bra_9840
C - - - - - 0x00184E 00:983E: A9 FF     LDA #$FF
bra_9840:
C - - - - - 0x001850 00:9840: 71 E6     ADC (ram_00E6_t05_ppu_data),Y
...
C - - - - - 0x00185C 00:984C: B1 E6     LDA (ram_00E6_t05_ppu_data),Y
...
bra_985B_loop:
C - - - - - 0x00186B 00:985B: B1 E6     LDA (ram_00E6_t05_ppu_data),Y
...
C - - - - - 0x00187A 00:986A: 65 E6     ADC ram_00E6_t05_ppu_data
C - - - - - 0x00187C 00:986C: 85 E6     STA ram_00E6_t05_ppu_data
C - - - - - 0x00187E 00:986E: A5 E7     LDA ram_00E6_t05_ppu_data + $01
C - - - - - 0x001880 00:9870: 69 00     ADC #$00
C - - - - - 0x001882 00:9872: 85 E7     STA ram_00E6_t05_ppu_data + $01
C - - - - - 0x001884 00:9874: 4C 2F 98  JMP loc_982F_loop
bra_9877_закончить:
...
C - - - - - 0x001890 00:9880: A5 20     LDA ram_for_2000
C - - - - - 0x001892 00:9882: 09 80     ORA #$80
C - - - - - 0x001894 00:9884: 85 20     STA ram_for_2000
...
; in
    ; A = номер тайла
C D 0 - - - 0x0018A5 00:9895: 84 E6     STY ram_00E6_t17_ppu_addr_lo
C - - - - - 0x0018A7 00:9897: 86 E7     STX ram_00E7_t03_ppu_addr_hi
C - - - - - 0x0018A9 00:9899: A6 E9     LDX ram_00E9_t19_длина_строки
C - - - - - 0x0018AB 00:989B: A0 01     LDY #$01    ; количество строк
C - - - - - 0x0018AD 00:989D: 4C EA 98  JMP loc_98EA_замостить_часть_экрана_тайлом_A
...
; выключить рендеринг
C - - - - - 0x0018B0 00:98A0: A5 20     LDA ram_for_2000
C - - - - - 0x0018B2 00:98A2: 29 7F     AND #$7F
C - - - - - 0x0018B4 00:98A4: 8D 00 20  STA $2000
C - - - - - 0x0018B7 00:98A7: 85 20     STA ram_for_2000
...
C - - - - - 0x0018E3 00:98D3: A5 20     LDA ram_for_2000
C - - - - - 0x0018E5 00:98D5: 09 80     ORA #$80
C - - - - - 0x0018E7 00:98D7: 85 20     STA ram_for_2000
...
sub_0x0018EF:
- - - - - - 0x0018EF 00:98DF: 85 EB     STA ram_00EB_t09_fill_tile
- - - - - - 0x0018F1 00:98E1: 98        TYA
- - - - - - 0x0018F2 00:98E2: 09 80     ORA #$80    ; флаг пропуска кадра на каждом цикле
...
sub_0x0018FA_замостить_часть_экрана_тайлом_A:
; in
    ; A = fill tile
    ; X = длина строки
    ; Y = количество строк
        ; +80 = флаг пропуска кадра на каждом цикле
    ; ram_00E6_t17_ppu_addr_lo
    ; ram_00E7_t03_ppu_addr_hi
                                        STA ram_00EB_t09_fill_tile
                                        LDA ram_004A_t01_степень_яркости_фона
                                        ORA ram_004B_t01_степень_яркости_спрайтов
                                        BEQ bra_992C
loc_98F2:
                                        STY ram_00E8_t20_колво_строк
                                        STX ram_00E9_t13_длина_строки
bra_98F6_loop:
                                        LDA ram_00E9_t13_длина_строки
                                        LDY ram_00E6_t17_ppu_addr_lo
                                        LDX ram_00E7_t03_ppu_addr_hi
                                        JSR sub_9B28_подготовить_буфер
                                        LDY ram_00E9_t13_длина_строки
                                        LDA ram_00EB_t09_fill_tile
bra_9903_loop:
                                        STA ram_05E8_буфер,X
                                        INX
                                        DEY
                                        ...
                                        LDA ram_00E8_t20_колво_строк
                                        BPL bra_9916_skip
                                        LDA #$01
                                        JSR sub_9FA8_задержка_кадра
bra_9916_skip:
                                        LDA ram_00E6_t17_ppu_addr_lo
                                        CLC
                                        ADC #< $0020
                                        STA ram_00E6_t17_ppu_addr_lo
                                        LDA ram_00E7_t03_ppu_addr_hi
                                        ADC #> $0020
                                        STA ram_00E7_t03_ppu_addr_hi
                                        DEC ram_00E8_t20_колво_строк
                                        LDA ram_00E8_t20_колво_строк
                                        AND #$7F
                                        BNE bra_98F6_loop
                                        RTS
bra_992C:
                                        ...
                                        STA $2001
                                        STA ram_for_2001
                                        STX ram_00E9_t14_длина_строки
                                        STY ram_00E8_t21_колво_строк
bra_9942_loop:
                                        LDY ram_00E9_t14_длина_строки
                                        LDA ram_00E7_t03_ppu_addr_hi
                                        STA $2006
                                        LDA ram_00E6_t17_ppu_addr_lo
                                        STA $2006
...
; in
    ; A = bg pal index
    ; X = spr pal index
C - - - - - 0x00198A 00:997A: 85 48     STA ram_0048_t03_bg_pal_index
C - - - - - 0x00198C 00:997C: 86 49     STX ram_0049_t04_spr_pal_index
...
C - - - - - 0x001997 00:9987: A6 E9     LDX ram_00E9_t20_копия_prg_bank
C - - - - - 0x001999 00:9989: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
bra_998C_loop:
C - - - - - 0x00199C 00:998C: A5 4A     LDA ram_004A_t01_степень_яркости_фона
C - - - - - 0x00199E 00:998E: C9 0F     CMP #$0F
C - - - - - 0x0019A0 00:9990: B0 02     BCS bra_9994
C - - - - - 0x0019A2 00:9992: E6 4A     INC ram_004A_t01_степень_яркости_фона
bra_9994:
C - - - - - 0x0019A4 00:9994: A5 4B     LDA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x0019A6 00:9996: C9 0F     CMP #$0F
C - - - - - 0x0019A8 00:9998: B0 02     BCS bra_999C
C - - - - - 0x0019AA 00:999A: E6 4B     INC ram_004B_t01_степень_яркости_спрайтов
bra_999C:
...
C - - - - - 0x0019B4 00:99A4: A5 4A     LDA ram_004A_t01_степень_яркости_фона
C - - - - - 0x0019B6 00:99A6: 18        CLC
C - - - - - 0x0019B7 00:99A7: 65 4B     ADC ram_004B_t01_степень_яркости_спрайтов
...
C - - - - - 0x0019E7 00:99D7: A6 E9     LDX ram_00E9_t20_копия_prg_bank
C - - - - - 0x0019E9 00:99D9: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
loc_99DC:
C D 0 - - - 0x0019EC 00:99DC: A5 4B     LDA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x0019EE 00:99DE: C9 0F     CMP #$0F
C - - - - - 0x0019F0 00:99E0: B0 0D     BCS bra_99EF_RTS
C - - - - - 0x0019F2 00:99E2: E6 4B     INC ram_004B_t01_степень_яркости_спрайтов
...
ofs_006_0x001A00_08_выход_из_экрана:
ofs_065_0x001A00_08_выход_из_экрана:
sub_0x001A00_выход_из_экрана:
loc_0x001A00_выход_из_экрана:
loc_99F0_loop:
C D 0 - - - 0x001A00 00:99F0: A5 4A     LDA ram_004A_t01_степень_яркости_фона
C - - - - - 0x001A02 00:99F2: 05 4B     ORA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x001A04 00:99F4: F0 16     BEQ bra_9A0C_RTS
C - - - - - 0x001A06 00:99F6: AA        TAX
C - - - - - 0x001A07 00:99F7: F0 02     BEQ bra_99FB
C - - - - - 0x001A09 00:99F9: C6 4A     DEC ram_004A_t01_степень_яркости_фона
bra_99FB:
C - - - - - 0x001A0B 00:99FB: A5 4B     LDA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x001A0D 00:99FD: F0 02     BEQ bra_9A01
C - - - - - 0x001A0F 00:99FF: C6 4B     DEC ram_004B_t01_степень_яркости_спрайтов
bra_9A01:
...
sub_0x001A1D:
loc_9A0D_loop:
C D 0 - - - 0x001A1D 00:9A0D: A5 4A     LDA ram_004A_t01_степень_яркости_фона
C - - - - - 0x001A1F 00:9A0F: F0 0D     BEQ bra_9A1E_RTS
C - - - - - 0x001A21 00:9A11: C6 4A     DEC ram_004A_t01_степень_яркости_фона
...
sub_9A1F:
loc_9A1F_loop:
C D 0 - - - 0x001A2F 00:9A1F: A5 4B     LDA ram_004B_t01_степень_яркости_спрайтов
C - - - - - 0x001A31 00:9A21: F0 0D     BEQ bra_9A30_RTS
C - - - - - 0x001A33 00:9A23: C6 4B     DEC ram_004B_t01_степень_яркости_спрайтов
...
C - - - - - 0x001A3D 00:9A2D: 4C 1F 9A  JMP loc_9A1F_loop
bra_9A30_RTS:
...
; in
    ; A = bg pal index
    ; X = spr pal index
C - - - - - 0x001A41 00:9A31: 85 48     STA ram_0048_t03_bg_pal_index
C - - - - - 0x001A43 00:9A33: 86 49     STX ram_0049_t04_spr_pal_index
sub_9A35:
sub_0x001A45:
...
C - - - - - 0x001A4E 00:9A3E: A6 E9     LDX ram_00E9_t20_копия_prg_bank
C - - - - - 0x001A50 00:9A40: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
sub_9A43:
sub_0x001A53:
C - - - - - 0x001A53 00:9A43: A9 0F     LDA #$0F
C - - - - - 0x001A55 00:9A45: 85 4A     STA ram_004A_t01_степень_яркости_фона
C - - - - - 0x001A57 00:9A47: 85 4B     STA ram_004B_t01_степень_яркости_спрайтов
...
; in
    ; A = spr pal index
C - - - - - 0x001A70 00:9A60: 85 49     STA ram_0049_t04_spr_pal_index
C - - - - - 0x001A72 00:9A62: 20 07 9B  JSR sub_9B07
C - - - - - 0x001A75 00:9A65: 20 DA 9A  JSR sub_9ADA_запись_палитры_спрайтов_в_буфер
C - - - - - 0x001A78 00:9A68: A6 E9     LDX ram_00E9_t20_копия_prg_bank
C - - - - - 0x001A7A 00:9A6A: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
C - - - - - 0x001A7D 00:9A6D: A9 0F     LDA #$0F
C - - - - - 0x001A7F 00:9A6F: 85 4B     STA ram_004B_t01_степень_яркости_спрайтов
sub_9A71:
loc_9A71:
C D 0 - - - 0x001A81 00:9A71: A9 20     LDA #$20
C - - - - - 0x001A83 00:9A73: A0 00     LDY #< $3F00
C - - - - - 0x001A85 00:9A75: A2 3F     LDX #> $3F00
C - - - - - 0x001A87 00:9A77: 20 28 9B  JSR sub_9B28_подготовить_буфер
C - - - - - 0x001A8A 00:9A7A: 86 E7     STX ram_00E7_t16_индекс_буфера
...
C - - - - - 0x001A94 00:9A84: 65 4A     ADC ram_004A_t01_степень_яркости_фона
...
C - - - - - 0x001AA3 00:9A93: 65 4B     ADC ram_004B_t01_степень_яркости_спрайтов
...
C - - - - - 0x001AD2 00:9AC2: 26 E7     ROL ram_00E7_t18
C - - - - - 0x001AD4 00:9AC4: 0A        ASL
C - - - - - 0x001AD5 00:9AC5: 26 E7     ROL ram_00E7_t18
C - - - - - 0x001AD7 00:9AC7: 0A        ASL
C - - - - - 0x001AD8 00:9AC8: 26 E7     ROL ram_00E7_t18
C - - - - - 0x001ADA 00:9ACA: 18        CLC
C - - - - - 0x001ADB 00:9ACB: 69 00     ADC #< tbl_0x00D010_палитра_фона
C - - - - - 0x001ADD 00:9ACD: 85 E6     STA ram_00E6_t06_data
C - - - - - 0x001ADF 00:9ACF: A5 E7     LDA ram_00E7_t18
C - - - - - 0x001AE1 00:9AD1: 69 B0     ADC #> tbl_0x00D010_палитра_фона
C - - - - - 0x001AE3 00:9AD3: 85 E7     STA ram_00E6_t06_data + $01
...
C - - - - - 0x001AEC 00:9ADC: 85 E7     STA ram_00E7_t17
C - - - - - 0x001AEE 00:9ADE: A5 49     LDA ram_0049_t04_spr_pal_index
; * 10
C - - - - - 0x001AF0 00:9AE0: 0A        ASL
C - - - - - 0x001AF1 00:9AE1: 26 E7     ROL ram_00E7_t17
C - - - - - 0x001AF3 00:9AE3: 0A        ASL
C - - - - - 0x001AF4 00:9AE4: 26 E7     ROL ram_00E7_t17
C - - - - - 0x001AF6 00:9AE6: 0A        ASL
C - - - - - 0x001AF7 00:9AE7: 26 E7     ROL ram_00E7_t17
C - - - - - 0x001AF9 00:9AE9: 0A        ASL
C - - - - - 0x001AFA 00:9AEA: 26 E7     ROL ram_00E7_t17
C - - - - - 0x001AFC 00:9AEC: 18        CLC
C - - - - - 0x001AFD 00:9AED: 69 00     ADC #< tbl_0x00D310_палитра_спрайтов
C - - - - - 0x001AFF 00:9AEF: 85 E6     STA ram_00E6_t06_data
C - - - - - 0x001B01 00:9AF1: A5 E7     LDA ram_00E7_t17
C - - - - - 0x001B03 00:9AF3: 69 B3     ADC #> tbl_0x00D310_палитра_спрайтов
C - - - - - 0x001B05 00:9AF5: 85 E7     STA ram_00E6_t06_data + $01
C - - - - - 0x001B07 00:9AF7: A2 10     LDX #$10
loc_9AF9_чтение_палитры:
C D 0 - - - 0x001B09 00:9AF9: A0 00     LDY #$00
bra_9AFB_loop:
C - - - - - 0x001B0B 00:9AFB: B1 E6     LDA (ram_00E6_t06_data),Y
...
loc_9B28_повторить:
; in
    ; A = выделенное количество тайлов для буфера перед записью в него
        ; +80 = вывести тайлы вертикально
    ; X = ppu addr hi
    ; Y = ppu addr lo
C D 0 - - - 0x001B38 00:9B28: 48        PHA
C - - - - - 0x001B39 00:9B29: 2C 29 06  BIT ram_0629_флаги_буфера
...
C - - - - - 0x001B54 00:9B44: 8D 29 06  STA ram_0629_флаги_буфера
C - - - - - 0x001B57 00:9B47: 8A        TXA
C - - - - - 0x001B58 00:9B48: AE 28 06  LDX ram_индекс_буфера
C - - - - - 0x001B5B 00:9B4B: 9D EA 05  STA ram_05E8_ppu_hi,X
C - - - - - 0x001B5E 00:9B4E: 98        TYA
C - - - - - 0x001B5F 00:9B4F: 9D E9 05  STA ram_05E8_ppu_lo,X
C - - - - - 0x001B62 00:9B52: AD 29 06  LDA ram_0629_флаги_буфера
C - - - - - 0x001B65 00:9B55: 29 BF     AND #$40 ^ $FF
C - - - - - 0x001B67 00:9B57: 9D E8 05  STA ram_05E8_буфер,X
...
C - - - - - 0x001B70 00:9B60: 9D E8 05  STA ram_05E8_буфер,X
C - - - - - 0x001B73 00:9B63: 8E 28 06  STX ram_индекс_буфера
C - - - - - 0x001B76 00:9B66: AD 29 06  LDA ram_0629_флаги_буфера
C - - - - - 0x001B79 00:9B69: 29 BF     AND #$40 ^ $FF
C - - - - - 0x001B7B 00:9B6B: 8D 29 06  STA ram_0629_флаги_буфера
...
; in
    ; A = 
    ; ram_0044_t01_scroll_Y
    ; ram_0045_t01
; out
    ; ram_0044_t01_scroll_Y
    ; ram_0045_t01
C - - - - - 0x001BB9 00:9BA9: 85 46     STA ram_0046_t01
C - - - - - 0x001BBB 00:9BAB: A8        TAY
C - - - - - 0x001BBC 00:9BAC: 30 0E     BMI bra_9BBC
C - - - - - 0x001BBE 00:9BAE: 18        CLC
C - - - - - 0x001BBF 00:9BAF: 65 44     ADC ram_0044_t01_scroll_Y
C - - - - - 0x001BC1 00:9BB1: C9 F0     CMP #$F0
C - - - - - 0x001BC3 00:9BB3: 90 04     BCC bra_9BB9
; C = 1
C - - - - - 0x001BC5 00:9BB5: 69 0F     ADC #$0F
C - - - - - 0x001BC7 00:9BB7: E6 45     INC ram_0045_t01
bra_9BB9:
C - - - - - 0x001BC9 00:9BB9: 85 44     STA ram_0044_t01_scroll_Y
C - - - - - 0x001BCB 00:9BBB: 60        RTS
bra_9BBC:
C - - - - - 0x001BCC 00:9BBC: 18        CLC
C - - - - - 0x001BCD 00:9BBD: 65 44     ADC ram_0044_t01_scroll_Y
C - - - - - 0x001BCF 00:9BBF: C9 F0     CMP #$F0
C - - - - - 0x001BD1 00:9BC1: 90 04     BCC bra_9BC7
; C = 1
C - - - - - 0x001BD3 00:9BC3: E9 10     SBC #$10
C - - - - - 0x001BD5 00:9BC5: C6 45     DEC ram_0045_t01
bra_9BC7:
C - - - - - 0x001BD7 00:9BC7: 85 44     STA ram_0044_t01_scroll_Y
...
; in
    ; A = 
C - - - - - 0x001BDA 00:9BCA: 85 47     STA ram_0047_t02
C - - - - - 0x001BDC 00:9BCC: 48        PHA
C - - - - - 0x001BDD 00:9BCD: 18        CLC
C - - - - - 0x001BDE 00:9BCE: 65 7A     ADC ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x001BE0 00:9BD0: 85 7A     STA ram_007A_t01_массив_scroll_X_lo
C - - - - - 0x001BE2 00:9BD2: 68        PLA
C - - - - - 0x001BE3 00:9BD3: 30 07     BMI bra_9BDC
C - - - - - 0x001BE5 00:9BD5: A5 7B     LDA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x001BE7 00:9BD7: 69 00     ADC #$00
C - - - - - 0x001BE9 00:9BD9: 4C E0 9B  JMP loc_9BE0
bra_9BDC:
C - - - - - 0x001BEC 00:9BDC: A5 7B     LDA ram_007B_t02_массив_scroll_X_hi
C - - - - - 0x001BEE 00:9BDE: E9 00     SBC #$00
loc_9BE0:
C D 0 - - - 0x001BF0 00:9BE0: 85 7B     STA ram_007B_t02_массив_scroll_X_hi
...
C - - - - - 0x001C12 00:9C02: 85 E7     STA ram_00E7_t02_номер_опции
C - - - - - 0x001C14 00:9C04: A9 F8     LDA #$F8
C - - - - - 0x001C16 00:9C06: 99 68 04  STA ram_copy_spr_Y,Y
C - - - - - 0x001C19 00:9C09: A5 E7     LDA ram_00E7_t02_номер_опции
...
; in
    ; A = 00 02 04 06 08 
C D 0 - - - 0x001C38 00:9C28: 84 E6     STY ram_00E6_t07_data
C - - - - - 0x001C3A 00:9C2A: 86 E7     STX ram_00E6_t07_data + $01
C - - - - - 0x001C3C 00:9C2C: A8        TAY
C - - - - - 0x001C3D 00:9C2D: B1 E6     LDA (ram_00E6_t07_data),Y
C - - - - - 0x001C3F 00:9C2F: AA        TAX
C - - - - - 0x001C40 00:9C30: C8        INY
C - - - - - 0x001C41 00:9C31: B1 E6     LDA (ram_00E6_t07_data),Y
C - - - - - 0x001C43 00:9C33: 85 E7     STA ram_00E6_t14_jmp + $01
C - - - - - 0x001C45 00:9C35: 86 E6     STX ram_00E6_t14_jmp
C - - - - - 0x001C47 00:9C37: 6C E6 00  JMP (ram_00E6_t14_jmp)
...
; out
    ; ram_00E6_t16_max_spr_Y_курсора
    ; ram_00E7_t01_min_spr_Y_курсора
C - - - - - 0x001C4C 00:9C3C: 85 E9     STA ram_00E9_t07_min_spr_Y_курсора
C - - - - - 0x001C4E 00:9C3E: 84 E6     STY ram_00E6_t08_data_курсор
C - - - - - 0x001C50 00:9C40: 86 E7     STX ram_00E6_t08_data_курсор + $01
C - - - - - 0x001C52 00:9C42: A0 00     LDY #$00
C - - - - - 0x001C54 00:9C44: B1 E6     LDA (ram_00E6_t08_data_курсор),Y
C - - - - - 0x001C56 00:9C46: AA        TAX
C - - - - - 0x001C57 00:9C47: C8        INY ; 01
C - - - - - 0x001C58 00:9C48: B1 E6     LDA (ram_00E6_t08_data_курсор),Y
C - - - - - 0x001C5A 00:9C4A: 85 E8     STA ram_00E8_t07_min_spr_Y_курсора
C - - - - - 0x001C5C 00:9C4C: C5 E9     CMP ram_00E9_t07_min_spr_Y_курсора
...
bra_9C58_loop:
C - - - - - 0x001C68 00:9C58: B1 E6     LDA (ram_00E6_t08_data_курсор),Y
...
C - - - - - 0x001C73 00:9C63: B1 E6     LDA (ram_00E6_t08_data_курсор),Y
C - - - - - 0x001C75 00:9C65: 85 E6     STA ram_00E6_t16_max_spr_Y_курсора
C - - - - - 0x001C77 00:9C67: 8A        TXA
C - - - - - 0x001C78 00:9C68: 38        SEC
C - - - - - 0x001C79 00:9C69: E9 04     SBC #$04
C - - - - - 0x001C7B 00:9C6B: A8        TAY
C - - - - - 0x001C7C 00:9C6C: A5 E8     LDA ram_00E8_t07_min_spr_Y_курсора
C - - - - - 0x001C7E 00:9C6E: 85 E7     STA ram_00E7_t01_min_spr_Y_курсора
...
; in
    ...
    ; ram_00E7_t01_min_spr_Y_курсора
    ; ram_00E9_t22
    ; ram_00EB_t27_номер_выделенного_игрока
C - - - - - 0x001C81 00:9C71: A9 10     LDA #$10
loc_9C73_loop:
C D 0 - - - 0x001C83 00:9C73: 85 E8     STA ram_00E8_t08_счетчик_игроков
bra_9C75_loop:
...
; upd 13.01.2026 а че это пофиксит?
; если только заменить LDX на LDA,
; + по логу X мог быть 80+. видимо
; читает разную хрень из-за этого
                                       ;AND #con_btns_Dpad
C - - - - - 0x001CCA 00:9CBA: BD E2 9E  LDA tbl_9EE2_кнопка_вверх_или_вниз,X
C - - - - - 0x001CCD 00:9CBD: F0 09     BEQ bra_9CC8_RTS
C - - - - - 0x001CCF 00:9CBF: C6 E8     DEC ram_00E8_t08_счетчик_игроков
...
C - - - - - 0x001D03 00:9CF3: C5 E7     CMP ram_00E7_t01_min_spr_Y_курсора
C - - - - - 0x001D05 00:9CF5: B0 02     BCS bra_9CF9
C - - - - - 0x001D07 00:9CF7: A5 E6     LDA ram_00E6_t16_max_spr_Y_курсора
bra_9CF9:
C - - - - - 0x001D09 00:9CF9: C5 E6     CMP ram_00E6_t16_max_spr_Y_курсора
C - - - - - 0x001D0B 00:9CFB: F0 04     BEQ bra_9D01
C - - - - - 0x001D0D 00:9CFD: 90 02     BCC bra_9D01
C - - - - - 0x001D0F 00:9CFF: A5 E7     LDA ram_00E7_t01_min_spr_Y_курсора
bra_9D01:
...
; in
    ...
    ; Y = 
; out
    ; ram_00ED_t24_порядковый_номер_игрока
...
C - - - - - 0x001D25 00:9D15: 85 ED     STA ram_00ED_t24_порядковый_номер_игрока
...
C - - - - - 0x001D32 00:9D22: 85 ED     STA ram_00ED_t24_порядковый_номер_игрока
...
C - - - - - 0x001D37 00:9D27: 84 E6     STY ram_00E6_t09_data
C - - - - - 0x001D39 00:9D29: 86 E7     STX ram_00E6_t09_data + $01
bra_9D2B_loop:
C - - - - - 0x001D3B 00:9D2B: A0 00     LDY #$00
C - - - - - 0x001D3D 00:9D2D: B1 E6     LDA (ram_00E6_t09_data),Y
C - - - - - 0x001D3F 00:9D2F: 85 E8     STA ram_00E8_t04_ppu_addr_lo
C - - - - - 0x001D41 00:9D31: C8        INY ; 01
C - - - - - 0x001D42 00:9D32: B1 E6     LDA (ram_00E6_t09_data),Y
C - - - - - 0x001D44 00:9D34: 85 E9     STA ram_00E9_t05_ppu_addr_hi
C - - - - - 0x001D46 00:9D36: 84 EB     STY ram_00EB_t28_data_index
C - - - - - 0x001D48 00:9D38: 20 58 9D  JSR sub_9D58
C - - - - - 0x001D4B 00:9D3B: AA        TAX
C - - - - - 0x001D4C 00:9D3C: E6 EB     INC ram_00EB_t28_data_index
C - - - - - 0x001D4E 00:9D3E: A5 EB     LDA ram_00EB_t28_data_index
C - - - - - 0x001D50 00:9D40: 18        CLC
C - - - - - 0x001D51 00:9D41: 65 E6     ADC ram_00E6_t09_data
C - - - - - 0x001D53 00:9D43: 85 E6     STA ram_00E6_t09_data
C - - - - - 0x001D55 00:9D45: A5 E7     LDA ram_00E6_t09_data + $01
C - - - - - 0x001D57 00:9D47: 69 00     ADC #$00
C - - - - - 0x001D59 00:9D49: 85 E7     STA ram_00E6_t09_data + $01
...
; in
    ; X = 
    ; Y = 
    ; ram_00E8_t04_ppu_addr_lo
    ; ram_00E9_t05_ppu_addr_hi
C D 0 - - - 0x001D60 00:9D50: 84 E6     STY ram_00E6_t09_data
C - - - - - 0x001D62 00:9D52: 86 E7     STX ram_00E6_t09_data + $01
C - - - - - 0x001D64 00:9D54: A9 FF     LDA #$FF
C - - - - - 0x001D66 00:9D56: 85 EB     STA ram_00EB_t28_data_index
sub_9D58:
loc_9D58_loop:
C D 0 - - - 0x001D68 00:9D58: E6 EB     INC ram_00EB_t28_data_index
C - - - - - 0x001D6A 00:9D5A: A4 EB     LDY ram_00EB_t28_data_index
C - - - - - 0x001D6C 00:9D5C: B1 E6     LDA (ram_00E6_t09_data),Y
C - - - - - 0x001D6E 00:9D5E: C9 FC     CMP #$FC
C - - - - - 0x001D70 00:9D60: B0 10     BCS bra_9D72_RTS
C - - - - - 0x001D72 00:9D62: A4 E8     LDY ram_00E8_t04_ppu_addr_lo
C - - - - - 0x001D74 00:9D64: A6 E9     LDX ram_00E9_t05_ppu_addr_hi
C - - - - - 0x001D76 00:9D66: 20 CA 88  JSR sub_88CA_запись_символа_в_буфер
C - - - - - 0x001D79 00:9D69: E6 E8     INC ram_00E8_t04_ppu_addr_lo
C - - - - - 0x001D7B 00:9D6B: D0 02     BNE bra_9D6F_пропустить
- - - - - - 0x001D7D 00:9D6D: E6 E9     INC ram_00E9_t05_ppu_addr_hi
bra_9D6F_пропустить:
...
sub_0x001D83_добавить_тайлы_закрытия_полоски_special_в_буфер:
; in
    ; A = длина полоски
C - - - - - 0x001D83 00:9D73: 85 E8     STA ram_00E8_t22_длина_полоски
C - - - - - 0x001D85 00:9D75: 20 28 9B  JSR sub_9B28_подготовить_буфер
; bzk optimize, A всегда 1E, AND не нужен
; добавить LDA 1E в начале кода, уддалить промежуточный temp
C - - - - - 0x001D88 00:9D78: A5 E8     LDA ram_00E8_t22_длина_полоски
C - - - - - 0x001D8A 00:9D7A: 29 3F     AND #$3F
C - - - - - 0x001D8C 00:9D7C: 85 E8     STA ram_00E8_t23_длина_полоски
C - - - - - 0x001D8E 00:9D7E: A0 00     LDY #$00
bra_9D80_loop:
C - - - - - 0x001D90 00:9D80: B1 E6     LDA (ram_00E6_t10_data_тайлы_закр_пол_special),Y
C - - - - - 0x001D92 00:9D82: 9D E8 05  STA ram_05E8_буфер,X
C - - - - - 0x001D95 00:9D85: C8        INY
C - - - - - 0x001D96 00:9D86: E8        INX
C - - - - - 0x001D97 00:9D87: C6 E8     DEC ram_00E8_t23_длина_полоски
...
; in
    ; A = 
C - - - - - 0x001D9E 00:9D8E: 85 EC     STA ram_00EC_t26
...
C - - - - - 0x001DB2 00:9DA2: 9D E8 05  STA ram_05E8_буфер,X
C - - - - - 0x001DB5 00:9DA5: E8        INX
C - - - - - 0x001DB6 00:9DA6: A5 EC     LDA ram_00EC_t26
...
; in
    ; ram_00ED_t17_сотни_и_тысячи
    ; ram_00EC_t25_единицы_и_десятки
...
C - - - - - 0x001DCC 00:9DBC: 85 E7     STA ram_00E7_t10
C - - - - - 0x001DD3 00:9DC3: A5 ED     LDA ram_00ED_t17_сотни_и_тысячи
C - - - - - 0x001DD5 00:9DC5: 20 DE 9D  JSR sub_9DDE_единицы
C - - - - - 0x001DD8 00:9DC8: A5 EC     LDA ram_00EC_t25_единицы_и_десятки
...
C - - - - - 0x001DF4 00:9DE4: 84 E7     STY ram_00E7_t10
bra_9DE6:
C - - - - - 0x001DF6 00:9DE6: 18        CLC
C - - - - - 0x001DF7 00:9DE7: 65 E7     ADC ram_00E7_t10
C - - - - - 0x001DF9 00:9DE9: 9D E8 05  STA ram_05E8_буфер,X
...
; in
    ...
    ; X = множитель 2
; out
    ; ram_00EC_t04_произведение_lo
    ; ram_00ED_t03_произведение_hi
                                        STA $5205
                                        STX $5206
                                        LDA $5205
                                        STA ram_00EC_t04_произведение_lo
                                        LDA $5206
                                        STA ram_00ED_t03_произведение_hi
                                        RTS



sub_9E0C_конвертация_в_dec___хз:
sub_0x001E1C_конвертация_в_dec___хз:
; in
    ; ram_00EA_t09_lo
    ; ram_00EB_t12_hi
    ; ram_00EC_t27_число_lo
    ; ram_00ED_t18_число_hi
; out
    ; ram_00E8_t10_lo
    ; ram_00EC_t28_lo
C - - - - - 0x001E1C 00:9E0C: A9 00     LDA #$00
C - - - - - 0x001E1E 00:9E0E: 85 E8     STA ram_00E8_t09_lo
C - - - - - 0x001E20 00:9E10: 85 E9     STA ram_00E9_t03_hi
C - - - - - 0x001E22 00:9E12: A2 10     LDX #$10
bra_9E14_loop:
C - - - - - 0x001E24 00:9E14: 06 EC     ASL ram_00EC_t27_число_lo
C - - - - - 0x001E26 00:9E16: 26 ED     ROL ram_00ED_t18_число_hi
C - - - - - 0x001E28 00:9E18: 26 E8     ROL ram_00E8_t09_lo
C - - - - - 0x001E2A 00:9E1A: 26 E9     ROL ram_00E9_t03_hi
C - - - - - 0x001E2C 00:9E1C: A5 E8     LDA ram_00E8_t09_lo
C - - - - - 0x001E2E 00:9E1E: 38        SEC
C - - - - - 0x001E2F 00:9E1F: E5 EA     SBC ram_00EA_t09_lo
C - - - - - 0x001E31 00:9E21: A8        TAY
C - - - - - 0x001E32 00:9E22: A5 E9     LDA ram_00E9_t03_hi
C - - - - - 0x001E34 00:9E24: E5 EB     SBC ram_00EB_t12_hi
C - - - - - 0x001E36 00:9E26: 90 0A     BCC bra_9E32
C - - - - - 0x001E38 00:9E28: 85 E9     STA ram_00E9_t03_hi
C - - - - - 0x001E3A 00:9E2A: 84 E8     STY ram_00E8_t09_lo
C - - - - - 0x001E3C 00:9E2C: E6 EC     INC ram_00EC_t27_число_lo
C - - - - - 0x001E3E 00:9E2E: D0 02     BNE bra_9E32
; if overflow
- - - - - - 0x001E40 00:9E30: E6 ED     INC ram_00ED_t18_число_hi
bra_9E32:
C - - - - - 0x001E42 00:9E32: CA        DEX
C - - - - - 0x001E43 00:9E33: D0 DF     BNE bra_9E14_loop
                                       ;LDA ram_00EC_t27_число_lo
                                       ;STA ram_00EC_t28_lo
                                       ;LDA ram_00E8_t09_lo
                                       ;STA ram_00E8_t10_lo
...
; in
    ; ram_00EC_t27_число_lo
    ; ram_00ED_t18_число_hi
C - - - - - 0x001E5F 00:9E4F: A9 0A     LDA #< $000A
C - - - - - 0x001E61 00:9E51: 85 EA     STA ram_00EA_t09_lo
C - - - - - 0x001E63 00:9E53: A9 00     LDA #> $000A
C - - - - - 0x001E65 00:9E55: 85 EB     STA ram_00EB_t12_hi
C - - - - - 0x001E67 00:9E57: A9 03     LDA #$03
C - - - - - 0x001E69 00:9E59: 85 E6     STA ram_00E6_t27_loop_counter
bra_9E5B_loop:
C - - - - - 0x001E6B 00:9E5B: 20 0C 9E  JSR sub_9E0C_конвертация_в_dec___хз
C - - - - - 0x001E6E 00:9E5E: A5 E8     LDA ram_00E8_t10_lo
...
C - - - - - 0x001E7B 00:9E6B: 05 E7     ORA ram_00E7_t11
C - - - - - 0x001E7D 00:9E6D: 48        PHA
C - - - - - 0x001E7E 00:9E6E: C6 E6     DEC ram_00E6_t27_loop_counter
C - - - - - 0x001E80 00:9E70: D0 E9     BNE bra_9E5B_loop
; PHA в 0x001E7D
; bzk optimize
C - - - - - 0x001E82 00:9E72: 68        PLA
C - - - - - 0x001E83 00:9E73: 85 EA     STA ram_00EA_tFF_unused_дес_и_сот_тысяч
C - - - - - 0x001E85 00:9E75: 68        PLA
C - - - - - 0x001E86 00:9E76: 85 E9     STA ram_00E9_t15_сотни_и_тысячи
C - - - - - 0x001E88 00:9E78: 68        PLA
C - - - - - 0x001E89 00:9E79: 85 E8     STA ram_00E8_t25_единицы_и_десятки
...
; на выходе DEC число будет храниться в 00ED (сотни) и 00EC (десятки + единицы)
                                        STA ram_00ED_t16_lo
                                        LDA #$0A
                                        STA ram_00EC_t24_система_счисления
...
; * 10
                                        ...
                                        ASL
                                        ORA ram_00EB_t24
; bzk optimize, можно сразу записывать в 00EC без 00EB
                                        STA ram_00EB_t25_единицы_и_десятки
                                        JSR sub_9E36_конвертация
                                        LDA ram_00EA_t15_hi
                                        STA ram_00ED_t17_сотни_и_тысячи
                                        LDA ram_00EB_t25_единицы_и_десятки
                                        STA ram_00EC_t25_единицы_и_десятки
                                        RTS
...
; in
    ; ram_00EC_t24_система_счисления
    ; ram_00ED_t16_lo
; out
    ; ram_00EA_t15_hi
    ; ram_00ED_t16_lo
...
bra_9E3C_loop:
                                        ...
                                        LDA ram_00EA_t15_hi
                                        SEC
; bzk optimize, всегда 0A
                                        SBC ram_00EC_t24_система_счисления
                                        BCC bra_9E4B
                                        STA ram_00EA_t15_hi
                                        INC ram_00ED_t16_lo
bra_9E4B:
...
C - - - - - 0x001F01 00:9EF1: F0 08     BEQ bra_9EFB_00
C - - - - - 0x001F03 00:9EF3: C9 FF     CMP #$FF
C - - - - - 0x001F05 00:9EF5: F0 5B     BEQ bra_9F52_FF
...
C - - - - - 0x001F18 00:9F08: 29 7F     AND #$80 ^ $FF
C - - - - - 0x001F1A 00:9F0A: 85 1B     STA ram_флаг_nmi
C - - - - - 0x001F1C 00:9F0C: 4C ED 9E  JMP loc_9EED_loop
bra_9F0F:
...
C - - - - - 0x001F3A 00:9F2A: B5 02     LDA ram_0002_prg_bank,X
C - - - - - 0x001F3C 00:9F2C: 85 24     STA ram_for_5114
                                        ORA #$80
C - - - - - 0x001F3E 00:9F2E: 8D 01 80  STA $5114
C - - - - - 0x001F41 00:9F31: B5 01     LDA ram_0001_stack_pointer,X
C - - - - - 0x001F43 00:9F33: AA        TAX
C - - - - - 0x001F44 00:9F34: 9A        TXS
; восстановить temp
C - - - - - 0x001F45 00:9F35: 68        PLA
C - - - - - 0x001F46 00:9F36: 85 E6     STA ram_00E6_temp
C - - - - - 0x001F48 00:9F38: 68        PLA
C - - - - - 0x001F49 00:9F39: 85 E7     STA ram_00E7_temp
C - - - - - 0x001F4B 00:9F3B: 68        PLA
C - - - - - 0x001F4C 00:9F3C: 85 E8     STA ram_00E8_temp
C - - - - - 0x001F4E 00:9F3E: 68        PLA
C - - - - - 0x001F4F 00:9F3F: 85 E9     STA ram_00E9_temp
C - - - - - 0x001F51 00:9F41: 68        PLA
C - - - - - 0x001F52 00:9F42: 85 EA     STA ram_00EA_temp
C - - - - - 0x001F54 00:9F44: 68        PLA
C - - - - - 0x001F55 00:9F45: 85 EB     STA ram_00EB_temp
C - - - - - 0x001F57 00:9F47: 68        PLA
C - - - - - 0x001F58 00:9F48: 85 EC     STA ram_00EC_temp
C - - - - - 0x001F5A 00:9F4A: 68        PLA
C - - - - - 0x001F5B 00:9F4B: 85 ED     STA ram_00ED_temp
...
C - - - - - 0x001F6D 00:9F5D: B5 02     LDA ram_0002_prg_bank,X
C - - - - - 0x001F6F 00:9F5F: 85 24     STA ram_for_5114
                                        ORA #$80
C - - - - - 0x001F71 00:9F61: 8D 01 80  STA $5114
C - - - - - 0x001F74 00:9F64: B5 01     LDA ram_0001_stack_pointer,X
...
; in
    ; Y = stack pointer
                                        LDA #$00
C - - - - - 0x001F79 00:9F69: 95 02     STA ram_0002_prg_bank,X
C - - - - - 0x001F7D 00:9F6D: B5 00     LDA ram_0000,X
C - - - - - 0x001F7F 00:9F6F: 99 01 01  STA ram_stack + $01,Y
C - - - - - 0x001F82 00:9F72: B5 01     LDA ram_0001_stack_pointer,X
C - - - - - 0x001F84 00:9F74: 99 02 01  STA ram_stack + $02,Y
C - - - - - 0x001F87 00:9F77: 94 01     STY ram_0001_stack_pointer,X
...
C - - - - - 0x001F94 00:9F84: 95 01     STA ram_0001_stack_pointer,X
C - - - - - 0x001F96 00:9F86: 4C FB 9E  JMP loc_9EFB



sub_0x001F99:
C - - - - - 0x001F99 00:9F89: B5 01     LDA ram_0001_stack_pointer,X
...
; in
    ; A = колво кадров
C - - - - - 0x001FB8 00:9FA8: 85 19     STA ram_0019_t01_величина_задержки
; сохранить регистры
...
; сохранить temp
C - - - - - 0x001FBE 00:9FAE: A5 ED     LDA ram_00ED_temp
C - - - - - 0x001FC0 00:9FB0: 48        PHA
C - - - - - 0x001FC1 00:9FB1: A5 EC     LDA ram_00EC_temp
C - - - - - 0x001FC3 00:9FB3: 48        PHA
C - - - - - 0x001FC4 00:9FB4: A5 EB     LDA ram_00EB_temp
C - - - - - 0x001FC6 00:9FB6: 48        PHA
C - - - - - 0x001FC7 00:9FB7: A5 EA     LDA ram_00EA_temp
C - - - - - 0x001FC9 00:9FB9: 48        PHA
C - - - - - 0x001FCA 00:9FBA: A5 E9     LDA ram_00E9_temp
C - - - - - 0x001FCC 00:9FBC: 48        PHA
C - - - - - 0x001FCD 00:9FBD: A5 E8     LDA ram_00E8_temp
C - - - - - 0x001FCF 00:9FBF: 48        PHA
C - - - - - 0x001FD0 00:9FC0: A5 E7     LDA ram_00E7_temp
C - - - - - 0x001FD2 00:9FC2: 48        PHA
C - - - - - 0x001FD3 00:9FC3: A5 E6     LDA ram_00E6_temp
C - - - - - 0x001FD5 00:9FC5: 48        PHA
; 
C - - - - - 0x001FD6 00:9FC6: BA        TSX
C - - - - - 0x001FD7 00:9FC7: 8A        TXA
C - - - - - 0x001FD8 00:9FC8: A6 00     LDX ram_0000
C - - - - - 0x001FDA 00:9FCA: 95 01     STA ram_0001_stack_pointer,X
C - - - - - 0x001FDC 00:9FCC: AD 24 00  LDA ram_for_5114
C - - - - - 0x001FDF 00:9FCF: 95 02     STA ram_0002_prg_bank,X
C - - - - - 0x001FE1 00:9FD1: AD 25 00  LDA ram_for_5115
C - - - - - 0x001FE4 00:9FD4: 95 03     STA ram_0003,X
C - - - - - 0x001FE6 00:9FD6: A5 19     LDA ram_0019_t01_величина_задержки
C - - - - - 0x001FE8 00:9FD8: F0 04     BEQ bra_9FDE
; bzk optimize, нет такого случая с FF
...
.out .sprintf("Free bytes in bank 80: 0x%04X [%d]", ($A000 - *), ($A000 - *))
