...
C - - - - 0x00209B 02:A08B: D0 B0     BNE bra_A03D_loop
...
C - - - - 0x0020CE 02:A0BE: D0 FA     BNE bra_A0BA_loop
...
C - - - - 0x002102 02:A0F2: 90 BF     BCC bra_A0B3_loop
...
C - - - - 0x002128 02:A118: D0 FA     BNE bra_A114_loop
C - - - - 0x00212A 02:A11A: A2 2C     LDX #con_chr_bank + $2C
C - - - - 0x00212C 02:A11C: A0 2D     LDY #con_chr_bank + $2D
C - - - - 0x00212E 02:A11E: 20 6F 9B  JSR sub_0x001B7F_запись_первых_двух_банков_спрайтов
C - - - - 0x002131 02:A121: A2 2E     LDX #con_chr_bank + $2E
C - - - - 0x002133 02:A123: A0 2F     LDY #con_chr_bank + $2F
...
C - - - - 0x002153 02:A143: A9 C4     LDA #< $21E4
C - - - - 0x002155 02:A145: 85 E8     STA ram_00E8
C - - - - 0x002157 02:A147: A9 21     LDA #> $21E4
...
C - - - - 0x00217A 02:A16A: D0 EB     BNE bra_A157_loop_записи_строки
...
C - - - - 0x00218B 02:A17B: D0 D6     BNE bra_A153_loop_записи_символов_пароля
...
C - - - - 0x002196 02:A186: D0 F7     BNE bra_A17F_loop
...
C - - - - 0x00223A 02:A22A: D0 EB     BNE bra_A217_loop
...
C - - - - 0x0022B6 02:A2A6: D0 E6     BNE bra_A28E_loop
...
C - - - - 0x002436 02:A426: D0 ED     BNE bra_A415_loop
...
sub_0x0024FB_VS_экран_и_повышение_уровня:
                                      ...
                                      ADC #$80
                                      STA a: $90
C D - - - 0x0024FB 02:A4EB: A2 6A     LDX #con_chr_bank + $6A
C - - - - 0x0024FD 02:A4ED: A0 6B     LDY #con_chr_bank + $6B
C - - - - 0x0024FF 02:A4EF: 20 6F 9B  JSR sub_0x001B7F_запись_первых_двух_банков_спрайтов
C - - - - 0x002502 02:A4F2: A2 7A     LDX #con_chr_bank + $7A
C - - - - 0x002504 02:A4F4: A0 7B     LDY #con_chr_bank + $7B
...
C - - - - 0x0025FF 02:A5EF: D0 D5     BNE bra_A5C6_loop
...
C - - - - 0x002632 02:A622: A0 03     LDY #con_plr_lvl
...
C - - - - 0x00263A 02:A62A: A0 00     LDY #con_plr_id
...
C - - - - 0x002649 02:A639: D0 D8     BNE bra_A613_loop
...
tbl_A673_опции:
- D - I - 0x002683 02:A673: 7B A6     .word ofs_005_A67B_00_advice
- D - I - 0x002685 02:A675: 9F A6     .word ofs_005_A69F_01_score_memo
- D - I - 0x002687 02:A677: BE A6     .word ofs_005_A6BE_02_options
- D - I - 0x002689 02:A679: C4 A6     .word ofs_005_A6C4_03_kickoff
...
C - - - - 0x002734 02:A724: A2 1F     LDX #con_chr_bank + $1F
C - - - - 0x002736 02:A726: A0 2E     LDY #con_chr_bank + $2E
...
- D - I - 0x002791 02:A781: 8B A7     .word ofs_006_A78B_опция_formation_сан_паулу_нанкацу
- D - I - 0x002793 02:A783: AC A7     .word ofs_006_A7AC_опция_defense_сан_паулу_нанкацу
- D - I - 0x002795 02:A785: C5 A7     .word ofs_006_A7C5_опция_lineup_сан_паулу_нанкацу
- D - I - 0x002797 02:A787: DD AA     .word ofs_006_AADD_экран_status
...
C - - - - 0x002AD4 02:AAC4: A0 00     LDY #con_plr_id
...
C - - - - 0x002AFF 02:AAEF: A9 84     LDA #< $20A3      
C - - - - 0x002B01 02:AAF1: 85 E6     STA ram_00E6
C - - - - 0x002B03 02:AAF3: A9 20     LDA #> $20A3
...
C - - - - 0x002B0A 02:AAFA: A9 AA     LDA #< $20AC      
C - - - - 0x002B0C 02:AAFC: 85 5C     STA ram_005C
C - - - - 0x002B0E 02:AAFE: A9 20     LDA #> $20AC
...
C - - - - 0x002B1D 02:AB0D: 10 F7     BPL bra_AB06_loop
...
C - - - - 0x002B25 02:AB15: A9 92     LDA #< $20B1      
C - - - - 0x002B27 02:AB17: 85 E6     STA ram_00E6
C - - - - 0x002B29 02:AB19: A9 20     LDA #> $20B1
...
C - - - - 0x002B30 02:AB20: A9 B8     LDA #< $20BA      
C - - - - 0x002B32 02:AB22: 85 5C     STA ram_005C
C - - - - 0x002B34 02:AB24: A9 20     LDA #> $20BA
...
C - - - - 0x002B45 02:AB35: D0 F5     BNE bra_AB2C_loop
bra_AB37:
...
C - - - - 0x002B66 02:AB56: 20 71 9C  JSR sub_0x001C81_поиск_забаненых_игроков
...
C - - - - 0x002BB9 02:ABA9: A0 00     LDY #con_plr_id
C - - - - 0x002BBB 02:ABAB: B1 34     LDA (ram_plr_data),Y
; адрес ppu для имени игрока
C - - - - 0x002BBD 02:ABAD: A0 46     LDY #< $2064
C - - - - 0x002BBF 02:ABAF: A2 20     LDX #> $2064
C - - - - 0x002BC1 02:ABB1: 20 05 AF  JSR sub_AF05
C - - - - 0x002BC4 02:ABB4: A0 03     LDY #con_plr_lvl
...
C - - - - 0x002BCE 02:ABBE: A0 AB     LDY #< $20AB
C - - - - 0x002BD0 02:ABC0: A2 20     LDX #> $20AB
...
C - - - - 0x002BE7 02:ABD7: A0 29     LDY #< $212A
C - - - - 0x002BE9 02:ABD9: A2 21     LDX #> $212A
...
C - - - - 0x002C4F 02:AC3F: A0 00     LDY #con_plr_id
...
C - - - - 0x002C60 02:AC50: D0 F3     BNE bra_AC45_loop
...
C - - - - 0x002C7F 02:AC6F: D0 0A     BNE bra_AC7B_loopон
...
C - - - - 0x002D46 02:AD36: 69 63     ADC #< $2561
C - - - - 0x002D48 02:AD38: A8        TAY
C - - - - 0x002D49 02:AD39: A5 ED     LDA ram_00ED
C - - - - 0x002D4B 02:AD3B: 69 25     ADC #> $2561
...
C - - - - 0x002E27 02:AE17: 10 EE     BPL bra_AE07_loop
...
C - - - - 0x002FCF 02:AFBF: 90 DF     BCC bra_AFA0_loop
...
C - - - - 0x00308D 02:B07D: D0 F7     BNE bra_B076_loop_копирования
