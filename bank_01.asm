...
C - - - - - 0x002146 01:A136: A9 09     LDA #$09
...
C - - - - - 0x00225F 01:A24F: 8D 01 07  STA ram_звук + 1
...
- - - - - - 0x002378 01:A368: 4C DF A2  JMP loc_A2DF_цикл
bra_A36B_продолжить:
...
C - - - - - 0x0025E7 01:A5D7: BD 59 BC  LDA tbl_BC58_адрес_ppu_для_имен_игроков + 1,X
...
C - - - - - 0x00266D 01:A65D: A9 01     LDA #$01
...
C - - - - - 0x00281F 01:A80F: A5 35     LDA ram_plr_data + 1
...
C - - - - - 0x002A18 01:AA08: A5 35     LDA ram_plr_data + 1
...
C - - - - - 0x002A43 01:AA33: 9D 50 04  STA ram_забаненный_игрок - 1,X
...
C - - - - - 0x002ADE 01:AACE: CD 52 04  CMP ram_забаненный_игрок + 1
C - - - - - 0x002AE1 01:AAD1: F0 06     BEQ bra_AAD9
C - - - - - 0x002AE3 01:AAD3: E8        INX
C - - - - - 0x002AE4 01:AAD4: CD 53 04  CMP ram_забаненный_игрок + 2
...
C - - - - - 0x002AFF 01:AAEF: A9 84     LDA #$A3      ; ppu адрес для отображения имен основного состава
C - - - - - 0x002B01 01:AAF1: 85 E6     STA ram_00E6
C - - - - - 0x002B03 01:AAF3: A9 20     LDA #$20
C - - - - - 0x002B05 01:AAF5: 85 E7     STA ram_00E7
C - - - - - 0x002B07 01:AAF7: 20 AC AE  JSR sub_AEAC
C - - - - - 0x002B0A 01:AAFA: A9 AA     LDA #$AC      ; ppu адрес для отображения энергии основного состава
C - - - - - 0x002B0C 01:AAFC: 85 5C     STA ram_005C
C - - - - - 0x002B0E 01:AAFE: A9 20     LDA #$20
...
C - - - - - 0x002B25 01:AB15: A9 92     LDA #$B1      ; начальный адрес для отображения имен запасного состава
C - - - - - 0x002B27 01:AB17: 85 E6     STA ram_00E6
C - - - - - 0x002B29 01:AB19: A9 20     LDA #$20
C - - - - - 0x002B2B 01:AB1B: 85 E7     STA ram_00E7
C - - - - - 0x002B2D 01:AB1D: 20 B5 AE  JSR sub_AEB5
C - - - - - 0x002B30 01:AB20: A9 B8     LDA #$BA      ; начальный адрес для отображения энергии запасного состава
C - - - - - 0x002B32 01:AB22: 85 5C     STA ram_005C
C - - - - - 0x002B34 01:AB24: A9 20     LDA #$20
...
C - - - - - 0x002BE7 01:ABD7: A0 29     LDY #$2A      ; адрес ppu для максимальной энергии
C - - - - - 0x002BE9 01:ABD9: A2 21     LDX #$21
...
C - - - - - 0x002C2A 01:AC1A: B9 82 B9  LDA tbl_B981_позиция_числовых_статов_полевого + 1,Y
C - - - - - 0x002C2D 01:AC1D: BE 83 B9  LDX tbl_B981_позиция_числовых_статов_полевого + 2,Y
...
C - - - - - 0x002C62 01:AC52: BD 2F BB  LDA tbl_BB2E_список_спешалов_игроков + 1,X
C - - - - - 0x002C65 01:AC55: 85 5C     STA ram_005C
C - - - - - 0x002C67 01:AC57: BD 30 BB  LDA tbl_BB2E_список_спешалов_игроков + 2,X
...
C - - - - - 0x002CAB 01:AC9B: BD 49 BC  LDA tbl_BC48_адрес_ppu_спешалов + 1,X
...
bra_ACBB_пропуск:
C - - - - - 0x002CCB 01:ACBB: 4C A0 AC  JMP loc_ACA0_цикл_чтения_имени_спешала
...
C - - - - - 0x002D18 01:AD08: BD 49 BC  LDA tbl_BC48_адрес_ppu_спешалов + 1,X
...
C - - - - - 0x002D26 01:AD16: 69 05     ADC #$05
C - - - - - 0x002D28 01:AD18: 85 5C     STA ram_005C
C - - - - - 0x002D2A 01:AD1A: A5 5D     LDA ram_005D
C - - - - - 0x002D2C 01:AD1C: 69 00     ADC #$00
C - - - - - 0x002D2E 01:AD1E: 85 5D     STA ram_005D
C - - - - - 0x002D30 01:AD20: 4C 60 AC  JMP loc_AC60_цикл_чтения_спешалов_игрока
...
C - - - - - 0x002D46 01:AD36: 69 63     ADC #$61      ; начало
C - - - - - 0x002D48 01:AD38: A8        TAY
C - - - - - 0x002D49 01:AD39: A5 ED     LDA ram_00ED
C - - - - - 0x002D4B 01:AD3B: 69 25     ADC #$25
...
- D - - - - 0x002D9C 01:AD8C: 01        .byte $01   ; <あ>
- D - - - - 0x002D9D 01:AD8D: 02        .byte $02   ; <い>

- D - - - - 0x002D9E 01:AD8E: 03        .byte $03   ; <う>
- D - - - - 0x002D9F 01:AD8F: 03        .byte $03   ; <う>
- D - - - - 0x002DA0 01:AD90: 04        .byte $04   ; <え>
- D - - - - 0x002DA1 01:AD91: 05        .byte $05   ; <お>

- D - - - - 0x002DA2 01:AD92: 06        .byte $06   ; <か>
- D - - - - 0x002DA3 01:AD93: 06        .byte $06   ; <か>
- D - - - - 0x002DA4 01:AD94: 07        .byte $07   ; <き>
- D - - - - 0x002DA5 01:AD95: 08        .byte $08   ; <く>

- D - - - - 0x002DA6 01:AD96: 09        .byte $09   ; <け>
- D - - - - 0x002DA7 01:AD97: 09        .byte $09   ; <け>
- D - - - - 0x002DA8 01:AD98: 0A        .byte $0A   ; <こ>
- D - - - - 0x002DA9 01:AD99: 0B        .byte $0B   ; <さ>

- D - - - - 0x002DAA 01:AD9A: 0C        .byte $0C   ; <し>
- D - - - - 0x002DAB 01:AD9B: 0C        .byte $0C   ; <し>
- - - - - - 0x002DAC 01:AD9C: 0D        .byte $0D   ; <す>
- - - - - - 0x002DAD 01:AD9D: 0E        .byte $0E   ; <せ>
...
bra_AE07_loop:
C - - - - - 0x002E17 01:AE07: BD 23 B8  LDA tbl_B823,X
...
C - - - - - 0x002F06 01:AEF6: 69 40     ADC #$40
...
C - - - - - 0x002F92 01:AF82: BD 4D BA  LDA tbl_BA4C_опыт_за_победу_над_командой + 1,X
...
C - - - - - 0x002FA3 01:AF93: BD 4D BA  LDA tbl_BA4C_опыт_за_победу_над_командой + 1,X
...
C - - - - - 0x002FE8 01:AFD8: B9 4D BA  LDA tbl_BA4C_опыт_за_победу_над_командой + 1,Y
...
C - - - - - 0x00305B 01:B04B: BD 91 BA  LDA tbl_BA90_опыт_для_достижения_уровня + 1,X
...
C - - - - - 0x0030DF 01:B0CF: BD D8 B0  LDA tbl_B0D7 + 1,X
...
- D - - - - 0x00330E 01:B2FE: 01        .byte $01   ; <あ>
- D - - - - 0x00330F 01:B2FF: 00        .byte $00
- D - - - - 0x003310 01:B300: 50        .byte $50   ; <タ>
- D - - - - 0x003311 01:B301: 48        .byte $48   ; <ク>
- D - - - - 0x003312 01:B302: 01        .byte $01   ; <あ>
- D - - - - 0x003313 01:B303: 00        .byte $00
- D - - - - 0x003314 01:B304: 50        .byte $50   ; <タ>
...
tbl_B823:
- D - - - - 0x003833 01:B823: 1C        .byte $1C   ; <ふ>
- D - - - - 0x003834 01:B824: 1D        .byte $1D   ; <へ>
- D - - - - 0x003835 01:B825: 1E        .byte $1E   ; <ほ>
- D - - - - 0x003836 01:B826: 1F        .byte $1F   ; <ま>
- D - - - - 0x003837 01:B827: 30        .byte $30   ; <ゃ>
- D - - - - 0x003838 01:B828: 31        .byte $31   ; <ゅ>
- D - - - - 0x003839 01:B829: 32        .byte $32   ; <ょ>
- D - - - - 0x00383A 01:B82A: 33        .byte $33   ; <0>
- D - - - - 0x00383B 01:B82B: 34        .byte $34   ; <1>
- D - - - - 0x00383C 01:B82C: 35        .byte $35   ; <2>
...
- D - - - - 0x003840 01:B830: 3C        .byte off_B86D_бразильская - tbl_B831_спрайты_миникарты
...
tbl_BB10_нанкацу:
- D - I - - 0x003B20 01:BB10: 0A        .byte $0A   ; <こ>
- D - I - - 0x003B21 01:BB11: 04        .byte $04   ; <え>
- D - I - - 0x003B22 01:BB12: 02        .byte $02   ; <い>
- D - I - - 0x003B23 01:BB13: 06        .byte $06   ; <か>
- D - I - - 0x003B24 01:BB14: 00        .byte $00
- D - I - - 0x003B25 01:BB15: 10        .byte $10   ; <た>
- D - I - - 0x003B26 01:BB16: 12        .byte $12   ; <つ>
- D - I - - 0x003B27 01:BB17: 08        .byte $08   ; <く>
- D - I - - 0x003B28 01:BB18: 0E        .byte $0E   ; <せ>
- D - I - - 0x003B29 01:BB19: 0C        .byte $0C   ; <し>

tbl_BB1A_сан_паулу_2:
- D - I - - 0x003B2A 01:BB1A: 08        .byte $08   ; <く>
- D - I - - 0x003B2B 01:BB1B: 04        .byte $04   ; <え>
- D - I - - 0x003B2C 01:BB1C: 02        .byte $02   ; <い>
- D - I - - 0x003B2D 01:BB1D: 06        .byte $06   ; <か>
- D - I - - 0x003B2E 01:BB1E: 0E        .byte $0E   ; <せ>
- D - I - - 0x003B2F 01:BB1F: 00        .byte $00
- D - I - - 0x003B30 01:BB20: 12        .byte $12   ; <つ>
- D - I - - 0x003B31 01:BB21: 10        .byte $10   ; <た>
- D - I - - 0x003B32 01:BB22: 0A        .byte $0A   ; <こ>
- D - I - - 0x003B33 01:BB23: 0C        .byte $0C   ; <し>

tbl_BB24_япония:
- D - I - - 0x003B34 01:BB24: 00        .byte $00
- D - I - - 0x003B35 01:BB25: 04        .byte $04   ; <え>
- D - I - - 0x003B36 01:BB26: 00        .byte $00
- D - I - - 0x003B37 01:BB27: 08        .byte $08   ; <く>
- D - I - - 0x003B38 01:BB28: 0E        .byte $0E   ; <せ>
- D - I - - 0x003B39 01:BB29: 06        .byte $06   ; <か>
- D - I - - 0x003B3A 01:BB2A: 00        .byte $00
- D - I - - 0x003B3B 01:BB2B: 0E        .byte $0E   ; <せ>
- D - I - - 0x003B3C 01:BB2C: 02        .byte $02   ; <い>
- D - I - - 0x003B3D 01:BB2D: 02        .byte $02   ; <い>
