...
C - - - - 0x0020E6 02:A0D6: BD 41 B2  LDA tbl_B241_смещение_ppu_введенных_символов,X
...
C - - - - 0x002255 02:A245: BC 41 B2  LDY tbl_B241_смещение_ppu_введенных_символов,X
...
C - - - - 0x0022E3 02:A2D3: 85 7E     STA ram_007E      ; выключить вторую nametable
...
C - - - - 0x0023E4 02:A3D4: F0 23     BEQ bra_A3F9_спрятать_введенный_символ
...
bra_A3F9_спрятать_введенный_символ:
...
@запись_катсцены:
    TYA
    CLC
    ADC tbl_B3B5_номер_катсцены_перерыва,X
    ADC #$49
...
loc_A6E8_цикл:
    ...
    JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
    LDX ram_матч
    LDA tbl_B3B5_номер_катсцены_перерыва,X
    CLC
    ADC #$49
    JSR sub_0x000474_воспроизвести_катсцену
loc_A6F9_продолжить:
...
tbl_B241_смещение_ppu_введенных_символов:
    .byte $0B, $0C, $0D, $0E, $0F,      $11, $12, $13, $14, $15
    .byte $4B, $4C, $4D, $4E, $4F,      $51, $52, $53
