...
C - - - - 0x002509 02:A4F9: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
									  ...
									  ASL
									  TAX
									  LDY tbl_0x040003_экран_номера_матча,X
									  LDA tbl_0x040003_экран_номера_матча + 1,X
									  TAX
...
bra_A50B:
C - - - - 0x00251B 02:A50B: B9 71 B2  LDA tbl_B33D_спрайты_логотипа_vs_экрана - $CC,Y
...
; отображение имени твоей команды
...
; отображение имени команды соперника
...
C - - - - 0x0026EA 02:A6DA: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
...
C - - - - 0x0026FB 02:A6EB: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
...
tbl_B33D_спрайты_логотипа_vs_экрана:
	.byte $30, $DF, $02, $78
	.byte $38, $F1, $02, $68
	.byte $38, $F4, $02, $70
	.byte $38, $F5, $02, $78
