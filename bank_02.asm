...
C - - - - - 0x00401A 03:A00A: AD 28 06  LDA ram_индекс_буфера
C - - - - - 0x00401D 03:A00D: F0 4E     BEQ bra_A05D
C - - - - - 0x00401F 03:A00F: 2C 29 06  BIT ram_0629
...
C - - - - - 0x00402D 03:A01D: BD E8 05  LDA ram_05E8,X
...
C - - - - - 0x00403A 03:A02A: BD EA 05  LDA ram_облако,X
C - - - - - 0x00403D 03:A02D: 8D 06 20  STA $2006
C - - - - - 0x004040 03:A030: BD E9 05  LDA ram_таймер_облака_ХЗ,X
C - - - - - 0x004043 03:A033: 8D 06 20  STA $2006
bra_A036:
C - - - - - 0x004046 03:A036: BD EB 05  LDA ram_05EB,X
...
bra_A0AA:
                                        ...
                                        STA ram_0078
bra_A0AF:
C - - - - - 0x0040C4 03:A0B4: A5 9E     LDA ram_для_5124
C - - - - - 0x0040C6 03:A0B6: 8D 01 80  STA $5124
C - - - - - 0x0040CE 03:A0BE: A5 9F     LDA ram_для_5125
C - - - - - 0x0040D0 03:A0C0: 8D 01 80  STA $5125
C - - - - - 0x0040D8 03:A0C8: A5 A0     LDA ram_для_5126
C - - - - - 0x0040DA 03:A0CA: 8D 01 80  STA $5126
C - - - - - 0x0040E2 03:A0D2: A5 A1     LDA ram_для_5127
C - - - - - 0x0040E4 03:A0D4: 8D 01 80  STA $5127
; bzk зачем тут опрос джойстиков если уже есть такая подпрограмма
C - - - - - 0x0040E7 03:A0D7: A2 02     LDX #$01
C - - - - - 0x0040E9 03:A0D9: A9 04     LDA #$04
C - - - - - 0x0040EB 03:A0DB: 85 40     STA ram_0040
bra_A0DD_loop:
C - - - - - 0x0040ED 03:A0DD: B5 1B     LDA ram_btn_hold,X
bra_A0DF_loop:
...
bra_A16E_мусорный_цикл:
C - - - - - 0x00417E 03:A16E: 88        DEY
C - - - - - 0x00417F 03:A16F: D0 FD     BNE bra_A16E_мусорный_цикл
...
bra_A18F_мусорный_цикл:
C - - - - - 0x00419F 03:A18F: 88        DEY
C - - - - - 0x0041A0 03:A190: D0 FD     BNE bra_A18F_мусорный_цикл
...
C - - - - - 0x0041D5 03:A1C5: A0 18     LDY #$18    ; 0090-0091
sub_A1CB_банксвич_CHR_00_01:
C - - - - - 0x0041DB 03:A1CB: B6 78     LDX ram_008E - $16,Y
                                        STX $5128
C - - - - - 0x0041E4 03:A1D4: 8E 01 80  STX $5120
                                        INX
                                        STX $5129
                                        STX $5121
C - - - - - 0x0041E7 03:A1D7: B6 79     LDX ram_008F - $16,Y
                                        STX $512A
...
C - - - - - 0x00423E 03:A22E: 99 19 FF  STA ram_0001 - $E8,Y
C - - - - - 0x004241 03:A231: C8        INY
C - - - - - 0x004242 03:A232: D0 FA     BNE bra_A22E_loop
C - - - - - 0x004244 03:A234: A9 00     LDA #$00
C - - - - - 0x004246 03:A236: A0 5A     LDY #$5A
bra_A238_loop:
; адреса оперативки 003A-00DF
C - - - - - 0x004248 03:A238: 99 E0 FF  STA ram_003A - $5A,Y
C - - - - - 0x00424B 03:A23B: C8        INY
C - - - - - 0x00424C 03:A23C: D0 FA     BNE bra_A238_loop
...
bra_A24F_loop:
C - - - - - 0x00425F 03:A24F: 99 4A 05  STA ram_054A,Y
C - - - - - 0x004262 03:A252: C8        INY
C - - - - - 0x004263 03:A253: D0 FA     BNE bra_A24F_loop
C - - - - - 0x004265 03:A255: 20 43 9A  JSR sub_0x001A53
C - - - - - 0x004268 03:A258: A9 00     LDA #$00
C - - - - - 0x00426A 03:A25A: 85 4A     STA ram_степень_яркости_фона
C - - - - - 0x00426C 03:A25C: 85 4B     STA ram_степень_яркости_спрайтов
C - - - - - 0x00426E 03:A25E: 20 A0 98  JSR sub_0x0018B0_очистка_двух_nametable
C - - - - - 0x004271 03:A261: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
C - - - - - 0x004274 03:A264: A9 02     LDA #con_chr_bank + $02
C - - - - - 0x004276 03:A266: 85 8F     STA ram_008F
C - - - - - 0x004278 03:A268: 85 91     STA ram_0091
C - - - - - 0x00427A 03:A26A: 68        PLA
C - - - - - 0x00427B 03:A26B: F0 14     BEQ bra_A281_это_был_reset
; срабатывает в перерыве после первого тайма
C - - - - - 0x00427D 03:A26D: A2 01     LDX #$01
C - - - - - 0x00427F 03:A26F: A9 FF     LDA #< (ofs_0x000010_действие_после_конца_тайма - 1)
C - - - - - 0x004281 03:A271: 95 00     STA ram_0000,X
C - - - - - 0x004283 03:A273: A9 7F     LDA #> (ofs_0x000010_действие_после_конца_тайма - 1)
...
C - - - - - 0x004293 03:A283: A9 1E     LDA #< (ofs_0x00002F - 1)
C - - - - - 0x004295 03:A285: 95 00     STA ram_0000,X
C - - - - - 0x004297 03:A287: A9 80     LDA #> (ofs_0x00002F - 1)
...
C - - - - - 0x0042A4 03:A294: A9 EC     LDA #< (ofs_0x0002FD - 1)
C - - - - - 0x0042A6 03:A296: 95 00     STA ram_0000,X
C - - - - - 0x0042A8 03:A298: A9 82     LDA #> (ofs_0x0002FD - 1)
...
loc_0x0042BF:
C D - - - - 0x0042BF 03:A2AF: 20 F0 99  JSR sub_0x001A00_выход_из_экрана
C - - - - - 0x0042C2 03:A2B2: 20 A0 98  JSR sub_0x0018B0_очистка_двух_nametable
C - - - - - 0x0042C5 03:A2B5: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
...
bra_A2C8_loop:
; адреса оперативки 0001-0018
C - - - - - 0x0042D8 03:A2C8: 99 19 FF  STA ram_0001 - $E8,Y
C - - - - - 0x0042DB 03:A2CB: C8        INY
C - - - - - 0x0042DC 03:A2CC: D0 FA     BNE bra_A2C8_loop
C - - - - - 0x0042DE 03:A2CE: A9 00     LDA #$00
C - - - - - 0x0042E0 03:A2D0: A0 5A     LDY #$5A
bra_A2D2_loop:
; адреса оперативки 003A-00DF
C - - - - - 0x0042E2 03:A2D2: 99 E0 FF  STA ram_003A - $5A,Y
C - - - - - 0x0042E5 03:A2D5: C8        INY
C - - - - - 0x0042E6 03:A2D6: D0 FA     BNE bra_A2D2_loop
...
C - - - - - 0x004302 03:A2F2: 99 EC FF  STA ram_00E6 - $FA,Y
C - - - - - 0x004305 03:A2F5: C8        INY
C - - - - - 0x004306 03:A2F6: D0 FA     BNE bra_A2F2_loop
loc_A2F8:
C D - - - - 0x004308 03:A2F8: A9 01     LDA #$01
C - - - - - 0x00430A 03:A2FA: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x004343 03:A333: D0 CE     BNE bra_A303_loop
...
C - - - - - 0x004380 03:A370: D0 D8     BNE bra_A34A_loop
loc_A372:
C D - - - - 0x004382 03:A372: A9 01     LDA #$01
C - - - - - 0x004384 03:A374: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x0043AE 03:A39E: D0 D9     BNE bra_A379_loop
C - - - - - 0x0043B0 03:A3A0: 4C 72 A3  JMP loc_A372
bra_A3A3:
C - - - - - 0x0043B3 03:A3A3: AD 68 05  LDA ram_0568
C - - - - - 0x0043B6 03:A3A6: 09 10     ORA #$10
C - - - - - 0x0043B8 03:A3A8: 8D 68 05  STA ram_0568
loc_A3AB:
C D - - - - 0x0043BB 03:A3AB: A9 04     LDA #$04
C - - - - - 0x0043BD 03:A3AD: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
C - - - - - 0x0043C0 03:A3B0: A9 08     LDA #$08
C - - - - - 0x0043C2 03:A3B2: 85 44     STA ram_0044
C - - - - - 0x0043C4 03:A3B4: 85 46     STA ram_0046
C - - - - - 0x0043C6 03:A3B6: AD 6D 05  LDA ram_056D
C - - - - - 0x0043C9 03:A3B9: 38        SEC
C - - - - - 0x0043CA 03:A3BA: E9 04     SBC #$04
C - - - - - 0x0043CC 03:A3BC: 8D 6D 05  STA ram_056D
C - - - - - 0x0043CF 03:A3BF: A9 04     LDA #$04
C - - - - - 0x0043D1 03:A3C1: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x0043DC 03:A3CC: AD 6D 05  LDA ram_056D
C - - - - - 0x0043DF 03:A3CF: 18        CLC
C - - - - - 0x0043E0 03:A3D0: 69 04     ADC #$04
C - - - - - 0x0043E2 03:A3D2: 8D 6D 05  STA ram_056D
...
C D - - - - 0x0043E8 03:A3D8: 20 F0 99  JSR sub_0x001A00_выход_из_экрана
C - - - - - 0x0043EB 03:A3DB: A9 61     LDA #con_cutscene + $48      ; катсцена с музыкальным экраном
C - - - - - 0x0043ED 03:A3DD: 20 64 84  JSR sub_0x000474_воспроизвести_катсцену
C - - - - - 0x0043F0 03:A3E0: 20 A9 82  JSR sub_0x0002B9_ожидание_завершения_катсцены
C - - - - - 0x0043F3 03:A3E3: A0 F8     LDY #$F8
bra_A3E5_loop:
C - - - - - 0x0043F5 03:A3E5: B9 84 A3  LDA tbl_A47C_атрибуты_спрайтов_цифр_звука - $F8,Y
C - - - - - 0x0043F8 03:A3E8: 99 60 04  STA ram_0558 - $F8,Y
C - - - - - 0x0043FB 03:A3EB: C8        INY
C - - - - - 0x0043FC 03:A3EC: D0 F7     BNE bra_A3E5_loop
C - - - - - 0x0043FE 03:A3EE: A9 00     LDA #$00
C - - - - - 0x004402 03:A3F2: 20 54 A4  JSR sub_A454_выбрать_тайлы_цифр
...
C - - - - - 0x004416 03:A406: 70 08     BVS bra_A410_выключить_звук       ; con_btn_B
...
C - - - - - 0x004444 03:A434: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x00445E 03:A44E: 20 F0 99  JSR sub_0x001A00_выход_из_экрана
C - - - - - 0x004461 03:A451: 4C 53 80  JMP loc_0x000063

sub_A454_выбрать_тайлы_цифр:
C - - - - - 0x004464 03:A454: A5 E7     STA ram_00E7
C - - - - - 0x004466 03:A456: 20 7C 9E  JSR sub_0x001E8C_перевод_из_HEX_в_DEC
C - - - - - 0x004469 03:A459: A5 EC     LDA ram_00EC
C - - - - - 0x00446B 03:A45B: 4A        LSR           ; десятки числа
...
C - - - - - 0x004473 03:A463: 8D 59 05  STA ram_0559
C - - - - - 0x004476 03:A466: A5 EC     LDA ram_00EC
C - - - - - 0x004478 03:A468: 29 0F     AND #$0F       ; единицы числа
C - - - - - 0x00447A 03:A46A: A8        TAY
C - - - - - 0x00447B 03:A46B: B9 72 A4  LDA tbl_A472_номера_тайлов_цифр,Y
C - - - - - 0x00447E 03:A46E: 8D 5D 05  STA ram_055D
C - - - - - 0x004481 03:A471: 60        RTS

tbl_A472_номера_тайлов_цифр:
; bzk нужно только из-за того что на музыкальном экране цифра 0 это буква О
    .byte $10       ; 0
    .byte $18       ; 1
    .byte $19       ; 2
    .byte $1A       ; 3
...
C - - - - - 0x004498 03:A488: BD 92 A4  LDA tbl_A491_подпрограмма + 1,X
C - - - - - 0x00449B 03:A48B: 48        PHA
C - - - - - 0x00449C 03:A48C: BD 91 A4  LDA tbl_A491_подпрограмма,X
...
C - - - - - 0x0044DD 03:A4CD: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
C - - - - - 0x0044E0 03:A4D0: A9 01     LDA #$01
C - - - - - 0x0044E2 03:A4D2: 20 0C 89  JSR sub_0x00091C_смещение_Y_спрайтов
C - - - - - 0x0044E5 03:A4D5: 88        DEY
C - - - - - 0x0044E6 03:A4D6: D0 F3     BNE bra_A4CB_loop
...
; bzk поместить запись в этот счетчик перед началом цикла
...
C - - - - - 0x004540 03:A530: A9 00     LDA #con_chr_bank + $00
C - - - - - 0x004542 03:A532: 85 90     STA ram_0090
C - - - - - 0x004544 03:A534: A9 02     LDA #con_chr_bank + $02
C - - - - - 0x004546 03:A536: 85 91     STA ram_0091
C - - - - - 0x004548 03:A538: 20 F0 99  JSR sub_0x001A00_выход_из_экрана
C - - - - - 0x00454B 03:A53B: 20 7F 9B  JSR sub_0x001B8F_очистить_обе_памяти_спрайтов
...
C - - - - - 0x00455F 03:A54F: 20 EA 98  JSR sub_0x0018FA_замостить_часть_экрана_тайлом
...
ofs_008_A57C_02:
C - - - - - 0x00458C 03:A57C: 20 91 9B  JSR sub_0x001BA1_очистить_0568_0588_05A8_05C8
...
- - - - - - 0x00459E 03:A58E: 20 E8 98  JSR sub_0x0018F8_затереть_часть_экрана
...
- - - - - - 0x0045AD 03:A59D: 20 E8 98  JSR sub_0x0018F8_затереть_часть_экрана
...
C - - - - - 0x004646 03:A636: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
C - - - - - 0x004649 03:A639: AD 8F 05  LDA ram_058F
C - - - - - 0x00464C 03:A63C: 29 7F     AND #$7F
C - - - - - 0x00464E 03:A63E: 8D 8F 05  STA ram_058F
...
C - - - - - 0x004667 03:A657: B9 97 AA  LDA tbl_AA97_параметры_очистки_буфера,Y
...
C - - - - - 0x00467A 03:A66A: B9 97 AA  LDA tbl_AA97_параметры_очистки_буфера,Y
C - - - - - 0x00467D 03:A66D: 85 EB     STA ram_00EB
C - - - - - 0x00467F 03:A66F: C8        INY
C - - - - - 0x004680 03:A670: B9 97 AA  LDA tbl_AA97_параметры_очистки_буфера,Y
C - - - - - 0x004683 03:A673: C8        INY
C - - - - - 0x004684 03:A674: 84 ED     STY ram_00ED
C - - - - - 0x004686 03:A676: A4 EB     LDY ram_00EB
C - - - - - 0x004688 03:A678: 20 28 9B  JSR sub_0x001B38_подготовить_буфер
...
C - - - - - 0x004691 03:A681: 9D E8 05  STA ram_05E8,X
C - - - - - 0x004694 03:A684: E8        INX
C - - - - - 0x004695 03:A685: C6 EB     DEC ram_00EB
C - - - - - 0x004697 03:A687: D0 F8     BNE bra_A681_loop_очистки_буфера
C - - - - - 0x004699 03:A689: 20 5E 9B  JSR sub_0x001B6E_закрыть_буфер
C - - - - - 0x00469C 03:A68C: 24 EA     BIT ram_00EA
C - - - - - 0x00469E 03:A68E: 30 0A     BMI bra_A69A_закончить
C - - - - - 0x0046A0 03:A690: 50 C3     BVC bra_A655_повторить
C - - - - - 0x0046A2 03:A692: A9 02     LDA #$02
C - - - - - 0x0046A4 03:A694: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
C - - - - - 0x0046A7 03:A697: 4C 55 A6  JMP loc_A655_повторить
bra_A69A_закончить:
...
C - - - - - 0x00470C 03:A6FC: 99 60 04  STA ram_055C - $FC,Y
C - - - - - 0x00470F 03:A6FF: C8        INY
C - - - - - 0x004710 03:A700: D0 F7     BNE bra_A6F9_loop
...
bra_A72E:
C - - - - - 0x00473E 03:A72E: AD E4 04  LDA ram_04E4
C - - - - - 0x004741 03:A731: 18        CLC
C - - - - - 0x004742 03:A732: 65 ED     ADC ram_00ED
C - - - - - 0x004744 03:A734: 8D E4 04  STA ram_04E4
C - - - - - 0x004747 03:A737: AD E7 04  LDA ram_04E7
C - - - - - 0x00474A 03:A73A: 18        CLC
C - - - - - 0x00474B 03:A73B: 65 EC     ADC ram_00EC
C - - - - - 0x00474D 03:A73D: 8D E7 04  STA ram_04E7
...
C - - - - - 0x004770 03:A760: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x00477C 03:A76C: 99 E8 03  STA ram_03E8,Y
...
- - - - - - 0x0047BF 03:A7AF: 20 91 9B  JSR sub_0x001BA1_очистить_0568_0588_05A8_05C8
bra_A7B2:
- - - - - - 0x0047C2 03:A7B2: A9 01     LDA #$01
- - - - - - 0x0047C4 03:A7B4: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x004803 03:A7F3: D0 EB     BNE bra_A7E0_loop_для_атрибутов
C - - - - - 0x004805 03:A7F5: 88        DEY
C - - - - - 0x004806 03:A7F6: D0 E1     BNE bra_A7D9_loop
...
C - - - - - 0x00481D 03:A80D: 20 CA 88  JSR sub_0x0008DA_запись_символа_в_буфер
C - - - - - 0x004820 03:A810: E6 53     INC ram_0053
C - - - - - 0x004822 03:A812: A9 06     LDA #$06
C - - - - - 0x004824 03:A814: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
bra_A817:
...
C - - - - - 0x004832 03:A822: 20 CA 88  JSR sub_0x0008DA_запись_символа_в_буфер
C - - - - - 0x004835 03:A825: E6 53     INC ram_0053
C - - - - - 0x004837 03:A827: A9 06     LDA #$06
C - - - - - 0x004839 03:A829: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
...
C - - - - - 0x004869 03:A859: B0 4D     BCS bra_A8A8_запись_номера_команды
C - - - - - 0x00486B 03:A85B: A5 26     LDA ram_матч
C - - - - - 0x00486D 03:A85D: F0 1D     BEQ bra_A87C_сан_паулу
C - - - - - 0x00486F 03:A85F: C9 06     CMP #$06
C - - - - - 0x004871 03:A861: F0 21     BEQ bra_A884_нанкацу
C - - - - - 0x004873 03:A863: C9 0C     CMP #$0C
C - - - - - 0x004875 03:A865: F0 15     BEQ bra_A87C_сан_паулу
C - - - - - 0x004877 03:A867: C9 10     CMP #$10
C - - - - - 0x004879 03:A869: F0 21     BEQ bra_A88C_япония
C - - - - - 0x00487B 03:A86B: 4C A8 A8  JMP loc_A8A8_запись_номера_команды
...
C - - - - - 0x004882 03:A872: 90 08     BCC bra_A87C_сан_паулу
- - - - - - 0x004884 03:A874: C9 0C     CMP #$0C
- - - - - - 0x004886 03:A876: 90 0C     BCC bra_A884_нанкацу
- - - - - - 0x004888 03:A878: C9 10     CMP #$10
- - - - - - 0x00488A 03:A87A: B0 10     BCS bra_A88C_япония
bra_A87C_сан_паулу:
C - - - - - 0x00488C 03:A87C: A2 00     LDX #$00
C - - - - - 0x00488E 03:A87E: 20 B7 A8  JSR sub_A8B7_запись_номеров
C - - - - - 0x004891 03:A881: 4C A3 A8  JMP loc_A8A3_запись_расстановки
bra_A884_нанкацу:
C - - - - - 0x004894 03:A884: A2 0C     LDX #$0C
C - - - - - 0x004896 03:A886: 20 B7 A8  JSR sub_A8B7_запись_номеров
C - - - - - 0x004899 03:A889: 4C A3 A8  JMP loc_A8A3_запись_расстановки
bra_A88C_япония:
C - - - - - 0x00489C 03:A88C: A2 18     LDX #$18
C - - - - - 0x00489E 03:A88E: 20 B7 A8  JSR sub_A8B7_запись_номеров
C - - - - - 0x0048A1 03:A891: A0 00     LDY #$00
bra_A893_loop:
C - - - - - 0x0048A3 03:A893: BD 47 AA  LDA tbl_AA47_номера_игроков,X
C - - - - - 0x0048A6 03:A896: 99 08 04  STA ram_bench_1,Y
...
C - - - - - 0x0048B1 03:A8A1: 90 F0     BCC bra_A893_loop
loc_A8A3_запись_расстановки:
C D - - - - 0x0048B3 03:A8A3: BD 47 AA  LDA tbl_AA47_номера_игроков,X
...
C - - - - - 0x0048BA 03:A8AA: BD 75 AA  LDA tbl_AA75_номер_команды,X
...
bra_A8BD_loop:
C - - - - - 0x0048CD 03:A8BD: BD 47 AA  LDA tbl_AA47_номера_игроков,X
C - - - - - 0x0048D0 03:A8C0: 99 00 03  STA ram_номер_игрока,Y
...
C - - - - - 0x0048DB 03:A8CB: 90 F0     BCC bra_A8BD_loop
...
C - - - - - 0x00490B 03:A8FB: D0 D8     BNE bra_A8D5_loop_копирования
C - - - - - 0x00490D 03:A8FD: 60        RTS

sub_AA06:
; bzk на вход всегда подается Y = 04
...
C - - - - - 0x004A2A 03:AA1A: D0 EF     BNE bra_AA0B_loop
C - - - - - 0x004A2C 03:AA1C: CA        DEX
C - - - - - 0x004A2D 03:AA1D: D0 EC     BNE bra_AA0B_loop
C - - - - - 0x004A2F 03:AA1F: 60        RTS

sub_AA20_проверка_нажатий_вверх_вниз:
C - - - - - 0x004A30 03:AA20: A5 1C     LDA ram_btn_hold
C - - - - - 0x004A32 03:AA22: 29 08     AND #con_btn_Up
C - - - - - 0x004A34 03:AA24: F0 04     BEQ bra_AA2A_вверх_не_нажато
C - - - - - 0x004A36 03:AA26: A9 01     LDA #$01
C - - - - - 0x004A38 03:AA28: 38        SEC
C - - - - - 0x004A39 03:AA29: 60        RTS
bra_AA2A_вверх_не_нажато:
C - - - - - 0x004A3A 03:AA2A: A5 1C     LDA ram_btn_hold
C - - - - - 0x004A3C 03:AA2C: 29 04     AND #con_btn_Down
C - - - - - 0x004A3E 03:AA2E: F0 04     BEQ bra_AA34_вниз_не_нажато
