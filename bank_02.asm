...
C - - - - 0x002192 02:A182: 99 60 04  STA $0558 - $F8,Y
...
C - - - - 0x0029E6 02:A9D6: 8D 5C 05  STA $055C
...
tbl_B9D3_смещение_указателя_таблицы_исходя_из_команды:
    .byte tbl_sao_paulo_B9D6 - tbl_B9D3_смещение_указателя_таблицы_исходя_из_команды - $03
    .byte tbl_nankatsu__B9D6 - tbl_B9D3_смещение_указателя_таблицы_исходя_из_команды - $03
    .byte tbl_japan_____B9D6 - tbl_B9D3_смещение_указателя_таблицы_исходя_из_команды - $03
...
; последние 4 байта в каждой секции видимо не используются
- D - - - 0x003A2C 02:BA1C: 30        .byte $30     ; забить гол
- D - - - 0x003A2D 02:BA1D: 0C        .byte $0C     ; обвести игрока/игрок не смог перехватить твой пас/удар
- D - - - 0x003A2E 02:BA1E: 04        .byte $04     ; выиграть борьбу на чужой штрафной
- D - - - 0x003A2F 02:BA1F: 08        .byte $08     ; засейвить кипером

- D - - - 0x003A34 02:BA24: 20        .byte $20     ; забить гол
- D - - - 0x003A35 02:BA25: 08        .byte $08     ; обвести игрока/игрок не смог перехватить твой пас/удар
- D - - - 0x003A36 02:BA26: 02        .byte $02     ; выиграть борьбу на чужой штрафной
- - - - - 0x003A37 02:BA27: 06        .byte $06     ; засейвить кипером

- - - - - 0x003A3C 02:BA2C: 20        .byte $20     ; забить гол
- D - - - 0x003A3D 02:BA2D: 08        .byte $08     ; обвести игрока/игрок не смог перехватить твой пас/удар
- D - - - 0x003A3E 02:BA2E: 02        .byte $02     ; выиграть борьбу на чужой штрафной
- - - - - 0x003A3F 02:BA2F: 06        .byte $06     ; засейвить кипером

- - - - - 0x003A44 02:BA34: 18        .byte $18     ; забить гол
- D - - - 0x003A45 02:BA35: 04        .byte $04     ; обвести игрока/игрок не смог перехватить твой пас/удар
- - - - - 0x003A46 02:BA36: 02        .byte $02     ; выиграть борьбу на чужой штрафной
- D - - - 0x003A47 02:BA37: 04        .byte $04     ; засейвить кипером

- D - - - 0x003A4C 02:BA3C: 18        .byte $18     ; забить гол
- D - - - 0x003A4D 02:BA3D: 04        .byte $04     ; обвести игрока/игрок не смог перехватить твой пас/удар
- D - - - 0x003A4E 02:BA3E: 02        .byte $02     ; выиграть борьбу на чужой штрафной
- - - - - 0x003A4F 02:BA3F: 04        .byte $04     ; засейвить кипером

- - - - - 0x003A54 02:BA44: 1A        .byte $1A     ; забить гол
- D - - - 0x003A55 02:BA45: 06        .byte $06     ; обвести игрока/игрок не смог перехватить твой пас/удар
- D - - - 0x003A56 02:BA46: 02        .byte $02     ; выиграть борьбу на чужой штрафной
- - - - - 0x003A57 02:BA47: 04        .byte $04     ; засейвить кипером
