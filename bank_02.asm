...
; хотя возможно код выполнится при правильном вводе пароля
...
; пропуск VS экрана по кнопке или по таймеру
; con_btn_A
C - - - - 0x002588 02:A578: 30 03     BMI bra_A57D_кнопка_нажата
C - - - - 0x00258A 02:A57A: CA        DEX
C - - - - 0x00258B 02:A57B: D0 F4     BNE bra_A571_ожидание_нажатия
bra_A57D_кнопка_нажата:
...
; bzk подправить адреса с учетом начального Y
