...
sub_0x004010:
C D - - - - 0x004010 02:A000: A9 00     LDA #$00
C - - - - - 0x004012 02:A002: 8D 03 20  STA $2003
C - - - - - 0x004015 02:A005: A9 02     LDA #$02
...
bra_A05D:
C - - - - - 0x00406D 02:A05D: A5 21     LDA ram_для_2001
...
bra_A0AA:
                                        ...
                                        STA ram_0078
bra_A0AF:
C - - - - - 0x0040C4 02:A0B4: A5 9E     LDA ram_для_5124
C - - - - - 0x0040C6 02:A0B6: 8D 01 80  STA $5124
C - - - - - 0x0040CE 02:A0BE: A5 9F     LDA ram_для_5125
C - - - - - 0x0040D0 02:A0C0: 8D 01 80  STA $5125
C - - - - - 0x0040D8 02:A0C8: A5 A0     LDA ram_для_5126
C - - - - - 0x0040DA 02:A0CA: 8D 01 80  STA $5126
C - - - - - 0x0040E2 02:A0D2: A5 A1     LDA ram_для_5127
...
C - - - - - 0x00417F 02:A16F: D0 FD     BNE bra_A16E_мусорный_цикл
...
C - - - - - 0x0041A0 02:A190: D0 FD     BNE bra_A18F_мусорный_цикл
...
bra_A24F_loop:
C - - - - - 0x00425F 02:A24F: 99 4A 05  STA ram_054A,Y
...
C - - - - - 0x00427F 02:A26F: A9 FF     LDA #< (ofs_0x000010_действие_после_конца_тайма - 1)
C - - - - - 0x004281 02:A271: 95 00     STA ram_0000,X
C - - - - - 0x004283 02:A273: A9 7F     LDA #> (ofs_0x000010_действие_после_конца_тайма - 1)
...
C - - - - - 0x004293 02:A283: A9 1E     LDA #< (ofs_0x00002F - 1)
C - - - - - 0x004295 02:A285: 95 00     STA ram_0000,X
C - - - - - 0x004297 02:A287: A9 80     LDA #> (ofs_0x00002F - 1)
...
C - - - - - 0x0042A4 02:A294: A9 EC     LDA #< (ofs_0x0002FD - 1)
C - - - - - 0x0042A6 02:A296: 95 00     STA ram_0000,X
C - - - - - 0x0042A8 02:A298: A9 82     LDA #> (ofs_0x0002FD - 1)
...
C - - - - - 0x004322 02:A312: B9 E0 AA  LDA tbl_AADF + 1,Y
C - - - - - 0x004325 02:A315: 75 7A     ADC ram_007A,X
C - - - - - 0x004327 02:A317: 95 7A     STA ram_007A,X
C - - - - - 0x004329 02:A319: B9 E0 AA  LDA tbl_AADF + 1,Y
...
C - - - - - 0x004398 02:A388: 79 21 AB  ADC tbl_AB1F + 2,Y
...
C - - - - - 0x0043A2 02:A392: 79 22 AB  ADC tbl_AB1F + 3,Y
...
C - - - - - 0x004498 02:A488: BD 92 A4  LDA tbl_A491_подпрограмма + 1,X
...
- D - - - - 0x0044A1 02:A491: C0 A4     .word ofs_008_A4C1_00 - 1
- D - - - - 0x0044A3 02:A493: 59 A5     .word ofs_008_A55A_01 - 1
- D - - - - 0x0044A5 02:A495: 7B A5     .word ofs_008_A57C_02 - 1
- - - - - - 0x0044A7 02:A497: 81 A5     .word ofs_008_A582_03 - 1
- - - - - - 0x0044A9 02:A499: A2 A5     .word ofs_008_A5A3_04 - 1
- D - - - - 0x0044AB 02:A49B: A8 A5     .word ofs_008_A5A9_05 - 1
- D - - - - 0x0044AD 02:A49D: B0 A5     .word ofs_008_A5B1_06 - 1
- - - - - - 0x0044AF 02:A49F: B8 A5     .word ofs_008_A5B9_07 - 1
- - - - - - 0x0044B1 02:A4A1: BF A5     .word ofs_008_A5C0_08 - 1
- - - - - - 0x0044B3 02:A4A3: CD A5     .word ofs_008_A5CE_09 - 1
- D - - - - 0x0044B5 02:A4A5: DB A5     .word ofs_008_A5DC_0A - 1
- D - - - - 0x0044B7 02:A4A7: E8 A5     .word ofs_008_A5E9_0B - 1
- D - - - - 0x0044B9 02:A4A9: 02 A6     .word ofs_008_A603_0C - 1
- D - - - - 0x0044BB 02:A4AB: 1C A6     .word ofs_008_A61D_0D - 1
- D - - - - 0x0044BD 02:A4AD: 29 A6     .word ofs_008_A62A_0E - 1
- D - - - - 0x0044BF 02:A4AF: 50 A6     .word ofs_008_A651_0F - 1
- D - - - - 0x0044C1 02:A4B1: 9C A6     .word ofs_008_A69D_10_схема_драйв_удара_и_циклона - 1
- D - - - - 0x0044C3 02:A4B3: 7A A7     .word ofs_008_A77B_11_дождь - 1
- D - - - - 0x0044C5 02:A4B5: 82 A7     .word ofs_008_A783_12 - 1
- - - - - - 0x0044C7 02:A4B7: 8D A7     .word ofs_008_A78E_13 - 1
- D - - - - 0x0044C9 02:A4B9: BD A7     .word ofs_008_A7BE_14 - 1
- D - - - - 0x0044CB 02:A4BB: CE A7     .word ofs_008_A7CF_15 - 1
- D - - - - 0x0044CD 02:A4BD: D6 A7     .word ofs_008_A7D7_16 - 1
- D - - - - 0x0044CF 02:A4BF: FA A7     .word ofs_008_A7FB_17_вывод_забитых_голов_в_катсцене - 1
...
C - - - - - 0x0044F7 02:A4E7: A9 03     LDA #$03
...
C - - - - - 0x004525 02:A515: A9 00     LDA #$00
...
C - - - - - 0x004562 02:A552: A9 01     LDA #$01
...
C - - - - - 0x0045F1 02:A5E1: A9 05     LDA #$05
...
C - - - - - 0x004602 02:A5F2: A9 06     LDA #$06
...
C - - - - - 0x00461C 02:A60C: A9 08     LDA #$08
...
C - - - - - 0x004632 02:A622: A9 07     LDA #$07
...
C - - - - - 0x0046A0 02:A690: 50 C3     BVC bra_A655_повторить
C - - - - - 0x0046A2 02:A692: A9 02     LDA #$02
C - - - - - 0x0046A4 02:A694: 20 A8 9F  JSR sub_0x001FB8_задержка_кадра
C - - - - - 0x0046A7 02:A697: 4C 55 A6  JMP loc_A655_повторить
bra_A69A_закончить:
...
- D - - - - 0x004785 02:A775: 03        .byte $03   ; <う>
- D - - - - 0x004786 02:A776: C2        .byte $C2   ; <ド>

tbl_A777:
- D - - - - 0x004787 02:A777: 46        .byte $46   ; <カ>
- D - - - - 0x004788 02:A778: F6        .byte $F6
- D - - - - 0x004789 02:A779: 02        .byte $02   ; <い>
- D - - - - 0x00478A 02:A77A: 52        .byte $52   ; <ツ>
...
C - - - - - 0x00486D 02:A85D: F0 1D     BEQ bra_A87C_сан_паулу
C - - - - - 0x00486F 02:A85F: C9 06     CMP #$06
C - - - - - 0x004871 02:A861: F0 21     BEQ bra_A884_нанкацу
C - - - - - 0x004873 02:A863: C9 0C     CMP #$0C
C - - - - - 0x004875 02:A865: F0 15     BEQ bra_A87C_сан_паулу
C - - - - - 0x004877 02:A867: C9 10     CMP #$10
C - - - - - 0x004879 02:A869: F0 21     BEQ bra_A88C_япония
...
C - - - - - 0x004882 02:A872: 90 08     BCC bra_A87C_сан_паулу
- - - - - - 0x004884 02:A874: C9 0C     CMP #$0C
- - - - - - 0x004886 02:A876: 90 0C     BCC bra_A884_нанкацу
- - - - - - 0x004888 02:A878: C9 10     CMP #$10
- - - - - - 0x00488A 02:A87A: B0 10     BCS bra_A88C_япония
bra_A87C_сан_паулу:
...
- D - - - - 0x004AA7 02:AA97: 20        .byte $20   ; <み>
- D - - - - 0x004AA8 02:AA98: 00        .byte $00
- D - - - - 0x004AA9 02:AA99: 20        .byte $20   ; <み>

- D - - - - 0x004AAA 02:AA9A: 20        .byte $20   ; <み>
- D - - - - 0x004AAB 02:AA9B: 20        .byte $20   ; <み>
- D - - - - 0x004AAC 02:AA9C: 8F        .byte $8F   ; <S>

- D - - - - 0x004AAD 02:AA9D: 60        .byte $60   ; <ミ>
- D - - - - 0x004AAE 02:AA9E: 3F        .byte $3F   ; <•>
- D - - - - 0x004AAF 02:AA9F: 8F        .byte $8F   ; <S>

- D - - - - 0x004AB0 02:AAA0: 20        .byte $20   ; <み>
- D - - - - 0x004AB1 02:AAA1: 21        .byte $21   ; <む>
- D - - - - 0x004AB2 02:AAA2: 1E        .byte $1E   ; <ほ>

- D - - - - 0x004AB3 02:AAA3: 20        .byte $20   ; <み>
- D - - - - 0x004AB4 02:AAA4: 41        .byte $41   ; <ア>
- D - - - - 0x004AB5 02:AAA5: 8E        .byte $8E   ; <L>

- D - - - - 0x004AB6 02:AAA6: 60        .byte $60   ; <ミ>
- D - - - - 0x004AB7 02:AAA7: 5E        .byte $5E   ; <ホ>
- D - - - - 0x004AB8 02:AAA8: 8E        .byte $8E   ; <L>

- D - - - - 0x004AB9 02:AAA9: 20        .byte $20   ; <み>
- D - - - - 0x004ABA 02:AAAA: 42        .byte $42   ; <イ>
- D - - - - 0x004ABB 02:AAAB: 1C        .byte $1C   ; <ふ>

- D - - - - 0x004ABC 02:AAAC: 20        .byte $20   ; <み>
- D - - - - 0x004ABD 02:AAAD: 62        .byte $62   ; <メ>
- D - - - - 0x004ABE 02:AAAE: 8D        .byte $8D   ; <P>

- D - - - - 0x004ABF 02:AAAF: 60        .byte $60   ; <ミ>
- D - - - - 0x004AC0 02:AAB0: 7D        .byte $7D   ; <ー>
- D - - - - 0x004AC1 02:AAB1: 8D        .byte $8D   ; <P>

- D - - - - 0x004AC2 02:AAB2: 20        .byte $20   ; <み>
- D - - - - 0x004AC3 02:AAB3: 63        .byte $63   ; <モ>
- D - - - - 0x004AC4 02:AAB4: 1A        .byte $1A   ; <は>

- D - - - - 0x004AC5 02:AAB5: 20        .byte $20   ; <み>
- D - - - - 0x004AC6 02:AAB6: 83        .byte $83   ; <C>
- D - - - - 0x004AC7 02:AAB7: 8C        .byte $8C   ; <M>

- D - - - - 0x004AC8 02:AAB8: 60        .byte $60   ; <ミ>
- D - - - - 0x004AC9 02:AAB9: 9C        .byte $9C
- D - - - - 0x004ACA 02:AABA: 8C        .byte $8C   ; <M>

- D - - - - 0x004ACB 02:AABB: 20        .byte $20   ; <み>
- D - - - - 0x004ACC 02:AABC: 84        .byte $84   ; <D>
- D - - - - 0x004ACD 02:AABD: 18        .byte $18   ; <ね>

- D - - - - 0x004ACE 02:AABE: 20        .byte $20   ; <み>
- D - - - - 0x004ACF 02:AABF: A4        .byte $A4   ; <ご>
- D - - - - 0x004AD0 02:AAC0: 8B        .byte $8B   ; <K>

- D - - - - 0x004AD1 02:AAC1: 60        .byte $60   ; <ミ>
- D - - - - 0x004AD2 02:AAC2: BB        .byte $BB   ; <ズ>
- D - - - - 0x004AD3 02:AAC3: 8B        .byte $8B   ; <K>

- D - - - - 0x004AD4 02:AAC4: 20        .byte $20   ; <み>
- D - - - - 0x004AD5 02:AAC5: A5        .byte $A5   ; <ざ>
- D - - - - 0x004AD6 02:AAC6: 16        .byte $16   ; <に>

- D - - - - 0x004AD7 02:AAC7: 20        .byte $20   ; <み>
- D - - - - 0x004AD8 02:AAC8: C5        .byte $C5   ; <ブ>
- D - - - - 0x004AD9 02:AAC9: 8A        .byte $8A   ; <N>

- D - - - - 0x004ADA 02:AACA: 60        .byte $60   ; <ミ>
- D - - - - 0x004ADB 02:AACB: DA        .byte $DA
- D - - - - 0x004ADC 02:AACC: 8A        .byte $8A   ; <N>

- D - - - - 0x004ADD 02:AACD: 20        .byte $20   ; <み>
- D - - - - 0x004ADE 02:AACE: C6        .byte $C6   ; <ベ>
- D - - - - 0x004ADF 02:AACF: 14        .byte $14   ; <と>

- D - - - - 0x004AE0 02:AAD0: 20        .byte $20   ; <み>
- D - - - - 0x004AE1 02:AAD1: E6        .byte $E6
- D - - - - 0x004AE2 02:AAD2: 89        .byte $89   ; <I>

- D - - - - 0x004AE3 02:AAD3: 60        .byte $60   ; <ミ>
- D - - - - 0x004AE4 02:AAD4: F9        .byte $F9
- D - - - - 0x004AE5 02:AAD5: 89        .byte $89   ; <I>

- D - - - - 0x004AE6 02:AAD6: 20        .byte $20   ; <み>
- D - - - - 0x004AE7 02:AAD7: E7        .byte $E7
- D - - - - 0x004AE8 02:AAD8: 12        .byte $12   ; <つ>

- D - - - - 0x004AE9 02:AAD9: 20        .byte $20   ; <み>
- D - - - - 0x004AEA 02:AADA: 07        .byte $07   ; <き>
- D - - - - 0x004AEB 02:AADB: 88        .byte $88   ; <H>

- D - - - - 0x004AEC 02:AADC: E0        .byte $E0
- D - - - - 0x004AED 02:AADD: 18        .byte $18   ; <ね>
- D - - - - 0x004AEE 02:AADE: 88        .byte $88   ; <H>
...
tbl_AB1F:
- D - - - - 0x004B2F 02:AB1F: 6C        .byte $6C   ; <ワ>
- - - - - - 0x004B30 02:AB20: 00        .byte $00
- D - - - - 0x004B31 02:AB21: 04        .byte $04   ; <え>
- D - - - - 0x004B32 02:AB22: FC        .byte $FC

- D - - - - 0x004B33 02:AB23: 6E        .byte $6E   ; <ン>
- - - - - - 0x004B34 02:AB24: 00        .byte $00
- D - - - - 0x004B35 02:AB25: 05        .byte $05   ; <お>
- D - - - - 0x004B36 02:AB26: FC        .byte $FC

- D - - - - 0x004B37 02:AB27: 70        .byte $70   ; <ャ>
- - - - - - 0x004B38 02:AB28: 00        .byte $00
- D - - - - 0x004B39 02:AB29: 06        .byte $06   ; <か>
- D - - - - 0x004B3A 02:AB2A: FA        .byte $FA

- D - - - - 0x004B3B 02:AB2B: 74        .byte $74   ; <ィ>
- - - - - - 0x004B3C 02:AB2C: 00        .byte $00
- D - - - - 0x004B3D 02:AB2D: 07        .byte $07   ; <き>
