...
C D - - - - 0x000010 00:8000: A5 27     LDA ram_номер_тайма
C - - - - - 0x000012 00:8002: 0A        ASL
C - - - - - 0x000013 00:8003: AA        TAX
C - - - - - 0x000014 00:8004: BD 0E 80  LDA tbl_800D_подпрограмма + 1,X
...
- D - - - - 0x00001D 00:800D: 65 81     .word ofs_000_8166_00_закончился_первый_тайм - 1
- D - - - - 0x00001F 00:800F: 8A 81     .word ofs_000_818B_01_закончился_второй_тайм - 1
- - - - - - 0x000021 00:8011: AD 81     .word ofs_000_81AE_02 - 1
- D - - - - 0x000023 00:8013: B4 81     .word ofs_000_81B5_03_закончился_овертайм - 1
- D - - - - 0x000025 00:8015: DA 81     .word ofs_000_81DB_04_закончились_пк_после_матча - 1



loc_8017:
C D - - - - 0x000027 00:8017: A2 02     LDX #con_prg_bank + $02
...
loc_0x000063:
C D - - - - 0x000063 00:8053: 20 11 9B  JSR sub_9B11
...
loc_8091:
C D - - - - 0x0000A1 00:8091: A5 ED     LDA ram_00ED
...
loc_80C0:
C D - - - - 0x0000D0 00:80C0: 85 ED     STA ram_00ED
...
loc_80FD:
C D - - - - 0x00010D 00:80FD: A9 00     LDA #$00
C - - - - - 0x00010F 00:80FF: 85 28     STA ram_голы
C - - - - - 0x000111 00:8101: 85 29     STA ram_голы + 1
...
C - - - - - 0x000147 00:8137: 8D 52 04  STA ram_забаненный_игрок + 1
C - - - - - 0x00014A 00:813A: 8D 53 04  STA ram_забаненный_игрок + 2
...
C - - - - - 0x00019D 00:818D: C5 29     CMP ram_голы + 1
...
ofs_000_81AE_02:
- - - - - - 0x0001BE 00:81AE: A9 03     LDA #$03
- - - - - - 0x0001C0 00:81B0: 85 27     STA ram_номер_тайма
- - - - - - 0x0001C2 00:81B2: 4C 17 80  JMP loc_8017



ofs_000_81B5_03_закончился_овертайм:
C - - - - - 0x0001C5 00:81B5: A5 28     LDA ram_голы
C - - - - - 0x0001C7 00:81B7: C5 29     CMP ram_голы + 1
...
C - - - - - 0x0001ED 00:81DD: C5 29     CMP ram_голы + 1
C - - - - - 0x0001EF 00:81DF: F0 05     BEQ bra_81E6_ничья
C - - - - - 0x0001F1 00:81E1: B0 23     BCS bra_8206_наша_команда_победила
C - - - - - 0x0001F3 00:81E3: 4C E6 81  JMP loc_81E6_поражение    ; bzk опт, бесполезно
bra_81E6_ничья:
loc_81E6_поражение:
C D - - - - 0x0001F6 00:81E6: A2 01     LDX #con_prg_bank + $01
...
C - - - - - 0x00021B 00:820B: 20 12 A0  JSR sub_0x002F89_начислить_опыт_за_победу
...
C - - - - - 0x000262 00:8252: 20 18 A0  JSR sub_0x003060
...
loc_826A:
C D - - - - 0x00027A 00:826A: A2 01     LDX #con_prg_bank + $01
...
- - - - - - 0x000282 00:8272: A2 02     LDX #con_prg_bank + $02
- - - - - - 0x000284 00:8274: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
- - - - - - 0x000287 00:8277: 20 0F A2  JSR sub_0x00487E_номера_игроков_и_расстановка_твоей_команды
- - - - - - 0x00028A 00:827A: A2 01     LDX #con_prg_bank + $01
- - - - - - 0x00028C 00:827C: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
- - - - - - 0x00028F 00:827F: 20 1B A0  JSR sub_0x0023AB
- - - - - - 0x000292 00:8282: 4C FD 80  JMP loc_80FD
...
C - - - - - 0x0002D4 00:82C4: F0 EF     BEQ bra_82B5_попытка_пропуска_катсцены
bra_82C6:
...
ofs_0x0002FD:
bra_82ED_loop:
C D - - - - 0x0002FD 00:82ED: 20 8A 83  JSR sub_838A
...
C - - - - - 0x00030B 00:82FB: BD 01 B8  LDA tbl_0x00D810 + 1,X
...
bra_8383:
loc_8383:
C D - - - - 0x000393 00:8383: A9 00     LDA #$00
...
- - - - - - 0x0003A8 00:8398: 00        .byte $00    ; 00
- - - - - - 0x0003A9 00:8399: 00        .byte $00    ; 01
- D - - - - 0x0003AA 00:839A: 02        .byte $02    ; 02
- - - - - - 0x0003AB 00:839B: 02        .byte $02    ; 03
- D - - - - 0x0003AC 00:839C: 04        .byte $04    ; 04
- - - - - - 0x0003AD 00:839D: 04        .byte $04    ; 05
- - - - - - 0x0003AE 00:839E: 06        .byte $06    ; 06
- - - - - - 0x0003AF 00:839F: 06        .byte $06    ; 07
- - - - - - 0x0003B0 00:83A0: 08        .byte $08    ; 08
- - - - - - 0x0003B1 00:83A1: 08        .byte $08    ; 09
- - - - - - 0x0003B2 00:83A2: 0A        .byte $0A    ; 0A
- - - - - - 0x0003B3 00:83A3: 0A        .byte $0A    ; 0B
- D - - - - 0x0003B4 00:83A4: 0C        .byte $0C    ; 0C
- - - - - - 0x0003B5 00:83A5: 0C        .byte $0C    ; 0D
- - - - - - 0x0003B6 00:83A6: 0E        .byte $0E    ; 0E
- - - - - - 0x0003B7 00:83A7: 0E        .byte $0E    ; 0F
- - - - - - 0x0003B8 00:83A8: 10        .byte $10    ; 10
- - - - - - 0x0003B9 00:83A9: 10        .byte $10    ; 11
- - - - - - 0x0003BA 00:83AA: 12        .byte $12    ; 12
- - - - - - 0x0003BB 00:83AB: 12        .byte $12    ; 13
- - - - - - 0x0003BC 00:83AC: 14        .byte $14    ; 14
- - - - - - 0x0003BD 00:83AD: 14        .byte $14    ; 15
- - - - - - 0x0003BE 00:83AE: 16        .byte $16    ; 16
- D - - - - 0x0003BF 00:83AF: 17        .byte $17    ; 17
- D - - - - 0x0003C0 00:83B0: 17        .byte $17    ; 18
- D - - - - 0x0003C1 00:83B1: 19        .byte $19    ; 19
- - - - - - 0x0003C2 00:83B2: 19        .byte $19    ; 1A
- D - - - - 0x0003C3 00:83B3: 1B        .byte $1B    ; 1B
- - - - - - 0x0003C4 00:83B4: 1B        .byte $1B    ; 1C
- - - - - - 0x0003C5 00:83B5: 1D        .byte $1D    ; 1D
- - - - - - 0x0003C6 00:83B6: 1D        .byte $1D    ; 1E
- - - - - - 0x0003C7 00:83B7: 1F        .byte $1F    ; 1F
- D - - - - 0x0003C8 00:83B8: 1F        .byte $1F    ; 20
...
- D - - - - 0x0003EC 00:83DC: 02        .byte con_cutscene + $02    ; 00
- D - - - - 0x0003ED 00:83DD: 00        .byte $00    ; 01
- D - - - - 0x0003EE 00:83DE: 00        .byte $00    ; 02
- D - - - - 0x0003EF 00:83DF: 00        .byte $00    ; 03
- D - - - - 0x0003F0 00:83E0: 00        .byte $00    ; 04
- D - - - - 0x0003F1 00:83E1: 07        .byte con_cutscene + $07    ; 05
- D - - - - 0x0003F2 00:83E2: 00        .byte $00    ; 06
- D - - - - 0x0003F3 00:83E3: 00        .byte $00    ; 07
- D - - - - 0x0003F4 00:83E4: 00        .byte $00    ; 08
- D - - - - 0x0003F5 00:83E5: 00        .byte $00    ; 09
- D - - - - 0x0003F6 00:83E6: 0C        .byte con_cutscene + $0C    ; 0A
- D - - - - 0x0003F7 00:83E7: 0E        .byte con_cutscene + $0E    ; 0B
- D - - - - 0x0003F8 00:83E8: 00        .byte $00    ; 0C
- D - - - - 0x0003F9 00:83E9: 00        .byte $00    ; 0D
- D - - - - 0x0003FA 00:83EA: 10        .byte con_cutscene + $10    ; 0E
- D - - - - 0x0003FB 00:83EB: 12        .byte con_cutscene + $12    ; 0F
- D - - - - 0x0003FC 00:83EC: 00        .byte $00    ; 10
- D - - - - 0x0003FD 00:83ED: 00        .byte $00    ; 11
- D - - - - 0x0003FE 00:83EE: 00        .byte $00    ; 12
- D - - - - 0x0003FF 00:83EF: 00        .byte $00    ; 13
- D - - - - 0x000400 00:83F0: 00        .byte $00    ; 14
- D - - - - 0x000401 00:83F1: 00        .byte $00    ; 15
- D - - - - 0x000402 00:83F2: 00        .byte $00    ; 16
- D - - - - 0x000403 00:83F3: 00        .byte $00    ; 17
- D - - - - 0x000404 00:83F4: 00        .byte $00    ; 18
- D - - - - 0x000405 00:83F5: 00        .byte $00    ; 19
- D - - - - 0x000406 00:83F6: 18        .byte con_cutscene + $18    ; 1A
- D - - - - 0x000407 00:83F7: 00        .byte $00    ; 1B
- D - - - - 0x000408 00:83F8: 00        .byte $00    ; 1C
- D - - - - 0x000409 00:83F9: 00        .byte $00    ; 1D
- D - - - - 0x00040A 00:83FA: 00        .byte $00    ; 1E
- D - - - - 0x00040B 00:83FB: 1E        .byte con_cutscene + $1E    ; 1F
- D - - - - 0x00040C 00:83FC: 20        .byte con_cutscene + $20    ; 20
...
- D - - - - 0x00040F 00:83FF: 00        .byte $00    ; 01
- D - - - - 0x000410 00:8400: 00        .byte $00    ; 02
- D - - - - 0x000411 00:8401: 00        .byte $00    ; 03
- D - - - - 0x000412 00:8402: 00        .byte $00    ; 04
- D - - - - 0x000413 00:8403: 00        .byte $00    ; 05
- D - - - - 0x000414 00:8404: 00        .byte $00    ; 06
- D - - - - 0x000415 00:8405: 00        .byte $00    ; 07
- D - - - - 0x000416 00:8406: 00        .byte $00    ; 08
- D - - - - 0x000417 00:8407: 0A        .byte con_cutscene + $0A    ; 09 мисуги
- D - - - - 0x000418 00:8408: 00        .byte $00    ; 0A
- D - - - - 0x000419 00:8409: 00        .byte $00    ; 0B
- D - - - - 0x00041A 00:840A: 00        .byte $00    ; 0C
- D - - - - 0x00041B 00:840B: 00        .byte $00    ; 0D
- D - - - - 0x00041C 00:840C: 00        .byte $00    ; 0E
- D - - - - 0x00041D 00:840D: 00        .byte $00    ; 0F
- D - - - - 0x00041E 00:840E: 00        .byte $00    ; 10
- D - - - - 0x00041F 00:840F: 00        .byte $00    ; 11
- D - - - - 0x000420 00:8410: 00        .byte $00    ; 12
- D - - - - 0x000421 00:8411: 00        .byte $00    ; 13
- D - - - - 0x000422 00:8412: 00        .byte $00    ; 14
- D - - - - 0x000423 00:8413: 00        .byte $00    ; 15
- D - - - - 0x000424 00:8414: 00        .byte $00    ; 16
- D - - - - 0x000425 00:8415: 00        .byte $00    ; 17
- D - - - - 0x000426 00:8416: 00        .byte $00    ; 18
- D - - - - 0x000427 00:8417: 00        .byte $00    ; 19
- D - - - - 0x000428 00:8418: 00        .byte $00    ; 1A
- D - - - - 0x000429 00:8419: 00        .byte $00    ; 1B
- D - - - - 0x00042A 00:841A: 00        .byte $00    ; 1C
- D - - - - 0x00042B 00:841B: 00        .byte $00    ; 1D
- D - - - - 0x00042C 00:841C: 00        .byte $00    ; 1E
- D - - - - 0x00042D 00:841D: 00        .byte $00    ; 1F
- D - - - - 0x00042E 00:841E: 21        .byte con_cutscene + $21    ; 20 бразилия



tbl_8420_катсцена_после_матча:
- D - - - - 0x000430 00:8420: 03        .byte con_cutscene + $03    ; 00
- D - - - - 0x000431 00:8421: 04        .byte con_cutscene + $04    ; 01
- D - - - - 0x000432 00:8422: 05        .byte con_cutscene + $05    ; 02
- D - - - - 0x000433 00:8423: 00        .byte $00    ; 03
- D - - - - 0x000434 00:8424: 06        .byte con_cutscene + $06    ; 04
- D - - - - 0x000435 00:8425: 00        .byte $00    ; 05
- D - - - - 0x000436 00:8426: 00        .byte $00    ; 06
- D - - - - 0x000437 00:8427: 00        .byte $00    ; 07
- D - - - - 0x000438 00:8428: 00        .byte $00    ; 08
- D - - - - 0x000439 00:8429: 0B        .byte con_cutscene + $0B    ; 09
- D - - - - 0x00043A 00:842A: 0D        .byte $0D    ; 0A
- D - - - - 0x00043B 00:842B: 00        .byte $00    ; 0B
- D - - - - 0x00043C 00:842C: 00        .byte $00    ; 0C
- D - - - - 0x00043D 00:842D: 00        .byte $00    ; 0D
- D - - - - 0x00043E 00:842E: 11        .byte con_cutscene + $11    ; 0E
- D - - - - 0x00043F 00:842F: 00        .byte $00    ; 0F
- D - - - - 0x000440 00:8430: 00        .byte $00    ; 10
- D - - - - 0x000441 00:8431: 14        .byte con_cutscene + $14    ; 11
- D - - - - 0x000442 00:8432: 00        .byte $00    ; 12
- D - - - - 0x000443 00:8433: 00        .byte $00    ; 13
- D - - - - 0x000444 00:8434: 00        .byte $00    ; 14
- D - - - - 0x000445 00:8435: 00        .byte $00    ; 15
- D - - - - 0x000446 00:8436: 16        .byte con_cutscene + $16    ; 16
- D - - - - 0x000447 00:8437: 00        .byte $00    ; 17
- D - - - - 0x000448 00:8438: 17        .byte con_cutscene + $17    ; 18
- D - - - - 0x000449 00:8439: 00        .byte $00    ; 19
- D - - - - 0x00044A 00:843A: 00        .byte $00    ; 1A
- D - - - - 0x00044B 00:843B: 1A        .byte con_cutscene + $1A    ; 1B
- D - - - - 0x00044C 00:843C: 1B        .byte con_cutscene + $1B    ; 1C
- D - - - - 0x00044D 00:843D: 1C        .byte con_cutscene + $1C    ; 1D
- D - - - - 0x00044E 00:843E: 1D        .byte con_cutscene + $1D    ; 1E
- D - - - - 0x00044F 00:843F: 1F        .byte con_cutscene + $1F    ; 1F
- D - - - - 0x000450 00:8440: 00        .byte $00    ; 20



tbl_8442_катсцена_после_завершения_турнира:
- D - - - - 0x000452 00:8442: 00        .byte $00    ; 00
- D - - - - 0x000453 00:8443: 00        .byte $00    ; 01
- D - - - - 0x000454 00:8444: 00        .byte $00    ; 02
- D - - - - 0x000455 00:8445: 00        .byte $00    ; 03
- D - - - - 0x000456 00:8446: 00        .byte $00    ; 04
- D - - - - 0x000457 00:8447: 08        .byte $08    ; 05
- D - - - - 0x000458 00:8448: 00        .byte $00    ; 06
- D - - - - 0x000459 00:8449: 00        .byte $00    ; 07
- D - - - - 0x00045A 00:844A: 00        .byte $00    ; 08
- D - - - - 0x00045B 00:844B: 00        .byte $00    ; 09
- D - - - - 0x00045C 00:844C: 00        .byte $00    ; 0A
- D - - - - 0x00045D 00:844D: 0F        .byte con_cutscene + $0F    ; 0B
- D - - - - 0x00045E 00:844E: 00        .byte $00    ; 0C
- D - - - - 0x00045F 00:844F: 00        .byte $00    ; 0D
- D - - - - 0x000460 00:8450: 00        .byte $00    ; 0E
- D - - - - 0x000461 00:8451: 13        .byte con_cutscene + $13    ; 0F
- D - - - - 0x000462 00:8452: 00        .byte $00    ; 10
- D - - - - 0x000463 00:8453: 00        .byte $00    ; 11
- D - - - - 0x000464 00:8454: 00        .byte $00    ; 12
- D - - - - 0x000465 00:8455: 00        .byte $00    ; 13
- D - - - - 0x000466 00:8456: 00        .byte $00    ; 14
- D - - - - 0x000467 00:8457: 15        .byte con_cutscene + $15    ; 15
- D - - - - 0x000468 00:8458: 00        .byte $00    ; 16
- D - - - - 0x000469 00:8459: 00        .byte $00    ; 17
- D - - - - 0x00046A 00:845A: 00        .byte $00    ; 18
- D - - - - 0x00046B 00:845B: 00        .byte $00    ; 19
- D - - - - 0x00046C 00:845C: 19        .byte con_cutscene + $19    ; 1A
- D - - - - 0x00046D 00:845D: 00        .byte $00    ; 1B
- D - - - - 0x00046E 00:845E: 00        .byte $00    ; 1C
- D - - - - 0x00046F 00:845F: 00        .byte $00    ; 1D
- D - - - - 0x000470 00:8460: 00        .byte $00    ; 1E
- D - - - - 0x000471 00:8461: 00        .byte $00    ; 1F
- D - - - - 0x000472 00:8462: 22        .byte con_cutscene + $22    ; 20
...
C - - - - - 0x00047E 00:846E: F9 EC 8A  SBC tbl_8AEE - 2,Y
C - - - - - 0x000481 00:8471: BE ED 8A  LDX tbl_8AEE - 1,Y
...
C - - - - - 0x000491 00:8481: A5 25     LDA ram_для_5115
...
C - - - - - 0x0004A6 00:8496: A9 C5     LDA #< (ofs_84C6 - 1)
C - - - - - 0x0004A8 00:8498: 95 00     STA ram_0000,X
C - - - - - 0x0004AA 00:849A: A9 84     LDA #> (ofs_84C6 - 1)
...
loc_84D7:
C D - - - - 0x0004E7 00:84D7: A5 4F     LDA ram_004F
...
C - - - - - 0x00054C 00:853C: BD 46 85  LDA tbl_8545_управляющие_байты_катсцены + 1,X
...
C - - - - - 0x000674 00:8664: BE 41 BB  LDX tbl_0x00DB50_оформление_окна_диалога + 1,Y
...
C - - - - - 0x000695 00:8685: D0 08     BNE bra_868F_01_и_выше
...
C - - - - - 0x0006A3 00:8693: 30 08     BMI bra_869D_01_7E
...
C - - - - - 0x0006CD 00:86BD: BD C7 86  LDA tbl_86C6 + 1,X
...
- D - - - - 0x0006D8 00:86C8: DD 86     .word ofs_002_86DE_01 - 1
- D - - - - 0x0006DA 00:86CA: E5 86     .word ofs_002_86E6_02 - 1
- D - - - - 0x0006DC 00:86CC: ED 86     .word ofs_002_86EE_03 - 1
- D - - - - 0x0006DE 00:86CE: F5 86     .word ofs_002_86F6_04_скрыть_текст - 1
- D - - - - 0x0006E0 00:86D0: 12 87     .word ofs_002_8713_05_показать_текст - 1
- D - - - - 0x0006E2 00:86D2: 33 87     .word ofs_002_8734_06_ожидание_перехода_к_скрытому_диалогу - 1
- D - - - - 0x0006E4 00:86D4: 9E 87     .word ofs_002_879F_07_возврат_из_скрытой_катсцены - 1
...
C - - - - - 0x00070C 00:86FC: BD B3 87  LDA tbl_87B4 - 1,X
...
C - - - - - 0x000746 00:8736: B9 D2 88  LDA tbl_89CE_графика_мячика_диалога - $FC,Y
C - - - - - 0x000749 00:8739: 99 68 04  STA ram_copy_spr_Y,Y
C - - - - - 0x00074C 00:873C: C8        INY
C - - - - - 0x00074D 00:873D: D0 F7     BNE bra_8736_loop_копирования
...
C D - - - - 0x000753 00:8743: A9 01     LDA #$01
...
C - - - - - 0x000767 00:8757: F0 DB     BEQ bra_8734_повторить_цикл_моргания
...
C - - - - - 0x000770 00:8760: 4C 43 87  JMP loc_8743_цикл_ожидания_нажатия
bra_8763_нажата_A:
...
C - - - - - 0x0007A2 00:8792: B9 00 A0  LDA tbl_879D_поинтер_скрытой_катсцены + 1,Y
C - - - - - 0x0007A5 00:8795: 85 4D     STA ram_004D
C - - - - - 0x0007A7 00:8797: B9 01 A0  LDA tbl_879D_поинтер_скрытой_катсцены + 2,Y
...
tbl_87B4:
- D - - - - 0x0007C4 00:87B4: 30        .byte $30   ; <ゃ>
- D - - - - 0x0007C5 00:87B5: 20        .byte $20   ; <み>
- D - - - - 0x0007C6 00:87B6: 10        .byte $10   ; <た>
- D - - - - 0x0007C7 00:87B7: 0F        .byte $0F   ; <そ>
...
C - - - - - 0x000828 00:8818: 4C 1F 88  JMP loc_881F  ; bzk опт
...
loc_881F:
C D - - - - 0x00082F 00:881F: 85 5B     STA ram_005B
...
C - - - - - 0x00085E 00:884E: D0 02     BNE bra_8852
...
C - - - - - 0x000886 00:8876: 4C 7E 9F  JMP loc_9F7E



loc_8879_сместить_указатель_байтов_катсцены:
C D - - - - 0x000889 00:8879: 18        CLC
...
C - - - - - 0x0008A9 00:8899: A9 A8     LDA #< (ofs_88A9 - 1)
C - - - - - 0x0008AB 00:889B: 95 00     STA ram_0000,X
C - - - - - 0x0008AD 00:889D: A9 88     LDA #> (ofs_88A9 - 1)
...
C - - - - - 0x000942 00:8932: A5 25     LDA ram_для_5115
...
C - - - - - 0x0009B5 00:89A5: B9 D2 88  LDA tbl_89CE_графика_мячика_диалога - $FC,Y
C - - - - - 0x0009B8 00:89A8: 99 68 04  STA ram_copy_spr_Y,Y
C - - - - - 0x0009BB 00:89AB: C8        INY
C - - - - - 0x0009BC 00:89AC: D0 F7     BNE bra_89A5_loop_копирования
; X = скрыть спрайт, Y = задержка мерцания
...
C D - - - - 0x0009C2 00:89B2: A9 01     LDA #$01
...
C - - - - - 0x0009CE 00:89BE: F0 E3     BEQ bra_89A3_повторить_цикл_моргания
; мячик затирается если эта единственная проверка не пройдена, и счетчик продолжает отсчет
; цикл отрисовки не начнется заново пока счетчик не закончится, поэтому мяч останется скрытым
...
C - - - - - 0x0009D7 00:89C7: 4C B2 89  JMP loc_89B2_цикл_ожидания_нажатия
...
C - - - - - 0x0009F1 00:89E1: BD 01 BD  LDA tbl_0x00DD10_номера_анимаций_чарли + 1,X
...
C D - - - - 0x000A24 00:8A14: AD 54 06  LDA ram_data_чарли_lo
...
C - - - - - 0x000A93 00:8A83: 4C 14 8A  JMP loc_8A14_цикл_анимации
...
loc_8A8B:
C D - - - - 0x000A9B 00:8A8B: A6 56     LDX ram_0056
C - - - - - 0x000A9D 00:8A8D: 20 B9 C4  JSR sub_0x03C4C9_банксвич_PRG_5115
C D - - - - 0x000AA0 00:8A90: 60        RTS
...
C - - - - - 0x000B19 00:8B09: A5 25     LDA ram_для_5115
...
bra_8BAB:
loc_8BAB:
C D - - - - 0x000BBB 00:8BAB: 20 76 90  JSR sub_9076_очистить_2400_25FF
loc_8BAE:
C D - - - - 0x000BBE 00:8BAE: A9 01     LDA #$01
...
loc_8C59:
C D - - - - 0x000C69 00:8C59: 85 6D     STA ram_006D
...
C - - - - - 0x000C87 00:8C77: A9 B9     LDA #< (ofs_8CBA - 1)
C - - - - - 0x000C89 00:8C79: 95 00     STA ram_0000,X
C - - - - - 0x000C8B 00:8C7B: A9 8C     LDA #> (ofs_8CBA - 1)
...
C - - - - - 0x000CA6 00:8C96: A9 21     LDA #< (ofs_8D22 - 1)
C - - - - - 0x000CA8 00:8C98: 95 00     STA ram_0000,X
C - - - - - 0x000CAA 00:8C9A: A9 8D     LDA #> (ofs_8D22 - 1)
...
bra_8CA5:
loc_8CA5:
C D - - - - 0x000CB5 00:8CA5: A5 75     LDA ram_0075
...
C - - - - - 0x000D1C 00:8D0C: A9 FE     LDA #< (ofs_8DFF - 1)
C - - - - - 0x000D1E 00:8D0E: 95 00     STA ram_0000,X
C - - - - - 0x000D20 00:8D10: A9 8D     LDA #> (ofs_8DFF - 1)
...
C D - - - - 0x000D32 00:8D22: A2 07     LDX #con_prg_bank + $07
...
loc_8D59:
bra_8D59_loop:
C D - - - - 0x000D69 00:8D59: A9 01     LDA #$01
...
loc_8DC8:
C D - - - - 0x000DD8 00:8DC8: A5 62     LDA ram_0062
...
bra_8DFC:
C - - - - - 0x000E0C 00:8DFC: 4C 7E 9F  JMP loc_9F7E
...
C - - - - - 0x000E22 00:8E12: 4C 7E 9F  JMP loc_9F7E
...
loc_8E19_loop:
C D - - - - 0x000E29 00:8E19: A5 63     LDA ram_0063
...
loc_8E6E:
C D - - - - 0x000E7E 00:8E6E: 85 64     STA ram_0064
...
loc_8E8A:
C D - - - - 0x000E9A 00:8E8A: 85 64     STA ram_0064
...
bra_8EE8:
loc_8EE8:
C D - - - - 0x000EF8 00:8EE8: C6 6C     DEC ram_006C
...
loc_9041:
C D - - - - 0x001051 00:9041: 9D E8 05  STA ram_05E8,X
...
bra_9078:
C D - - - - 0x001088 00:9078: 85 E7     STA ram_00E7
...
C - - - - - 0x00109D 00:908D: D0 FA     BNE bra_9089_loop
...
loc_90AE:
C D - - - - 0x0010BE 00:90AE: A6 25     LDX ram_для_5115
...
C - - - - - 0x001100 00:90F0: A5 25     LDA ram_для_5115
...
C - - - - - 0x001129 00:9119: D0 02     BNE bra_911D
...
C - - - - - 0x00113E 00:912E: 4C AE 90  JMP loc_90AE
bra_9131:
C - - - - - 0x001141 00:9131: A2 11     LDX #$11
C - - - - - 0x001143 00:9133: A9 47     LDA #< (ofs_9148 - 1)
C - - - - - 0x001145 00:9135: 95 00     STA ram_0000,X
C - - - - - 0x001147 00:9137: A9 91     LDA #> (ofs_9148 - 1)
...
loc_9143:
C D - - - - 0x001153 00:9143: A9 01     LDA #$01
...
loc_9154:
C D - - - - 0x001164 00:9154: A0 00     LDY #$00
...
loc_91B4:
C D - - - - 0x0011C4 00:91B4: A0 10     LDY #$10
...
loc_91F3:
C D - - - - 0x001203 00:91F3: A0 01     LDY #$01
...
bra_9224:
loc_9224:
C D - - - - 0x001234 00:9224: A0 00     LDY #$00
...
C - - - - - 0x0012EC 00:92DC: BD E6 92  LDA tbl_92E5_управляющие_байты_анимации + 1,X
...
- D - - - - 0x0012F5 00:92E5: 04 93     .word ofs_003_9305_F0_повтор_анимации - 1
- D - - - - 0x0012F7 00:92E7: 38 93     .word ofs_003_9339_F1_координаты_Y_X - 1
- - - - - - 0x0012F9 00:92E9: 4F 93     .word ofs_003_9350_F2 - 1
- - - - - - 0x0012FB 00:92EB: 5D 93     .word ofs_003_935E_F3 - 1
- - - - - - 0x0012FD 00:92ED: 6B 93     .word ofs_003_936C_F4 - 1
- D - - - - 0x0012FF 00:92EF: 8C 93     .word ofs_003_938D_F5 - 1
- D - - - - 0x001301 00:92F1: 99 93     .word ofs_003_939A_F6 - 1
- D - - - - 0x001303 00:92F3: A6 93     .word ofs_003_93A7_F7_физика - 1
- - - - - - 0x001305 00:92F5: 29 94     .word ofs_003_942A_F8_запись_палитры - 1
- D - - - - 0x001307 00:92F7: 34 94     .word ofs_003_9435_F9 - 1
- D - - - - 0x001309 00:92F9: 41 94     .word ofs_003_9442_FA_разговор - 1
- - - - - - 0x00130B 00:92FB: 8E 94     .word $0000
- - - - - - 0x00130D 00:92FD: 8E 94     .word $0000
- - - - - - 0x00130F 00:92FF: 8E 94     .word $0000
- - - - - - 0x001311 00:9301: 91 94     .word ofs_003_9492_FE - 1
- D - - - - 0x001313 00:9303: BB 94     .word ofs_003_94BC_FF - 1
...
loc_93DE:
C D - - - - 0x0013EE 00:93DE: A0 01     LDY #$01
...
loc_9413:
C D - - - - 0x001423 00:9413: A9 00     LDA #$00
...
loc_9459:
C D - - - - 0x001469 00:9459: 24 99     BIT ram_0099
...
loc_94C1:
C D - - - - 0x0014D1 00:94C1: A5 94     LDA ram_0094
...
C D - - - - 0x001525 00:9515: A0 00     LDY #$00
...
loc_9541:
C D - - - - 0x001551 00:9541: 29 01     AND #$01
...
loc_9645:
C D - - - - 0x001655 00:9645: 29 01     AND #$01
...
C D - - - - 0x001694 00:9684: 38        SEC
C - - - - - 0x001695 00:9685: E9 F8     SBC #$F8
C - - - - - 0x001697 00:9687: 0A        ASL
C - - - - - 0x001698 00:9688: AA        TAX
C - - - - - 0x001699 00:9689: BD 93 96  LDA tbl_9692_управляющие_байты_спрайтов_анимации + 1,X
...
- D - - - - 0x0016A6 00:9696: A4 96     .word ofs_004_96A5_FA_прыжок_с_возвратом - 1
- D - - - - 0x0016A8 00:9698: C6 96     .word ofs_004_96C7_FB_прыжок - 1
- - - - - - 0x0016AA 00:969A: A1 96     .word $0000
- - - - - - 0x0016AC 00:969C: A1 96     .word $0000
- D - - - - 0x0016AE 00:969E: D5 96     .word ofs_004_96D6_FE - 1
- D - - - - 0x0016B0 00:96A0: F1 96     .word ofs_004_96F2_FF_выход - 1
...
C - - - - - 0x001710 00:9700: 4C 27 97  JMP loc_9727  ; bzk опт, можно заменить на BNE
bra_9703:
...
bra_9727:
loc_9727:
C D - - - - 0x001737 00:9727: A5 98     LDA ram_0098
...
tbl_978B:
; 00-1F
- D - - - - 0x00179B 00:978B: 80        .byte $80
- D - - - - 0x00179C 00:978C: 01        .byte $01   ; <あ>
- D - - - - 0x00179D 00:978D: 00        .byte $00
- D - - - - 0x00179E 00:978E: 00        .byte $00
- D - - - - 0x00179F 00:978F: 00        .byte $00
- D - - - - 0x0017A0 00:9790: 30        .byte $30   ; <ゃ>
- D - - - - 0x0017A1 00:9791: 00        .byte $00
- D - - - - 0x0017A2 00:9792: 40        .byte $40   ; <「>
- D - - - - 0x0017A3 00:9793: 00        .byte $00
- D - - - - 0x0017A4 00:9794: 00        .byte $00
- D - - - - 0x0017A5 00:9795: 00        .byte $00
- D - - - - 0x0017A6 00:9796: 00        .byte $00
- D - - - - 0x0017A7 00:9797: 00        .byte $00
- D - - - - 0x0017A8 00:9798: 00        .byte $00
- D - - - - 0x0017A9 00:9799: 00        .byte $00
- D - - - - 0x0017AA 00:979A: 00        .byte $00
- D - - - - 0x0017AB 00:979B: 00        .byte $00
- D - - - - 0x0017AC 00:979C: 00        .byte $00
- D - - - - 0x0017AD 00:979D: 00        .byte $00
- D - - - - 0x0017AE 00:979E: 00        .byte $00
- D - - - - 0x0017AF 00:979F: 00        .byte $00
- D - - - - 0x0017B0 00:97A0: 00        .byte $00
- D - - - - 0x0017B1 00:97A1: 00        .byte $00
- D - - - - 0x0017B2 00:97A2: 00        .byte $00
- D - - - - 0x0017B3 00:97A3: 00        .byte $00
- D - - - - 0x0017B4 00:97A4: 00        .byte $00
- D - - - - 0x0017B5 00:97A5: 00        .byte $00
- D - - - - 0x0017B6 00:97A6: 00        .byte $00
- D - - - - 0x0017B7 00:97A7: 00        .byte $00
- D - - - - 0x0017B8 00:97A8: 00        .byte $00
- D - - - - 0x0017B9 00:97A9: 00        .byte $00
- D - - - - 0x0017BA 00:97AA: 00        .byte $00
...
loc_97C4:
C D - - - - 0x0017D4 00:97C4: 84 E6     STY ram_00E6
...
C - - - - - 0x001826 00:9816: 50 B0     BVC bra_97C8_повторить_цикл
...
bra_9877_закончить:
C - - - - - 0x001887 00:9877: A5 21     LDA ram_для_2001
C - - - - - 0x001889 00:9879: 09 18     ORA #$18
C - - - - - 0x00188B 00:987B: 8D 01 20  STA $2001
C - - - - - 0x00188E 00:987E: 85 21     STA ram_для_2001
...
sub_0x0018A5:
loc_0x0018A5:
C D - - - - 0x0018A5 00:9895: 84 E6     STY ram_00E6
...
C D - - - - 0x0018F8 00:98E8: A9 00     LDA #$00
...
loc_99DC:
C D - - - - 0x0019EC 00:99DC: A5 4B     LDA ram_степень_яркости_спрайтов
...
loc_99F0_цикл:
C D - - - - 0x001A00 00:99F0: A5 4A     LDA ram_степень_яркости_фона
...
C - - - - - 0x001A19 00:9A09: 4C F0 99  JMP loc_99F0_цикл
bra_9A0C_RTS:
...
sub_0x001A1D:
loc_9A0D_цикл:
C D - - - - 0x001A1D 00:9A0D: A5 4A     LDA ram_степень_яркости_фона
...
C - - - - - 0x001A2B 00:9A1B: 4C 0D 9A  JMP loc_9A0D_цикл
bra_9A1E_RTS:
...
sub_9A1F:
loc_9A1F:
C D - - - - 0x001A2F 00:9A1F: A5 4B     LDA ram_степень_яркости_спрайтов
...
sub_9A71:
loc_9A71:
C D - - - - 0x001A81 00:9A71: A9 20     LDA #$20
...
C D - - - - 0x001B09 00:9AF9: A0 00     LDY #$00
bra_9AFB_loop:
...
sub_9B07:
C - - - - - 0x001B17 00:9B07: A5 25     LDA ram_для_5115
...
C D - - - - 0x001B6E 00:9B5E: A9 00     LDA #$00
...
C - - - - - 0x001B7F 00:9B6F: 86 9E     STX ram_для_5124
C - - - - - 0x001B81 00:9B71: 84 9F     STY ram_для_5125
C - - - - - 0x001B83 00:9B73: 60        RTS



sub_0x001B84_запись_вторых_двух_банков_спрайтов:
C - - - - - 0x001B84 00:9B74: 86 A0     STX ram_для_5126
C - - - - - 0x001B86 00:9B76: 84 A1     STY ram_для_5127
...
C D - - - - 0x001B8F 00:9B7F: A2 00     LDX #$00
...
loc_9BE0:
C D - - - - 0x001BF0 00:9BE0: 85 7B     STA ram_007B
...
C D - - - - 0x001C38 00:9C28: 84 E6     STY ram_00E6
...
loc_9C73_loop:
C D - - - - 0x001C83 00:9C73: 85 E8     STA ram_00E8
bra_9C75_loop:
...
C - - - - - 0x001CB9 00:9CA9: CD 52 04  CMP ram_забаненный_игрок + 1
C - - - - - 0x001CBC 00:9CAC: F0 C7     BEQ bra_9C75_loop
C - - - - - 0x001CBE 00:9CAE: CD 53 04  CMP ram_забаненный_игрок + 2
C - - - - - 0x001CC1 00:9CB1: F0 C2     BEQ bra_9C75_loop
loc_9CB3:
bra_9CB3_loop:
C D - - - - 0x001CC3 00:9CB3: A9 01     LDA #$01
...
loc_9EED:
loc_0x001EFD:
C D - - - - 0x001EFD 00:9EED: A2 01     LDX #$01
bra_9EEF_loop:
...
C - - - - - 0x001F2C 00:9F1C: 85 25     STA ram_для_5115
                                        ORA #$80
C - - - - - 0x001F2E 00:9F1E: 8D 01 80  STA $5115
C - - - - - 0x001F3A 00:9F2A: B5 02     LDA ram_0002,X
C - - - - - 0x001F3C 00:9F2C: 85 24     STA ram_для_5114
                                        ORA #$80
...
C - - - - - 0x001F7F 00:9F6F: 99 01 01  STA ram_stack + 1,Y
C - - - - - 0x001F82 00:9F72: B5 01     LDA ram_0001,X
C - - - - - 0x001F84 00:9F74: 99 02 01  STA ram_stack + 2,Y
...
loc_9F7E:
C D - - - - 0x001F8E 00:9F7E: A9 00     LDA #$00
...
C - - - - - 0x001FDC 00:9FCC: AD 24 00  LDA ram_для_5114
C - - - - - 0x001FDF 00:9FCF: 95 02     STA ram_0002,X
C - - - - - 0x001FE1 00:9FD1: AD 25 00  LDA ram_для_5115
