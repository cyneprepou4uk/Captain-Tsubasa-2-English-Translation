...
bra_8611:
C - - - - 0x038621 24:8611: AD 00 06  LDA ram_колво_нападающих
...
C - - - - 0x038633 24:8623: BD 01 06  LDA ram_номер_нападающего,X
...
C - - - - 0x038649 24:8639: CD 00 06  CMP ram_колво_нападающих
