...
_scenario_8AB1_00:
    .byte con_branch, con_bra_34 + $00     ; узнать высоту мяча
...
off_case_00_00_00_02_pass_cut:
                            ...
                            .byte con_branch, con_bra_03 + $80     ; результат действия защитника
...
_scenario_9205_0F:
    .byte con_mirror_condition, $01       ; номер защитника
    .byte con_branch, con_bra_43 + $00         ; действие атакующего на своей штрафной
...
off_case_0F_00_00_мяч_низкий:
                    .byte con_branch, con_bra_05 + $80     ; порядковый номер защитника
...
off_case_12_00_00_защитник_выживет:
    .byte con_branch, con_bra_03 + $00     ; результат действия защитника
...
_scenario_9369_09:
    ...
    .byte con_branch, con_bra_02 + $00     ; действие защитника (кипера)
...
off_case_09_01_00_01:
    .byte con_branch, con_bra_0C + $80     ; обычный или спешал
...
off_case_09_00_01_01_защитник_убьется:
    .byte con_branch, con_bra_03 + $80     ; результат действия кипера
...
_scenario_96E3_0C:
    ...
    .byte con_jsr
    .word sub_9EF6_выбор_анимации_полета_удара
    .byte con_branch, con_bra_03 + $80     ; результат действия защитника     ; ? порвется ли мяч
...
off_case_0C_01_мяч_порвется:
    .byte con_branch, con_bra_0C + $80     ; обычный или спешал     ; ? порвется ли мяч
    .byte off_case_96F0_00_мяч_не_порвется - *
...
_scenario_96F7_0D:
    ...
    .byte con_jsr
    .word sub_B4E7
    .byte con_branch, con_bra_13 + $80     ; появится ли спасающий ворота защитник
...
_scenario_9C30_30:
    .byte con_branch, con_bra_22 + $00     ; у чьей команды мяч
...
bra_long_case_30_00_мяч_у_команды_слева:
            ...
            .byte con_branch, con_bra_21 + $00     ; порвана ли сетка
...
loc_A275_мерцание_фона_с_портретом_игроков:
                            ...
                            .byte con_animation + con_skip
                            .byte con_cloud + con_skip
                            .byte con_branch, con_bra_26 + $80     ; проигрывает ли германия
...
off_case_30_00_00_02_00_германия_не_проигрывает:
                                    .byte con_branch, con_bra_2D + $80     ; забил ли гол jito с sano
...
off_case_9CA3_02_dribble:
            .byte con_branch, con_bra_1C + $00     ; спешал дриблинг
...
_scenario_9CEE_1D:
    .byte con_branch, con_bra_34 + $80     ; узнать высоту мяча
...
_scenario_9E57_32:
    .byte con_mirror_off
    .byte con_branch, con_bra_41 + $00     ; какая у кипера рожа
...
sub_9F6E_рандом_анимации_отпизженного_игрока_с_сообщением:
    .byte con_branch, con_bra_42 + $00     ; 2 варианта рандома
    .word off_case_A224_00_рандом_1 - *
    .word off_case_A229_01_рандом_2 - *
...
sub_9F7A_защитнику_бежит_к_низкому_мячу_блоком:
    .byte con_branch, con_bra_33 + $00     ; защитный спешал
...
sub_9F9C_крит_кипера:
    .byte con_branch, con_bra_2F + $80     ; киперы с критами
...
sub_A3CF_kurae_если_не_спешал:
    .byte con_branch, con_bra_33 + $80     ; защитный спешал
...
sub_A6E0_защитник_бежит_к_низкому_мячу:
    .byte con_branch, con_bra_37 + $80     ; защитный спешал или нет
...
bra_long_case_9CA3_02_02_forcible_dribble:
    .byte con_branch, con_bra_force_drib + $80
...
bra_long_case_9CA3_02_06_hedgehog_dribble:
    .byte con_branch, con_bra_3A + $80     ; проверка на kaltz
...
bra_long_case_AC6E_0D_neo_tiger_shot:
    .byte con_branch, con_bra_2C + $80     ; напали ли защитники
...
bra_long_case_B0FB_21_slider_cannon:
    .byte con_branch, con_bra_25 + $80     ; slider cannon уже били или нет
...
bra_long_case_B1CA_09_twin_shot:
    .byte con_branch, con_bra_49 + $80     ; twin shot
...
_scenario_B486_1B:
    .byte con_mirror_condition, $00
    .byte con_branch, con_bra_0C + $00     ; обычный или спешал
...
bra_long_case_B61D_17_mach_shot:
    ...
    .byte con_animation + $00
    .byte con_cloud + con_clear
    .byte con_branch, con_bra_25 + $80     ; coimbra уже бил или нет
...
off_case_B63F_00_coimbra_еще_не_бил:
    ...
    .byte con_mirror_off
    .byte con_branch, con_bra_41 + $80     ; какая у кипера рожа
...
_scenario_B738_20:
    .byte con_jsr
    .word sub_BBC7_очистка
    .byte con_branch, con_bra_22 + $80     ; у чьей команды мяч
...
off_case_BBE2_01_мяч_порвется:
    .byte con_branch, con_bra_49 + $80     ; спешал перепасовка
