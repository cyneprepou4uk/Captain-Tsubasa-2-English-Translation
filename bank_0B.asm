...
bra_8329:
loc_8329:
C D 0 - - - 0x016339 0B:8329: B1 52     LDA (ram_0052),Y
loc_832B:
...
_off005_88E3_01:
- D 0 - I - 0x0168F3 0B:88E3: F0        .byte con___F0
...
_off005_8B3E_72:
- D 0 - I - 0x016B4E 0B:8B3E: F2        .byte con___F2
...
.out .sprintf("Free bytes in bank 0B: 0x%04X [%d]", ($A000 - *), ($A000 - *))
