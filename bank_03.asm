...
C - - - - 0x004350 03:A340: 20 BD C4  JSR sub_0x03C4CD_банксвич_PRG_5115
...
C - - - - 0x004688 03:A678: 20 28 9B  JSR sub_0x001B38_запись_в_буфер
...
C - - - - 0x00481D 03:A80D: 20 CA 88  JSR sub_0x0008DA_запись_символа_в_буфер_с_учетом_кодировки
...
C - - - - 0x004832 03:A822: 20 CA 88  JSR sub_0x0008DA_запись_символа_в_буфер_с_учетом_кодировки
