...
; bzk цикл проходит с X 01-02, поменять на 00-01 чтобы улучшить комментарии
C - - - - 0x0040E7 03:A0D7: A2 02     LDX #$02
C - - - - 0x0040E9 03:A0D9: A9 04     LDA #$04
C - - - - 0x0040EB 03:A0DB: 85 40     STA ram_0040
bra_A0DD:
C - - - - 0x0040ED 03:A0DD: B5 1B     LDA ram_удержанные - 1,X
bra_A0DF:
...
bra_A0ED:
C - - - - 0x0040FD 03:A0ED: BD 15 40  LDA $4015,X
...
bra_A107:
C - - - - 0x004117 03:A107: B5 1B     LDA ram_удержанные - 1,X
C - - - - 0x004119 03:A109: 45 3F     EOR ram_003F
C - - - - 0x00411B 03:A10B: 25 3F     AND ram_003F
C - - - - 0x00411D 03:A10D: 95 1D     STA ram_одноразовые - 1,X
C - - - - 0x00411F 03:A10F: A5 3F     LDA ram_003F
C - - - - 0x004121 03:A111: 95 1B     STA ram_удержанные - 1,X
loc_A113:
C - - - - 0x004123 03:A113: CA        DEX
C - - - - 0x004124 03:A114: D0 C7     BNE bra_A0DD
...
C - - - - 0x00443D 03:A42D: 85 E7     STA ram_00E7
...
; bzk сюда 2 прыжка, и перед ними запись в 00E7, а тут чтение 00E7
; сэкономить место, поставив запись здесь и избавиться от чтения
C - - - - 0x004464 03:A454: A5 E7     LDA ram_00E7
...
bra_A8D5:
C - - - - 0x0048E5 03:A8D5: BE 68 04  LDX ram_копия_спрайт_Y,Y
C - - - - 0x0048E8 03:A8D8: B9 6A 04  LDA ram_копия_спрайт_атрибут,Y
C - - - - 0x0048EB 03:A8DB: 29 0C     AND #$0C
C - - - - 0x0048ED 03:A8DD: F0 02     BEQ bra_A8E1_скрыть_спрайт
C - - - - 0x0048EF 03:A8DF: A2 F8     LDX #$F8
bra_A8E1_скрыть_спрайт:
; bzk если спрайт будет скрыт, нет необходимости копировать остальные атрибуты
; поместить запись координаты Y в конец и поменять переход
C - - - - 0x0048F1 03:A8E1: 8A        TXA
...
; bzk
- - - - - 0x004BA4 03:AB94: A9 08     LDA #$08
- - - - - 0x004BA6 03:AB96: 8D 00 20  STA $2000
- - - - - 0x004BA9 03:AB99: A9 00     LDA #$00
- - - - - 0x004BAB 03:AB9B: 8D 01 20  STA $2001
- - - - - 0x004BAE 03:AB9E: 8D 05 20  STA $2005
- - - - - 0x004BB1 03:ABA1: 8D 05 20  STA $2005
- - - - - 0x004BB4 03:ABA4: A9 00     LDA #$00
- - - - - 0x004BB6 03:ABA6: A0 01     LDY #$01
bra_ABA8:
- - - - - 0x004BB8 03:ABA8: 99 FF 01  STA ram_спрайт_Y - 1,Y
- - - - - 0x004BBB 03:ABAB: C8        INY
- - - - - 0x004BBC 03:ABAC: D0 FA     BNE bra_ABA8
- - - - - 0x004BBE 03:ABAE: A9 00     LDA #$00
- - - - - 0x004BC0 03:ABB0: 8D 03 20  STA $2003
- - - - - 0x004BC3 03:ABB3: A9 02     LDA #$02
- - - - - 0x004BC5 03:ABB5: 8D 14 40  STA $4014
- - - - - 0x004BC8 03:ABB8: A9 00     LDA #$00
- - - - - 0x004BCA 03:ABBA: 8D 00 80  STA $8000
- - - - - 0x004BCD 03:ABBD: 8D 01 80  STA $8001
- - - - - 0x004BD0 03:ABC0: A9 01     LDA #$01
- - - - - 0x004BD2 03:ABC2: 8D 00 80  STA $8000
- - - - - 0x004BD5 03:ABC5: A9 02     LDA #$02
- - - - - 0x004BD7 03:ABC7: 8D 01 80  STA $8001
- - - - - 0x004BDA 03:ABCA: A9 20     LDA #$20
- - - - - 0x004BDC 03:ABCC: 8D 06 20  STA $2006
- - - - - 0x004BDF 03:ABCF: A9 00     LDA #$00
- - - - - 0x004BE1 03:ABD1: 8D 06 20  STA $2006
- - - - - 0x004BE4 03:ABD4: A2 10     LDX #$10
- - - - - 0x004BE6 03:ABD6: A0 00     LDY #$00
bra_ABD8:
- - - - - 0x004BE8 03:ABD8: A9 00     LDA #$00
- - - - - 0x004BEA 03:ABDA: 8D 07 20  STA $2007
- - - - - 0x004BED 03:ABDD: 88        DEY
- - - - - 0x004BEE 03:ABDE: D0 F8     BNE bra_ABD8
- - - - - 0x004BF0 03:ABE0: CA        DEX
- - - - - 0x004BF1 03:ABE1: D0 F5     BNE bra_ABD8
loc_ABE3:
- - - - - 0x004BF3 03:ABE3: A9 00     LDA #$00
- - - - - 0x004BF5 03:ABE5: 85 E8     STA ram_00E8
- - - - - 0x004BF7 03:ABE7: 85 E9     STA ram_00E9
- - - - - 0x004BF9 03:ABE9: A9 20     LDA #$20
- - - - - 0x004BFB 03:ABEB: 85 EB     STA ram_00EB
loc_ABED:
- - - - - 0x004BFD 03:ABED: A9 02     LDA #$02
- - - - - 0x004BFF 03:ABEF: 85 E6     STA ram_00E6
- - - - - 0x004C01 03:ABF1: A9 21     LDA #$21
- - - - - 0x004C03 03:ABF3: 85 E7     STA ram_00E7
- - - - - 0x004C05 03:ABF5: A9 08     LDA #$08
- - - - - 0x004C07 03:ABF7: 85 EA     STA ram_00EA
loc_ABF9:
- - - - - 0x004C09 03:ABF9: A5 E7     LDA ram_00E7
- - - - - 0x004C0B 03:ABFB: 8D 06 20  STA $2006
- - - - - 0x004C0E 03:ABFE: A5 E6     LDA ram_00E6
- - - - - 0x004C10 03:AC00: 8D 06 20  STA $2006
- - - - - 0x004C13 03:AC03: A5 E9     LDA ram_00E9
- - - - - 0x004C15 03:AC05: 20 71 AC  JSR sub_AC71
- - - - - 0x004C18 03:AC08: 8D 07 20  STA $2007
- - - - - 0x004C1B 03:AC0B: A5 E8     LDA ram_00E8
- - - - - 0x004C1D 03:AC0D: 20 6D AC  JSR sub_AC6D
- - - - - 0x004C20 03:AC10: 8D 07 20  STA $2007
- - - - - 0x004C23 03:AC13: A5 E8     LDA ram_00E8
- - - - - 0x004C25 03:AC15: 20 71 AC  JSR sub_AC71
- - - - - 0x004C28 03:AC18: 8D 07 20  STA $2007
- - - - - 0x004C2B 03:AC1B: A9 00     LDA #$00
- - - - - 0x004C2D 03:AC1D: 8D 07 20  STA $2007
- - - - - 0x004C30 03:AC20: 8D 07 20  STA $2007
- - - - - 0x004C33 03:AC23: A0 00     LDY #$00
bra_AC25:
- - - - - 0x004C35 03:AC25: B1 E8     LDA (ram_00E8),Y
- - - - - 0x004C37 03:AC27: 20 6D AC  JSR sub_AC6D
- - - - - 0x004C3A 03:AC2A: 8D 07 20  STA $2007
- - - - - 0x004C3D 03:AC2D: B1 E8     LDA (ram_00E8),Y
- - - - - 0x004C3F 03:AC2F: 20 71 AC  JSR sub_AC71
- - - - - 0x004C42 03:AC32: 8D 07 20  STA $2007
- - - - - 0x004C45 03:AC35: A9 00     LDA #$00
- - - - - 0x004C47 03:AC37: 8D 07 20  STA $2007
- - - - - 0x004C4A 03:AC3A: C8        INY
- - - - - 0x004C4B 03:AC3B: C0 08     CPY #$08
- - - - - 0x004C4D 03:AC3D: D0 E6     BNE bra_AC25
- - - - - 0x004C4F 03:AC3F: A5 E8     LDA ram_00E8
- - - - - 0x004C51 03:AC41: 18        CLC
- - - - - 0x004C52 03:AC42: 69 08     ADC #$08
- - - - - 0x004C54 03:AC44: 85 E8     STA ram_00E8
- - - - - 0x004C56 03:AC46: A5 E9     LDA ram_00E9
- - - - - 0x004C58 03:AC48: 69 00     ADC #$00
- - - - - 0x004C5A 03:AC4A: 85 E9     STA ram_00E9
- - - - - 0x004C5C 03:AC4C: A5 E6     LDA ram_00E6
- - - - - 0x004C5E 03:AC4E: 18        CLC
- - - - - 0x004C5F 03:AC4F: 69 40     ADC #$40
- - - - - 0x004C61 03:AC51: 85 E6     STA ram_00E6
- - - - - 0x004C63 03:AC53: A5 E7     LDA ram_00E7
- - - - - 0x004C65 03:AC55: 69 00     ADC #$00
- - - - - 0x004C67 03:AC57: 85 E7     STA ram_00E7
- - - - - 0x004C69 03:AC59: C6 EA     DEC ram_00EA
- - - - - 0x004C6B 03:AC5B: F0 03     BEQ bra_AC60
- - - - - 0x004C6D 03:AC5D: 4C F9 AB  JMP loc_ABF9
bra_AC60:
- - - - - 0x004C70 03:AC60: 20 7E AC  JSR sub_AC7E
- - - - - 0x004C73 03:AC63: C6 EB     DEC ram_00EB
- - - - - 0x004C75 03:AC65: F0 03     BEQ bra_AC6A
- - - - - 0x004C77 03:AC67: 4C ED AB  JMP loc_ABED
bra_AC6A:
- - - - - 0x004C7A 03:AC6A: 4C E3 AB  JMP loc_ABE3
...
; bzk
sub_AC7E:
- - - - - 0x004C8E 03:AC7E: A9 18     LDA #$18
- - - - - 0x004C90 03:AC80: 8D 01 20  STA $2001
- - - - - 0x004C93 03:AC83: A9 00     LDA #$00
- - - - - 0x004C95 03:AC85: 8D 05 20  STA $2005
- - - - - 0x004C98 03:AC88: 8D 05 20  STA $2005
- - - - - 0x004C9B 03:AC8B: A8        TAY
- - - - - 0x004C9C 03:AC8C: AA        TAX
- - - - - 0x004C9D 03:AC8D: A9 40     LDA #$40
bra_AC8F:
- - - - - 0x004C9F 03:AC8F: 88        DEY
- - - - - 0x004CA0 03:AC90: D0 FD     BNE bra_AC8F
- - - - - 0x004CA2 03:AC92: CA        DEX
- - - - - 0x004CA3 03:AC93: D0 FA     BNE bra_AC8F
- - - - - 0x004CA5 03:AC95: 38        SEC
- - - - - 0x004CA6 03:AC96: E9 01     SBC #$01
- - - - - 0x004CA8 03:AC98: D0 F5     BNE bra_AC8F
- - - - - 0x004CAA 03:AC9A: A9 00     LDA #$00
- - - - - 0x004CAC 03:AC9C: 8D 01 20  STA $2001
- - - - - 0x004CAF 03:AC9F: 8D 05 20  STA $2005
- - - - - 0x004CB2 03:ACA2: 8D 05 20  STA $2005
- - - - - 0x004CB5 03:ACA5: 60        RTS
