...
.export loc_0x0042BF
loc_0x0042BF:
C D - - - 0x0042BF 03:A2AF: 20 F0 99  JSR sub_0x001A00_опция_выход
...
C D - - - 0x0043E8 03:A3D8: 20 F0 99  JSR sub_0x001A00_опция_выход
...
C - - - - 0x00445E 03:A44E: 20 F0 99  JSR sub_0x001A00_опция_выход
...
C - - - - 0x004548 03:A538: 20 F0 99  JSR sub_0x001A00_опция_выход
