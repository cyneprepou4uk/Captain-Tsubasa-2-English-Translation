...
off_B398_1A_цубаса_планирует_циклон_1:
    ...
    .byte con_катсцена_FB, $02, $BD, $9B
    .byte con_катсцена_осветление_экрана
    .byte con_катсцена_задержка, $3C
    .byte con_катсцена_номер_звука, $04
    .byte con_катсцена_F8, $10
    .byte con_катсцена_задержка, $50
    .byte con_катсцена_скорость_текста, $02
    .byte con_катсцена_смещение_текста, $02
    .text "(OK -"
...
off_B71E_1C_цубаса_изучил_циклон:
    ...
    .byte con_катсцена_FB, $01, $AC
    .byte con_катсцена_номер_звука, $70
    .byte con_катсцена_задержка, $78
    .byte con_катсцена_F8, $11
    .byte con_катсцена_осветление_экрана
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_F3, $27
    .byte con_катсцена_задержка, $03
    .byte con_катсцена_F3, $0C
    .byte con_катсцена_задержка, $02
    .byte con_катсцена_F3, $27
    .byte con_катсцена_задержка, $03
    .byte con_катсцена_F3, $0C
    .byte con_катсцена_задержка, $0A
    .byte con_катсцена_F3, $11
    ...
    .byte con_катсцена_FB, $02, $BE, $72
    .byte con_катсцена_номер_звука, $10
    .byte con_катсцена_затемнение_экрана
    .byte con_катсцена_задний_фон, $68
    .byte con_катсцена_FB, $03, $89, $AA, $BF
    ...
    .byte con_катсцена_затемнение_экрана
    .byte con_катсцена_затереть_текст
    .byte con_катсцена_FA, $48
    .byte con_катсцена_FB, $01, $35
    .byte con_катсцена_осветление_экрана
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_смещение_текста, $03
    ...
    .byte con_катсцена_FA, $53
    .byte con_катсцена_FB, $01, $AB
    .byte con_катсцена_F7
    .byte con_катсцена_F3, $00
    .byte con_катсцена_F8, $11
    .byte con_катсцена_задержка, $78
    ...
    .byte con_катсцена_FB, $01, $A4
    .byte con_катсцена_F7
    .byte con_катсцена_F3, $FF, $13, $01
    ...
    .byte con_катсцена_задержка, $78
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_FA, $3E
    .byte con_катсцена_FB, $02, $A7, $A8
    .byte con_катсцена_F8, $12
    .byte con_катсцена_F7
    .byte con_катсцена_FA, $41
    .byte con_катсцена_F8, $11
    .byte con_катсцена_F3, $FF, $28, $44
    .byte con_катсцена_задержка, $50
    .byte con_катсцена_F3, $FF, $29, $45
    .byte con_катсцена_задержка, $50
    .byte con_катсцена_номер_звука, $70
    .byte con_катсцена_F3, $FF, $2A, $1E
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_задержка, $F0
    .byte con_катсцена_скорость_текста, $08
    ...
    .byte con_катсцена_задержка, $3C
    .byte con_катсцена_F3, $2B
    .byte con_катсцена_задержка, $03
    .byte con_катсцена_F3, $2A
    .byte con_катсцена_задержка, $02
    .byte con_катсцена_F3, $2B
    .byte con_катсцена_задержка, $03
    .byte con_катсцена_F3, $2A
...
off_BA74_1D_после_победы_над_аргентиной:
    ...
    .byte con_катсцена_FA, $59
    .byte con_катсцена_FB, $01, $83
    .byte con_катсцена_F7
    .byte con_катсцена_F3, $00
    .byte con_катсцена_номер_звука, $09
    ...
    .byte con_катсцена_задержка, $50
    .byte con_катсцена_FA, $40
    .byte con_катсцена_F5, $FF
    
    
    
    .byte con_катсцена_частично_затереть_текст
    .byte con_катсцена_FB, $03, $C0, $7E, $94
    .byte con_катсцена_F3, $00
    .byte con_катсцена_номер_звука, $0B
    .byte con_катсцена_задержка, $0F
